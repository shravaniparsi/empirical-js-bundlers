...
import styles from './ProductsColorPicker1.module.css';


interface ProductsColorPicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ProductsColorPicker1({
  label,
  name,
