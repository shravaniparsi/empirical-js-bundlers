...
import ProductsInfiniteScroll1 from './ProductsInfiniteScroll1';
import styles from './ProductsBadge.module.css';

interface ProductsBadgeItem {
  priority: number;
  createdAt: Date;
  title: string;
  tags: string[];
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['priority', 'createdAt', 'title']);
