...
import AnalyticsAlert1 from '../analytics/AnalyticsAlert1';
import styles from './ProductsRetry.module.css';
...
interface ProductsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
