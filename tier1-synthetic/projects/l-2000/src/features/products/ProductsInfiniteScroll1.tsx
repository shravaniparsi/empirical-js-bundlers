...
import styles from './ProductsInfiniteScroll1.module.css';
...
interface ProductsInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: ProductsInfiniteScroll1Props<T>) {
