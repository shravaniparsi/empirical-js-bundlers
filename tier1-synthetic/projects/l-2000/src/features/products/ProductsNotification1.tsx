...
import ProductsScroll2 from './ProductsScroll2';
import ProductsPaginated from './ProductsPaginated';
import styles from './ProductsNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProductsNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProductsNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
