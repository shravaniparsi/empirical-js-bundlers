...
import ProductsRangeSlider from './ProductsRangeSlider';
import styles from './ProductsRank.module.css';

interface ProductsRankItem {
  assignee: string;
  title: string;
  updatedAt: Date;
  status: string;
...
interface ProductsRankProps {
  items?: ProductsRankItem[];
