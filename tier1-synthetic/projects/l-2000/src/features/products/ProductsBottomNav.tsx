...
import ProductsInfiniteScroll2 from './ProductsInfiniteScroll2';
import ProductsSparkline from './ProductsSparkline';
import WebhooksRegistry from '../webhooks/WebhooksRegistry';
import WebhooksFeed1 from '../webhooks/WebhooksFeed1';
import DashboardSpacer from '../dashboard/DashboardSpacer';
import ProfileLoader1 from '../profile/ProfileLoader1';
import styles from './ProductsBottomNav.module.css';
...
interface ProductsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function ProductsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProductsBottomNav">
      {activeItem && (
