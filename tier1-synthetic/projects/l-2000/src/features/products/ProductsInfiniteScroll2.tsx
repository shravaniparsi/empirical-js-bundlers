...
import styles from './ProductsInfiniteScroll2.module.css';
...
interface ProductsInfiniteScroll2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsInfiniteScroll2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: ProductsInfiniteScroll2Props<T>) {
