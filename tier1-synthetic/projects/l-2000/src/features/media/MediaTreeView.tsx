...
import styles from './MediaTreeView.module.css';
...
export default function MediaTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="MediaTreeView">
      {activeItem && (
