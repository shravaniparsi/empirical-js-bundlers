...
import { z } from 'zod';
import MediaGrid1 from './MediaGrid1';
import styles from './MediaColorPicker.module.css';

const MediaColorPickerSchema = z.object({
...
export default function MediaColorPicker({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = MediaColorPickerSchema.safeParse({ value: val });
