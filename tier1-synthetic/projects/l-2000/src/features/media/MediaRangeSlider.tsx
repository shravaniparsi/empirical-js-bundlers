...
import DocumentsFileUpload from '../documents/DocumentsFileUpload';
import PaymentsContext from '../payments/PaymentsContext';
import styles from './MediaRangeSlider.module.css';

const MediaRangeSliderSchema = z.object({
...
export default function MediaRangeSlider({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = MediaRangeSliderSchema.safeParse({ value: val });
