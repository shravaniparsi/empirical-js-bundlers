...
import DocumentsRadio1 from '../documents/DocumentsRadio1';
import styles from './WebhooksDonut.module.css';
...
export default function WebhooksDonut({
  data,
  title,
  height = 300,
  showLegend = true,
