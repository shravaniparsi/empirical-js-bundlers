...
import styles from './WebhooksPreview.module.css';

interface WebhooksPreviewItem {
  priority: number;
  tags: string[];
  description: string;
  id: string;
...
interface WebhooksPreviewProps {
  items?: WebhooksPreviewItem[];
...
export default function WebhooksPreview({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WebhooksPreviewProps) {
