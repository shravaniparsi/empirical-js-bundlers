...
import WebhooksSticky from './WebhooksSticky';
import styles from './WebhooksSummary1.module.css';

interface WebhooksSummary1Item {
  tags: string[];
  updatedAt: Date;
  title: string;
  description: string;
...
interface WebhooksSummary1Props {
  items?: WebhooksSummary1Item[];
...
export default function WebhooksSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WebhooksSummary1Props) {
