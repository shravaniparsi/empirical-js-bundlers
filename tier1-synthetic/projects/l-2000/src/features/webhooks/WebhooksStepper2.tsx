...
import styles from './WebhooksStepper2.module.css';
...
interface WebhooksStepper2Props {
  items: NavItem[];
  activeId?: string;
...
export default function WebhooksStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksStepper2">
      {activeItem && (
