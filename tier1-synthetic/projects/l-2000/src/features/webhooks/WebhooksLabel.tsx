...
import WebhooksFactory1 from './WebhooksFactory1';
import WebhooksRadio from './WebhooksRadio';
import ThemesSparkline from '../themes/ThemesSparkline';
import styles from './WebhooksLabel.module.css';

interface WebhooksLabelItem {
  tags: string[];
  updatedAt: Date;
  title: string;
  status: string;
...
interface WebhooksLabelProps {
  items?: WebhooksLabelItem[];
...
export default function WebhooksLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
