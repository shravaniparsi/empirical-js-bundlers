...
import styles from './WebhooksPolling.module.css';
...
interface WebhooksPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
