...
import styles from './WebhooksBadge.module.css';

interface WebhooksBadgeItem {
  priority: number;
  createdAt: Date;
  tags: string[];
  id: string;
...
interface WebhooksBadgeProps {
  items?: WebhooksBadgeItem[];
...
export default function WebhooksBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
