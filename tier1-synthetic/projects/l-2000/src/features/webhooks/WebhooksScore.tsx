...
import styles from './WebhooksScore.module.css';

interface WebhooksScoreItem {
  title: string;
  priority: number;
  description: string;
  assignee: string;
...
interface WebhooksScoreProps {
  items?: WebhooksScoreItem[];
...
export default function WebhooksScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
