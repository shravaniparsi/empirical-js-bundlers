...
import WebhooksTimePicker from './WebhooksTimePicker';
import WebhooksSlider from './WebhooksSlider';
import WebhooksChip from './WebhooksChip';
import styles from './WebhooksScore1.module.css';

interface WebhooksScore1Item {
  createdAt: Date;
  title: string;
  tags: string[];
  description: string;
...
interface WebhooksScore1Props {
  items?: WebhooksScore1Item[];
...
export default function WebhooksScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
