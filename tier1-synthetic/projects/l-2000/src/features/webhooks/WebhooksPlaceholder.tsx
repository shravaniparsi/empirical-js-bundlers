...
import WebhooksMenu2 from './WebhooksMenu2';
import styles from './WebhooksPlaceholder.module.css';
...
interface WebhooksPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
