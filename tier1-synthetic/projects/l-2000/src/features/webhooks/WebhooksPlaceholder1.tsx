...
import styles from './WebhooksPlaceholder1.module.css';
...
interface WebhooksPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
