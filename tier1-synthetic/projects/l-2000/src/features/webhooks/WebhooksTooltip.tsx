...
import WebhooksSplit from './WebhooksSplit';
import WebhooksPlaceholder from './WebhooksPlaceholder';
import OrdersCollapse1 from '../orders/OrdersCollapse1';
import styles from './WebhooksTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WebhooksTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WebhooksTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
