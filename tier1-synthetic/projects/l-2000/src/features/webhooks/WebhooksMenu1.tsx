...
import styles from './WebhooksMenu1.module.css';
...
export default function WebhooksMenu1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksMenu1">
      {activeItem && (
