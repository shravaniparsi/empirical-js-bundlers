...
import WebhooksSummary1 from './WebhooksSummary1';
import WebhooksFeed1 from './WebhooksFeed1';
import styles from './WebhooksErrorBoundary.module.css';
...
interface WebhooksErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
