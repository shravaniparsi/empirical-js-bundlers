...
import WebhooksFooter from './WebhooksFooter';
import WebhooksPolling from './WebhooksPolling';
import WebhooksMeter from './WebhooksMeter';
import styles from './WebhooksSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WebhooksSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WebhooksSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
