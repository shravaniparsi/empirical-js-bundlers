...
import styles from './WebhooksPolling1.module.css';
...
interface WebhooksPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
