...
import WebhooksMenu1 from './WebhooksMenu1';
import WebhooksPreview from './WebhooksPreview';
import ShippingHeader from '../shipping/ShippingHeader';
import styles from './WebhooksChip.module.css';

interface WebhooksChipItem {
  tags: string[];
  createdAt: Date;
  updatedAt: Date;
  status: string;
...
interface WebhooksChipProps {
  items?: WebhooksChipItem[];
...
export default function WebhooksChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
