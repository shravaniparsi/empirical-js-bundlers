...
import WebhooksRegistry from './WebhooksRegistry';
...
import styles from './WebhooksStepper.module.css';
...
interface WebhooksStepperProps {
  items: NavItem[];
  activeId?: string;
...
export default function WebhooksStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksStepper">
      {activeItem && (
