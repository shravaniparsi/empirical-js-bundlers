...
import styles from './WebhooksPreview1.module.css';

interface WebhooksPreview1Item {
  description: string;
  title: string;
  priority: number;
  status: string;
...
interface WebhooksPreview1Props {
  items?: WebhooksPreview1Item[];
...
export default function WebhooksPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WebhooksPreview1Props) {
