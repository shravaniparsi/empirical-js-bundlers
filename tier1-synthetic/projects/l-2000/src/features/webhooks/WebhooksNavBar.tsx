...
import styles from './WebhooksNavBar.module.css';
...
export default function WebhooksNavBar({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksNavBar">
      {activeItem && (
