...
import styles from './DocumentsRank1.module.css';

interface DocumentsRank1Item {
  assignee: string;
  status: string;
  createdAt: Date;
  updatedAt: Date;
...
interface DocumentsRank1Props {
  items?: DocumentsRank1Item[];
...
export default function DocumentsRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
