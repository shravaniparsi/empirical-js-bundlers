...
import DocumentsRadio1 from './DocumentsRadio1';
import DocumentsSplit from './DocumentsSplit';
import styles from './DocumentsDetail1.module.css';

interface DocumentsDetail1Item {
  updatedAt: Date;
  description: string;
  priority: number;
  tags: string[];
...
interface DocumentsDetail1Props {
  items?: DocumentsDetail1Item[];
...
export default function DocumentsDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: DocumentsDetail1Props) {
