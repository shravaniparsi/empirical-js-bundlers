...
import DocumentsHeatmap1 from './DocumentsHeatmap1';
import DocumentsRetry from './DocumentsRetry';
import SettingsBadge from '../settings/SettingsBadge';
import AnalyticsSticky from '../analytics/AnalyticsSticky';
import styles from './DocumentsGauge.module.css';
...
export default function DocumentsGauge({
  data,
  title,
  height = 300,
  showLegend = true,
