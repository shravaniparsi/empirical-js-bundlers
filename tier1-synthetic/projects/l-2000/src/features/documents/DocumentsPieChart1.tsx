...
import DocumentsHook from './DocumentsHook';
import DocumentsGrid from './DocumentsGrid';
import ThemesRating from '../themes/ThemesRating';
import styles from './DocumentsPieChart1.module.css';
...
interface DocumentsPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function DocumentsPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
