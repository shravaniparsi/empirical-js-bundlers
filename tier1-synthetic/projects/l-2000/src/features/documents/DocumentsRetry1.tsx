...
import styles from './DocumentsRetry1.module.css';
...
interface DocumentsRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
