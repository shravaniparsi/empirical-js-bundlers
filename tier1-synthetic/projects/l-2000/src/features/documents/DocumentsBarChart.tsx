...
import DocumentsBottomNav from './DocumentsBottomNav';
import DocumentsRadio1 from './DocumentsRadio1';
import styles from './DocumentsBarChart.module.css';
...
export default function DocumentsBarChart({
  data,
  title,
  height = 300,
  showLegend = true,
