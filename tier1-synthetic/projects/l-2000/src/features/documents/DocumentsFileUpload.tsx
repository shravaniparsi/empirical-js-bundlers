...
import DocumentsBadge from './DocumentsBadge';
import DocumentsLabel1 from './DocumentsLabel1';
import styles from './DocumentsFileUpload.module.css';


interface DocumentsFileUploadProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function DocumentsFileUpload({
  label,
  name,
