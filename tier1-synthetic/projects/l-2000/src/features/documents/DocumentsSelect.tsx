...
import styles from './DocumentsSelect.module.css';

const DocumentsSelectSchema = z.object({
...
export default function DocumentsSelect({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = DocumentsSelectSchema.safeParse({ value: val });
