...
import CartSparkline from '../cart/CartSparkline';
import ProfileLoader1 from '../profile/ProfileLoader1';
import styles from './DocumentsProgress.module.css';

interface DocumentsProgressItem {
  status: string;
  tags: string[];
  title: string;
  assignee: string;
