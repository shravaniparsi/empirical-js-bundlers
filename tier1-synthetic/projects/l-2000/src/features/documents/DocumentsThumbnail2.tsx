...
import styles from './DocumentsThumbnail2.module.css';

interface DocumentsThumbnail2Item {
  assignee: string;
  title: string;
  description: string;
  id: string;
...
interface DocumentsThumbnail2Props {
  items?: DocumentsThumbnail2Item[];
...
export default function DocumentsThumbnail2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: DocumentsThumbnail2Props) {
