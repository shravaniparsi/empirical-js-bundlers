...
import styles from './DocumentsChip.module.css';

interface DocumentsChipItem {
  status: string;
  priority: number;
  createdAt: Date;
  description: string;
...
interface DocumentsChipProps {
  items?: DocumentsChipItem[];
...
export default function DocumentsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
