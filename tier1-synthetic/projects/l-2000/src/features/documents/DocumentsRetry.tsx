...
import styles from './DocumentsRetry.module.css';
...
interface DocumentsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
