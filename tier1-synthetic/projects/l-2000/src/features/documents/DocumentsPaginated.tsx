...
import DocumentsPopover1 from './DocumentsPopover1';
import styles from './DocumentsPaginated.module.css';
...
interface DocumentsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
