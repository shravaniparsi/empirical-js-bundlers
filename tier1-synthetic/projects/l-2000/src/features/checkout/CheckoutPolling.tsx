...
import styles from './CheckoutPolling.module.css';
...
interface CheckoutPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
