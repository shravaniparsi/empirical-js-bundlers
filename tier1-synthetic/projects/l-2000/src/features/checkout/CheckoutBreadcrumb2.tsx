...
import styles from './CheckoutBreadcrumb2.module.css';
...
interface CheckoutBreadcrumb2Props {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutBreadcrumb2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutBreadcrumb2">
      {activeItem && (
