...
import styles from './CheckoutTag2.module.css';

interface CheckoutTag2Item {
  description: string;
  status: string;
  priority: number;
  assignee: string;
...
interface CheckoutTag2Props {
  items?: CheckoutTag2Item[];
...
export default function CheckoutTag2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
