...
import ReviewsThumbnail from '../reviews/ReviewsThumbnail';
import DocumentsDonut from '../documents/DocumentsDonut';
import WebhooksSticky from '../webhooks/WebhooksSticky';
import styles from './CheckoutInfiniteScroll.module.css';
...
interface CheckoutInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
