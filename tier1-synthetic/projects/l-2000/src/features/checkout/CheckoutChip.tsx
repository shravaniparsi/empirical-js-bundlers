...
import styles from './CheckoutChip.module.css';

interface CheckoutChipItem {
  createdAt: Date;
  title: string;
  status: string;
  tags: string[];
...
interface CheckoutChipProps {
  items?: CheckoutChipItem[];
...
export default function CheckoutChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
