...
import styles from './CheckoutRadio.module.css';

const CheckoutRadioSchema = z.object({
...
export default function CheckoutRadio({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutRadioSchema.safeParse({ value: val });
