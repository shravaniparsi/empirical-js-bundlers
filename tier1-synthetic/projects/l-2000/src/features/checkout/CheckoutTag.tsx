...
import CheckoutBreadcrumb3 from './CheckoutBreadcrumb3';
import CheckoutSummary from './CheckoutSummary';
import DocumentsDonut from '../documents/DocumentsDonut';
import styles from './CheckoutTag.module.css';

interface CheckoutTagItem {
  tags: string[];
  status: string;
  assignee: string;
  title: string;
...
interface CheckoutTagProps {
  items?: CheckoutTagItem[];
