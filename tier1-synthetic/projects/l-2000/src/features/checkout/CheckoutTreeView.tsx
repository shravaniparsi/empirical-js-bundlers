...
import styles from './CheckoutTreeView.module.css';
...
interface CheckoutTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutTreeView">
      {activeItem && (
