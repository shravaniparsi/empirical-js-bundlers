...
import styles from './CheckoutAvatar.module.css';

interface CheckoutAvatarItem {
  updatedAt: Date;
  createdAt: Date;
  status: string;
  description: string;
...
interface CheckoutAvatarProps {
  items?: CheckoutAvatarItem[];
...
export default function CheckoutAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
