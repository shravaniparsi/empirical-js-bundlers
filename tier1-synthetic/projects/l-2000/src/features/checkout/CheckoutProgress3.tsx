...
import styles from './CheckoutProgress3.module.css';

interface CheckoutProgress3Item {
  assignee: string;
  priority: number;
  status: string;
  updatedAt: Date;
...
interface CheckoutProgress3Props {
  items?: CheckoutProgress3Item[];
...
export default function CheckoutProgress3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CheckoutProgress3Props) {
