...
import styles from './CheckoutTreeView1.module.css';
...
interface CheckoutTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutTreeView1">
      {activeItem && (
