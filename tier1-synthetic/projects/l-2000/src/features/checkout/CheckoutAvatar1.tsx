...
import styles from './CheckoutAvatar1.module.css';

interface CheckoutAvatar1Item {
  tags: string[];
  priority: number;
  updatedAt: Date;
  status: string;
...
interface CheckoutAvatar1Props {
  items?: CheckoutAvatar1Item[];
...
export default function CheckoutAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CheckoutAvatar1Props) {
