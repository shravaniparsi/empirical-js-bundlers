...
import CheckoutChip from './CheckoutChip';
import CheckoutFileUpload1 from './CheckoutFileUpload1';
import styles from './CheckoutBreadcrumb1.module.css';
...
interface CheckoutBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutBreadcrumb1">
      {activeItem && (
