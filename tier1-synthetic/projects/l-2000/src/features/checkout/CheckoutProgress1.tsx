...
import CheckoutPieChart1 from './CheckoutPieChart1';
import ShippingTable from '../shipping/ShippingTable';
import styles from './CheckoutProgress1.module.css';

interface CheckoutProgress1Item {
  status: string;
  description: string;
  createdAt: Date;
  tags: string[];
...
interface CheckoutProgress1Props {
  items?: CheckoutProgress1Item[];
...
export default function CheckoutProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CheckoutProgress1Props) {
