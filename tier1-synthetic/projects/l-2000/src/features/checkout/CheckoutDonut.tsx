...
import CheckoutScroll1 from './CheckoutScroll1';
import CheckoutConfirm from './CheckoutConfirm';
import styles from './CheckoutDonut.module.css';
...
export default function CheckoutDonut({
  data,
  title,
  height = 300,
  showLegend = true,
