...
import CheckoutScatter from './CheckoutScatter';
import ThemesSparkline from '../themes/ThemesSparkline';
import styles from './CheckoutFeed.module.css';

interface CheckoutFeedItem {
  title: string;
  tags: string[];
  assignee: string;
  id: string;
...
export default function CheckoutFeed({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
