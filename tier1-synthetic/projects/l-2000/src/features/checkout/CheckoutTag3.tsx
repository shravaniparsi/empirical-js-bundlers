...
import styles from './CheckoutTag3.module.css';

interface CheckoutTag3Item {
  priority: number;
  createdAt: Date;
  updatedAt: Date;
  status: string;
...
interface CheckoutTag3Props {
  items?: CheckoutTag3Item[];
...
export default function CheckoutTag3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
