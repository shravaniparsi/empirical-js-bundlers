...
import CheckoutBarChart from './CheckoutBarChart';
import CheckoutTag1 from './CheckoutTag1';
import styles from './CheckoutFileUpload1.module.css';


interface CheckoutFileUpload1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutFileUpload1({
  label,
  name,
