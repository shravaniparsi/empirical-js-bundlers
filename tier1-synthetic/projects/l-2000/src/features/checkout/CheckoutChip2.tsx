...
import CheckoutPolling from './CheckoutPolling';
import CheckoutChip from './CheckoutChip';
import styles from './CheckoutChip2.module.css';

interface CheckoutChip2Item {
  assignee: string;
  status: string;
  tags: string[];
  updatedAt: Date;
...
interface CheckoutChip2Props {
  items?: CheckoutChip2Item[];
...
export default function CheckoutChip2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
