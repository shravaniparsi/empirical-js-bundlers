...
import { z } from 'zod';
import CheckoutProgress4 from './CheckoutProgress4';
import CheckoutAccordion from './CheckoutAccordion';
import CheckoutChip from './CheckoutChip';
import styles from './CheckoutDatePicker.module.css';

const CheckoutDatePickerSchema = z.object({
...
export default function CheckoutDatePicker({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutDatePickerSchema.safeParse({ value: val });
