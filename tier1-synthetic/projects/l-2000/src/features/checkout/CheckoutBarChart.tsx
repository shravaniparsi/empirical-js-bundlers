...
import SearchTimeline from '../search/SearchTimeline';
import styles from './CheckoutBarChart.module.css';
...
interface CheckoutBarChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CheckoutBarChart({
  data,
  title,
  height = 300,
  showLegend = true,
