...
import NotificationsNavBar1 from './NotificationsNavBar1';
import NotificationsTag from './NotificationsTag';
import styles from './NotificationsSnackbar2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsSnackbar2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsSnackbar2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
