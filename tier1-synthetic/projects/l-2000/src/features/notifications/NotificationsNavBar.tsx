...
import NotificationsPopover1 from './NotificationsPopover1';
import DashboardSpacer from '../dashboard/DashboardSpacer';
import styles from './NotificationsNavBar.module.css';
...
export default function NotificationsNavBar({
  ...
  return (
    <nav className={navClasses} aria-label="NotificationsNavBar">
      {activeItem && (
