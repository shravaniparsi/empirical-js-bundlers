...
import NotificationsDonut from './NotificationsDonut';
import NotificationsPopover1 from './NotificationsPopover1';
import NotificationsTabs from './NotificationsTabs';
import styles from './NotificationsToggle1.module.css';


interface NotificationsToggle1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function NotificationsToggle1({
  label,
  name,
