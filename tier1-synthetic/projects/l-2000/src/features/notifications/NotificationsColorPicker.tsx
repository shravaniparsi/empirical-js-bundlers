...
import styles from './NotificationsColorPicker.module.css';


interface NotificationsColorPickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function NotificationsColorPicker({
  label,
  name,
