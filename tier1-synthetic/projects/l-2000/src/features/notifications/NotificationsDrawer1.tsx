...
import styles from './NotificationsDrawer1.module.css';
...
interface NotificationsDrawer1Props {
  items: NavItem[];
  activeId?: string;
...
export default function NotificationsDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="NotificationsDrawer1">
      {activeItem && (
