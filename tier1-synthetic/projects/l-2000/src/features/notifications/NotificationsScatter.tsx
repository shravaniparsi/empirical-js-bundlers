...
import NotificationsSnackbar2 from './NotificationsSnackbar2';
import styles from './NotificationsScatter.module.css';
...
interface NotificationsScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsScatter({
  data,
  title,
  height = 300,
  showLegend = true,
