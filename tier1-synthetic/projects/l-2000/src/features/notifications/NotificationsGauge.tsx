...
import NotificationsSnackbar1 from './NotificationsSnackbar1';
import NotificationsAreaChart from './NotificationsAreaChart';
import styles from './NotificationsGauge.module.css';
...
interface NotificationsGaugeProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsGauge({
  data,
  title,
  height = 300,
  showLegend = true,
