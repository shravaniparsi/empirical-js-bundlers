...
import NotificationsToggle1 from './NotificationsToggle1';
import styles from './NotificationsGauge1.module.css';
...
interface NotificationsGauge1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsGauge1({
  data,
  title,
  height = 300,
  showLegend = true,
