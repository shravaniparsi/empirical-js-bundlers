...
import styles from './NotificationsNavBar1.module.css';
...
interface NotificationsNavBar1Props {
  items: NavItem[];
  activeId?: string;
...
export default function NotificationsNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="NotificationsNavBar1">
      {activeItem && (
