...
import styles from './NotificationsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
