...
import styles from './NotificationsErrorBoundary.module.css';
...
interface NotificationsErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: NotificationsErrorBoundaryProps<T>) {
