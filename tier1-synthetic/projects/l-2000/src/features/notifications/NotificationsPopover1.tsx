...
import styles from './NotificationsPopover1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsPopover1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsPopover1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
