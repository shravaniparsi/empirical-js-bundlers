...
import NotificationsRating from './NotificationsRating';
import ProductsProgress from '../products/ProductsProgress';
import styles from './NotificationsLoader.module.css';
...
interface NotificationsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
