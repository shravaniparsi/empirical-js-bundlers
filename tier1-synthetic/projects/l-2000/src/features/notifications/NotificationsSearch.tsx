...
import NotificationsDrawer1 from './NotificationsDrawer1';
import styles from './NotificationsSearch.module.css';
...
export default function NotificationsSearch({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = NotificationsSearchSchema.safeParse({ value: val });
