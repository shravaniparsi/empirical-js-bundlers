...
import NotificationsComposer from './NotificationsComposer';
import styles from './NotificationsToggle.module.css';

const NotificationsToggleSchema = z.object({
...
export default function NotificationsToggle({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = NotificationsToggleSchema.safeParse({ value: val });
