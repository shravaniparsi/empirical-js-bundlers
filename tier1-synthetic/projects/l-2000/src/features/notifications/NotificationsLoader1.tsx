...
import NotificationsInput1 from './NotificationsInput1';
import styles from './NotificationsLoader1.module.css';
...
interface NotificationsLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
