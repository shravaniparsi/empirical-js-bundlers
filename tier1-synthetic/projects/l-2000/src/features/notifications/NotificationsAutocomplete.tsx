...
import NotificationsSplit1 from './NotificationsSplit1';
import NotificationsLink from './NotificationsLink';
import styles from './NotificationsAutocomplete.module.css';


interface NotificationsAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function NotificationsAutocomplete({
  label,
  name,
  ...
  onBlur,
  className,
}: NotificationsAutocompleteProps) {
