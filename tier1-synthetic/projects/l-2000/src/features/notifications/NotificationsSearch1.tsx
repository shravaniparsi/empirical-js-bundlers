...
import NotificationsStack1 from './NotificationsStack1';
import styles from './NotificationsSearch1.module.css';


interface NotificationsSearch1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function NotificationsSearch1({
  label,
  name,
