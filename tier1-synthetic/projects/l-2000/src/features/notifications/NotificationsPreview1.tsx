...
import styles from './NotificationsPreview1.module.css';

interface NotificationsPreview1Item {
  tags: string[];
  description: string;
  updatedAt: Date;
  status: string;
...
interface NotificationsPreview1Props {
  items?: NotificationsPreview1Item[];
...
export default function NotificationsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsPreview1Props) {
