...
import NotificationsToggle2 from './NotificationsToggle2';
import NotificationsAreaChart from './NotificationsAreaChart';
import styles from './NotificationsSelect.module.css';
...
export default function NotificationsSelect({
  label,
  name,
