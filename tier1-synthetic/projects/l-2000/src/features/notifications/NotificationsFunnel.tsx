...
import styles from './NotificationsFunnel.module.css';
...
interface NotificationsFunnelProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
