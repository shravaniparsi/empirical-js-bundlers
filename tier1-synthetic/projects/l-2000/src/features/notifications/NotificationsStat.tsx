...
import styles from './NotificationsStat.module.css';

interface NotificationsStatItem {
  assignee: string;
  description: string;
  title: string;
  tags: string[];
...
interface NotificationsStatProps {
  items?: NotificationsStatItem[];
...
export default function NotificationsStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsStatProps) {
