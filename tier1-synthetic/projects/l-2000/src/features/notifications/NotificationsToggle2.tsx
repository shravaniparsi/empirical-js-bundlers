...
import NotificationsRegistry from './NotificationsRegistry';
import styles from './NotificationsToggle2.module.css';


interface NotificationsToggle2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function NotificationsToggle2({
  label,
  name,
