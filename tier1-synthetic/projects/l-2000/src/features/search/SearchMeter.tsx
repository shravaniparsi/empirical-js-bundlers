...
import SearchInfiniteScroll1 from './SearchInfiniteScroll1';
import SearchInfiniteScroll3 from './SearchInfiniteScroll3';
import styles from './SearchMeter.module.css';

interface SearchMeterItem {
  assignee: string;
  status: string;
  title: string;
  priority: number;
...
export default function SearchMeter({
  ...
  return (
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <SearchInfiniteScroll1 />
      <SearchInfiniteScroll3 />
      </div>
    </div>
  );
}
