...
import SearchCollapse1 from './SearchCollapse1';
import CatalogPieChart from '../catalog/CatalogPieChart';
import CartSpinner from '../cart/CartSpinner';
import styles from './SearchErrorBoundary.module.css';
...
interface SearchErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
