...
import styles from './SearchInfiniteScroll2.module.css';
...
interface SearchInfiniteScroll2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchInfiniteScroll2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
