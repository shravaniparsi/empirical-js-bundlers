...
import styles from './SearchInfiniteScroll3.module.css';
...
interface SearchInfiniteScroll3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchInfiniteScroll3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
