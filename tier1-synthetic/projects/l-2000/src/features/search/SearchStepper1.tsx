...
import SearchInfiniteScroll4 from './SearchInfiniteScroll4';
import styles from './SearchStepper1.module.css';
...
export default function SearchStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SearchStepper1">
      {activeItem && (
