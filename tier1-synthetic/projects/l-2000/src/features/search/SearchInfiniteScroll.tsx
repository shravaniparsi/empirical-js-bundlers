...
import SearchCheckbox2 from './SearchCheckbox2';
import ReportsScatter from '../reports/ReportsScatter';
import styles from './SearchInfiniteScroll.module.css';
...
interface SearchInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
