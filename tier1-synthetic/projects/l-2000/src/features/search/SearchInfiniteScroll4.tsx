...
import styles from './SearchInfiniteScroll4.module.css';
...
interface SearchInfiniteScroll4Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchInfiniteScroll4<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
