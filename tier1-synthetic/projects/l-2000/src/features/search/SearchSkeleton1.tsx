...
import SearchCheckbox1 from './SearchCheckbox1';
import SearchDrawer from './SearchDrawer';
import ThemesSparkline from '../themes/ThemesSparkline';
import styles from './SearchSkeleton1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SearchSkeleton1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SearchSkeleton1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
