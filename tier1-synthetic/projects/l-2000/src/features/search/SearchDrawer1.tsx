...
import styles from './SearchDrawer1.module.css';
...
export default function SearchDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SearchDrawer1">
      {activeItem && (
