...
import styles from './TagsPlaceholder2.module.css';
...
interface TagsPlaceholder2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TagsPlaceholder2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
