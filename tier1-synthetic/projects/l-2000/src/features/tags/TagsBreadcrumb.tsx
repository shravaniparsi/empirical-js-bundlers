...
import TagsThumbnail1 from './TagsThumbnail1';
import BillingScatter1 from '../billing/BillingScatter1';
import styles from './TagsBreadcrumb.module.css';
...
export default function TagsBreadcrumb({
  ...
  return (
    <nav className={navClasses} aria-label="TagsBreadcrumb">
      {activeItem && (
