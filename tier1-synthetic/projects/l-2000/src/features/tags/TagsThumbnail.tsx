...
import TagsTreeView from './TagsTreeView';
import styles from './TagsThumbnail.module.css';

interface TagsThumbnailItem {
  assignee: string;
  title: string;
  createdAt: Date;
  status: string;
...
interface TagsThumbnailProps {
  items?: TagsThumbnailItem[];
...
export default function TagsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
