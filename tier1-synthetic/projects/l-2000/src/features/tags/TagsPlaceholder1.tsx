...
import TagsLineChart from './TagsLineChart';
import TagsSkeleton from './TagsSkeleton';
import styles from './TagsPlaceholder1.module.css';
...
interface TagsPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TagsPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
