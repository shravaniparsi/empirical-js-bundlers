...
import TagsStepper from './TagsStepper';
import PaymentsTooltip from '../payments/PaymentsTooltip';
import styles from './TagsDetail.module.css';

interface TagsDetailItem {
  title: string;
  createdAt: Date;
  tags: string[];
  updatedAt: Date;
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['title', 'createdAt', 'tags']);
