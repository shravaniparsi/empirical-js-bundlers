...
import TagsDatePicker1 from './TagsDatePicker1';
import styles from './TagsPlaceholder.module.css';
...
interface TagsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TagsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
