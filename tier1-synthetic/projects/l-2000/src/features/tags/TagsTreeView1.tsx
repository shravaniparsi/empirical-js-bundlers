...
import styles from './TagsTreeView1.module.css';
...
export default function TagsTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TagsTreeView1">
      {activeItem && (
