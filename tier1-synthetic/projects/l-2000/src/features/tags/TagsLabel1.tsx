...
import TagsPlaceholder1 from './TagsPlaceholder1';
import ProductsInfiniteScroll1 from '../products/ProductsInfiniteScroll1';
import ShippingHeader from '../shipping/ShippingHeader';
import styles from './TagsLabel1.module.css';

interface TagsLabel1Item {
  updatedAt: Date;
  description: string;
  tags: string[];
  status: string;
...
interface TagsLabel1Props {
  items?: TagsLabel1Item[];
...
export default function TagsLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
