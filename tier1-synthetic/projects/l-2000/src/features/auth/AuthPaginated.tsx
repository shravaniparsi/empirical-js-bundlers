...
import AuthDonut1 from './AuthDonut1';
import AuthTimeline1 from './AuthTimeline1';
import styles from './AuthPaginated.module.css';
...
interface AuthPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuthPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
