...
import AuthBottomNav1 from './AuthBottomNav1';
import AuthChip from './AuthChip';
import AuthStepper1 from './AuthStepper1';
import styles from './AuthPrefetch.module.css';
...
interface AuthPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuthPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
