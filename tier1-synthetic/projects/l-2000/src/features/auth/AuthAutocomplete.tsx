...
import { z } from 'zod';
import AuthConfirm1 from './AuthConfirm1';
import AuthHeatmap from './AuthHeatmap';
import AuthScroll from './AuthScroll';
import SearchDetail from '../search/SearchDetail';
import styles from './AuthAutocomplete.module.css';

const AuthAutocompleteSchema = z.object({
...
export default function AuthAutocomplete({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = AuthAutocompleteSchema.safeParse({ value: val });
