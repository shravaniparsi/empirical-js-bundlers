...
import ThemesColorPicker1 from './ThemesColorPicker1';
import ThemesHeader1 from './ThemesHeader1';
import styles from './ThemesStepper.module.css';
...
export default function ThemesStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesStepper">
      {activeItem && (
