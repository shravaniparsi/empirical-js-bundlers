...
import ThemesAreaChart from './ThemesAreaChart';
import styles from './ThemesErrorBoundary.module.css';
...
interface ThemesErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ThemesErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
