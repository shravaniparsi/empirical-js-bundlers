...
import styles from './ThemesTimeline.module.css';

interface ThemesTimelineItem {
  status: string;
  description: string;
  tags: string[];
  id: string;
...
interface ThemesTimelineProps {
  items?: ThemesTimelineItem[];
...
export default function ThemesTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
