...
import ThemesTooltip from './ThemesTooltip';
import ThemesTimeline from './ThemesTimeline';
import styles from './ThemesLabel.module.css';

interface ThemesLabelItem {
  assignee: string;
  title: string;
  priority: number;
  description: string;
...
interface ThemesLabelProps {
  items?: ThemesLabelItem[];
...
export default function ThemesLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
