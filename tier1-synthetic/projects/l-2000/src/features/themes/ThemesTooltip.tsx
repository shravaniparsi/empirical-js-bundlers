...
import ThemesCheckbox1 from './ThemesCheckbox1';
import ThemesScore1 from './ThemesScore1';
import styles from './ThemesTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ThemesTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ThemesTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
