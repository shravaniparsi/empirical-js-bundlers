...
import ThemesRadio from './ThemesRadio';
import ProductsAdapter from '../products/ProductsAdapter';
import styles from './ThemesTag.module.css';

interface ThemesTagItem {
  tags: string[];
  createdAt: Date;
  updatedAt: Date;
  title: string;
...
export default function ThemesTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
