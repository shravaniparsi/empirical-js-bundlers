...
import ThemesRank from './ThemesRank';
import styles from './ThemesCached.module.css';
...
interface ThemesCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ThemesCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
