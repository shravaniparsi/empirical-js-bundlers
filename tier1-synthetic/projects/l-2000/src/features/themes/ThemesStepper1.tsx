...
import ThemesCached from './ThemesCached';
import ThemesTabs from './ThemesTabs';
import ThemesProvider from './ThemesProvider';
import styles from './ThemesStepper1.module.css';
...
export default function ThemesStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesStepper1">
      {activeItem && (
