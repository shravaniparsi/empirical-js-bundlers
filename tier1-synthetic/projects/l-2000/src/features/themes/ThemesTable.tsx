...
import ThemesAccordion1 from './ThemesAccordion1';
import ThemesMeter from './ThemesMeter';
import ShippingMenu from '../shipping/ShippingMenu';
import styles from './ThemesTable.module.css';

interface ThemesTableItem {
  description: string;
  priority: number;
  tags: string[];
  title: string;
