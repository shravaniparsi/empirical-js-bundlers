...
import ThemesRating from './ThemesRating';
import CategoriesNotification1 from '../categories/CategoriesNotification1';
import styles from './ThemesPolling.module.css';
...
interface ThemesPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ThemesPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
