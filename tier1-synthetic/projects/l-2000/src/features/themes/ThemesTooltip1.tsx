...
import ThemesPolling from './ThemesPolling';
import ThemesSummary from './ThemesSummary';
import styles from './ThemesTooltip1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ThemesTooltip1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ThemesTooltip1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
