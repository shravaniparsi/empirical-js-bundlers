...
import styles from './ThemesScore1.module.css';

interface ThemesScore1Item {
  updatedAt: Date;
  status: string;
  priority: number;
  assignee: string;
...
interface ThemesScore1Props {
  items?: ThemesScore1Item[];
...
export default function ThemesScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
