...
import styles from './ApiKeysFeed1.module.css';

interface ApiKeysFeed1Item {
  createdAt: Date;
  description: string;
  title: string;
  updatedAt: Date;
...
interface ApiKeysFeed1Props {
  items?: ApiKeysFeed1Item[];
...
export default function ApiKeysFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
