...
import ApiKeysDetail1 from './ApiKeysDetail1';
import ApiKeysTreeView from './ApiKeysTreeView';
import styles from './ApiKeysTag.module.css';

interface ApiKeysTagItem {
  tags: string[];
  createdAt: Date;
  priority: number;
  updatedAt: Date;
...
interface ApiKeysTagProps {
  items?: ApiKeysTagItem[];
...
export default function ApiKeysTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
