...
import styles from './ApiKeysStepper.module.css';
...
export default function ApiKeysStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysStepper">
      {activeItem && (
