...
import ApiKeysDetail from './ApiKeysDetail';
import ApiKeysSlider1 from './ApiKeysSlider1';
import styles from './ApiKeysGrid2.module.css';

interface ApiKeysGrid2Item {
  description: string;
  assignee: string;
  createdAt: Date;
  status: string;
...
interface ApiKeysGrid2Props {
  items?: ApiKeysGrid2Item[];
...
export default function ApiKeysGrid2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
