...
import styles from './ApiKeysDetail1.module.css';

interface ApiKeysDetail1Item {
  description: string;
  tags: string[];
  createdAt: Date;
  title: string;
...
interface ApiKeysDetail1Props {
  items?: ApiKeysDetail1Item[];
...
export default function ApiKeysDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
