...
import ApiKeysAlert1 from './ApiKeysAlert1';
import ApiKeysLabel from './ApiKeysLabel';
import styles from './ApiKeysSparkline.module.css';
...
interface ApiKeysSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ApiKeysSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
