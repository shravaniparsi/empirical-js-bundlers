...
import ApiKeysTextArea1 from './ApiKeysTextArea1';
...
import styles from './ApiKeysPieChart.module.css';
...
interface ApiKeysPieChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ApiKeysPieChart({
  data,
  title,
  height = 300,
  showLegend = true,
