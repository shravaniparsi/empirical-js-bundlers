...
import ApiKeysFeed1 from './ApiKeysFeed1';
import styles from './ApiKeysTooltip1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ApiKeysTooltip1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ApiKeysTooltip1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
