...
import styles from './ApiKeysPaginated.module.css';
...
interface ApiKeysPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ApiKeysPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
