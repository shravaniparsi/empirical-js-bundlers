...
import ApiKeysLineChart from './ApiKeysLineChart';
import styles from './ApiKeysDrawer.module.css';
...
export default function ApiKeysDrawer({
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysDrawer">
      {activeItem && (
