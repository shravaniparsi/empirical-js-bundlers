...
import ApiKeysPrefetch from './ApiKeysPrefetch';
import ApiKeysAlert from './ApiKeysAlert';
import styles from './ApiKeysAreaChart1.module.css';
...
interface ApiKeysAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ApiKeysAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
