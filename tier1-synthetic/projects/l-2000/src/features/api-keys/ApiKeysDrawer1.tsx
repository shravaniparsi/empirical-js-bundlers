...
import styles from './ApiKeysDrawer1.module.css';
...
export default function ApiKeysDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysDrawer1">
      {activeItem && (
