...
import SearchResponsive1 from '../search/SearchResponsive1';
import styles from './ApiKeysSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ApiKeysSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ApiKeysSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
