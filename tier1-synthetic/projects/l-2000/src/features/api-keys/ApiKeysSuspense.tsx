...
import styles from './ApiKeysSuspense.module.css';
...
interface ApiKeysSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ApiKeysSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
