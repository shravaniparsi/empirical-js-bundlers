...
import ApiKeysSparkline from './ApiKeysSparkline';
import ApiKeysThumbnail from './ApiKeysThumbnail';
import styles from './ApiKeysSearch.module.css';


interface ApiKeysSearchProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ApiKeysSearch({
  label,
  name,
