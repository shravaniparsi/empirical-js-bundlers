...
import styles from './ApiKeysErrorBoundary.module.css';
...
interface ApiKeysErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ApiKeysErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
