...
import ApiKeysScore from './ApiKeysScore';
import ApiKeysSidebar from './ApiKeysSidebar';
import ApiKeysStat from './ApiKeysStat';
import CartSpinner from '../cart/CartSpinner';
import styles from './ApiKeysTag1.module.css';

interface ApiKeysTag1Item {
  assignee: string;
  title: string;
  priority: number;
  id: string;
...
interface ApiKeysTag1Props {
  items?: ApiKeysTag1Item[];
...
export default function ApiKeysTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
