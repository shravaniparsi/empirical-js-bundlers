...
import ApiKeysSpacer from './ApiKeysSpacer';
import styles from './ApiKeysStat1.module.css';

interface ApiKeysStat1Item {
  status: string;
  description: string;
  priority: number;
  title: string;
...
interface ApiKeysStat1Props {
  items?: ApiKeysStat1Item[];
...
export default function ApiKeysStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
