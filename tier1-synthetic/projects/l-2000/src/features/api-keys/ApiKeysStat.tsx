...
import ApiKeysAreaChart from './ApiKeysAreaChart';
import styles from './ApiKeysStat.module.css';

interface ApiKeysStatItem {
  description: string;
  title: string;
  updatedAt: Date;
  id: string;
...
interface ApiKeysStatProps {
  items?: ApiKeysStatItem[];
...
export default function ApiKeysStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
