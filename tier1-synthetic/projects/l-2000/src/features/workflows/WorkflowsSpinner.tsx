...
import WorkflowsRangeSlider1 from './WorkflowsRangeSlider1';
import styles from './WorkflowsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WorkflowsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WorkflowsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
