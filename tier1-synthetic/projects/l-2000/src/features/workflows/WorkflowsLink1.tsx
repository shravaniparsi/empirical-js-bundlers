...
import styles from './WorkflowsLink1.module.css';
...
export default function WorkflowsLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsLink1">
      {activeItem && (
