...
import WorkflowsStepper1 from './WorkflowsStepper1';
import styles from './WorkflowsScatter.module.css';
...
interface WorkflowsScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsScatter({
  data,
  title,
  height = 300,
  showLegend = true,
