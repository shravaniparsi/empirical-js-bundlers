...
import ThemesBottomNav from '../themes/ThemesBottomNav';
import styles from './WorkflowsBadge.module.css';

interface WorkflowsBadgeItem {
  createdAt: Date;
  title: string;
  updatedAt: Date;
  assignee: string;
...
interface WorkflowsBadgeProps {
  items?: WorkflowsBadgeItem[];
...
export default function WorkflowsBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
