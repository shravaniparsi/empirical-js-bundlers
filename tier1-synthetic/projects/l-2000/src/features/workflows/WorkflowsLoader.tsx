...
import styles from './WorkflowsLoader.module.css';
...
interface WorkflowsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
