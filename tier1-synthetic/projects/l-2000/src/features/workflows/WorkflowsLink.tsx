...
import styles from './WorkflowsLink.module.css';
...
export default function WorkflowsLink({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsLink">
      {activeItem && (
