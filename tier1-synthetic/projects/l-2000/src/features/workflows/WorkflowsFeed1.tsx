...
import WorkflowsRating from './WorkflowsRating';
import WorkflowsMeter from './WorkflowsMeter';
import WorkflowsBadge from './WorkflowsBadge';
import styles from './WorkflowsFeed1.module.css';

interface WorkflowsFeed1Item {
  description: string;
  status: string;
  createdAt: Date;
  id: string;
...
interface WorkflowsFeed1Props {
  items?: WorkflowsFeed1Item[];
...
export default function WorkflowsFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
