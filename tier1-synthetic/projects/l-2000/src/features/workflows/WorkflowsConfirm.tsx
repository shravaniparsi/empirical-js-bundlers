...
import WorkflowsCached from './WorkflowsCached';
import styles from './WorkflowsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WorkflowsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WorkflowsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
