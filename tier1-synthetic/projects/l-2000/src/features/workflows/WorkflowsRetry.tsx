...
import styles from './WorkflowsRetry.module.css';
...
interface WorkflowsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
