...
import WorkflowsDrawer from './WorkflowsDrawer';
import styles from './WorkflowsTag.module.css';

interface WorkflowsTagItem {
  status: string;
  createdAt: Date;
  title: string;
  priority: number;
...
interface WorkflowsTagProps {
  items?: WorkflowsTagItem[];
...
export default function WorkflowsTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
