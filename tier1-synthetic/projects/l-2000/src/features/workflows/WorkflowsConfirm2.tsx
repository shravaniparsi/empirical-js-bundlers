...
import WorkflowsThumbnail1 from './WorkflowsThumbnail1';
import styles from './WorkflowsConfirm2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WorkflowsConfirm2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WorkflowsConfirm2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
