...
import styles from './WorkflowsBadge1.module.css';

interface WorkflowsBadge1Item {
  assignee: string;
  updatedAt: Date;
  createdAt: Date;
  title: string;
...
interface WorkflowsBadge1Props {
  items?: WorkflowsBadge1Item[];
...
export default function WorkflowsBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WorkflowsBadge1Props) {
