...
import styles from './WorkflowsRetry1.module.css';
...
interface WorkflowsRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
