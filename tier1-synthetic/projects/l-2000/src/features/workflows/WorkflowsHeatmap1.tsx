...
import WorkflowsConfirm from './WorkflowsConfirm';
import styles from './WorkflowsHeatmap1.module.css';
...
interface WorkflowsHeatmap1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsHeatmap1({
  data,
  title,
  height = 300,
  showLegend = true,
