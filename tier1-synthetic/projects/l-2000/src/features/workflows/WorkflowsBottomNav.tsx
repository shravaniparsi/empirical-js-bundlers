...
import styles from './WorkflowsBottomNav.module.css';
...
interface WorkflowsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function WorkflowsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsBottomNav">
      {activeItem && (
