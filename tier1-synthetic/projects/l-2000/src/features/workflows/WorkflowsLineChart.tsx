...
import WorkflowsLink1 from './WorkflowsLink1';
import WorkflowsHeatmap from './WorkflowsHeatmap';
import styles from './WorkflowsLineChart.module.css';
...
interface WorkflowsLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
