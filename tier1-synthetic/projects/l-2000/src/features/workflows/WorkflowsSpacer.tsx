...
import WorkflowsRetry from './WorkflowsRetry';
import styles from './WorkflowsSpacer.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface WorkflowsSpacerProps {
...
export default function WorkflowsSpacer({
  children,
