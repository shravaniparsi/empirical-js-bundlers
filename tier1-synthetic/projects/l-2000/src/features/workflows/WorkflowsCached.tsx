...
import styles from './WorkflowsCached.module.css';
...
interface WorkflowsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
