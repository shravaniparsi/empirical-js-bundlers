...
import WorkflowsTag from './WorkflowsTag';
import WorkflowsBanner from './WorkflowsBanner';
import styles from './WorkflowsStepper1.module.css';
...
interface WorkflowsStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function WorkflowsStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsStepper1">
      {activeItem && (
