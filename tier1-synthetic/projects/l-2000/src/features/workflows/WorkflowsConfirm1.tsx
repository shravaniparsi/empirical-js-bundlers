...
import DocumentsChip from '../documents/DocumentsChip';
import styles from './WorkflowsConfirm1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WorkflowsConfirm1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WorkflowsConfirm1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
