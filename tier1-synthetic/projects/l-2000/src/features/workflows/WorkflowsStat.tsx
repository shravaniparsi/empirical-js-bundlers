...
import WorkflowsFunnel from './WorkflowsFunnel';
import WorkflowsHOC from './WorkflowsHOC';
import styles from './WorkflowsStat.module.css';

interface WorkflowsStatItem {
  title: string;
  tags: string[];
  assignee: string;
  priority: number;
...
interface WorkflowsStatProps {
  items?: WorkflowsStatItem[];
...
export default function WorkflowsStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['title', 'tags', 'assignee']);
