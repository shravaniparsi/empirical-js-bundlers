...
import WorkflowsThumbnail2 from './WorkflowsThumbnail2';
import styles from './WorkflowsSticky.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface WorkflowsStickyProps {
...
export default function WorkflowsSticky({
  children,
