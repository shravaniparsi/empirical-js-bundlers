...
import ProfileChip1 from './ProfileChip1';
import ProfileBottomNav from './ProfileBottomNav';
import styles from './ProfileChip2.module.css';

interface ProfileChip2Item {
  createdAt: Date;
  priority: number;
  title: string;
  id: string;
...
interface ProfileChip2Props {
  items?: ProfileChip2Item[];
...
export default function ProfileChip2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
