...
import styles from './ProfileChip1.module.css';

interface ProfileChip1Item {
  createdAt: Date;
  status: string;
  updatedAt: Date;
  assignee: string;
...
interface ProfileChip1Props {
  items?: ProfileChip1Item[];
...
export default function ProfileChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
