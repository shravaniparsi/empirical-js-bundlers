...
import ApiKeysTimePicker1 from '../api-keys/ApiKeysTimePicker1';
import styles from './ProfileAreaChart.module.css';
...
interface ProfileAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
