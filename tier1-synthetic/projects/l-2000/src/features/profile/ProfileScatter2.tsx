...
import ProfileErrorBoundary1 from './ProfileErrorBoundary1';
import ProfileSuspense from './ProfileSuspense';
import ProfileDetail from './ProfileDetail';
import styles from './ProfileScatter2.module.css';
...
interface ProfileScatter2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ProfileScatter2({
  data,
  title,
  height = 300,
  showLegend = true,
