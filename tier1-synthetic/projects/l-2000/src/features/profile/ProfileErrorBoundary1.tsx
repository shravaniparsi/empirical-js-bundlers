...
import ProfileScatter1 from './ProfileScatter1';
import ProfileSplit from './ProfileSplit';
import styles from './ProfileErrorBoundary1.module.css';
...
interface ProfileErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfileErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
