...
import AdminScore1 from '../admin/AdminScore1';
import styles from './ProfileErrorBoundary.module.css';
...
interface ProfileErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfileErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
