...
import ProfileScatter from './ProfileScatter';
import styles from './ProfileCached.module.css';
...
interface ProfileCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfileCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
