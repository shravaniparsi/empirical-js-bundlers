...
import styles from './ProfileRadio.module.css';

const ProfileRadioSchema = z.object({
...
export default function ProfileRadio({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ProfileRadioSchema.safeParse({ value: val });
