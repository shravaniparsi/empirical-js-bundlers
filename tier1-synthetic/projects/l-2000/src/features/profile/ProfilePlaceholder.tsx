...
import ProfileGrid1 from './ProfileGrid1';
...
interface ProfilePlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfilePlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
