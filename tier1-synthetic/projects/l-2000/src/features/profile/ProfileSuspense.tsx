...
import styles from './ProfileSuspense.module.css';
...
interface ProfileSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfileSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
