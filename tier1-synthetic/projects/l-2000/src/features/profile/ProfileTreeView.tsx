...
import styles from './ProfileTreeView.module.css';
...
interface ProfileTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function ProfileTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProfileTreeView">
      {activeItem && (
