...
import { z } from 'zod';
import ProfileAutocomplete1 from './ProfileAutocomplete1';
import ProfilePreview1 from './ProfilePreview1';
import PaymentsAvatar2 from '../payments/PaymentsAvatar2';
import styles from './ProfileFileUpload.module.css';

const ProfileFileUploadSchema = z.object({
...
export default function ProfileFileUpload({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ProfileFileUploadSchema.safeParse({ value: val });
