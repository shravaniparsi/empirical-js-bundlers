...
import styles from './ProfileNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProfileNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProfileNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
