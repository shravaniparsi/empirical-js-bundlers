...
import styles from './ProfilePrefetch.module.css';
...
interface ProfilePrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfilePrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
