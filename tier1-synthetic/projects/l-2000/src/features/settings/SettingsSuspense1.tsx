...
import SettingsSlider1 from './SettingsSlider1';
import styles from './SettingsSuspense1.module.css';
...
interface SettingsSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
