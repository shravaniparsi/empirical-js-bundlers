...
import SettingsPieChart from './SettingsPieChart';
import DocumentsDonut from '../documents/DocumentsDonut';
import styles from './SettingsProgress.module.css';

interface SettingsProgressItem {
  tags: string[];
  priority: number;
  createdAt: Date;
  description: string;
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['tags', 'priority', 'createdAt']);
