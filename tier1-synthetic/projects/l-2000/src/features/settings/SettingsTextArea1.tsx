...
import SettingsSuspense from './SettingsSuspense';
import SettingsBadge from './SettingsBadge';
import AuditNavBar from '../audit/AuditNavBar';
import styles from './SettingsTextArea1.module.css';


interface SettingsTextArea1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SettingsTextArea1({
  label,
  name,
