...
import styles from './SettingsAvatar1.module.css';

interface SettingsAvatar1Item {
  description: string;
  status: string;
  title: string;
  assignee: string;
...
interface SettingsAvatar1Props {
  items?: SettingsAvatar1Item[];
...
export default function SettingsAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SettingsAvatar1Props) {
