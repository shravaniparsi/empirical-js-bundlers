...
import styles from './SettingsScore2.module.css';

interface SettingsScore2Item {
  assignee: string;
  createdAt: Date;
  priority: number;
  description: string;
...
interface SettingsScore2Props {
  items?: SettingsScore2Item[];
...
export default function SettingsScore2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
