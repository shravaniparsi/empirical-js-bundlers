...
import styles from './SettingsTable1.module.css';

interface SettingsTable1Item {
  createdAt: Date;
  priority: number;
  title: string;
  assignee: string;
...
interface SettingsTable1Props {
  items?: SettingsTable1Item[];
...
export default function SettingsTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
