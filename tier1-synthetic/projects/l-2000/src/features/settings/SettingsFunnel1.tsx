...
import SettingsRank from './SettingsRank';
import SettingsDivider3 from './SettingsDivider3';
import styles from './SettingsFunnel1.module.css';
...
interface SettingsFunnel1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SettingsFunnel1({
  data,
  title,
  height = 300,
  showLegend = true,
