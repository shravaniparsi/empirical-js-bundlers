...
import SettingsScore1 from './SettingsScore1';
import styles from './SettingsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SettingsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SettingsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
