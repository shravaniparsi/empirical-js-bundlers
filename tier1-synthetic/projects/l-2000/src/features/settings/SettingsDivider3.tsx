...
import SettingsThumbnail from './SettingsThumbnail';
import SettingsTooltip from './SettingsTooltip';
import SettingsWrapper from './SettingsWrapper';
import styles from './SettingsDivider3.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SettingsDivider3Props {
...
export default function SettingsDivider3({
  children,
