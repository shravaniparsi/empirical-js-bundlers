...
import SettingsSnackbar1 from './SettingsSnackbar1';
import SettingsResponsive from './SettingsResponsive';
import ReviewsDetail3 from '../reviews/ReviewsDetail3';
import DashboardSpacer from '../dashboard/DashboardSpacer';
import styles from './SettingsScore.module.css';

interface SettingsScoreItem {
  createdAt: Date;
  updatedAt: Date;
  title: string;
  assignee: string;
...
interface SettingsScoreProps {
  items?: SettingsScoreItem[];
