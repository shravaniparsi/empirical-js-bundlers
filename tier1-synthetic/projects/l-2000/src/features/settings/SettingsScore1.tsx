...
import styles from './SettingsScore1.module.css';

interface SettingsScore1Item {
  updatedAt: Date;
  assignee: string;
  createdAt: Date;
  tags: string[];
...
interface SettingsScore1Props {
  items?: SettingsScore1Item[];
...
export default function SettingsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
