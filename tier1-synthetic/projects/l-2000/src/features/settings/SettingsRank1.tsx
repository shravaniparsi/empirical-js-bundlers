...
import styles from './SettingsRank1.module.css';

interface SettingsRank1Item {
  description: string;
  status: string;
  tags: string[];
  assignee: string;
...
interface SettingsRank1Props {
  items?: SettingsRank1Item[];
...
export default function SettingsRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
