...
import SettingsFunnel1 from './SettingsFunnel1';
import DashboardSpacer from '../dashboard/DashboardSpacer';
import styles from './SettingsTreeView.module.css';
...
export default function SettingsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SettingsTreeView">
      {activeItem && (
