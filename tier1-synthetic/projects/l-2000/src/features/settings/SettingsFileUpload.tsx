...
import SettingsSuspense1 from './SettingsSuspense1';
import WebhooksFeed1 from '../webhooks/WebhooksFeed1';
import CheckoutTag1 from '../checkout/CheckoutTag1';
import styles from './SettingsFileUpload.module.css';

const SettingsFileUploadSchema = z.object({
...
export default function SettingsFileUpload({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = SettingsFileUploadSchema.safeParse({ value: val });
