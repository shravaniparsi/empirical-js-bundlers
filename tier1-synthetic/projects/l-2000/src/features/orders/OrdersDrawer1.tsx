...
import styles from './OrdersDrawer1.module.css';
...
export default function OrdersDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OrdersDrawer1">
      {activeItem && (
