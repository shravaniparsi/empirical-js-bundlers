...
import styles from './OrdersThumbnail1.module.css';

interface OrdersThumbnail1Item {
  priority: number;
  title: string;
  updatedAt: Date;
  description: string;
...
interface OrdersThumbnail1Props {
  items?: OrdersThumbnail1Item[];
...
export default function OrdersThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: OrdersThumbnail1Props) {
