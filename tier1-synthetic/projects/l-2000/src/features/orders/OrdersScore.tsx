...
import OrdersModal1 from './OrdersModal1';
import OrdersChip from './OrdersChip';
import PaymentsPieChart2 from '../payments/PaymentsPieChart2';
import styles from './OrdersScore.module.css';

interface OrdersScoreItem {
  assignee: string;
  updatedAt: Date;
  createdAt: Date;
  description: string;
...
interface OrdersScoreProps {
  items?: OrdersScoreItem[];
...
export default function OrdersScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
