...
import InventoryScore from '../inventory/InventoryScore';
import styles from './OrdersLabel.module.css';

interface OrdersLabelItem {
  description: string;
  status: string;
  createdAt: Date;
  title: string;
...
export default function OrdersLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
