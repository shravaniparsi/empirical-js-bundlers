...
import OrdersFactory1 from './OrdersFactory1';
import styles from './OrdersPlaceholder1.module.css';
...
interface OrdersPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OrdersPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
