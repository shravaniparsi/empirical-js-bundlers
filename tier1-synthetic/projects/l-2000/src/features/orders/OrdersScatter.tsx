...
import OrdersNotification1 from './OrdersNotification1';
import OrdersModal from './OrdersModal';
import styles from './OrdersScatter.module.css';
...
export default function OrdersScatter({
  data,
  title,
  height = 300,
  showLegend = true,
