...
import OrdersDrawer1 from './OrdersDrawer1';
import AdminMeter from '../admin/AdminMeter';
import styles from './OrdersNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface OrdersNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function OrdersNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
