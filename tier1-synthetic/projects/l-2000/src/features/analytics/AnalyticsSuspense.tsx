...
import styles from './AnalyticsSuspense.module.css';
...
interface AnalyticsSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
