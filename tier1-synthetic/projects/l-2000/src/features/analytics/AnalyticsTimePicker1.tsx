...
import styles from './AnalyticsTimePicker1.module.css';


interface AnalyticsTimePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function AnalyticsTimePicker1({
  label,
  name,
