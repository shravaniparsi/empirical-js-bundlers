...
import styles from './AnalyticsList1.module.css';

interface AnalyticsList1Item {
  description: string;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface AnalyticsList1Props {
  items?: AnalyticsList1Item[];
...
export default function AnalyticsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
