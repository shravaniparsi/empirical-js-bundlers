...
import AnalyticsRetry from './AnalyticsRetry';
import styles from './AnalyticsLoader1.module.css';
...
interface AnalyticsLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
