...
import WebhooksScore from '../webhooks/WebhooksScore';
import styles from './AnalyticsDonut1.module.css';
...
interface AnalyticsDonut1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function AnalyticsDonut1({
  data,
  title,
  height = 300,
  showLegend = true,
