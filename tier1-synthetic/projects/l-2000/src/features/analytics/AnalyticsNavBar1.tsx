...
import AnalyticsSidebar1 from './AnalyticsSidebar1';
import PaymentsTextArea from '../payments/PaymentsTextArea';
import styles from './AnalyticsNavBar1.module.css';
...
interface AnalyticsNavBar1Props {
  items: NavItem[];
  activeId?: string;
...
export default function AnalyticsNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AnalyticsNavBar1">
      {activeItem && (
