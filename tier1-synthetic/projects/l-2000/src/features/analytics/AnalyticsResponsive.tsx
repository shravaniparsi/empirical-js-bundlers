...
import styles from './AnalyticsResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface AnalyticsResponsiveProps {
...
export default function AnalyticsResponsive({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
