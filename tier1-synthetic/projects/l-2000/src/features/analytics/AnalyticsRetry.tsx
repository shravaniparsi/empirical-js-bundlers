...
import styles from './AnalyticsRetry.module.css';
...
interface AnalyticsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
