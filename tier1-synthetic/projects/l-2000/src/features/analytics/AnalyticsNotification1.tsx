...
import AnalyticsScatter1 from './AnalyticsScatter1';
import AnalyticsRating from './AnalyticsRating';
import ProfileBottomNav from '../profile/ProfileBottomNav';
import styles from './AnalyticsNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface AnalyticsNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function AnalyticsNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
