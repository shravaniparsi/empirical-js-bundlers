...
import AnalyticsNavBar1 from './AnalyticsNavBar1';
...
interface AnalyticsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
