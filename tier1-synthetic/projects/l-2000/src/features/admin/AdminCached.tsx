...
import TagsLineChart from '../tags/TagsLineChart';
import styles from './AdminCached.module.css';
...
interface AdminCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AdminCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
