...
import AdminBottomNav2 from './AdminBottomNav2';
import AdminHeatmap from './AdminHeatmap';
import styles from './AdminDetail1.module.css';

interface AdminDetail1Item {
  description: string;
  tags: string[];
  status: string;
  updatedAt: Date;
...
interface AdminDetail1Props {
  items?: AdminDetail1Item[];
...
export default function AdminDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
