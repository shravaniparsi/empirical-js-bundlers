...
import CartRank from '../cart/CartRank';
import styles from './AdminPrefetch2.module.css';
...
interface AdminPrefetch2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AdminPrefetch2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
