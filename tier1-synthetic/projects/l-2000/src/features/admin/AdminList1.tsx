...
import AdminCached from './AdminCached';
import AdminBadge from './AdminBadge';
import ShippingTable from '../shipping/ShippingTable';
import styles from './AdminList1.module.css';

interface AdminList1Item {
  priority: number;
  title: string;
  updatedAt: Date;
  id: string;
...
interface AdminList1Props {
  items?: AdminList1Item[];
...
export default function AdminList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
