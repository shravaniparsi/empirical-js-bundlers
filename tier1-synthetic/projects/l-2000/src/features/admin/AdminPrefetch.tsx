...
import AdminPreview1 from './AdminPreview1';
import AdminPopover1 from './AdminPopover1';
import styles from './AdminPrefetch.module.css';
...
interface AdminPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AdminPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
