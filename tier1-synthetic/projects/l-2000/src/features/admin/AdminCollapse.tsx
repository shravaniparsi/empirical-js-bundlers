...
import AdminSplit from './AdminSplit';
import PaymentsDonut from '../payments/PaymentsDonut';
import DocumentsAccordion from '../documents/DocumentsAccordion';
import styles from './AdminCollapse.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface AdminCollapseProps {
...
export default function AdminCollapse({
  children,
