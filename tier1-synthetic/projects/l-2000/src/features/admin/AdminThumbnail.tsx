...
import AdminPopover1 from './AdminPopover1';
import MediaDivider1 from '../media/MediaDivider1';
import styles from './AdminThumbnail.module.css';

interface AdminThumbnailItem {
  assignee: string;
  description: string;
  updatedAt: Date;
  priority: number;
