...
import AdminInfiniteScroll from './AdminInfiniteScroll';
import AdminRadio1 from './AdminRadio1';
import styles from './AdminPrefetch1.module.css';
...
interface AdminPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AdminPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
