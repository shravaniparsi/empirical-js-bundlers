...
import AdminColorPicker1 from './AdminColorPicker1';
import styles from './AdminCollapse1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface AdminCollapse1Props {
...
export default function AdminCollapse1({
  children,
