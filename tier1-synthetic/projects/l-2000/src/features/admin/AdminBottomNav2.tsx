...
import AdminSearch1 from './AdminSearch1';
import AdminPrefetch1 from './AdminPrefetch1';
import ShippingTable from '../shipping/ShippingTable';
import styles from './AdminBottomNav2.module.css';
...
interface AdminBottomNav2Props {
  items: NavItem[];
  activeId?: string;
...
export default function AdminBottomNav2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AdminBottomNav2">
      {activeItem && (
