...
import AdminPieChart1 from './AdminPieChart1';
import AdminDetail1 from './AdminDetail1';
import styles from './AdminProgress1.module.css';

interface AdminProgress1Item {
  status: string;
  createdAt: Date;
  description: string;
  updatedAt: Date;
...
interface AdminProgress1Props {
  items?: AdminProgress1Item[];
...
export default function AdminProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
