...
import styles from './AdminMeter.module.css';

interface AdminMeterItem {
  tags: string[];
  updatedAt: Date;
  assignee: string;
  title: string;
...
interface AdminMeterProps {
  items?: AdminMeterItem[];
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['tags', 'updatedAt', 'assignee']);
