...
import styles from './AdminErrorBoundary1.module.css';
...
interface AdminErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AdminErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
