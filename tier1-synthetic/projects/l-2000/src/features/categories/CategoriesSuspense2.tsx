...
import styles from './CategoriesSuspense2.module.css';
...
interface CategoriesSuspense2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesSuspense2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
