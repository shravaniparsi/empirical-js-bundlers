...
import styles from './CategoriesTextArea1.module.css';


interface CategoriesTextArea1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CategoriesTextArea1({
  label,
  name,
