...
import AnalyticsPolling from '../analytics/AnalyticsPolling';
import styles from './CategoriesProgress.module.css';

interface CategoriesProgressItem {
  title: string;
  description: string;
  priority: number;
  createdAt: Date;
