...
import CategoriesPaginated2 from './CategoriesPaginated2';
import CategoriesRank1 from './CategoriesRank1';
import CategoriesScore from './CategoriesScore';
import styles from './CategoriesPaginated1.module.css';
...
interface CategoriesPaginated1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesPaginated1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
