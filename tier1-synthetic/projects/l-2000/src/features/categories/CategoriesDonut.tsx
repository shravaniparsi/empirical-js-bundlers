...
import CategoriesNotification1 from './CategoriesNotification1';
import CategoriesPagination1 from './CategoriesPagination1';
import styles from './CategoriesDonut.module.css';
...
export default function CategoriesDonut({
  data,
  title,
  height = 300,
  showLegend = true,
