...
import styles from './CategoriesSuspense.module.css';
...
interface CategoriesSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
