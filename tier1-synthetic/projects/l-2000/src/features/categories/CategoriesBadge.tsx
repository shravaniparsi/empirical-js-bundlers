...
import CategoriesTag1 from './CategoriesTag1';
import CategoriesSparkline from './CategoriesSparkline';
import ProfileChip1 from '../profile/ProfileChip1';
import styles from './CategoriesBadge.module.css';

interface CategoriesBadgeItem {
  createdAt: Date;
  priority: number;
  title: string;
  status: string;
