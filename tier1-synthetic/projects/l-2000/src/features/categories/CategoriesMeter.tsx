...
import styles from './CategoriesMeter.module.css';

interface CategoriesMeterItem {
  createdAt: Date;
  status: string;
  tags: string[];
  description: string;
...
interface CategoriesMeterProps {
  items?: CategoriesMeterItem[];
...
export default function CategoriesMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesMeterProps) {
