...
import styles from './CategoriesTag2.module.css';

interface CategoriesTag2Item {
  description: string;
  assignee: string;
  createdAt: Date;
  status: string;
...
interface CategoriesTag2Props {
  items?: CategoriesTag2Item[];
...
export default function CategoriesTag2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
