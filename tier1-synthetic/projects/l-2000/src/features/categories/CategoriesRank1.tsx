...
import CategoriesStepper from './CategoriesStepper';
import styles from './CategoriesRank1.module.css';

interface CategoriesRank1Item {
  tags: string[];
  priority: number;
  updatedAt: Date;
  assignee: string;
...
interface CategoriesRank1Props {
  items?: CategoriesRank1Item[];
...
export default function CategoriesRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesRank1Props) {
