...
import CategoriesSticky from './CategoriesSticky';
import CategoriesPagination2 from './CategoriesPagination2';
import styles from './CategoriesPagination1.module.css';
...
interface CategoriesPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CategoriesPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CategoriesPagination1">
      {activeItem && (
