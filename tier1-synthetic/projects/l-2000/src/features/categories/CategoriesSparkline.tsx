...
import CategoriesPaginated1 from './CategoriesPaginated1';
import PaymentsRating1 from '../payments/PaymentsRating1';
import styles from './CategoriesSparkline.module.css';
...
interface CategoriesSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CategoriesSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
