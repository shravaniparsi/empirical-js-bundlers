...
import CategoriesRank from './CategoriesRank';
import styles from './CategoriesSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CategoriesSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CategoriesSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
