...
import AuthBottomNav2 from '../auth/AuthBottomNav2';
import styles from './CategoriesChip.module.css';

interface CategoriesChipItem {
  title: string;
  tags: string[];
  assignee: string;
  id: string;
...
interface CategoriesChipProps {
  items?: CategoriesChipItem[];
