...
import styles from './CategoriesRank.module.css';

interface CategoriesRankItem {
  tags: string[];
  createdAt: Date;
  description: string;
  id: string;
...
interface CategoriesRankProps {
  items?: CategoriesRankItem[];
...
export default function CategoriesRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
