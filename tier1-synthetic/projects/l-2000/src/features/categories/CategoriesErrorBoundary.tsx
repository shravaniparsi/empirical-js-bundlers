...
import styles from './CategoriesErrorBoundary.module.css';
...
interface CategoriesErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: CategoriesErrorBoundaryProps<T>) {
