...
import styles from './CategoriesStat.module.css';

interface CategoriesStatItem {
  updatedAt: Date;
  createdAt: Date;
  assignee: string;
  priority: number;
...
interface CategoriesStatProps {
  items?: CategoriesStatItem[];
...
export default function CategoriesStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
