...
import styles from './CategoriesStat1.module.css';

interface CategoriesStat1Item {
  tags: string[];
  description: string;
  title: string;
  createdAt: Date;
...
interface CategoriesStat1Props {
  items?: CategoriesStat1Item[];
...
export default function CategoriesStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesStat1Props) {
