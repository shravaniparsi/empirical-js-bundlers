...
import CategoriesInput1 from './CategoriesInput1';
import styles from './CategoriesPaginated.module.css';
...
interface CategoriesPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
