...
import styles from './CategoriesRank2.module.css';

interface CategoriesRank2Item {
  createdAt: Date;
  updatedAt: Date;
  assignee: string;
  title: string;
...
interface CategoriesRank2Props {
  items?: CategoriesRank2Item[];
...
export default function CategoriesRank2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesRank2Props) {
