...
import styles from './CategoriesStat2.module.css';

interface CategoriesStat2Item {
  createdAt: Date;
  status: string;
  assignee: string;
  priority: number;
...
interface CategoriesStat2Props {
  items?: CategoriesStat2Item[];
...
export default function CategoriesStat2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesStat2Props) {
