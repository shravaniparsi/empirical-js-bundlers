...
import CategoriesGauge from './CategoriesGauge';
import CategoriesTextArea1 from './CategoriesTextArea1';
import CategoriesFooter from './CategoriesFooter';
import styles from './CategoriesTimePicker.module.css';


interface CategoriesTimePickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CategoriesTimePicker({
  label,
  name,
