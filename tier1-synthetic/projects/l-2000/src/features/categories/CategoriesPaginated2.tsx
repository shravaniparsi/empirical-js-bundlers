...
import styles from './CategoriesPaginated2.module.css';
...
interface CategoriesPaginated2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesPaginated2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
