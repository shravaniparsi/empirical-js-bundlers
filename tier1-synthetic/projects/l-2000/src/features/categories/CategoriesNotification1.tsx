...
import MediaSplit1 from '../media/MediaSplit1';
import styles from './CategoriesNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CategoriesNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CategoriesNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
