...
import styles from './PaymentsColorPicker1.module.css';


interface PaymentsColorPicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PaymentsColorPicker1({
  label,
  name,
