...
import PaymentsThumbnail1 from './PaymentsThumbnail1';
import styles from './PaymentsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PaymentsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PaymentsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
