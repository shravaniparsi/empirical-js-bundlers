...
import PaymentsDivider from './PaymentsDivider';
import PaymentsHeatmap from './PaymentsHeatmap';
import styles from './PaymentsColorPicker2.module.css';


interface PaymentsColorPicker2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PaymentsColorPicker2({
  label,
  name,
