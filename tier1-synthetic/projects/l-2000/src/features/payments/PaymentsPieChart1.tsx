...
import PaymentsTextArea from './PaymentsTextArea';
import styles from './PaymentsPieChart1.module.css';
...
interface PaymentsPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PaymentsPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
