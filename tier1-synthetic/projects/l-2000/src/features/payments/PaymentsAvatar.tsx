...
import styles from './PaymentsAvatar.module.css';

interface PaymentsAvatarItem {
  status: string;
  updatedAt: Date;
  priority: number;
  id: string;
...
interface PaymentsAvatarProps {
  items?: PaymentsAvatarItem[];
...
export default function PaymentsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
