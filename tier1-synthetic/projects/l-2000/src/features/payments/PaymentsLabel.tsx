...
import styles from './PaymentsLabel.module.css';

interface PaymentsLabelItem {
  updatedAt: Date;
  createdAt: Date;
  assignee: string;
  tags: string[];
...
interface PaymentsLabelProps {
  items?: PaymentsLabelItem[];
...
export default function PaymentsLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
