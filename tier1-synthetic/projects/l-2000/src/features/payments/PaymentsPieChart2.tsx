...
import PaymentsScatter from './PaymentsScatter';
import WorkflowsHeatmap from '../workflows/WorkflowsHeatmap';
import ThemesSparkline from '../themes/ThemesSparkline';
import styles from './PaymentsPieChart2.module.css';
...
interface PaymentsPieChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PaymentsPieChart2({
  data,
  title,
  height = 300,
  showLegend = true,
