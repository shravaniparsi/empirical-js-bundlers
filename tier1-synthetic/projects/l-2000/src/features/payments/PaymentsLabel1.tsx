...
import PaymentsBanner1 from './PaymentsBanner1';
import styles from './PaymentsLabel1.module.css';

interface PaymentsLabel1Item {
  priority: number;
  updatedAt: Date;
  title: string;
  description: string;
...
interface PaymentsLabel1Props {
  items?: PaymentsLabel1Item[];
...
export default function PaymentsLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
