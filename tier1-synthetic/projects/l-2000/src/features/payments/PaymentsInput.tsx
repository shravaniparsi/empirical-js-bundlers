...
import PaymentsGrid1 from './PaymentsGrid1';
import styles from './PaymentsInput.module.css';

const PaymentsInputSchema = z.object({
...
export default function PaymentsInput({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = PaymentsInputSchema.safeParse({ value: val });
