...
import PaymentsInfiniteScroll from './PaymentsInfiniteScroll';
import styles from './PaymentsTabs1.module.css';
...
export default function PaymentsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PaymentsTabs1">
      {activeItem && (
