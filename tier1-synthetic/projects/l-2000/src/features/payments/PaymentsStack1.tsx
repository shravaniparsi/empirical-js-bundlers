...
import BillingLabel from '../billing/BillingLabel';
import ReportsToast from '../reports/ReportsToast';
import styles from './PaymentsStack1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface PaymentsStack1Props {
...
export default function PaymentsStack1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
