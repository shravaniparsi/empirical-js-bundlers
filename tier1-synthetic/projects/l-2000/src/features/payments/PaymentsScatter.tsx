...
import PaymentsHOC from './PaymentsHOC';
import styles from './PaymentsScatter.module.css';
...
interface PaymentsScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PaymentsScatter({
  data,
  title,
  height = 300,
  showLegend = true,
