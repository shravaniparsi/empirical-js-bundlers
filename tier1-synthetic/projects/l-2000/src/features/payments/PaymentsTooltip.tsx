...
import PaymentsTabs1 from './PaymentsTabs1';
import BillingList2 from '../billing/BillingList2';
import styles from './PaymentsTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PaymentsTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PaymentsTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
