...
import styles from './PaymentsGrid2.module.css';

interface PaymentsGrid2Item {
  description: string;
  updatedAt: Date;
  createdAt: Date;
  status: string;
...
interface PaymentsGrid2Props {
  items?: PaymentsGrid2Item[];
...
export default function PaymentsGrid2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
