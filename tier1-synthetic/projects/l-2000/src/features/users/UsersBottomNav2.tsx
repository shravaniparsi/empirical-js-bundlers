...
import styles from './UsersBottomNav2.module.css';
...
interface UsersBottomNav2Props {
  items: NavItem[];
  activeId?: string;
...
export default function UsersBottomNav2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersBottomNav2">
      {activeItem && (
