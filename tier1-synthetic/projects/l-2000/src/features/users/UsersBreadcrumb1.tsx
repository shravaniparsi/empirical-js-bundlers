...
import UsersBottomNav2 from './UsersBottomNav2';
import styles from './UsersBreadcrumb1.module.css';
...
interface UsersBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function UsersBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersBreadcrumb1">
      {activeItem && (
