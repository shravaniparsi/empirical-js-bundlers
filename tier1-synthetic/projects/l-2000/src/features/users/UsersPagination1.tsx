...
import styles from './UsersPagination1.module.css';
...
interface UsersPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function UsersPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersPagination1">
      {activeItem && (
