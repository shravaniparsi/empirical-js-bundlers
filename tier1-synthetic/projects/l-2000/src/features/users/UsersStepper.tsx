...
import DashboardChip1 from '../dashboard/DashboardChip1';
import styles from './UsersStepper.module.css';
...
export default function UsersStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersStepper">
      {activeItem && (
