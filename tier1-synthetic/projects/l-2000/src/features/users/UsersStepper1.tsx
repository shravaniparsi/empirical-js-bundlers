...
import UsersPanel2 from './UsersPanel2';
import styles from './UsersStepper1.module.css';
...
export default function UsersStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersStepper1">
      {activeItem && (
