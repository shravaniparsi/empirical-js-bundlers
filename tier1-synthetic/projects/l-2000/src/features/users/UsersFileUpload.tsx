...
import { z } from 'zod';
import UsersHOC from './UsersHOC';
import UsersBottomNav1 from './UsersBottomNav1';
import UsersStepper from './UsersStepper';
import OrdersScatter from '../orders/OrdersScatter';
import ProfileProvider from '../profile/ProfileProvider';
import styles from './UsersFileUpload.module.css';

const UsersFileUploadSchema = z.object({
...
export default function UsersFileUpload({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = UsersFileUploadSchema.safeParse({ value: val });
