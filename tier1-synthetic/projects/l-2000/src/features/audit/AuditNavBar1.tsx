...
import styles from './AuditNavBar1.module.css';
...
export default function AuditNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuditNavBar1">
      {activeItem && (
