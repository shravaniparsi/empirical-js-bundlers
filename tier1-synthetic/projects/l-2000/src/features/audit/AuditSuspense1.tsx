...
import styles from './AuditSuspense1.module.css';
...
interface AuditSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
