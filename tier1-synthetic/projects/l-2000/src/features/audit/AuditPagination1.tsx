...
import styles from './AuditPagination1.module.css';
...
interface AuditPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function AuditPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuditPagination1">
      {activeItem && (
