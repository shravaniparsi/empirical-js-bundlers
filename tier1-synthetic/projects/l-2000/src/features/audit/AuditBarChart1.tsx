...
import AuditPolling1 from './AuditPolling1';
import styles from './AuditBarChart1.module.css';
...
export default function AuditBarChart1({
  data,
  title,
  height = 300,
  showLegend = true,
