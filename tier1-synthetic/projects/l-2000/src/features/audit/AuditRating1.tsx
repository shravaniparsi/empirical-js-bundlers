...
import AuditPagination1 from './AuditPagination1';
import AuditColorPicker1 from './AuditColorPicker1';
import AuditHeatmap2 from './AuditHeatmap2';
import PaymentsPieChart2 from '../payments/PaymentsPieChart2';
import styles from './AuditRating1.module.css';


interface AuditRating1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function AuditRating1({
  label,
  name,
