...
import AuditBarChart1 from './AuditBarChart1';
import AuditModal from './AuditModal';
import AuditList1 from './AuditList1';
import styles from './AuditPolling.module.css';
...
interface AuditPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
