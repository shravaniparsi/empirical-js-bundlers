...
import AuditDivider from './AuditDivider';
import ProfileSplit from '../profile/ProfileSplit';
import styles from './AuditErrorBoundary.module.css';
...
interface AuditErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
