...
import AuditFileUpload from './AuditFileUpload';
import AnalyticsPlaceholder1 from '../analytics/AnalyticsPlaceholder1';
import styles from './AuditRetry.module.css';
...
interface AuditRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
