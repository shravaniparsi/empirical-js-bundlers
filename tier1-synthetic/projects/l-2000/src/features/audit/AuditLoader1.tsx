...
import AuditAreaChart from './AuditAreaChart';
...
import styles from './AuditLoader1.module.css';
...
interface AuditLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
