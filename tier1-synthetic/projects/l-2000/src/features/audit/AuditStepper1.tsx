...
import AuditSticky from './AuditSticky';
import styles from './AuditStepper1.module.css';
...
export default function AuditStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuditStepper1">
      {activeItem && (
