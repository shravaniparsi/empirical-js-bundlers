...
import styles from './CatalogRating.module.css';

const CatalogRatingSchema = z.object({
...
export default function CatalogRating({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CatalogRatingSchema.safeParse({ value: val });
