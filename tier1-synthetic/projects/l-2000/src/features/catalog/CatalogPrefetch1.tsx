...
import CatalogChip1 from './CatalogChip1';
import CatalogPaginated from './CatalogPaginated';
import CatalogTimeline1 from './CatalogTimeline1';
import styles from './CatalogPrefetch1.module.css';
...
interface CatalogPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CatalogPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
