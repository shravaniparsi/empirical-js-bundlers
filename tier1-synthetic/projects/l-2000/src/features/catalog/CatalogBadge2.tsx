...
import styles from './CatalogBadge2.module.css';

interface CatalogBadge2Item {
  updatedAt: Date;
  description: string;
  status: string;
  tags: string[];
...
interface CatalogBadge2Props {
  items?: CatalogBadge2Item[];
...
export default function CatalogBadge2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
