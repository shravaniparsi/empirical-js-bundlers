...
import styles from './CatalogMeter1.module.css';

interface CatalogMeter1Item {
  title: string;
  priority: number;
  updatedAt: Date;
  status: string;
...
interface CatalogMeter1Props {
  items?: CatalogMeter1Item[];
...
export default function CatalogMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
