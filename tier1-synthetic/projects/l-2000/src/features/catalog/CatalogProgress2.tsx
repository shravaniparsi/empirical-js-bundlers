...
import styles from './CatalogProgress2.module.css';

interface CatalogProgress2Item {
  title: string;
  status: string;
  tags: string[];
  createdAt: Date;
...
interface CatalogProgress2Props {
  items?: CatalogProgress2Item[];
...
export default function CatalogProgress2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CatalogProgress2Props) {
