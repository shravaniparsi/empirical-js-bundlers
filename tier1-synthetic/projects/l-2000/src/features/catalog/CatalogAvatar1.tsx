...
import styles from './CatalogAvatar1.module.css';

interface CatalogAvatar1Item {
  tags: string[];
  status: string;
  updatedAt: Date;
  id: string;
...
interface CatalogAvatar1Props {
  items?: CatalogAvatar1Item[];
...
export default function CatalogAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
