...
import CatalogHeatmap from './CatalogHeatmap';
import styles from './CatalogHeader1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CatalogHeader1Props {
...
export default function CatalogHeader1({
  children,
