...
import CatalogAvatar from './CatalogAvatar';
import CheckoutTreeView1 from '../checkout/CheckoutTreeView1';
import ReviewsDetail3 from '../reviews/ReviewsDetail3';
import AnalyticsSticky from '../analytics/AnalyticsSticky';
import styles from './CatalogBottomNav.module.css';
...
interface CatalogBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function CatalogBottomNav({
  ...
  return (
    <nav className={navClasses} aria-label="CatalogBottomNav">
      {activeItem && (
