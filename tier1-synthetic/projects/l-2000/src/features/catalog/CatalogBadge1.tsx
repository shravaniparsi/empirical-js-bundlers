...
import CatalogSkeleton1 from './CatalogSkeleton1';
import CatalogGrid from './CatalogGrid';
import styles from './CatalogBadge1.module.css';

interface CatalogBadge1Item {
  updatedAt: Date;
  title: string;
  assignee: string;
  description: string;
...
interface CatalogBadge1Props {
  items?: CatalogBadge1Item[];
...
export default function CatalogBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
