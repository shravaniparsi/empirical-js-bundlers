...
import BillingScroll from './BillingScroll';
import BillingTabs from './BillingTabs';
import ReportsToast from '../reports/ReportsToast';
import styles from './BillingList1.module.css';

interface BillingList1Item {
  description: string;
  assignee: string;
  title: string;
  tags: string[];
...
interface BillingList1Props {
  items?: BillingList1Item[];
...
export default function BillingList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
