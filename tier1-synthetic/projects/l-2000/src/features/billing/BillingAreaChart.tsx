...
interface BillingAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function BillingAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
