...
import BillingResponsive from './BillingResponsive';
import BillingSummary from './BillingSummary';
import styles from './BillingAreaChart2.module.css';
...
interface BillingAreaChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function BillingAreaChart2({
  data,
  title,
  height = 300,
  showLegend = true,
