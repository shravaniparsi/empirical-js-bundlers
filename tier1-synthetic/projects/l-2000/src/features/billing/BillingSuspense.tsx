...
import BillingPagination1 from './BillingPagination1';
import styles from './BillingSuspense.module.css';
...
interface BillingSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
