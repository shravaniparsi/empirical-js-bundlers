...
import IntegrationsRank1 from '../integrations/IntegrationsRank1';
import styles from './BillingHeatmap.module.css';
...
export default function BillingHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
