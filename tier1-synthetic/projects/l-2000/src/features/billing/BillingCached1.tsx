...
import styles from './BillingCached1.module.css';
...
interface BillingCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
