...
import BillingThumbnail from './BillingThumbnail';
import BillingConfirm from './BillingConfirm';
import styles from './BillingPagination1.module.css';
...
interface BillingPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function BillingPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="BillingPagination1">
      {activeItem && (
