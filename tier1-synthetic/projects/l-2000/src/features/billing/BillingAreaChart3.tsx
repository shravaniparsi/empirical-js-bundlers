...
import BillingSidebar1 from './BillingSidebar1';
import styles from './BillingAreaChart3.module.css';
...
interface BillingAreaChart3Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function BillingAreaChart3({
  data,
  title,
  height = 300,
  showLegend = true,
