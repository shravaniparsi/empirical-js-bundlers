...
import BillingHeatmap1 from './BillingHeatmap1';
import BillingPanel from './BillingPanel';
import styles from './BillingPaginated.module.css';
...
interface BillingPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
