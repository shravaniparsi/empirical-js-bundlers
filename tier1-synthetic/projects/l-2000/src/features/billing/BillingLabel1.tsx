...
import styles from './BillingLabel1.module.css';

interface BillingLabel1Item {
  createdAt: Date;
  status: string;
  description: string;
  priority: number;
...
interface BillingLabel1Props {
  items?: BillingLabel1Item[];
...
export default function BillingLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
