...
import BillingScatter1 from './BillingScatter1';
import AdminMeter from '../admin/AdminMeter';
import styles from './BillingThumbnail.module.css';

interface BillingThumbnailItem {
  createdAt: Date;
  description: string;
  title: string;
  status: string;
...
interface BillingThumbnailProps {
  items?: BillingThumbnailItem[];
...
export default function BillingThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: BillingThumbnailProps) {
