...
import BillingAreaChart2 from './BillingAreaChart2';
import styles from './BillingScatter1.module.css';
...
interface BillingScatter1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function BillingScatter1({
  data,
  title,
  height = 300,
  showLegend = true,
