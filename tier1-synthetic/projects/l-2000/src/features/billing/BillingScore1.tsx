...
import styles from './BillingScore1.module.css';

interface BillingScore1Item {
  assignee: string;
  updatedAt: Date;
  title: string;
  status: string;
...
interface BillingScore1Props {
  items?: BillingScore1Item[];
...
export default function BillingScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
