...
import styles from './BillingScore.module.css';

interface BillingScoreItem {
  assignee: string;
  tags: string[];
  createdAt: Date;
  id: string;
...
interface BillingScoreProps {
  items?: BillingScoreItem[];
...
export default function BillingScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
