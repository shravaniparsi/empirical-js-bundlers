...
import styles from './BillingGrid3.module.css';

interface BillingGrid3Item {
  createdAt: Date;
  updatedAt: Date;
  title: string;
  status: string;
...
interface BillingGrid3Props {
  items?: BillingGrid3Item[];
...
export default function BillingGrid3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
