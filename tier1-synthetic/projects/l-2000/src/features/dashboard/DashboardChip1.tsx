...
import styles from './DashboardChip1.module.css';

interface DashboardChip1Item {
  createdAt: Date;
  assignee: string;
  updatedAt: Date;
  status: string;
...
interface DashboardChip1Props {
  items?: DashboardChip1Item[];
...
export default function DashboardChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
