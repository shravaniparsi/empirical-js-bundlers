...
import DashboardDatePicker1 from './DashboardDatePicker1';
import styles from './DashboardPolling.module.css';
...
interface DashboardPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
