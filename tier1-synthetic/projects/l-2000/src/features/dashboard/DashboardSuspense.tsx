...
import DashboardInput1 from './DashboardInput1';
import SettingsSnackbar from '../settings/SettingsSnackbar';
import styles from './DashboardSuspense.module.css';
...
interface DashboardSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
