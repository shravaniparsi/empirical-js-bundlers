...
import styles from './DashboardMeter1.module.css';

interface DashboardMeter1Item {
  updatedAt: Date;
  tags: string[];
  priority: number;
  status: string;
...
interface DashboardMeter1Props {
  items?: DashboardMeter1Item[];
...
export default function DashboardMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: DashboardMeter1Props) {
