...
import AuthLineChart from '../auth/AuthLineChart';
import styles from './DashboardSticky.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface DashboardStickyProps {
...
export default function DashboardSticky({
  children,
