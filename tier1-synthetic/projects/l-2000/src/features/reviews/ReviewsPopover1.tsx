...
import ReviewsHook1 from './ReviewsHook1';
import styles from './ReviewsPopover1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReviewsPopover1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReviewsPopover1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
