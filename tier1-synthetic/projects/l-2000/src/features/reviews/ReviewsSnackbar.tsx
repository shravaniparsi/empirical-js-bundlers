...
import ReviewsThumbnail from './ReviewsThumbnail';
import styles from './ReviewsSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReviewsSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReviewsSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
