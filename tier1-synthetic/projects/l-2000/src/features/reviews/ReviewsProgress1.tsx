...
import styles from './ReviewsProgress1.module.css';

interface ReviewsProgress1Item {
  priority: number;
  createdAt: Date;
  assignee: string;
  description: string;
...
interface ReviewsProgress1Props {
  items?: ReviewsProgress1Item[];
...
export default function ReviewsProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReviewsProgress1Props) {
