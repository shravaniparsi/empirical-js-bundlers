...
import styles from './ReviewsDetail2.module.css';

interface ReviewsDetail2Item {
  status: string;
  priority: number;
  createdAt: Date;
  tags: string[];
...
interface ReviewsDetail2Props {
  items?: ReviewsDetail2Item[];
...
export default function ReviewsDetail2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
