...
import ReviewsRadio1 from './ReviewsRadio1';
import CartSpinner from '../cart/CartSpinner';
import styles from './ReviewsLoader.module.css';
...
interface ReviewsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
