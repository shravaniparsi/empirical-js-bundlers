...
import styles from './ReviewsThumbnail1.module.css';

interface ReviewsThumbnail1Item {
  title: string;
  status: string;
  createdAt: Date;
  updatedAt: Date;
...
interface ReviewsThumbnail1Props {
  items?: ReviewsThumbnail1Item[];
...
export default function ReviewsThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReviewsThumbnail1Props) {
