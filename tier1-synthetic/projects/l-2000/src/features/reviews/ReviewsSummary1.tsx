...
import styles from './ReviewsSummary1.module.css';

interface ReviewsSummary1Item {
  priority: number;
  status: string;
  title: string;
  id: string;
...
interface ReviewsSummary1Props {
  items?: ReviewsSummary1Item[];
...
export default function ReviewsSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReviewsSummary1Props) {
