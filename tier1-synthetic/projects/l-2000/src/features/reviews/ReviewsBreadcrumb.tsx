...
import WebhooksFunnel from '../webhooks/WebhooksFunnel';
import styles from './ReviewsBreadcrumb.module.css';
...
interface ReviewsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function ReviewsBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsBreadcrumb">
      {activeItem && (
