...
import styles from './ReviewsRank1.module.css';

interface ReviewsRank1Item {
  tags: string[];
  createdAt: Date;
  priority: number;
  assignee: string;
...
interface ReviewsRank1Props {
  items?: ReviewsRank1Item[];
...
export default function ReviewsRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
