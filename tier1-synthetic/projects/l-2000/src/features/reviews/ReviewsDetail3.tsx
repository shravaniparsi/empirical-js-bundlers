...
import ReviewsCheckbox from './ReviewsCheckbox';
import styles from './ReviewsDetail3.module.css';

interface ReviewsDetail3Item {
  assignee: string;
  priority: number;
  status: string;
  tags: string[];
...
interface ReviewsDetail3Props {
  items?: ReviewsDetail3Item[];
...
export default function ReviewsDetail3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
