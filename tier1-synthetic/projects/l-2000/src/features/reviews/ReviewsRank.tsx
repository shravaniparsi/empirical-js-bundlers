...
import ReviewsCached from './ReviewsCached';
import ReviewsAccordion from './ReviewsAccordion';
import styles from './ReviewsRank.module.css';

interface ReviewsRankItem {
  status: string;
  createdAt: Date;
  title: string;
  assignee: string;
...
interface ReviewsRankProps {
  items?: ReviewsRankItem[];
...
export default function ReviewsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
