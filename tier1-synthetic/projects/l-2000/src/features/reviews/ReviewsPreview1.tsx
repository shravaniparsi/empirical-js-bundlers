...
import styles from './ReviewsPreview1.module.css';

interface ReviewsPreview1Item {
  description: string;
  updatedAt: Date;
  priority: number;
  title: string;
...
interface ReviewsPreview1Props {
  items?: ReviewsPreview1Item[];
...
export default function ReviewsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReviewsPreview1Props) {
