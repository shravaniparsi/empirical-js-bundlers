...
import ReviewsHeader1 from './ReviewsHeader1';
import ReviewsMeter from './ReviewsMeter';
import styles from './ReviewsCached.module.css';
...
interface ReviewsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
