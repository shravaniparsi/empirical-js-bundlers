...
import styles from './ReviewsCached1.module.css';
...
interface ReviewsCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
