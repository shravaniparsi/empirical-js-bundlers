...
import ReviewsSticky from './ReviewsSticky';
import ReviewsDatePicker from './ReviewsDatePicker';
import WebhooksRegistry from '../webhooks/WebhooksRegistry';
import styles from './ReviewsTreeView.module.css';
...
interface ReviewsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function ReviewsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsTreeView">
      {activeItem && (
