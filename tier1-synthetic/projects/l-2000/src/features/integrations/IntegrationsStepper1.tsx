...
import IntegrationsProgress from './IntegrationsProgress';
...
import styles from './IntegrationsStepper1.module.css';
...
interface IntegrationsStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsStepper1">
      {activeItem && (
