...
import styles from './IntegrationsProgress.module.css';

interface IntegrationsProgressItem {
  createdAt: Date;
  tags: string[];
  assignee: string;
  id: string;
...
interface IntegrationsProgressProps {
  items?: IntegrationsProgressItem[];
...
export default function IntegrationsProgress({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsProgressProps) {
