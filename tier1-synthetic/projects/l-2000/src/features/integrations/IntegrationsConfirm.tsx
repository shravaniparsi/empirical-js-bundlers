...
import styles from './IntegrationsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
