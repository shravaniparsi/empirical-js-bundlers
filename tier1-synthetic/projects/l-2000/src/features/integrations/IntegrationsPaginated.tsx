...
import IntegrationsRank1 from './IntegrationsRank1';
import CheckoutRank from '../checkout/CheckoutRank';
import styles from './IntegrationsPaginated.module.css';
...
interface IntegrationsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
