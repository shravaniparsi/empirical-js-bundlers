...
import IntegrationsHeader1 from './IntegrationsHeader1';
import IntegrationsTimePicker1 from './IntegrationsTimePicker1';
import IntegrationsSpinner1 from './IntegrationsSpinner1';
import styles from './IntegrationsScatter.module.css';
...
interface IntegrationsScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsScatter({
  data,
  title,
  height = 300,
  showLegend = true,
