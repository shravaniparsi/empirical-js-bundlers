...
import IntegrationsSuspense1 from './IntegrationsSuspense1';
import styles from './IntegrationsChip.module.css';

interface IntegrationsChipItem {
  title: string;
  description: string;
  status: string;
  tags: string[];
...
interface IntegrationsChipProps {
  items?: IntegrationsChipItem[];
...
export default function IntegrationsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsChipProps) {
