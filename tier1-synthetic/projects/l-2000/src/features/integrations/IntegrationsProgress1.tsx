...
import styles from './IntegrationsProgress1.module.css';

interface IntegrationsProgress1Item {
  status: string;
  createdAt: Date;
  description: string;
  id: string;
...
interface IntegrationsProgress1Props {
  items?: IntegrationsProgress1Item[];
...
export default function IntegrationsProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsProgress1Props) {
