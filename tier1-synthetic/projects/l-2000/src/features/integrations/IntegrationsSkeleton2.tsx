...
import styles from './IntegrationsSkeleton2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSkeleton2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsSkeleton2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
