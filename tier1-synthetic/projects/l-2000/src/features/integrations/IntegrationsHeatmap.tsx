...
import styles from './IntegrationsHeatmap.module.css';
...
interface IntegrationsHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
