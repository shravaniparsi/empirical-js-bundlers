...
import styles from './IntegrationsNavBar.module.css';
...
interface IntegrationsNavBarProps {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsNavBar({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsNavBar">
      {activeItem && (
