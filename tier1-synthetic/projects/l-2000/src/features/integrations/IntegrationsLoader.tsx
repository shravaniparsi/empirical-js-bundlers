...
interface IntegrationsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
