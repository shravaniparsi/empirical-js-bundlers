...
import IntegrationsSticky1 from './IntegrationsSticky1';
import styles from './IntegrationsSummary.module.css';

interface IntegrationsSummaryItem {
  status: string;
  createdAt: Date;
  assignee: string;
  title: string;
