...
import IntegrationsNavBar from './IntegrationsNavBar';
import styles from './IntegrationsInfiniteScroll.module.css';
...
interface IntegrationsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: IntegrationsInfiniteScrollProps<T>) {
