...
import styles from './IntegrationsStepper.module.css';
...
export default function IntegrationsStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsStepper">
      {activeItem && (
