...
import styles from './IntegrationsResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface IntegrationsResponsiveProps {
...
export default function IntegrationsResponsive({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
