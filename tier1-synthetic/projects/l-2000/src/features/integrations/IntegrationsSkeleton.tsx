...
import IntegrationsInfiniteScroll from './IntegrationsInfiniteScroll';
import IntegrationsSuspense1 from './IntegrationsSuspense1';
import styles from './IntegrationsSkeleton.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSkeletonProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
