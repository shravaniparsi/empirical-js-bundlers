...
import PaymentsBottomNav from '../payments/PaymentsBottomNav';
import styles from './IntegrationsChip1.module.css';

interface IntegrationsChip1Item {
  tags: string[];
  updatedAt: Date;
  status: string;
  title: string;
...
interface IntegrationsChip1Props {
  items?: IntegrationsChip1Item[];
...
export default function IntegrationsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsChip1Props) {
