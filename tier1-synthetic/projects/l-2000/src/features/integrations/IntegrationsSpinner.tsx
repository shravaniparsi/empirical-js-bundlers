...
import IntegrationsChip from './IntegrationsChip';
import IntegrationsFooter from './IntegrationsFooter';
import styles from './IntegrationsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
