...
import styles from './IntegrationsTimeline.module.css';

interface IntegrationsTimelineItem {
  assignee: string;
  status: string;
  tags: string[];
  description: string;
...
interface IntegrationsTimelineProps {
  items?: IntegrationsTimelineItem[];
...
export default function IntegrationsTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsTimelineProps) {
