...
import styles from './IntegrationsAreaChart.module.css';
...
interface IntegrationsAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
