...
import styles from './IntegrationsSuspense1.module.css';
...
interface IntegrationsSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
