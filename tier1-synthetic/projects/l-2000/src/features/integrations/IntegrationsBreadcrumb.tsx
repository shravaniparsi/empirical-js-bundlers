...
import styles from './IntegrationsBreadcrumb.module.css';
...
interface IntegrationsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsBreadcrumb({
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsBreadcrumb">
      {activeItem && (
