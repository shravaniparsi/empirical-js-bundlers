...
import { z } from 'zod';
import InventorySelect1 from './InventorySelect1';
import ReportsScatter from '../reports/ReportsScatter';
import styles from './InventorySlider.module.css';

const InventorySliderSchema = z.object({
...
export default function InventorySlider({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = InventorySliderSchema.safeParse({ value: val });
