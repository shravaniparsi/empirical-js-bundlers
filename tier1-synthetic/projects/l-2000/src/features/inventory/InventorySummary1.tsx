...
import styles from './InventorySummary1.module.css';

interface InventorySummary1Item {
  assignee: string;
  updatedAt: Date;
  createdAt: Date;
  id: string;
...
interface InventorySummary1Props {
  items?: InventorySummary1Item[];
...
export default function InventorySummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventorySummary1Props) {
