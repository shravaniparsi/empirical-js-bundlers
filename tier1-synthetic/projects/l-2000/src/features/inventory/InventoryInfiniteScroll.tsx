...
import styles from './InventoryInfiniteScroll.module.css';
...
interface InventoryInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: InventoryInfiniteScrollProps<T>) {
