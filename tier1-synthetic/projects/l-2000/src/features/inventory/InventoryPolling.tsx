...
import CategoriesPagination1 from '../categories/CategoriesPagination1';
import ReportsScatter from '../reports/ReportsScatter';
import styles from './InventoryPolling.module.css';
...
interface InventoryPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
