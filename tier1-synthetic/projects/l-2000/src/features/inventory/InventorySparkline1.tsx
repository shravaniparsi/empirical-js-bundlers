...
import InventorySparkline2 from './InventorySparkline2';
import styles from './InventorySparkline1.module.css';
...
interface InventorySparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function InventorySparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
