...
import InventorySparkline from './InventorySparkline';
import styles from './InventoryToggle3.module.css';


interface InventoryToggle3Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function InventoryToggle3({
  label,
  name,
