...
import InventoryAlert1 from './InventoryAlert1';
import InventoryAdapter1 from './InventoryAdapter1';
import styles from './InventoryPrefetch.module.css';
...
interface InventoryPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
