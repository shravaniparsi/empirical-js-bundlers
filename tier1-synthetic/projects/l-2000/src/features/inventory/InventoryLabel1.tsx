...
import styles from './InventoryLabel1.module.css';

interface InventoryLabel1Item {
  updatedAt: Date;
  createdAt: Date;
  title: string;
  priority: number;
...
interface InventoryLabel1Props {
  items?: InventoryLabel1Item[];
...
export default function InventoryLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryLabel1Props) {
