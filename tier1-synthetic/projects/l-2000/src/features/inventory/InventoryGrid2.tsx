...
import styles from './InventoryGrid2.module.css';

interface InventoryGrid2Item {
  updatedAt: Date;
  title: string;
  priority: number;
  id: string;
...
interface InventoryGrid2Props {
  items?: InventoryGrid2Item[];
...
export default function InventoryGrid2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
