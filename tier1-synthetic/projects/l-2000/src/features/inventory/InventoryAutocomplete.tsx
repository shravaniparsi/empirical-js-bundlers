...
import styles from './InventoryAutocomplete.module.css';

const InventoryAutocompleteSchema = z.object({
...
export default function InventoryAutocomplete({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = InventoryAutocompleteSchema.safeParse({ value: val });
