...
import ShippingTextArea1 from './ShippingTextArea1';
import styles from './ShippingPieChart1.module.css';
...
interface ShippingPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ShippingPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
