...
import styles from './ShippingBadge1.module.css';

interface ShippingBadge1Item {
  updatedAt: Date;
  status: string;
  tags: string[];
  id: string;
...
interface ShippingBadge1Props {
  items?: ShippingBadge1Item[];
...
export default function ShippingBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
