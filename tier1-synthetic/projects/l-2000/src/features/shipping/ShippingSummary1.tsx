...
import ShippingLineChart from './ShippingLineChart';
import ShippingTag from './ShippingTag';
import ShippingSnackbar from './ShippingSnackbar';
import styles from './ShippingSummary1.module.css';

interface ShippingSummary1Item {
  tags: string[];
  priority: number;
  updatedAt: Date;
  createdAt: Date;
...
interface ShippingSummary1Props {
  items?: ShippingSummary1Item[];
...
export default function ShippingSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ShippingSummary1Props) {
