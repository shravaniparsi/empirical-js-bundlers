...
import ShippingRank1 from './ShippingRank1';
import styles from './ShippingBanner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ShippingBanner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ShippingBanner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
