...
import styles from './ShippingRank.module.css';

interface ShippingRankItem {
  updatedAt: Date;
  title: string;
  createdAt: Date;
  id: string;
...
interface ShippingRankProps {
  items?: ShippingRankItem[];
...
export default function ShippingRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
