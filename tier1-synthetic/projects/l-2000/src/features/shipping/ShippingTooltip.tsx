...
import ShippingPieChart1 from './ShippingPieChart1';
import styles from './ShippingTooltip.module.css';
...
export default function ShippingTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
