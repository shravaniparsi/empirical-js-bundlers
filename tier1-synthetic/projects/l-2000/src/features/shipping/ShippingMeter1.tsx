...
import styles from './ShippingMeter1.module.css';

interface ShippingMeter1Item {
  createdAt: Date;
  title: string;
  assignee: string;
  tags: string[];
...
interface ShippingMeter1Props {
  items?: ShippingMeter1Item[];
...
export default function ShippingMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
