...
import CheckoutSpacer1 from '../checkout/CheckoutSpacer1';
import styles from './ShippingPagination.module.css';
...
interface ShippingPaginationProps {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingPagination({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingPagination">
      {activeItem && (
