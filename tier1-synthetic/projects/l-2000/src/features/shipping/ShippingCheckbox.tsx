...
import styles from './ShippingCheckbox.module.css';

const ShippingCheckboxSchema = z.object({
...
export default function ShippingCheckbox({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ShippingCheckboxSchema.safeParse({ value: val });
