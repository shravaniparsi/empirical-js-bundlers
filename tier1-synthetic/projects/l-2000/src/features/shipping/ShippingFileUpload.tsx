...
import { z } from 'zod';
import ShippingCollapse1 from './ShippingCollapse1';
import ShippingProgress3 from './ShippingProgress3';
import styles from './ShippingFileUpload.module.css';

const ShippingFileUploadSchema = z.object({
...
export default function ShippingFileUpload({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ShippingFileUploadSchema.safeParse({ value: val });
