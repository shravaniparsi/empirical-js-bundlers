...
import styles from './ShippingRank1.module.css';

interface ShippingRank1Item {
  updatedAt: Date;
  status: string;
  assignee: string;
  tags: string[];
...
interface ShippingRank1Props {
  items?: ShippingRank1Item[];
...
export default function ShippingRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
