...
import styles from './ShippingMeter2.module.css';

interface ShippingMeter2Item {
  priority: number;
  title: string;
  assignee: string;
  tags: string[];
...
interface ShippingMeter2Props {
  items?: ShippingMeter2Item[];
...
export default function ShippingMeter2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
