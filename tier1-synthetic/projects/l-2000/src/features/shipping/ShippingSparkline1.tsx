...
import ShippingMeter1 from './ShippingMeter1';
...
import styles from './ShippingSparkline1.module.css';
...
interface ShippingSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ShippingSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
