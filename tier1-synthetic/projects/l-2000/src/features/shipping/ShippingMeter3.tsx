...
import styles from './ShippingMeter3.module.css';

interface ShippingMeter3Item {
  assignee: string;
  updatedAt: Date;
  createdAt: Date;
  priority: number;
...
interface ShippingMeter3Props {
  items?: ShippingMeter3Item[];
...
export default function ShippingMeter3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
