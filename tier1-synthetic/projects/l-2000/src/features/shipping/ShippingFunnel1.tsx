...
import ShippingMeter3 from './ShippingMeter3';
import ShippingPolling from './ShippingPolling';
import styles from './ShippingFunnel1.module.css';
...
interface ShippingFunnel1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ShippingFunnel1({
  data,
  title,
  height = 300,
  showLegend = true,
