...
import styles from './ShippingTabs1.module.css';
...
export default function ShippingTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingTabs1">
      {activeItem && (
