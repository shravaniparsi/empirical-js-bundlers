...
import UsersThumbnail from '../users/UsersThumbnail';
import styles from './ShippingResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ShippingResponsiveProps {
...
export default function ShippingResponsive({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
