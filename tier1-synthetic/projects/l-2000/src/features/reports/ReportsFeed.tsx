...
import ReportsScatter from './ReportsScatter';
import ReportsPrefetch from './ReportsPrefetch';
import DocumentsScroll from '../documents/DocumentsScroll';
import styles from './ReportsFeed.module.css';

interface ReportsFeedItem {
  title: string;
  assignee: string;
  createdAt: Date;
  tags: string[];
