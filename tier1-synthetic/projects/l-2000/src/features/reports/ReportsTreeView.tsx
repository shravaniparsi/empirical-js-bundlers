...
import ReportsCard2 from './ReportsCard2';
import styles from './ReportsTreeView.module.css';
...
export default function ReportsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsTreeView">
      {activeItem && (
