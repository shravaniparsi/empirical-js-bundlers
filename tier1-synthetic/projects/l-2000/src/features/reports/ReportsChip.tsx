...
import ReportsChip1 from './ReportsChip1';
import ReportsAvatar from './ReportsAvatar';
import WebhooksRegistry from '../webhooks/WebhooksRegistry';
import styles from './ReportsChip.module.css';

interface ReportsChipItem {
  title: string;
  status: string;
  assignee: string;
  id: string;
...
interface ReportsChipProps {
  items?: ReportsChipItem[];
...
export default function ReportsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
