...
import ReportsTimePicker2 from './ReportsTimePicker2';
import styles from './ReportsPolling.module.css';
...
interface ReportsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReportsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
