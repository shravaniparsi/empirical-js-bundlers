...
import ReportsSplit from './ReportsSplit';
import WebhooksTimeline1 from '../webhooks/WebhooksTimeline1';
import AnalyticsSticky from '../analytics/AnalyticsSticky';
import styles from './ReportsPopover.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReportsPopoverProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReportsPopover({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
