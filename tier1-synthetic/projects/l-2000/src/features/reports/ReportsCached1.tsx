...
import styles from './ReportsCached1.module.css';
...
interface ReportsCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReportsCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
