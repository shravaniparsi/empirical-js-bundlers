...
import ReportsSticky from './ReportsSticky';
import styles from './ReportsPrefetch.module.css';
...
interface ReportsPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReportsPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
