...
import MediaBarChart from '../media/MediaBarChart';
import styles from './ReportsChip1.module.css';

interface ReportsChip1Item {
  priority: number;
  title: string;
  assignee: string;
  tags: string[];
...
interface ReportsChip1Props {
  items?: ReportsChip1Item[];
...
export default function ReportsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
