...
import ReportsToggle from './ReportsToggle';
import ReportsDetail from './ReportsDetail';
import styles from './ReportsResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ReportsResponsiveProps {
...
export default function ReportsResponsive({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
