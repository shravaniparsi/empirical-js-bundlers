...
import ReportsInfiniteScroll from './ReportsInfiniteScroll';
import ReportsDivider from './ReportsDivider';
import ReportsBadge from './ReportsBadge';
import styles from './ReportsCard2.module.css';

interface ReportsCard2Item {
  createdAt: Date;
  updatedAt: Date;
  description: string;
  priority: number;
...
interface ReportsCard2Props {
  items?: ReportsCard2Item[];
...
export default function ReportsCard2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
