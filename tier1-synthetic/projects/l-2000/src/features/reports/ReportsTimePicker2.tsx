...
import ReportsRadio1 from './ReportsRadio1';
import styles from './ReportsTimePicker2.module.css';


interface ReportsTimePicker2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ReportsTimePicker2({
  label,
  name,
