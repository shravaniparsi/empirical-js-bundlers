...
import ReportsCard1 from './ReportsCard1';
import styles from './ReportsInfiniteScroll.module.css';
...
interface ReportsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReportsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
