...
import NotificationsScroll from '../notifications/NotificationsScroll';
import styles from './ReportsRank.module.css';

interface ReportsRankItem {
  createdAt: Date;
  description: string;
  tags: string[];
  status: string;
...
export default function ReportsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
