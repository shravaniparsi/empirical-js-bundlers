...
import styles from './ReportsCard1.module.css';

interface ReportsCard1Item {
  title: string;
  tags: string[];
  assignee: string;
  createdAt: Date;
...
interface ReportsCard1Props {
  items?: ReportsCard1Item[];
...
export default function ReportsCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
