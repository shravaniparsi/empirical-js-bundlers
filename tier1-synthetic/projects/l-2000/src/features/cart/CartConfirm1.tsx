...
import OrdersContainer1 from '../orders/OrdersContainer1';
import styles from './CartConfirm1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CartConfirm1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CartConfirm1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
