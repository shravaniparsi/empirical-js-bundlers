...
import styles from './AnalyticsThumbnail.module.css';

interface AnalyticsThumbnailItem {
  priority: number;
  createdAt: Date;
  status: string;
  tags: string[];
...
interface AnalyticsThumbnailProps {
  items?: AnalyticsThumbnailItem[];
...
export default function AnalyticsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsThumbnailProps) {
