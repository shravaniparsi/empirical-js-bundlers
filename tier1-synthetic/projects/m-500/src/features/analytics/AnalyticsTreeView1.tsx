...
import styles from './AnalyticsTreeView1.module.css';
...
interface AnalyticsTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function AnalyticsTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AnalyticsTreeView1">
      {activeItem && (
