...
import styles from './AnalyticsTreeView.module.css';
...
interface AnalyticsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function AnalyticsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AnalyticsTreeView">
      {activeItem && (
