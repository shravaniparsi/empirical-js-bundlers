...
import styles from './PaymentsDrawer1.module.css';
...
interface PaymentsDrawer1Props {
  items: NavItem[];
  activeId?: string;
...
export default function PaymentsDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PaymentsDrawer1">
      {activeItem && (
