...
import PaymentsSnackbar1 from './PaymentsSnackbar1';
import PaymentsPieChart from './PaymentsPieChart';
import ProductsAlert from '../products/ProductsAlert';
import styles from './PaymentsScore.module.css';

interface PaymentsScoreItem {
  description: string;
  createdAt: Date;
  assignee: string;
  status: string;
...
interface PaymentsScoreProps {
  items?: PaymentsScoreItem[];
...
export default function PaymentsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
