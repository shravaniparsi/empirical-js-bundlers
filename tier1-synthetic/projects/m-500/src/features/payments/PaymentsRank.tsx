...
import styles from './PaymentsRank.module.css';

interface PaymentsRankItem {
  priority: number;
  assignee: string;
  status: string;
  description: string;
...
interface PaymentsRankProps {
  items?: PaymentsRankItem[];
...
export default function PaymentsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
