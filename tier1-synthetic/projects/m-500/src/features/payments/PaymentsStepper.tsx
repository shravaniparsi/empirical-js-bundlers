...
import styles from './PaymentsStepper.module.css';
...
interface PaymentsStepperProps {
  items: NavItem[];
  activeId?: string;
...
export default function PaymentsStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PaymentsStepper">
      {activeItem && (
