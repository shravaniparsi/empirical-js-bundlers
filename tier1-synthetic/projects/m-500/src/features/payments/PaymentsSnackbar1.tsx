...
import PaymentsRank1 from './PaymentsRank1';
import styles from './PaymentsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PaymentsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PaymentsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
