...
import styles from './ProductsMenu1.module.css';
...
export default function ProductsMenu1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProductsMenu1">
      {activeItem && (
