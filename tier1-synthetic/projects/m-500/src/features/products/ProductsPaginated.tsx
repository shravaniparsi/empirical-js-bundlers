...
import DashboardPaginated from '../dashboard/DashboardPaginated';
import styles from './ProductsPaginated.module.css';
...
interface ProductsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
