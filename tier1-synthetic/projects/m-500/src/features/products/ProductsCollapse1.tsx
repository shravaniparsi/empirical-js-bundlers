...
import AnalyticsTag from '../analytics/AnalyticsTag';
import styles from './ProductsCollapse1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ProductsCollapse1Props {
...
export default function ProductsCollapse1({
  children,
