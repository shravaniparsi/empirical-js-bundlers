...
import styles from './ProductsMeter.module.css';

interface ProductsMeterItem {
  priority: number;
  description: string;
  title: string;
  id: string;
...
interface ProductsMeterProps {
  items?: ProductsMeterItem[];
...
export default function ProductsMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
