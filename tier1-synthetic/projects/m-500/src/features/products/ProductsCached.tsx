...
import styles from './ProductsCached.module.css';
...
interface ProductsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
