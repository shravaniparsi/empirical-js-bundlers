...
import ProductsMeter from './ProductsMeter';
import styles from './ProductsSuspense.module.css';
...
interface ProductsSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
