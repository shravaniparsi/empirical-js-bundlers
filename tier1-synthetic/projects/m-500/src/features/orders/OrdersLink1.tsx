...
import OrdersAvatar from './OrdersAvatar';
import styles from './OrdersLink1.module.css';
...
export default function OrdersLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OrdersLink1">
      {activeItem && (
