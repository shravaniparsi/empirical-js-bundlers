...
import AuthDatePicker from '../auth/AuthDatePicker';
import ShippingPieChart from '../shipping/ShippingPieChart';
import InventorySearch from '../inventory/InventorySearch';
import styles from './SearchRating.module.css';

const SearchRatingSchema = z.object({
...
export default function SearchRating({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = SearchRatingSchema.safeParse({ value: val });
