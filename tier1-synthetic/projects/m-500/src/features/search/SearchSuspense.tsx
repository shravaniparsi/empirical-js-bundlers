...
import SearchFileUpload from './SearchFileUpload';
import styles from './SearchSuspense.module.css';
...
interface SearchSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
