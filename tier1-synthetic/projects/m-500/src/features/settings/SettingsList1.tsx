...
import styles from './SettingsList1.module.css';

interface SettingsList1Item {
  description: string;
  status: string;
  assignee: string;
  tags: string[];
...
interface SettingsList1Props {
  items?: SettingsList1Item[];
...
export default function SettingsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
