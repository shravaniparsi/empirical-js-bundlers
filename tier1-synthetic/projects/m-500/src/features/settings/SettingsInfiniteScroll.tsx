...
import SettingsComposer from './SettingsComposer';
import styles from './SettingsInfiniteScroll.module.css';
...
interface SettingsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
