...
import styles from './SettingsPaginated.module.css';
...
interface SettingsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
