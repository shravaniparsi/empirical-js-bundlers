...
import SettingsPopover1 from './SettingsPopover1';
import SettingsTable1 from './SettingsTable1';
import DashboardBanner1 from '../dashboard/DashboardBanner1';
...
interface SettingsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
