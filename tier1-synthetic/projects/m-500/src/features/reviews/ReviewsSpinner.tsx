...
import ReviewsNavBar1 from './ReviewsNavBar1';
import ReviewsInput1 from './ReviewsInput1';
import styles from './ReviewsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReviewsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReviewsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
