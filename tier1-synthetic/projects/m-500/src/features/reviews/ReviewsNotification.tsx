...
import ReviewsSpinner from './ReviewsSpinner';
import styles from './ReviewsNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReviewsNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReviewsNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
