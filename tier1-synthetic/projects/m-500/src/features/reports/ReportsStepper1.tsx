...
import InventoryCheckbox from '../inventory/InventoryCheckbox';
import InventorySearch from '../inventory/InventorySearch';
import styles from './ReportsStepper1.module.css';
...
interface ReportsStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReportsStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsStepper1">
      {activeItem && (
