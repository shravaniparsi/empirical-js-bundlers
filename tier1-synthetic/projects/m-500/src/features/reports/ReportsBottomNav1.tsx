...
import styles from './ReportsBottomNav1.module.css';
...
interface ReportsBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReportsBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsBottomNav1">
      {activeItem && (
