...
import ReportsContext1 from './ReportsContext1';
import ReportsGauge from './ReportsGauge';
import ReportsBottomNav from './ReportsBottomNav';
import styles from './ReportsStepper.module.css';
...
export default function ReportsStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsStepper">
      {activeItem && (
