...
import ReportsConfirm from './ReportsConfirm';
import ReportsFileUpload from './ReportsFileUpload';
import styles from './ReportsBottomNav.module.css';
...
export default function ReportsBottomNav({
  ...
  return (
    <nav className={navClasses} aria-label="ReportsBottomNav">
      {activeItem && (
