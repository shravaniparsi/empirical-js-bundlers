...
import styles from './ReportsBreadcrumb1.module.css';
...
interface ReportsBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReportsBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsBreadcrumb1">
      {activeItem && (
