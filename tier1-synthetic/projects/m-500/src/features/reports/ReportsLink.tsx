...
import ReportsScroll from './ReportsScroll';
import ReportsPanel1 from './ReportsPanel1';
import styles from './ReportsLink.module.css';
...
export default function ReportsLink({
  ...
  return (
    <nav className={navClasses} aria-label="ReportsLink">
      {activeItem && (
