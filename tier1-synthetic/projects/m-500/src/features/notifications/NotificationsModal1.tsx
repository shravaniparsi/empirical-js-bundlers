...
import styles from './NotificationsModal1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsModal1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsModal1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
