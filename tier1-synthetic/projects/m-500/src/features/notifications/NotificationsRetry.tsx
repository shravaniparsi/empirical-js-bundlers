...
import styles from './NotificationsRetry.module.css';
...
interface NotificationsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
