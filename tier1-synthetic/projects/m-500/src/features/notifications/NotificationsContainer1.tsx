...
import styles from './NotificationsContainer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsContainer1Props {
...
export default function NotificationsContainer1({
  children,
