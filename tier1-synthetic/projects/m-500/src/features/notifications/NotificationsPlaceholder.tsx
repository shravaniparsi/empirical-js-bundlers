...
import styles from './NotificationsPlaceholder.module.css';
...
interface NotificationsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: NotificationsPlaceholderProps<T>) {
