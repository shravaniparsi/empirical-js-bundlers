...
import UsersResponsive from './UsersResponsive';
import UsersGrid from './UsersGrid';
import styles from './UsersBottomNav1.module.css';
...
interface UsersBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function UsersBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersBottomNav1">
      {activeItem && (
