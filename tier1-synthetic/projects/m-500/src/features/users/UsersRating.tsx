...
import { z } from 'zod';
import UsersRangeSlider from './UsersRangeSlider';
import styles from './UsersRating.module.css';

const UsersRatingSchema = z.object({
...
export default function UsersRating({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = UsersRatingSchema.safeParse({ value: val });
