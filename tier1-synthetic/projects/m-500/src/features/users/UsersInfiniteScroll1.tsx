...
import NotificationsNotification from '../notifications/NotificationsNotification';
import styles from './UsersInfiniteScroll1.module.css';
...
interface UsersInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function UsersInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
