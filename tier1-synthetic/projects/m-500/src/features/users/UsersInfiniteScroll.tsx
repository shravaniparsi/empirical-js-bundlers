...
import UsersRangeSlider1 from './UsersRangeSlider1';
import UsersRank from './UsersRank';
import UsersSnackbar from './UsersSnackbar';
import styles from './UsersInfiniteScroll.module.css';
...
interface UsersInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function UsersInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
