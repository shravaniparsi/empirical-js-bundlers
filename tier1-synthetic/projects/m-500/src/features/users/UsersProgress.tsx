...
import UsersTextArea from './UsersTextArea';
import UsersGrid from './UsersGrid';
import styles from './UsersProgress.module.css';

interface UsersProgressItem {
  createdAt: Date;
  assignee: string;
  tags: string[];
  description: string;
...
interface UsersProgressProps {
  items?: UsersProgressItem[];
