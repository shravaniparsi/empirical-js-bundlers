...
import styles from './InventoryResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface InventoryResponsiveProps {
...
export default function InventoryResponsive({
  children,
