...
import InventorySticky from './InventorySticky';
import styles from './InventoryLoader.module.css';
...
interface InventoryLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
