...
import InventoryDivider from './InventoryDivider';
import InventoryGrid from './InventoryGrid';
import UsersInfiniteScroll1 from '../users/UsersInfiniteScroll1';
import styles from './InventoryChip.module.css';

interface InventoryChipItem {
  assignee: string;
  createdAt: Date;
  status: string;
  tags: string[];
...
export default function InventoryChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
