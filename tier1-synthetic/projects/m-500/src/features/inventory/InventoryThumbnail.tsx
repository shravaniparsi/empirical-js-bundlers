...
import styles from './InventoryThumbnail.module.css';

interface InventoryThumbnailItem {
  assignee: string;
  tags: string[];
  updatedAt: Date;
  createdAt: Date;
...
export default function InventoryThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
