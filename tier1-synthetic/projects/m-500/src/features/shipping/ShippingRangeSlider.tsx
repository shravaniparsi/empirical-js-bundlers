...
import styles from './ShippingRangeSlider.module.css';


interface ShippingRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ShippingRangeSlider({
  label,
  name,
