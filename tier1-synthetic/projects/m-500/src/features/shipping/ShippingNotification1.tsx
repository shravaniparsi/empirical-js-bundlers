...
import styles from './ShippingNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ShippingNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ShippingNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
