...
import styles from './ShippingAvatar.module.css';

interface ShippingAvatarItem {
  updatedAt: Date;
  status: string;
  createdAt: Date;
  title: string;
...
interface ShippingAvatarProps {
  items?: ShippingAvatarItem[];
...
export default function ShippingAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
