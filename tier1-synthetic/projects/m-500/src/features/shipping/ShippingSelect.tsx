...
import { z } from 'zod';
import SettingsList1 from '../settings/SettingsList1';
import styles from './ShippingSelect.module.css';

const ShippingSelectSchema = z.object({
...
export default function ShippingSelect({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ShippingSelectSchema.safeParse({ value: val });
