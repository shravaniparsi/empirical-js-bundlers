...
import ShippingSelect1 from './ShippingSelect1';
import SearchDrawer from '../search/SearchDrawer';
import styles from './ShippingScore1.module.css';

interface ShippingScore1Item {
  createdAt: Date;
  status: string;
  priority: number;
  id: string;
...
interface ShippingScore1Props {
  items?: ShippingScore1Item[];
...
export default function ShippingScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
