...
import ShippingScore1 from './ShippingScore1';
import ReviewsScatter from '../reviews/ReviewsScatter';
import styles from './ShippingBottomNav.module.css';
...
interface ShippingBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingBottomNav">
      {activeItem && (
