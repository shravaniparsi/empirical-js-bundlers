...
import styles from './ShippingSuspense1.module.css';
...
interface ShippingSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
