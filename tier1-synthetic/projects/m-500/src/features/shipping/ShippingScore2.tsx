...
import styles from './ShippingScore2.module.css';

interface ShippingScore2Item {
  description: string;
  assignee: string;
  createdAt: Date;
  id: string;
...
interface ShippingScore2Props {
  items?: ShippingScore2Item[];
...
export default function ShippingScore2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
