...
import styles from './DashboardBottomNav1.module.css';
...
interface DashboardBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function DashboardBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DashboardBottomNav1">
      {activeItem && (
