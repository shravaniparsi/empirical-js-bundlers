...
import styles from './BillingBottomNav.module.css';
...
interface BillingBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function BillingBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="BillingBottomNav">
      {activeItem && (
