...
import NotificationsSuspense from '../notifications/NotificationsSuspense';
import styles from './BillingSlider.module.css';

const BillingSliderSchema = z.object({
...
export default function BillingSlider({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = BillingSliderSchema.safeParse({ value: val });
