...
import styles from './ProjectsTimePicker1.module.css';


interface ProjectsTimePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ProjectsTimePicker1({
  label,
  name,
