...
import ProjectsSearch1 from './ProjectsSearch1';
import styles from './ProjectsFunnel.module.css';
...
export default function ProjectsFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
