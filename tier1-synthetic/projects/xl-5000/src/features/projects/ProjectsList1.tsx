...
import styles from './ProjectsList1.module.css';

interface ProjectsList1Item {
  description: string;
  createdAt: Date;
  title: string;
  status: string;
...
interface ProjectsList1Props {
  items?: ProjectsList1Item[];
...
export default function ProjectsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
