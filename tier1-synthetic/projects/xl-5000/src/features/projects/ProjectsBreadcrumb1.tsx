...
import styles from './ProjectsBreadcrumb1.module.css';
...
interface ProjectsBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProjectsBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProjectsBreadcrumb1">
      {activeItem && (
