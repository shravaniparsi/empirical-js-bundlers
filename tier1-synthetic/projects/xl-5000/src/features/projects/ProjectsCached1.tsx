...
import ProjectsSummary1 from './ProjectsSummary1';
import styles from './ProjectsCached1.module.css';
...
interface ProjectsCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProjectsCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
