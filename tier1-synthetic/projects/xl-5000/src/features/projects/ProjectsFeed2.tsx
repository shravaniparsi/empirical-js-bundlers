...
import ProjectsBreadcrumb4 from './ProjectsBreadcrumb4';
import styles from './ProjectsFeed2.module.css';

interface ProjectsFeed2Item {
  assignee: string;
  priority: number;
  createdAt: Date;
  id: string;
...
interface ProjectsFeed2Props {
  items?: ProjectsFeed2Item[];
...
export default function ProjectsFeed2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
