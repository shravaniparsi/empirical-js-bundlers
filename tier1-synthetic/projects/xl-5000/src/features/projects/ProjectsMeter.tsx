...
import styles from './ProjectsMeter.module.css';

interface ProjectsMeterItem {
  title: string;
  status: string;
  createdAt: Date;
  assignee: string;
...
interface ProjectsMeterProps {
  items?: ProjectsMeterItem[];
...
export default function ProjectsMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
