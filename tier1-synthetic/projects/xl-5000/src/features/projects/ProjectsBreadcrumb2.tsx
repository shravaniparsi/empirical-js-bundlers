...
import styles from './ProjectsBreadcrumb2.module.css';
...
interface ProjectsBreadcrumb2Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProjectsBreadcrumb2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProjectsBreadcrumb2">
      {activeItem && (
