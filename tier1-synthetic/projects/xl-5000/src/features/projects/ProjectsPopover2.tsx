...
import ProjectsHeatmap from './ProjectsHeatmap';
import styles from './ProjectsPopover2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProjectsPopover2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProjectsPopover2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
