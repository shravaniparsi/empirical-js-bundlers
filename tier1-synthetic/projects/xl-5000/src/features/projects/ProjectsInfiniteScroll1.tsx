...
import ProjectsPaginated from './ProjectsPaginated';
import styles from './ProjectsInfiniteScroll1.module.css';
...
interface ProjectsInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProjectsInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: ProjectsInfiniteScroll1Props<T>) {
