...
import ProjectsBottomNav from './ProjectsBottomNav';
import styles from './ProjectsMeter1.module.css';

interface ProjectsMeter1Item {
  title: string;
  priority: number;
  createdAt: Date;
  id: string;
...
interface ProjectsMeter1Props {
  items?: ProjectsMeter1Item[];
...
export default function ProjectsMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
