...
import ProjectsGrid3 from './ProjectsGrid3';
import ProjectsBarChart1 from './ProjectsBarChart1';
import ProjectsToggle1 from './ProjectsToggle1';
import styles from './ProjectsCached.module.css';
...
interface ProjectsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProjectsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
