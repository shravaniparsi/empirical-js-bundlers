...
import ProjectsTextArea from './ProjectsTextArea';
import ProjectsCollapse from './ProjectsCollapse';
import styles from './ProjectsList2.module.css';

interface ProjectsList2Item {
  tags: string[];
  title: string;
  description: string;
  id: string;
...
interface ProjectsList2Props {
  items?: ProjectsList2Item[];
