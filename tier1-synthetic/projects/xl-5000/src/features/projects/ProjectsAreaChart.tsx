...
import ProjectsSpinner1 from './ProjectsSpinner1';
import CatalogTextArea1 from '../catalog/CatalogTextArea1';
import styles from './ProjectsAreaChart.module.css';
