...
import TagsThumbnail from '../tags/TagsThumbnail';
import styles from './ProjectsPreview1.module.css';

interface ProjectsPreview1Item {
  createdAt: Date;
  assignee: string;
  tags: string[];
  id: string;
...
interface ProjectsPreview1Props {
  items?: ProjectsPreview1Item[];
...
export default function ProjectsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ProjectsPreview1Props) {
