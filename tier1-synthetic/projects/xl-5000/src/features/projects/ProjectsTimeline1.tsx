...
import styles from './ProjectsTimeline1.module.css';

interface ProjectsTimeline1Item {
  assignee: string;
  description: string;
  status: string;
  createdAt: Date;
...
interface ProjectsTimeline1Props {
  items?: ProjectsTimeline1Item[];
