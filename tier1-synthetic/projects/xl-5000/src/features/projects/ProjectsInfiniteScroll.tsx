...
import ProjectsTimeline2 from './ProjectsTimeline2';
import ProjectsPopover1 from './ProjectsPopover1';
import ProjectsPopover2 from './ProjectsPopover2';
import styles from './ProjectsInfiniteScroll.module.css';
...
interface ProjectsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProjectsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
