...
import styles from './ProjectsRank.module.css';

interface ProjectsRankItem {
  tags: string[];
  createdAt: Date;
  priority: number;
  id: string;
...
interface ProjectsRankProps {
  items?: ProjectsRankItem[];
...
export default function ProjectsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
