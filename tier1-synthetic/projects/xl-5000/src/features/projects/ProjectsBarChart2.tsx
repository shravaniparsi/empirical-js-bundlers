...
import ProjectsAreaChart from './ProjectsAreaChart';
import ProjectsChip from './ProjectsChip';
import ProjectsConfirm from './ProjectsConfirm';
import styles from './ProjectsBarChart2.module.css';
...
interface ProjectsBarChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ProjectsBarChart2({
  data,
  title,
  height = 300,
  showLegend = true,
