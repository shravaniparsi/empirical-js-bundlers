...
import styles from './ProjectsBreadcrumb4.module.css';
...
interface ProjectsBreadcrumb4Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProjectsBreadcrumb4({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProjectsBreadcrumb4">
      {activeItem && (
