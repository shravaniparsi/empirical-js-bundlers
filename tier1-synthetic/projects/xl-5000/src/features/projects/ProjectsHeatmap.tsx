...
import ProjectsToggle2 from './ProjectsToggle2';
import styles from './ProjectsHeatmap.module.css';
...
interface ProjectsHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ProjectsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
