...
import styles from './ProjectsColorPicker.module.css';


interface ProjectsColorPickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ProjectsColorPicker({
  label,
  name,
