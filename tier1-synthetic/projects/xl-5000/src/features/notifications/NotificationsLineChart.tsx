...
import NotificationsLabel1 from './NotificationsLabel1';
import styles from './NotificationsLineChart.module.css';
...
interface NotificationsLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
