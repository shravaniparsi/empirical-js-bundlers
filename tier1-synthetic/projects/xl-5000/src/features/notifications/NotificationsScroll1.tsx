...
import NotificationsHeatmap1 from './NotificationsHeatmap1';
import NotificationsPieChart from './NotificationsPieChart';
import styles from './NotificationsScroll1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsScroll1Props {
...
export default function NotificationsScroll1({
  children,
