...
import styles from './NotificationsCheckbox1.module.css';


interface NotificationsCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function NotificationsCheckbox1({
  label,
  name,
