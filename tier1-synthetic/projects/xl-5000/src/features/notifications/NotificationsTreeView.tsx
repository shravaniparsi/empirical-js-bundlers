...
import NotificationsResponsive1 from './NotificationsResponsive1';
import InventoryPieChart from '../inventory/InventoryPieChart';
import styles from './NotificationsTreeView.module.css';
...
interface NotificationsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function NotificationsTreeView({
  ...
  return (
    <nav className={navClasses} aria-label="NotificationsTreeView">
      {activeItem && (
