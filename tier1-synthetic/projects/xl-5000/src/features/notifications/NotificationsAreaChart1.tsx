...
import NotificationsScroll1 from './NotificationsScroll1';
import styles from './NotificationsAreaChart1.module.css';
...
interface NotificationsAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
