...
import styles from './NotificationsSplit1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsSplit1Props {
...
export default function NotificationsSplit1({
  children,
