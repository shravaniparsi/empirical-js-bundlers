...
import NotificationsAreaChart1 from './NotificationsAreaChart1';
import PaymentsHOC from '../payments/PaymentsHOC';
import styles from './NotificationsSuspense.module.css';
...
interface NotificationsSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
