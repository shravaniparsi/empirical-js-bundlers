...
import styles from './NotificationsAreaChart3.module.css';
...
interface NotificationsAreaChart3Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsAreaChart3({
  data,
  title,
  height = 300,
  showLegend = true,
