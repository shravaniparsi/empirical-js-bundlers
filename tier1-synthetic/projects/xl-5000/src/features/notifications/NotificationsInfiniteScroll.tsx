...
import NotificationsChip1 from './NotificationsChip1';
import NotificationsSpacer from './NotificationsSpacer';
import styles from './NotificationsInfiniteScroll.module.css';
...
interface NotificationsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: NotificationsInfiniteScrollProps<T>) {
