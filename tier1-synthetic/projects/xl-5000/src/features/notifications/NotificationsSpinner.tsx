...
import styles from './NotificationsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
