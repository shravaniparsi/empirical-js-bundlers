...
import NotificationsList1 from './NotificationsList1';
import NotificationsDivider1 from './NotificationsDivider1';
import styles from './NotificationsCached1.module.css';
...
interface NotificationsCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
