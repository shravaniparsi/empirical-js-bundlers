...
import NotificationsSpinner1 from './NotificationsSpinner1';
import UsersTextArea from '../users/UsersTextArea';
import styles from './NotificationsScore.module.css';

interface NotificationsScoreItem {
  updatedAt: Date;
  title: string;
  tags: string[];
  description: string;
...
interface NotificationsScoreProps {
  items?: NotificationsScoreItem[];
...
export default function NotificationsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsScoreProps) {
