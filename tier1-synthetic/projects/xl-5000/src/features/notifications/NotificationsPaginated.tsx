...
import styles from './NotificationsPaginated.module.css';
...
interface NotificationsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
