...
import styles from './NotificationsAreaChart2.module.css';
...
interface NotificationsAreaChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsAreaChart2({
  data,
  title,
  height = 300,
  showLegend = true,
