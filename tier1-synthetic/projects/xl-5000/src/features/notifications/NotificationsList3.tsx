...
import styles from './NotificationsList3.module.css';

interface NotificationsList3Item {
  title: string;
  description: string;
  createdAt: Date;
  updatedAt: Date;
...
interface NotificationsList3Props {
  items?: NotificationsList3Item[];
...
export default function NotificationsList3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsList3Props) {
