...
import styles from './NotificationsHeatmap1.module.css';
...
interface NotificationsHeatmap1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsHeatmap1({
  data,
  title,
  height = 300,
  showLegend = true,
