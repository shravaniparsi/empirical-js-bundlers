...
import NotificationsSuspense from './NotificationsSuspense';
import NotificationsScatter from './NotificationsScatter';
import styles from './NotificationsChip.module.css';

interface NotificationsChipItem {
  createdAt: Date;
  tags: string[];
  assignee: string;
  id: string;
...
interface NotificationsChipProps {
  items?: NotificationsChipItem[];
...
export default function NotificationsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsChipProps) {
