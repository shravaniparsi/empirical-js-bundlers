...
import styles from './NotificationsSpinner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsSpinner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsSpinner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
