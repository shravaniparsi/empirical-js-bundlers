...
import styles from './NotificationsGrid5.module.css';

interface NotificationsGrid5Item {
  status: string;
  tags: string[];
  description: string;
  id: string;
...
interface NotificationsGrid5Props {
  items?: NotificationsGrid5Item[];
...
export default function NotificationsGrid5({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsGrid5Props) {
