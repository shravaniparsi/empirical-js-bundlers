...
import styles from './NotificationsResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsResponsiveProps {
...
export default function NotificationsResponsive({
  children,
