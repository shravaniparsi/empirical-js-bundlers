...
import styles from './NotificationsScatter1.module.css';
...
interface NotificationsScatter1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsScatter1({
  data,
  title,
  height = 300,
  showLegend = true,
