...
import NotificationsDivider2 from './NotificationsDivider2';
import styles from './NotificationsDivider.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsDividerProps {
...
export default function NotificationsDivider({
  children,
