...
import styles from './NotificationsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface NotificationsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function NotificationsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
