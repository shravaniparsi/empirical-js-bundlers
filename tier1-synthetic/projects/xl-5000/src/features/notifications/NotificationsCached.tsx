...
import styles from './NotificationsCached.module.css';
...
interface NotificationsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function NotificationsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
