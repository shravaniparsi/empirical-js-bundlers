...
import styles from './NotificationsSidebar1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsSidebar1Props {
...
export default function NotificationsSidebar1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
