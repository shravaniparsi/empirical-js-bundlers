...
import ApiKeysThumbnail2 from '../api-keys/ApiKeysThumbnail2';
import ReviewsDetail1 from '../reviews/ReviewsDetail1';
import styles from './NotificationsHeatmap.module.css';
...
interface NotificationsHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function NotificationsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
