...
import NotificationsGrid1 from './NotificationsGrid1';
import styles from './NotificationsPagination1.module.css';
...
interface NotificationsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function NotificationsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="NotificationsPagination1">
      {activeItem && (
