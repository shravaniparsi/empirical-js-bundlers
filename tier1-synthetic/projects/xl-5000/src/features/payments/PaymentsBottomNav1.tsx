...
import styles from './PaymentsBottomNav1.module.css';
...
interface PaymentsBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function PaymentsBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PaymentsBottomNav1">
      {activeItem && (
