...
import styles from './PaymentsErrorBoundary1.module.css';
...
interface PaymentsErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
