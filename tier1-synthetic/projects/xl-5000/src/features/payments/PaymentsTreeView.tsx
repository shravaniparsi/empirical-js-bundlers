...
import styles from './PaymentsTreeView.module.css';
...
interface PaymentsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function PaymentsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PaymentsTreeView">
      {activeItem && (
