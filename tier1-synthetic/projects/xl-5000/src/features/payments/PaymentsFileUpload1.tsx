...
import PaymentsRadio1 from './PaymentsRadio1';
import PaymentsLineChart from './PaymentsLineChart';
import styles from './PaymentsFileUpload1.module.css';


interface PaymentsFileUpload1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PaymentsFileUpload1({
  label,
  name,
