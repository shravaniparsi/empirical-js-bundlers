...
import PaymentsFooter2 from './PaymentsFooter2';
import styles from './PaymentsScatter2.module.css';
...
interface PaymentsScatter2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PaymentsScatter2({
  data,
  title,
  height = 300,
  showLegend = true,
