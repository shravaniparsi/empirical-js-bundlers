...
import PaymentsSticky from './PaymentsSticky';
import InventoryChip3 from '../inventory/InventoryChip3';
import styles from './PaymentsAutocomplete1.module.css';


interface PaymentsAutocomplete1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PaymentsAutocomplete1({
  label,
  name,
