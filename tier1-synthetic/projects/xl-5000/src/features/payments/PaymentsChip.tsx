...
import styles from './PaymentsChip.module.css';

interface PaymentsChipItem {
  description: string;
  title: string;
  tags: string[];
  id: string;
...
interface PaymentsChipProps {
  items?: PaymentsChipItem[];
...
export default function PaymentsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
