...
import styles from './PaymentsLoader1.module.css';
...
interface PaymentsLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
