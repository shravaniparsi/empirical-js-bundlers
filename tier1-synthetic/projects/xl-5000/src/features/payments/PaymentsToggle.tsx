...
import { z } from 'zod';
import PaymentsSparkline from './PaymentsSparkline';
import PaymentsErrorBoundary1 from './PaymentsErrorBoundary1';
import styles from './PaymentsToggle.module.css';

const PaymentsToggleSchema = z.object({
...
export default function PaymentsToggle({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = PaymentsToggleSchema.safeParse({ value: val });
