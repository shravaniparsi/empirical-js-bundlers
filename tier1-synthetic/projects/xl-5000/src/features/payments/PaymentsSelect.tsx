...
import styles from './PaymentsSelect.module.css';

const PaymentsSelectSchema = z.object({
...
export default function PaymentsSelect({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = PaymentsSelectSchema.safeParse({ value: val });
