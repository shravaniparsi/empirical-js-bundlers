...
import PaymentsBadge from './PaymentsBadge';
import PaymentsDrawer from './PaymentsDrawer';
import styles from './PaymentsBadge1.module.css';

interface PaymentsBadge1Item {
  status: string;
  tags: string[];
  updatedAt: Date;
  createdAt: Date;
...
interface PaymentsBadge1Props {
  items?: PaymentsBadge1Item[];
...
export default function PaymentsBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
