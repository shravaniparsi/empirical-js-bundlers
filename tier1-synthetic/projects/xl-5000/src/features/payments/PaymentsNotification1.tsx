...
import styles from './PaymentsNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PaymentsNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PaymentsNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
