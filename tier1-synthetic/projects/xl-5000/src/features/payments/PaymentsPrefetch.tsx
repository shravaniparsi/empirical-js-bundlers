...
import PaymentsPolling from './PaymentsPolling';
import ShippingTag1 from '../shipping/ShippingTag1';
import styles from './PaymentsPrefetch.module.css';
...
interface PaymentsPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
