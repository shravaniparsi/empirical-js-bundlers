...
import styles from './PaymentsErrorBoundary2.module.css';
...
interface PaymentsErrorBoundary2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsErrorBoundary2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
