...
import styles from './PaymentsChip1.module.css';

interface PaymentsChip1Item {
  priority: number;
  title: string;
  assignee: string;
  id: string;
...
interface PaymentsChip1Props {
  items?: PaymentsChip1Item[];
...
export default function PaymentsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
