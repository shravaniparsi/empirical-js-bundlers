...
import styles from './PaymentsScore1.module.css';

interface PaymentsScore1Item {
  status: string;
  createdAt: Date;
  description: string;
  priority: number;
...
interface PaymentsScore1Props {
  items?: PaymentsScore1Item[];
...
export default function PaymentsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
