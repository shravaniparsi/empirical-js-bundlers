...
import styles from './PaymentsLoader.module.css';
...
interface PaymentsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
