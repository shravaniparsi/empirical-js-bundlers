...
import PaymentsFileUpload from './PaymentsFileUpload';
import PaymentsTabs from './PaymentsTabs';
import PaymentsBadge1 from './PaymentsBadge1';
import styles from './PaymentsPreview1.module.css';

interface PaymentsPreview1Item {
  priority: number;
  status: string;
  updatedAt: Date;
  title: string;
...
interface PaymentsPreview1Props {
  items?: PaymentsPreview1Item[];
...
export default function PaymentsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PaymentsPreview1Props) {
