...
import PaymentsNotification1 from './PaymentsNotification1';
import PaymentsFunnel from './PaymentsFunnel';
import styles from './PaymentsPrefetch1.module.css';
...
interface PaymentsPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
