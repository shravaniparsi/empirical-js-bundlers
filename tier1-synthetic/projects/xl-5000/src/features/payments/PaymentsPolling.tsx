...
import styles from './PaymentsPolling.module.css';
...
interface PaymentsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
