...
import styles from './PaymentsNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PaymentsNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PaymentsNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
