...
import styles from './PaymentsBottomNav.module.css';
...
interface PaymentsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function PaymentsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PaymentsBottomNav">
      {activeItem && (
