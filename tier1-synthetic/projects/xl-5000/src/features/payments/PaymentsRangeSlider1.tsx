...
import styles from './PaymentsRangeSlider1.module.css';


interface PaymentsRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PaymentsRangeSlider1({
  label,
  name,
