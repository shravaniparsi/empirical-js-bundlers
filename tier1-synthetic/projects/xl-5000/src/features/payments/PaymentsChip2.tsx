...
import PaymentsTimeline1 from './PaymentsTimeline1';
import PaymentsCheckbox from './PaymentsCheckbox';
import styles from './PaymentsChip2.module.css';

interface PaymentsChip2Item {
  priority: number;
  assignee: string;
  description: string;
  tags: string[];
...
interface PaymentsChip2Props {
  items?: PaymentsChip2Item[];
...
export default function PaymentsChip2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
