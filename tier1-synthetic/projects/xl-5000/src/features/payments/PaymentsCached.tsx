...
import styles from './PaymentsCached.module.css';
...
interface PaymentsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PaymentsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
