...
import PaymentsScore1 from './PaymentsScore1';
import AdminDrawer from '../admin/AdminDrawer';
import InventorySummary from '../inventory/InventorySummary';
import styles from './PaymentsProgress1.module.css';

interface PaymentsProgress1Item {
  updatedAt: Date;
  description: string;
  createdAt: Date;
  title: string;
...
interface PaymentsProgress1Props {
  items?: PaymentsProgress1Item[];
...
export default function PaymentsProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PaymentsProgress1Props) {
