...
import styles from './PaymentsGrid1.module.css';

interface PaymentsGrid1Item {
  title: string;
  priority: number;
  updatedAt: Date;
  description: string;
...
interface PaymentsGrid1Props {
  items?: PaymentsGrid1Item[];
...
export default function PaymentsGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
