...
import PaymentsFileUpload1 from './PaymentsFileUpload1';
import UsersTextArea from '../users/UsersTextArea';
import styles from './PaymentsMeter.module.css';

interface PaymentsMeterItem {
  updatedAt: Date;
  priority: number;
  assignee: string;
  id: string;
...
interface PaymentsMeterProps {
  items?: PaymentsMeterItem[];
...
export default function PaymentsMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
