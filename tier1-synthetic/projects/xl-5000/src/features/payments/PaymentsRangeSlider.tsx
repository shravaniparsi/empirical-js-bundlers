...
import styles from './PaymentsRangeSlider.module.css';


interface PaymentsRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PaymentsRangeSlider({
  label,
  name,
