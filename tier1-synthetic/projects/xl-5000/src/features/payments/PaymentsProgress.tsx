...
import styles from './PaymentsProgress.module.css';

interface PaymentsProgressItem {
  status: string;
  priority: number;
  title: string;
  id: string;
...
interface PaymentsProgressProps {
  items?: PaymentsProgressItem[];
