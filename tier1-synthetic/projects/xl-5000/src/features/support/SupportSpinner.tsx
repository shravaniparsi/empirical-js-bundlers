...
import SupportGauge4 from './SupportGauge4';
import SupportFileUpload1 from './SupportFileUpload1';
import styles from './SupportSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SupportSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SupportSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
