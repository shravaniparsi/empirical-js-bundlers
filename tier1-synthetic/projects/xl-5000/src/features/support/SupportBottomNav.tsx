...
import SupportTimePicker1 from './SupportTimePicker1';
import SupportCollapse from './SupportCollapse';
import styles from './SupportBottomNav.module.css';
...
export default function SupportBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SupportBottomNav">
      {activeItem && (
