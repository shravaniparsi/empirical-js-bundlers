...
import SupportTable2 from './SupportTable2';
...
import styles from './SupportRank1.module.css';

interface SupportRank1Item {
  status: string;
  createdAt: Date;
  title: string;
  id: string;
...
interface SupportRank1Props {
  items?: SupportRank1Item[];
...
export default function SupportRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
