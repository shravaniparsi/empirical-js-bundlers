...
import SupportGauge from './SupportGauge';
import styles from './SupportRetry.module.css';
...
interface SupportRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SupportRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
