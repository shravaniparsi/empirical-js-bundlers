...
import SupportTimePicker from './SupportTimePicker';
import SupportRating from './SupportRating';
import styles from './SupportBreadcrumb.module.css';
...
export default function SupportBreadcrumb({
  ...
  return (
    <nav className={navClasses} aria-label="SupportBreadcrumb">
      {activeItem && (
