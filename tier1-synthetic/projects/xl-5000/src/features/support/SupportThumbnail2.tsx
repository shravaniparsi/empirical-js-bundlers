...
import styles from './SupportThumbnail2.module.css';

interface SupportThumbnail2Item {
  assignee: string;
  title: string;
  updatedAt: Date;
  tags: string[];
...
interface SupportThumbnail2Props {
  items?: SupportThumbnail2Item[];
...
export default function SupportThumbnail2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SupportThumbnail2Props) {
