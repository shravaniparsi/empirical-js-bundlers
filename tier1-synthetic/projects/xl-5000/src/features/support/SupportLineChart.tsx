...
import SupportGauge1 from './SupportGauge1';
import InventoryChip3 from '../inventory/InventoryChip3';
import styles from './SupportLineChart.module.css';
...
interface SupportLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SupportLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
