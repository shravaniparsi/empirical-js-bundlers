...
import styles from './SupportStepper1.module.css';
...
interface SupportStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function SupportStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SupportStepper1">
      {activeItem && (
