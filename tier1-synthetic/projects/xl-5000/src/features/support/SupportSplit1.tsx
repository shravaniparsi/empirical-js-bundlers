...
import SupportStepper1 from './SupportStepper1';
import SupportFeed from './SupportFeed';
import styles from './SupportSplit1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SupportSplit1Props {
...
export default function SupportSplit1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
