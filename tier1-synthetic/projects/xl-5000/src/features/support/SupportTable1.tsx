...
import styles from './SupportTable1.module.css';

interface SupportTable1Item {
  tags: string[];
  createdAt: Date;
  priority: number;
  description: string;
...
interface SupportTable1Props {
  items?: SupportTable1Item[];
...
export default function SupportTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
