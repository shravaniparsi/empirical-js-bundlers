...
export default function SupportMenu1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SupportMenu1">
      {activeItem && (
