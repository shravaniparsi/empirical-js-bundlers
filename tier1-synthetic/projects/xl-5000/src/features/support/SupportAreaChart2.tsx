...
import SupportGauge3 from './SupportGauge3';
import SupportCheckbox2 from './SupportCheckbox2';
import styles from './SupportAreaChart2.module.css';
...
interface SupportAreaChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SupportAreaChart2({
  data,
  title,
  height = 300,
  showLegend = true,
