...
import SupportSplit1 from './SupportSplit1';
import SupportTextArea from './SupportTextArea';
import SupportSlider from './SupportSlider';
import styles from './SupportSlider1.module.css';


interface SupportSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SupportSlider1({
  label,
  name,
