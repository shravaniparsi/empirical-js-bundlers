...
import SupportThumbnail2 from './SupportThumbnail2';
import SupportSpinner from './SupportSpinner';
import styles from './SupportCheckbox1.module.css';


interface SupportCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SupportCheckbox1({
  label,
  name,
