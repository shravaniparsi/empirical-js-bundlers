...
import { z } from 'zod';
import SupportHeader1 from './SupportHeader1';
import SupportThumbnail1 from './SupportThumbnail1';
import SupportContainer from './SupportContainer';
import styles from './SupportCheckbox.module.css';

const SupportCheckboxSchema = z.object({
...
export default function SupportCheckbox({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = SupportCheckboxSchema.safeParse({ value: val });
