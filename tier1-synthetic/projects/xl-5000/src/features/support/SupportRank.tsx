...
import SupportTable1 from './SupportTable1';
import OrdersScore1 from '../orders/OrdersScore1';
import styles from './SupportRank.module.css';

interface SupportRankItem {
  updatedAt: Date;
  priority: number;
  description: string;
  tags: string[];
...
interface SupportRankProps {
  items?: SupportRankItem[];
...
export default function SupportRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
