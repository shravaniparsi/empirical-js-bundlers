...
import SupportAreaChart1 from './SupportAreaChart1';
import styles from './SupportConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SupportConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SupportConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
