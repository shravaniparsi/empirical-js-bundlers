...
import SupportErrorBoundary1 from './SupportErrorBoundary1';
import styles from './SupportStepper2.module.css';
...
interface SupportStepper2Props {
  items: NavItem[];
  activeId?: string;
...
export default function SupportStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SupportStepper2">
      {activeItem && (
