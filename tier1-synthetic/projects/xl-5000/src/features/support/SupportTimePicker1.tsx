...
import SupportCheckbox1 from './SupportCheckbox1';
import SupportFooter from './SupportFooter';
import SupportSparkline from './SupportSparkline';
import styles from './SupportTimePicker1.module.css';


interface SupportTimePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SupportTimePicker1({
  label,
  name,
