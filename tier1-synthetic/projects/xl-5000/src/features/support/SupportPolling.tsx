...
import SupportLineChart from './SupportLineChart';
import SupportPlaceholder1 from './SupportPlaceholder1';
import AuthList from '../auth/AuthList';
import styles from './SupportPolling.module.css';
...
interface SupportPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SupportPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
