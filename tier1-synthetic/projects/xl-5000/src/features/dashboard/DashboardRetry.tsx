...
import DashboardAvatar1 from './DashboardAvatar1';
import DashboardStepper from './DashboardStepper';
import WebhooksSkeleton2 from '../webhooks/WebhooksSkeleton2';
import styles from './DashboardRetry.module.css';
...
interface DashboardRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
