...
import styles from './DashboardCached.module.css';
...
interface DashboardCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
