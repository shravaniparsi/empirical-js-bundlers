...
import DashboardTabs1 from './DashboardTabs1';
import DashboardSkeleton from './DashboardSkeleton';
import ProfileStepper3 from '../profile/ProfileStepper3';
import styles from './DashboardPaginated.module.css';
...
interface DashboardPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
