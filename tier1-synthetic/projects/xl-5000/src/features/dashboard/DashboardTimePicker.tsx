...
import CheckoutTimeline from '../checkout/CheckoutTimeline';
import styles from './DashboardTimePicker.module.css';

const DashboardTimePickerSchema = z.object({
...
export default function DashboardTimePicker({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = DashboardTimePickerSchema.safeParse({ value: val });
