...
import styles from './DashboardRank1.module.css';

interface DashboardRank1Item {
  tags: string[];
  createdAt: Date;
  updatedAt: Date;
  id: string;
...
interface DashboardRank1Props {
  items?: DashboardRank1Item[];
...
export default function DashboardRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
