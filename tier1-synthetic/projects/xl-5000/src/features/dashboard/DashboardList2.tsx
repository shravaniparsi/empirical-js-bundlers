...
import styles from './DashboardList2.module.css';

interface DashboardList2Item {
  assignee: string;
  tags: string[];
  title: string;
  id: string;
...
interface DashboardList2Props {
  items?: DashboardList2Item[];
...
export default function DashboardList2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
