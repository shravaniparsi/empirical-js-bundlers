...
import styles from './DashboardInfiniteScroll.module.css';
...
interface DashboardInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: DashboardInfiniteScrollProps<T>) {
