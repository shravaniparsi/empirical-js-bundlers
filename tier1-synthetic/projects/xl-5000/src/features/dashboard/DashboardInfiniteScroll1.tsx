...
import DashboardBanner1 from './DashboardBanner1';
import styles from './DashboardInfiniteScroll1.module.css';
...
interface DashboardInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: DashboardInfiniteScroll1Props<T>) {
