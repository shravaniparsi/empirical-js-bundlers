...
import styles from './DashboardColorPicker2.module.css';


interface DashboardColorPicker2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function DashboardColorPicker2({
  label,
  name,
