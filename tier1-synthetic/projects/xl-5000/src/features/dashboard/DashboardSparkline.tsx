...
import DashboardTimePicker from './DashboardTimePicker';
import KnowledgeBaseScroll from '../knowledge-base/KnowledgeBaseScroll';
import styles from './DashboardSparkline.module.css';
