...
import styles from './DashboardInfiniteScroll2.module.css';
...
interface DashboardInfiniteScroll2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DashboardInfiniteScroll2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: DashboardInfiniteScroll2Props<T>) {
