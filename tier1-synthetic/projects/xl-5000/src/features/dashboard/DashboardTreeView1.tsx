...
import DashboardRadio1 from './DashboardRadio1';
import DashboardGrid from './DashboardGrid';
import styles from './DashboardTreeView1.module.css';
...
interface DashboardTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function DashboardTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DashboardTreeView1">
      {activeItem && (
