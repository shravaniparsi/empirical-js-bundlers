...
import styles from './DashboardRangeSlider1.module.css';


interface DashboardRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function DashboardRangeSlider1({
  label,
  name,
