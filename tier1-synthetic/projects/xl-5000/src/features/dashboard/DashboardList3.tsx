...
import DashboardProgress1 from './DashboardProgress1';
import DashboardList1 from './DashboardList1';
import ReviewsStat from '../reviews/ReviewsStat';
import styles from './DashboardList3.module.css';

interface DashboardList3Item {
  status: string;
  title: string;
  createdAt: Date;
  priority: number;
...
interface DashboardList3Props {
  items?: DashboardList3Item[];
...
export default function DashboardList3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
