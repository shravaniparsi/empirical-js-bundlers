...
import styles from './DashboardLink1.module.css';
...
export default function DashboardLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DashboardLink1">
      {activeItem && (
