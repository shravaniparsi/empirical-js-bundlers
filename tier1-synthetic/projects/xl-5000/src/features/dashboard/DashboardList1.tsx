...
import styles from './DashboardList1.module.css';

interface DashboardList1Item {
  description: string;
  tags: string[];
  status: string;
  priority: number;
...
interface DashboardList1Props {
  items?: DashboardList1Item[];
...
export default function DashboardList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
