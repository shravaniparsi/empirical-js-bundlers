...
import { z } from 'zod';
import DashboardPaginated1 from './DashboardPaginated1';
import ProfileNavBar1 from '../profile/ProfileNavBar1';
import ShippingSpinner from '../shipping/ShippingSpinner';
import styles from './DashboardRating.module.css';

const DashboardRatingSchema = z.object({
...
export default function DashboardRating({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = DashboardRatingSchema.safeParse({ value: val });
