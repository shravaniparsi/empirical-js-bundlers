...
import styles from './DashboardLink2.module.css';
...
export default function DashboardLink2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DashboardLink2">
      {activeItem && (
