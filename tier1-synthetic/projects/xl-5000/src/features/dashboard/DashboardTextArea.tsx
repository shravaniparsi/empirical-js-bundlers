...
import DashboardHeatmap1 from './DashboardHeatmap1';
import styles from './DashboardTextArea.module.css';

const DashboardTextAreaSchema = z.object({
...
export default function DashboardTextArea({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = DashboardTextAreaSchema.safeParse({ value: val });
