...
import styles from './DashboardTabs1.module.css';
...
export default function DashboardTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DashboardTabs1">
      {activeItem && (
