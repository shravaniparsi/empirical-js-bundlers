...
import DashboardTreeView1 from './DashboardTreeView1';
import DashboardFactory from './DashboardFactory';
import CommentsStack from '../comments/CommentsStack';
import styles from './DashboardNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface DashboardNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function DashboardNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
