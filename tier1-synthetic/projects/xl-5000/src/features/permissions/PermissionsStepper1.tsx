...
import styles from './PermissionsStepper1.module.css';
...
interface PermissionsStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function PermissionsStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PermissionsStepper1">
      {activeItem && (
