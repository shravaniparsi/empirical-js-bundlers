...
import PermissionsResponsive from './PermissionsResponsive';
import PermissionsToast from './PermissionsToast';
import PermissionsNavBar from './PermissionsNavBar';
import styles from './PermissionsSuspense1.module.css';
...
interface PermissionsSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
