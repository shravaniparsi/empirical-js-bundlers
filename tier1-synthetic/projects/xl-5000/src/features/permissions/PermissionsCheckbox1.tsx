...
import styles from './PermissionsCheckbox1.module.css';


interface PermissionsCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function PermissionsCheckbox1({
  label,
  name,
