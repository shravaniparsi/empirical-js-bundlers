...
import PermissionsAreaChart2 from './PermissionsAreaChart2';
import DocumentsContext from '../documents/DocumentsContext';
import styles from './PermissionsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PermissionsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PermissionsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
