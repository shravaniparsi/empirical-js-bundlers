...
import styles from './PermissionsGrid1.module.css';

interface PermissionsGrid1Item {
  description: string;
  assignee: string;
  status: string;
  id: string;
...
interface PermissionsGrid1Props {
  items?: PermissionsGrid1Item[];
...
export default function PermissionsGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsGrid1Props) {
