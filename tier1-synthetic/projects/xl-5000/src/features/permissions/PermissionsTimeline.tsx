...
import styles from './PermissionsTimeline.module.css';

interface PermissionsTimelineItem {
  createdAt: Date;
  tags: string[];
  description: string;
  id: string;
...
interface PermissionsTimelineProps {
  items?: PermissionsTimelineItem[];
...
export default function PermissionsTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsTimelineProps) {
