...
import PermissionsRetry from './PermissionsRetry';
import PermissionsPopover from './PermissionsPopover';
import PermissionsSparkline1 from './PermissionsSparkline1';
import styles from './PermissionsPolling.module.css';
...
interface PermissionsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
