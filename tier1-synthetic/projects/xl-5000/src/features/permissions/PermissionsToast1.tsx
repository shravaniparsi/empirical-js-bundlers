...
import PermissionsSplit from './PermissionsSplit';
import FormsPolling2 from '../forms/FormsPolling2';
import styles from './PermissionsToast1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PermissionsToast1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PermissionsToast1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
