...
import styles from './PermissionsLink.module.css';
...
interface PermissionsLinkProps {
  items: NavItem[];
  activeId?: string;
...
export default function PermissionsLink({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PermissionsLink">
      {activeItem && (
