...
import styles from './PermissionsNavBar.module.css';
...
interface PermissionsNavBarProps {
  items: NavItem[];
  activeId?: string;
...
export default function PermissionsNavBar({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PermissionsNavBar">
      {activeItem && (
