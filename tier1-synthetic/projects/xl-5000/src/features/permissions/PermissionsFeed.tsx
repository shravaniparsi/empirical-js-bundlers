...
import styles from './PermissionsFeed.module.css';

interface PermissionsFeedItem {
  description: string;
  status: string;
  tags: string[];
  id: string;
...
interface PermissionsFeedProps {
  items?: PermissionsFeedItem[];
...
export default function PermissionsFeed({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsFeedProps) {
