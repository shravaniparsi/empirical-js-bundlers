...
import PermissionsRangeSlider from './PermissionsRangeSlider';
import PermissionsGauge from './PermissionsGauge';
import TasksPaginated1 from '../tasks/TasksPaginated1';
import styles from './PermissionsBreadcrumb.module.css';
...
interface PermissionsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function PermissionsBreadcrumb({
  ...
  return (
    <nav className={navClasses} aria-label="PermissionsBreadcrumb">
      {activeItem && (
