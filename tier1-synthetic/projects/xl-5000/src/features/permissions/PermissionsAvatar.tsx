...
import styles from './PermissionsAvatar.module.css';

interface PermissionsAvatarItem {
  tags: string[];
  priority: number;
  updatedAt: Date;
  id: string;
...
interface PermissionsAvatarProps {
  items?: PermissionsAvatarItem[];
...
export default function PermissionsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsAvatarProps) {
