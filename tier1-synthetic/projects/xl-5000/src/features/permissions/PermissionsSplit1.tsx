...
import PermissionsTooltip1 from './PermissionsTooltip1';
import InventoryPieChart from '../inventory/InventoryPieChart';
import styles from './PermissionsSplit1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface PermissionsSplit1Props {
...
export default function PermissionsSplit1({
  children,
