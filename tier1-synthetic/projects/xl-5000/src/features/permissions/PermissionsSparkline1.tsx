...
import styles from './PermissionsSparkline1.module.css';
...
interface PermissionsSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PermissionsSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
