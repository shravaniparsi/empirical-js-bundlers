...
import { z } from 'zod';
import PermissionsTimeline1 from './PermissionsTimeline1';
import PermissionsSuspense1 from './PermissionsSuspense1';
import styles from './PermissionsRadio.module.css';

const PermissionsRadioSchema = z.object({
...
export default function PermissionsRadio({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = PermissionsRadioSchema.safeParse({ value: val });
