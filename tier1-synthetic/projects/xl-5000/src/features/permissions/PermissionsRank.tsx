...
import styles from './PermissionsRank.module.css';

interface PermissionsRankItem {
  title: string;
  tags: string[];
  createdAt: Date;
  id: string;
...
interface PermissionsRankProps {
  items?: PermissionsRankItem[];
...
export default function PermissionsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsRankProps) {
