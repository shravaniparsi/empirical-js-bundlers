...
import styles from './PermissionsAreaChart.module.css';
...
interface PermissionsAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PermissionsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
