...
import styles from './PermissionsRetry.module.css';
...
interface PermissionsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
