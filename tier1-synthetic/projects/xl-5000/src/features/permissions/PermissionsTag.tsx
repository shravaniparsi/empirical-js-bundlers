...
import styles from './PermissionsTag.module.css';

interface PermissionsTagItem {
  priority: number;
  description: string;
  assignee: string;
  tags: string[];
...
interface PermissionsTagProps {
  items?: PermissionsTagItem[];
...
export default function PermissionsTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
