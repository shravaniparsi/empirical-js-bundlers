...
import PermissionsNavBar1 from './PermissionsNavBar1';
import styles from './PermissionsSpacer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface PermissionsSpacer1Props {
...
export default function PermissionsSpacer1({
  children,
