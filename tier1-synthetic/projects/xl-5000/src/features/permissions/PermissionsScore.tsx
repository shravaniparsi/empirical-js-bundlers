...
import styles from './PermissionsScore.module.css';

interface PermissionsScoreItem {
  title: string;
  createdAt: Date;
  description: string;
  status: string;
...
interface PermissionsScoreProps {
  items?: PermissionsScoreItem[];
...
export default function PermissionsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsScoreProps) {
