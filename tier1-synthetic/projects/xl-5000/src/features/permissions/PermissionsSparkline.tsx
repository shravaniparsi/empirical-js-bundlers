...
import styles from './PermissionsSparkline.module.css';
...
interface PermissionsSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PermissionsSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
