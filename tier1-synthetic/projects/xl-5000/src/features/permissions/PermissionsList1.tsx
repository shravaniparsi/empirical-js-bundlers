...
import CampaignsNotification1 from '../campaigns/CampaignsNotification1';
import DashboardPanel1 from '../dashboard/DashboardPanel1';
import styles from './PermissionsList1.module.css';

interface PermissionsList1Item {
  createdAt: Date;
  description: string;
  priority: number;
  tags: string[];
...
interface PermissionsList1Props {
  items?: PermissionsList1Item[];
...
export default function PermissionsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsList1Props) {
