...
import PermissionsScatter from './PermissionsScatter';
import PermissionsRegistry1 from './PermissionsRegistry1';
import styles from './PermissionsDivider1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface PermissionsDivider1Props {
...
export default function PermissionsDivider1({
  children,
