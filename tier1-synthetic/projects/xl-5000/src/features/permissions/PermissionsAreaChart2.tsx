...
import PermissionsDivider2 from './PermissionsDivider2';
import ReviewsErrorBoundary from '../reviews/ReviewsErrorBoundary';
import DocumentsContext from '../documents/DocumentsContext';
import AnalyticsBanner2 from '../analytics/AnalyticsBanner2';
import styles from './PermissionsAreaChart2.module.css';
...
interface PermissionsAreaChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PermissionsAreaChart2({
  data,
  title,
  height = 300,
  showLegend = true,
