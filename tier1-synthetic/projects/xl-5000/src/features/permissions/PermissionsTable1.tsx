...
import PermissionsSparkline from './PermissionsSparkline';
import PermissionsFactory from './PermissionsFactory';
import styles from './PermissionsTable1.module.css';

interface PermissionsTable1Item {
  description: string;
  assignee: string;
  status: string;
  tags: string[];
...
interface PermissionsTable1Props {
  items?: PermissionsTable1Item[];
...
export default function PermissionsTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsTable1Props) {
