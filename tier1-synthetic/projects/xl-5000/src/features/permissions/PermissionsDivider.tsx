...
import PermissionsGrid1 from './PermissionsGrid1';
import PermissionsTable from './PermissionsTable';
import styles from './PermissionsDivider.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface PermissionsDividerProps {
...
export default function PermissionsDivider({
  children,
