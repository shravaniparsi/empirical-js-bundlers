...
import PermissionsTimeline from './PermissionsTimeline';
import PermissionsDivider1 from './PermissionsDivider1';
import styles from './PermissionsToast.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PermissionsToastProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PermissionsToast({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
