...
import styles from './PermissionsNavBar2.module.css';
...
interface PermissionsNavBar2Props {
  items: NavItem[];
  activeId?: string;
...
export default function PermissionsNavBar2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="PermissionsNavBar2">
      {activeItem && (
