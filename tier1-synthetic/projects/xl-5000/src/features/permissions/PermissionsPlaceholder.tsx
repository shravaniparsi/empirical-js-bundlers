...
import PermissionsStat from './PermissionsStat';
import styles from './PermissionsPlaceholder.module.css';
...
interface PermissionsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
