...
import styles from './PermissionsPreview1.module.css';

interface PermissionsPreview1Item {
  status: string;
  assignee: string;
  updatedAt: Date;
  title: string;
...
interface PermissionsPreview1Props {
  items?: PermissionsPreview1Item[];
...
export default function PermissionsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: PermissionsPreview1Props) {
