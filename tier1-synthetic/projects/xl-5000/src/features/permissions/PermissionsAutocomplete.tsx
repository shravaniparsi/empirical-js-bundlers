...
import styles from './PermissionsAutocomplete.module.css';

const PermissionsAutocompleteSchema = z.object({
...
export default function PermissionsAutocomplete({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = PermissionsAutocompleteSchema.safeParse({ value: val });
