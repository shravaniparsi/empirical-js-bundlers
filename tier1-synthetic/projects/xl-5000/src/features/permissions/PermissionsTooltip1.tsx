...
import styles from './PermissionsTooltip1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface PermissionsTooltip1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function PermissionsTooltip1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
