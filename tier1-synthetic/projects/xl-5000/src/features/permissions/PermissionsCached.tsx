...
import styles from './PermissionsCached.module.css';
...
interface PermissionsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
