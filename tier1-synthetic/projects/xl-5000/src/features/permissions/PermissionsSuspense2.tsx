...
import PermissionsScore from './PermissionsScore';
import FaqScatter from '../faq/FaqScatter';
import FormsPolling2 from '../forms/FormsPolling2';
import styles from './PermissionsSuspense2.module.css';
...
interface PermissionsSuspense2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsSuspense2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
