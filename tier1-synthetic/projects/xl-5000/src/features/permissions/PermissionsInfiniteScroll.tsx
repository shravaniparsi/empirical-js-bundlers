...
import styles from './PermissionsInfiniteScroll.module.css';
...
interface PermissionsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: PermissionsInfiniteScrollProps<T>) {
