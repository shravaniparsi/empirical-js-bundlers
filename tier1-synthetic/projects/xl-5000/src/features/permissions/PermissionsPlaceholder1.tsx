...
import styles from './PermissionsPlaceholder1.module.css';
...
interface PermissionsPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function PermissionsPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: PermissionsPlaceholder1Props<T>) {
