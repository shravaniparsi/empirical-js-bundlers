...
import PermissionsNavBar2 from './PermissionsNavBar2';
import styles from './PermissionsLineChart.module.css';
...
interface PermissionsLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
