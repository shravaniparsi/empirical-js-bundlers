...
import PermissionsPlaceholder1 from './PermissionsPlaceholder1';
import styles from './PermissionsAreaChart1.module.css';
...
interface PermissionsAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function PermissionsAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
