...
import OrdersThumbnail1 from './OrdersThumbnail1';
import styles from './OrdersPieChart1.module.css';
...
interface OrdersPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OrdersPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
