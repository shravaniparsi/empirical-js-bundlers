...
import styles from './OrdersStepper1.module.css';
...
export default function OrdersStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OrdersStepper1">
      {activeItem && (
