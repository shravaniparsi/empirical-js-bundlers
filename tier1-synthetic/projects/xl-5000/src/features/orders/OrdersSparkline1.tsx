...
import OrdersHOC from './OrdersHOC';
import OrdersTable from './OrdersTable';
import OrdersCard from './OrdersCard';
import styles from './OrdersSparkline1.module.css';
...
interface OrdersSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OrdersSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
