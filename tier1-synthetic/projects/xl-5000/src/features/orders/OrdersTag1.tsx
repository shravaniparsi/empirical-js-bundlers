...
import OrdersSlider from './OrdersSlider';
import OrdersTreeView from './OrdersTreeView';
import OrdersConfirm1 from './OrdersConfirm1';
import styles from './OrdersTag1.module.css';

interface OrdersTag1Item {
  updatedAt: Date;
  description: string;
  status: string;
  tags: string[];
...
interface OrdersTag1Props {
  items?: OrdersTag1Item[];
...
export default function OrdersTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
