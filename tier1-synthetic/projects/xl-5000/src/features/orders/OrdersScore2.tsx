...
import styles from './OrdersScore2.module.css';

interface OrdersScore2Item {
  tags: string[];
  description: string;
  title: string;
  createdAt: Date;
...
interface OrdersScore2Props {
  items?: OrdersScore2Item[];
...
export default function OrdersScore2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
