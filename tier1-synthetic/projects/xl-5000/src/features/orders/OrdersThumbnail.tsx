...
import styles from './OrdersThumbnail.module.css';

interface OrdersThumbnailItem {
  createdAt: Date;
  status: string;
  tags: string[];
  description: string;
...
interface OrdersThumbnailProps {
  items?: OrdersThumbnailItem[];
...
export default function OrdersThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: OrdersThumbnailProps) {
