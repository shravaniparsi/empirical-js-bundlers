...
import OrdersNotification from './OrdersNotification';
import styles from './OrdersChip.module.css';

interface OrdersChipItem {
  updatedAt: Date;
  assignee: string;
  status: string;
  title: string;
...
interface OrdersChipProps {
  items?: OrdersChipItem[];
...
export default function OrdersChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
