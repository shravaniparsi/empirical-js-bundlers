...
import styles from './OrdersSuspense.module.css';
...
interface OrdersSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OrdersSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
