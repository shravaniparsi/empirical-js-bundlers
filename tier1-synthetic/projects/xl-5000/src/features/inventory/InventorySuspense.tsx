...
import styles from './InventorySuspense.module.css';
...
interface InventorySuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventorySuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
