...
import InventoryGrid1 from './InventoryGrid1';
import InventoryAreaChart1 from './InventoryAreaChart1';
import styles from './InventoryList1.module.css';

interface InventoryList1Item {
  status: string;
  priority: number;
  title: string;
  updatedAt: Date;
...
interface InventoryList1Props {
  items?: InventoryList1Item[];
...
export default function InventoryList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
