...
import styles from './InventoryChip3.module.css';

interface InventoryChip3Item {
  description: string;
  createdAt: Date;
  assignee: string;
  priority: number;
...
interface InventoryChip3Props {
  items?: InventoryChip3Item[];
...
export default function InventoryChip3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
