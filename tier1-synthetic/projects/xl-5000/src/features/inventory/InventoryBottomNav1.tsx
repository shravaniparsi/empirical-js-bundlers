...
import InventoryFactory1 from './InventoryFactory1';
import InventoryFileUpload from './InventoryFileUpload';
import styles from './InventoryBottomNav1.module.css';
...
interface InventoryBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function InventoryBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="InventoryBottomNav1">
      {activeItem && (
