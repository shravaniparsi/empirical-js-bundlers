...
import InventoryBadge2 from './InventoryBadge2';
import InventoryMeter from './InventoryMeter';
import styles from './InventoryScore.module.css';

interface InventoryScoreItem {
  createdAt: Date;
  status: string;
  description: string;
  priority: number;
...
interface InventoryScoreProps {
  items?: InventoryScoreItem[];
...
export default function InventoryScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
