...
import styles from './InventoryPaginated.module.css';
...
interface InventoryPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
