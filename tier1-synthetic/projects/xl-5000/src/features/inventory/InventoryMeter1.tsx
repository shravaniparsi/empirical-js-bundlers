...
import InventoryModal1 from './InventoryModal1';
import styles from './InventoryMeter1.module.css';

interface InventoryMeter1Item {
  status: string;
  priority: number;
  title: string;
  id: string;
...
interface InventoryMeter1Props {
  items?: InventoryMeter1Item[];
...
export default function InventoryMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryMeter1Props) {
