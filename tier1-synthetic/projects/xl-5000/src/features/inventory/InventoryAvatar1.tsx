...
import styles from './InventoryAvatar1.module.css';

interface InventoryAvatar1Item {
  status: string;
  updatedAt: Date;
  tags: string[];
  id: string;
...
interface InventoryAvatar1Props {
  items?: InventoryAvatar1Item[];
...
export default function InventoryAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryAvatar1Props) {
