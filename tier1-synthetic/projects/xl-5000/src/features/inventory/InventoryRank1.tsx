...
import styles from './InventoryRank1.module.css';

interface InventoryRank1Item {
  updatedAt: Date;
  createdAt: Date;
  title: string;
  status: string;
...
interface InventoryRank1Props {
  items?: InventoryRank1Item[];
...
export default function InventoryRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
