...
import styles from './InventoryChip1.module.css';

interface InventoryChip1Item {
  assignee: string;
  priority: number;
  description: string;
  id: string;
...
interface InventoryChip1Props {
  items?: InventoryChip1Item[];
...
export default function InventoryChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
