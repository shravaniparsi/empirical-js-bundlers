...
import InventorySuspense1 from './InventorySuspense1';
import InventoryFactory from './InventoryFactory';
import IntegrationsPopover1 from '../integrations/IntegrationsPopover1';
import styles from './InventorySplit.module.css';
...
export default function InventorySplit({
  children,
