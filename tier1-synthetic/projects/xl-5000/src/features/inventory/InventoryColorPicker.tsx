...
import styles from './InventoryColorPicker.module.css';


interface InventoryColorPickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function InventoryColorPicker({
  label,
  name,
