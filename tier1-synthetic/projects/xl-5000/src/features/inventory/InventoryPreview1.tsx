...
import styles from './InventoryPreview1.module.css';

interface InventoryPreview1Item {
  description: string;
  createdAt: Date;
  priority: number;
  title: string;
...
interface InventoryPreview1Props {
  items?: InventoryPreview1Item[];
...
export default function InventoryPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryPreview1Props) {
