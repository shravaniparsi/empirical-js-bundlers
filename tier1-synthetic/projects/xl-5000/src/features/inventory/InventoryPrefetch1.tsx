...
import InventoryHeader1 from './InventoryHeader1';
import InventoryHeader3 from './InventoryHeader3';
import TagsSummary from '../tags/TagsSummary';
import styles from './InventoryPrefetch1.module.css';
...
interface InventoryPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
