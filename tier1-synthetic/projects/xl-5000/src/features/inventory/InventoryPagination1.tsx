...
import InventoryFileUpload1 from './InventoryFileUpload1';
import InventoryFunnel from './InventoryFunnel';
import styles from './InventoryPagination1.module.css';
...
interface InventoryPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function InventoryPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="InventoryPagination1">
      {activeItem && (
