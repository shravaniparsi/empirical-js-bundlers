...
import styles from './InventoryRating.module.css';

const InventoryRatingSchema = z.object({
...
export default function InventoryRating({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = InventoryRatingSchema.safeParse({ value: val });
