...
import styles from './InventoryProgress2.module.css';

interface InventoryProgress2Item {
  tags: string[];
  updatedAt: Date;
  status: string;
  description: string;
...
interface InventoryProgress2Props {
  items?: InventoryProgress2Item[];
...
export default function InventoryProgress2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryProgress2Props) {
