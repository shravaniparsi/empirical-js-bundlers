...
import InventoryProgress1 from './InventoryProgress1';
import styles from './InventoryGrid1.module.css';

interface InventoryGrid1Item {
  description: string;
  priority: number;
  createdAt: Date;
  id: string;
...
interface InventoryGrid1Props {
  items?: InventoryGrid1Item[];
...
export default function InventoryGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
