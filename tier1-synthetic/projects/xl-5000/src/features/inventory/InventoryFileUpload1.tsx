...
import styles from './InventoryFileUpload1.module.css';


interface InventoryFileUpload1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function InventoryFileUpload1({
  label,
  name,
