...
import styles from './InventoryAreaChart1.module.css';
...
interface InventoryAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function InventoryAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
