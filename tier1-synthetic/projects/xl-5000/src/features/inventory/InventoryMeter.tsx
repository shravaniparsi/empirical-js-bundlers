...
import styles from './InventoryMeter.module.css';

interface InventoryMeterItem {
  priority: number;
  description: string;
  status: string;
  tags: string[];
...
interface InventoryMeterProps {
  items?: InventoryMeterItem[];
...
export default function InventoryMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
