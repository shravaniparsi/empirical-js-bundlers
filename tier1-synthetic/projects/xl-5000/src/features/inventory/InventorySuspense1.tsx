...
import styles from './InventorySuspense1.module.css';
...
interface InventorySuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventorySuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
