...
import styles from './InventoryProgress4.module.css';

interface InventoryProgress4Item {
  createdAt: Date;
  description: string;
  tags: string[];
  title: string;
...
interface InventoryProgress4Props {
  items?: InventoryProgress4Item[];
...
export default function InventoryProgress4({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryProgress4Props) {
