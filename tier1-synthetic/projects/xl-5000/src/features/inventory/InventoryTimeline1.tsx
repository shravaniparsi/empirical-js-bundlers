...
import styles from './InventoryTimeline1.module.css';

interface InventoryTimeline1Item {
  title: string;
  priority: number;
  createdAt: Date;
  assignee: string;
...
interface InventoryTimeline1Props {
  items?: InventoryTimeline1Item[];
...
export default function InventoryTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryTimeline1Props) {
