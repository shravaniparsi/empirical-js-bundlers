...
import InventoryPagination1 from './InventoryPagination1';
import InventoryRating from './InventoryRating';
import ThemesSticky1 from '../themes/ThemesSticky1';
import styles from './InventoryAvatar.module.css';

interface InventoryAvatarItem {
  description: string;
  status: string;
  createdAt: Date;
  id: string;
...
interface InventoryAvatarProps {
  items?: InventoryAvatarItem[];
...
export default function InventoryAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: InventoryAvatarProps) {
