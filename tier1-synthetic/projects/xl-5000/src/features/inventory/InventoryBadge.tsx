...
import InventoryTextArea from './InventoryTextArea';
import ActivityAreaChart1 from '../activity/ActivityAreaChart1';
import styles from './InventoryBadge.module.css';

interface InventoryBadgeItem {
  title: string;
  tags: string[];
  status: string;
  assignee: string;
