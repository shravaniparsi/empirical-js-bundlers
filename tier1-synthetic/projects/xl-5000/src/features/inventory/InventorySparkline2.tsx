...
import styles from './InventorySparkline2.module.css';
...
interface InventorySparkline2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function InventorySparkline2({
  data,
  title,
  height = 300,
  showLegend = true,
