...
import InventoryBottomNav1 from './InventoryBottomNav1';
import ProjectsTimePicker from '../projects/ProjectsTimePicker';
import styles from './InventoryRetry.module.css';
...
interface InventoryRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function InventoryRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
