...
import AdminStepper2 from './AdminStepper2';
import AdminTag from './AdminTag';
import styles from './AdminGrid1.module.css';

interface AdminGrid1Item {
  createdAt: Date;
  title: string;
  description: string;
  priority: number;
...
interface AdminGrid1Props {
  items?: AdminGrid1Item[];
...
export default function AdminGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
