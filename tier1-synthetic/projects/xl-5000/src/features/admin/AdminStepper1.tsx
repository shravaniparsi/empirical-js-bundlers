...
import AdminDrawer1 from './AdminDrawer1';
import styles from './AdminStepper1.module.css';
...
export default function AdminStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AdminStepper1">
      {activeItem && (
