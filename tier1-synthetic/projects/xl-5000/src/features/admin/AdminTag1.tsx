...
import AdminFeed1 from './AdminFeed1';
import styles from './AdminTag1.module.css';

interface AdminTag1Item {
  title: string;
  createdAt: Date;
  description: string;
  updatedAt: Date;
...
export default function AdminTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
