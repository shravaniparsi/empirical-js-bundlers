...
import AdminGrid1 from './AdminGrid1';
import AdminAccordion1 from './AdminAccordion1';
import styles from './AdminPaginated.module.css';
...
interface AdminPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AdminPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
