...
import styles from './AdminStepper2.module.css';
...
export default function AdminStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AdminStepper2">
      {activeItem && (
