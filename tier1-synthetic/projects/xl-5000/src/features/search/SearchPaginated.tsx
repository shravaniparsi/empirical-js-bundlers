...
import SearchSlider1 from './SearchSlider1';
import SearchBarChart from './SearchBarChart';
import styles from './SearchPaginated.module.css';
...
interface SearchPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
