...
import styles from './SearchPlaceholder2.module.css';
...
interface SearchPlaceholder2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchPlaceholder2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
