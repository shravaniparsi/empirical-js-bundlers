...
import SearchPagination1 from './SearchPagination1';
import SearchDatePicker1 from './SearchDatePicker1';
import styles from './SearchCached.module.css';
...
interface SearchCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
