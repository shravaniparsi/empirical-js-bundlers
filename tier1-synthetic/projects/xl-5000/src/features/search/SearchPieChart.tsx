...
import SearchPlaceholder2 from './SearchPlaceholder2';
import styles from './SearchPieChart.module.css';
...
export default function SearchPieChart({
  data,
  title,
  height = 300,
  showLegend = true,
