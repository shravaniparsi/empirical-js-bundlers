...
import SearchRank1 from './SearchRank1';
import styles from './SearchGrid3.module.css';

interface SearchGrid3Item {
  description: string;
  tags: string[];
  priority: number;
  id: string;
...
interface SearchGrid3Props {
  items?: SearchGrid3Item[];
...
export default function SearchGrid3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
