...
import SearchAutocomplete2 from './SearchAutocomplete2';
import SearchDatePicker from './SearchDatePicker';
import ThemesSticky1 from '../themes/ThemesSticky1';
import styles from './SearchErrorBoundary1.module.css';
...
interface SearchErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SearchErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
