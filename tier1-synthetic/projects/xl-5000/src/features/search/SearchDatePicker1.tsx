...
import SearchDivider1 from './SearchDivider1';
import SearchChip from './SearchChip';
import styles from './SearchDatePicker1.module.css';


interface SearchDatePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SearchDatePicker1({
  label,
  name,
