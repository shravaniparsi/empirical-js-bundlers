...
import SearchAutocomplete1 from './SearchAutocomplete1';
import TagsSummary from '../tags/TagsSummary';
import styles from './SearchPanel1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SearchPanel1Props {
...
export default function SearchPanel1({
  children,
