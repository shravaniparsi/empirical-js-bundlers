...
import styles from './SearchPagination2.module.css';
...
interface SearchPagination2Props {
  items: NavItem[];
  activeId?: string;
...
export default function SearchPagination2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SearchPagination2">
      {activeItem && (
