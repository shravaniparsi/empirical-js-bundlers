...
import SearchTreeView1 from './SearchTreeView1';
import styles from './SearchBadge1.module.css';

interface SearchBadge1Item {
  tags: string[];
  updatedAt: Date;
  priority: number;
  id: string;
...
interface SearchBadge1Props {
  items?: SearchBadge1Item[];
...
export default function SearchBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
