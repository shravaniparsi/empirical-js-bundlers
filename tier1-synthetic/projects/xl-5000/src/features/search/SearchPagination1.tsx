...
import styles from './SearchPagination1.module.css';
...
interface SearchPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function SearchPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SearchPagination1">
      {activeItem && (
