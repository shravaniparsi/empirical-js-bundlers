...
import styles from './SearchThumbnail1.module.css';

interface SearchThumbnail1Item {
  title: string;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface SearchThumbnail1Props {
  items?: SearchThumbnail1Item[];
...
export default function SearchThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SearchThumbnail1Props) {
