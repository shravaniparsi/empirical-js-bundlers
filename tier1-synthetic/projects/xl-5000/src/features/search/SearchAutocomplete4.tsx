...
import SearchContext2 from './SearchContext2';
import styles from './SearchAutocomplete4.module.css';


interface SearchAutocomplete4Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SearchAutocomplete4({
  label,
  name,
