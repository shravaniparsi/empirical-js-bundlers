...
import FormsTreeView from './FormsTreeView';
import styles from './FormsCheckbox.module.css';

const FormsCheckboxSchema = z.object({
...
export default function FormsCheckbox({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = FormsCheckboxSchema.safeParse({ value: val });
