...
import FormsHeatmap2 from './FormsHeatmap2';
import ImportsScroll2 from '../imports/ImportsScroll2';
import styles from './FormsAreaChart.module.css';
...
export default function FormsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
