...
import FormsConfirm from './FormsConfirm';
import styles from './FormsProgress.module.css';

interface FormsProgressItem {
  updatedAt: Date;
  createdAt: Date;
  assignee: string;
  description: string;
...
interface FormsProgressProps {
  items?: FormsProgressItem[];
...
export default function FormsProgress({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
