...
import styles from './FormsProgress2.module.css';

interface FormsProgress2Item {
  updatedAt: Date;
  description: string;
  status: string;
  createdAt: Date;
...
interface FormsProgress2Props {
  items?: FormsProgress2Item[];
...
export default function FormsProgress2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
