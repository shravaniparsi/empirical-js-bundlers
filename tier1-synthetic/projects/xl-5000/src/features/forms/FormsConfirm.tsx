...
import FormsAvatar from './FormsAvatar';
import FormsBadge1 from './FormsBadge1';
import CartPieChart from '../cart/CartPieChart';
import styles from './FormsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FormsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FormsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
