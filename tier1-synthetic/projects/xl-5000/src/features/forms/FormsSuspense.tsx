...
import FormsScatter1 from './FormsScatter1';
import ExportsDivider2 from '../exports/ExportsDivider2';
import styles from './FormsSuspense.module.css';
...
interface FormsSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FormsSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
