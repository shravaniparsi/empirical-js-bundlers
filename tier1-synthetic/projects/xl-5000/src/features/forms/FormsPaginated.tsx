...
import FormsFeed1 from './FormsFeed1';
import styles from './FormsPaginated.module.css';
...
interface FormsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FormsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
