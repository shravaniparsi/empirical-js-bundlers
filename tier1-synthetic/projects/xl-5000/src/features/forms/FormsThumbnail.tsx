...
import styles from './FormsThumbnail.module.css';

interface FormsThumbnailItem {
  description: string;
  tags: string[];
  createdAt: Date;
  priority: number;
...
interface FormsThumbnailProps {
  items?: FormsThumbnailItem[];
...
export default function FormsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
