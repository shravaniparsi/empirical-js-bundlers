...
import FormsPolling from './FormsPolling';
import styles from './FormsCached.module.css';
...
interface FormsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FormsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
