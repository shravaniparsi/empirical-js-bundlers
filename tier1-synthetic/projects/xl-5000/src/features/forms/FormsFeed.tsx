...
import FormsLineChart from './FormsLineChart';
import OrdersScore1 from '../orders/OrdersScore1';
import styles from './FormsFeed.module.css';

interface FormsFeedItem {
  createdAt: Date;
  tags: string[];
  priority: number;
  updatedAt: Date;
...
export default function FormsFeed({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
