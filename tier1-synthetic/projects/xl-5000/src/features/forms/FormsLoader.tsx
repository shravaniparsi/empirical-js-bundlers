...
import FormsColorPicker2 from './FormsColorPicker2';
import styles from './FormsLoader.module.css';
...
interface FormsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FormsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
