...
import FormsSidebar1 from './FormsSidebar1';
import FormsWrapper from './FormsWrapper';
import styles from './FormsTimeline.module.css';

interface FormsTimelineItem {
  priority: number;
  status: string;
  createdAt: Date;
  tags: string[];
...
interface FormsTimelineProps {
  items?: FormsTimelineItem[];
...
export default function FormsTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
