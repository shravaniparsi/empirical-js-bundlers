...
import FormsSticky from './FormsSticky';
import styles from './FormsPolling.module.css';
...
interface FormsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FormsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
