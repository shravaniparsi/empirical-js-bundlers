...
import FormsFunnel from './FormsFunnel';
import IntegrationsCard1 from '../integrations/IntegrationsCard1';
import styles from './FormsFooter2.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface FormsFooter2Props {
...
export default function FormsFooter2({
  children,
