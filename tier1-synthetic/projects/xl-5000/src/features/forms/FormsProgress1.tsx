...
import styles from './FormsProgress1.module.css';

interface FormsProgress1Item {
  priority: number;
  updatedAt: Date;
  status: string;
  assignee: string;
...
interface FormsProgress1Props {
  items?: FormsProgress1Item[];
...
export default function FormsProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
