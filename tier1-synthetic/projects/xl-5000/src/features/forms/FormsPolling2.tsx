...
import FormsStack1 from './FormsStack1';
import FormsRadio from './FormsRadio';
import styles from './FormsPolling2.module.css';
...
interface FormsPolling2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FormsPolling2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
