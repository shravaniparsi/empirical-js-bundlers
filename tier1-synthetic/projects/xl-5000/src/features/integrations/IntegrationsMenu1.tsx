...
import IntegrationsBadge3 from './IntegrationsBadge3';
import SearchDetail from '../search/SearchDetail';
import styles from './IntegrationsMenu1.module.css';
...
interface IntegrationsMenu1Props {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsMenu1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsMenu1">
      {activeItem && (
