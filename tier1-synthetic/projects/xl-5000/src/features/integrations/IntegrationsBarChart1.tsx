...
import IntegrationsMenu4 from './IntegrationsMenu4';
import styles from './IntegrationsBarChart1.module.css';
...
interface IntegrationsBarChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsBarChart1({
  data,
  title,
  height = 300,
  showLegend = true,
