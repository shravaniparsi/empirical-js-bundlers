...
import IntegrationsFeed1 from './IntegrationsFeed1';
import IntegrationsStepper2 from './IntegrationsStepper2';
import styles from './IntegrationsSuspense.module.css';
...
interface IntegrationsSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
