...
import IntegrationsBadge2 from './IntegrationsBadge2';
import styles from './IntegrationsPlaceholder.module.css';
...
interface IntegrationsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: IntegrationsPlaceholderProps<T>) {
