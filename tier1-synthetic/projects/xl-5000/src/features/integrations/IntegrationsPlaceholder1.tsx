...
import styles from './IntegrationsPlaceholder1.module.css';
...
interface IntegrationsPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: IntegrationsPlaceholder1Props<T>) {
