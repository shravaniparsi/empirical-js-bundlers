...
import styles from './IntegrationsSpinner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSpinner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsSpinner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
