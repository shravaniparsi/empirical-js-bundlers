...
import IntegrationsToggle1 from './IntegrationsToggle1';
import IntegrationsBadge1 from './IntegrationsBadge1';
import IntegrationsPopover from './IntegrationsPopover';
import styles from './IntegrationsBadge.module.css';

interface IntegrationsBadgeItem {
  updatedAt: Date;
  assignee: string;
  tags: string[];
  priority: number;
...
export default function IntegrationsBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsBadgeProps) {
