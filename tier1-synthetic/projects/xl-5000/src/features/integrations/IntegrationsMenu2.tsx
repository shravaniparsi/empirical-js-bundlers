...
import styles from './IntegrationsMenu2.module.css';
...
interface IntegrationsMenu2Props {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsMenu2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsMenu2">
      {activeItem && (
