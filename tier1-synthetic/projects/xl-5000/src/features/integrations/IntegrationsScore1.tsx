...
import styles from './IntegrationsScore1.module.css';

interface IntegrationsScore1Item {
  updatedAt: Date;
  status: string;
  title: string;
  priority: number;
...
interface IntegrationsScore1Props {
  items?: IntegrationsScore1Item[];
...
export default function IntegrationsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsScore1Props) {
