...
import styles from './IntegrationsFunnel1.module.css';
...
interface IntegrationsFunnel1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsFunnel1({
  data,
  title,
  height = 300,
  showLegend = true,
