...
import styles from './IntegrationsFeed3.module.css';

interface IntegrationsFeed3Item {
  status: string;
  assignee: string;
  createdAt: Date;
  id: string;
...
interface IntegrationsFeed3Props {
  items?: IntegrationsFeed3Item[];
...
export default function IntegrationsFeed3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: IntegrationsFeed3Props) {
