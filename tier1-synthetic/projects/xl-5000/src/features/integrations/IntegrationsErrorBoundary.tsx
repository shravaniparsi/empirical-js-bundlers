...
import IntegrationsMenu2 from './IntegrationsMenu2';
import styles from './IntegrationsErrorBoundary.module.css';
...
interface IntegrationsErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: IntegrationsErrorBoundaryProps<T>) {
