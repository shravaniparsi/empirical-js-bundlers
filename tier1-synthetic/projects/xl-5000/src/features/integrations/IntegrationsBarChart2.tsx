...
import styles from './IntegrationsBarChart2.module.css';
...
interface IntegrationsBarChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsBarChart2({
  data,
  title,
  height = 300,
  showLegend = true,
