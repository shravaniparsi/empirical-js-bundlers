...
import IntegrationsFactory from './IntegrationsFactory';
import UsersInput1 from '../users/UsersInput1';
import styles from './IntegrationsFileUpload.module.css';


interface IntegrationsFileUploadProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function IntegrationsFileUpload({
  label,
  name,
