...
import IntegrationsSuspense from './IntegrationsSuspense';
import ReviewsSearch from '../reviews/ReviewsSearch';
import WorkflowsFactory from '../workflows/WorkflowsFactory';
import styles from './IntegrationsDetail.module.css';

interface IntegrationsDetailItem {
  status: string;
  createdAt: Date;
  title: string;
  assignee: string;
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['status', 'createdAt', 'title']);
