...
import styles from './IntegrationsSnackbar2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSnackbar2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsSnackbar2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
