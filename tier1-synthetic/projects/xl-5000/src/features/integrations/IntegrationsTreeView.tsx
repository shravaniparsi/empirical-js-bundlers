...
import IntegrationsContainer1 from './IntegrationsContainer1';
import styles from './IntegrationsTreeView.module.css';
...
interface IntegrationsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsTreeView">
      {activeItem && (
