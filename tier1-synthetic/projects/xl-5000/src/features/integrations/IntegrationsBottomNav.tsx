...
import styles from './IntegrationsBottomNav.module.css';
...
interface IntegrationsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsBottomNav">
      {activeItem && (
