...
import IntegrationsAdapter from './IntegrationsAdapter';
import IntegrationsBarChart from './IntegrationsBarChart';
import IntegrationsPlaceholder1 from './IntegrationsPlaceholder1';
import ProductsTextArea from '../products/ProductsTextArea';
import styles from './IntegrationsAlert.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsAlertProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
