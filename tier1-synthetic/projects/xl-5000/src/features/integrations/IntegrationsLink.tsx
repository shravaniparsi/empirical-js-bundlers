...
interface IntegrationsLinkProps {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsLink({
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsLink">
      {activeItem && (
