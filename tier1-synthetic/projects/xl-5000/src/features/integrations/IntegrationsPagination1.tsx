...
import IntegrationsPaginated1 from './IntegrationsPaginated1';
import PermissionsContext from '../permissions/PermissionsContext';
import styles from './IntegrationsPagination1.module.css';
...
interface IntegrationsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsPagination1">
      {activeItem && (
