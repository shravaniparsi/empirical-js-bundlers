...
import styles from './IntegrationsPolling.module.css';
...
interface IntegrationsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
