...
import styles from './IntegrationsNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
