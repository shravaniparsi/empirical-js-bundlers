...
import styles from './IntegrationsLineChart.module.css';
...
interface IntegrationsLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
