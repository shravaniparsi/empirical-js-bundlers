...
import IntegrationsAvatar from './IntegrationsAvatar';
import styles from './IntegrationsGauge.module.css';
...
interface IntegrationsGaugeProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function IntegrationsGauge({
  data,
  title,
  height = 300,
  showLegend = true,
