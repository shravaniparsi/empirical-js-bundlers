...
import styles from './IntegrationsPaginated1.module.css';
...
interface IntegrationsPaginated1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function IntegrationsPaginated1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
