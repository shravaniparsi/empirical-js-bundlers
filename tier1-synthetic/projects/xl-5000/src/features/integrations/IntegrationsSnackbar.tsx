...
import IntegrationsPrefetch1 from './IntegrationsPrefetch1';
import IntegrationsPopover1 from './IntegrationsPopover1';
import IntegrationsSnackbar1 from './IntegrationsSnackbar1';
import styles from './IntegrationsSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
  ...
  return (
    ...
    >
      ...
      <IntegrationsPrefetch1 />
      <IntegrationsPopover1 />
      <IntegrationsSnackbar1 />
      </div>
    </div>
  );
}
