...
import IntegrationsAutocomplete from './IntegrationsAutocomplete';
import ReviewsContainer from '../reviews/ReviewsContainer';
import styles from './IntegrationsTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
