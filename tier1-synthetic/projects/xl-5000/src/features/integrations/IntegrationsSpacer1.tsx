...
import styles from './IntegrationsSpacer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface IntegrationsSpacer1Props {
...
export default function IntegrationsSpacer1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
