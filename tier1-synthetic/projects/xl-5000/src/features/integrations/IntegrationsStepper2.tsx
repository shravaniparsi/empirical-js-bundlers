...
import styles from './IntegrationsStepper2.module.css';
...
interface IntegrationsStepper2Props {
  items: NavItem[];
  activeId?: string;
...
export default function IntegrationsStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="IntegrationsStepper2">
      {activeItem && (
