...
import styles from './IntegrationsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface IntegrationsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function IntegrationsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
