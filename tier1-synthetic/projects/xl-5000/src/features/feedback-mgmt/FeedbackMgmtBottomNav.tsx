...
import styles from './FeedbackMgmtBottomNav.module.css';
...
interface FeedbackMgmtBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function FeedbackMgmtBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="FeedbackMgmtBottomNav">
      {activeItem && (
