...
import styles from './FeedbackMgmtInfiniteScroll1.module.css';
...
interface FeedbackMgmtInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: FeedbackMgmtInfiniteScroll1Props<T>) {
