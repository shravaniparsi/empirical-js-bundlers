...
import FeedbackMgmtPanel from './FeedbackMgmtPanel';
import styles from './FeedbackMgmtTooltip1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtTooltip1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtTooltip1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
