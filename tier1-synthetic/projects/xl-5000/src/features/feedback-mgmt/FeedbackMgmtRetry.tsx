...
import FeedbackMgmtRating from './FeedbackMgmtRating';
import styles from './FeedbackMgmtRetry.module.css';
...
interface FeedbackMgmtRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
