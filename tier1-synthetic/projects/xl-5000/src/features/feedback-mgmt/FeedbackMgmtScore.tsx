...
import FeedbackMgmtHeatmap from './FeedbackMgmtHeatmap';
import styles from './FeedbackMgmtScore.module.css';

interface FeedbackMgmtScoreItem {
  updatedAt: Date;
  status: string;
  priority: number;
  assignee: string;
...
interface FeedbackMgmtScoreProps {
  items?: FeedbackMgmtScoreItem[];
...
export default function FeedbackMgmtScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtScoreProps) {
