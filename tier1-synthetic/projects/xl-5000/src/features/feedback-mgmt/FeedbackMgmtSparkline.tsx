...
import styles from './FeedbackMgmtSparkline.module.css';
...
interface FeedbackMgmtSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
