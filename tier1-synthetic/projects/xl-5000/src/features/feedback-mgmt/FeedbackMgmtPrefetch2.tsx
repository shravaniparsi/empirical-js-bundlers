...
import styles from './FeedbackMgmtPrefetch2.module.css';
...
interface FeedbackMgmtPrefetch2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtPrefetch2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
