...
import FeedbackMgmtDrawer3 from './FeedbackMgmtDrawer3';
import FeedbackMgmtCollapse from './FeedbackMgmtCollapse';
import styles from './FeedbackMgmtTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
