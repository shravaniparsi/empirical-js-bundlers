...
import styles from './FeedbackMgmtLabel.module.css';

interface FeedbackMgmtLabelItem {
  status: string;
  updatedAt: Date;
  createdAt: Date;
  description: string;
...
interface FeedbackMgmtLabelProps {
  items?: FeedbackMgmtLabelItem[];
...
export default function FeedbackMgmtLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtLabelProps) {
