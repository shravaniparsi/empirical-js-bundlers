...
import FeedbackMgmtTextArea from './FeedbackMgmtTextArea';
import InventorySummary from '../inventory/InventorySummary';
import styles from './FeedbackMgmtAlert1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtAlert1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtAlert1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
