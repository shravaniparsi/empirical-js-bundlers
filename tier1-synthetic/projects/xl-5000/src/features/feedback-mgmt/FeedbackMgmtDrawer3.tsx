...
import FeedbackMgmtThumbnail from './FeedbackMgmtThumbnail';
import ReportsMeter1 from '../reports/ReportsMeter1';
import InventoryPieChart from '../inventory/InventoryPieChart';
import styles from './FeedbackMgmtDrawer3.module.css';
...
interface FeedbackMgmtDrawer3Props {
  items: NavItem[];
  activeId?: string;
...
export default function FeedbackMgmtDrawer3({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="FeedbackMgmtDrawer3">
      {activeItem && (
