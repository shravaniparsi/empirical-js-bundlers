...
import styles from './FeedbackMgmtNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
