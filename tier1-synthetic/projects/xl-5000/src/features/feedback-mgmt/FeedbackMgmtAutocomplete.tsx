...
import SchedulingAvatar1 from '../scheduling/SchedulingAvatar1';
import styles from './FeedbackMgmtAutocomplete.module.css';


interface FeedbackMgmtAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function FeedbackMgmtAutocomplete({
  label,
  name,
