...
import styles from './FeedbackMgmtNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
  ...
  actionLabel = 'Dismiss',
  className,
}: FeedbackMgmtNotification1Props) {
