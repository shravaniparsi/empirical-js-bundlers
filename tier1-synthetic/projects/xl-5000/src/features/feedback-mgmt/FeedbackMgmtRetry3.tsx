...
import styles from './FeedbackMgmtRetry3.module.css';
...
interface FeedbackMgmtRetry3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtRetry3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
