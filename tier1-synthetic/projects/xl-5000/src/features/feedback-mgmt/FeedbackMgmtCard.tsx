...
import styles from './FeedbackMgmtCard.module.css';

interface FeedbackMgmtCardItem {
  status: string;
  assignee: string;
  updatedAt: Date;
  createdAt: Date;
...
interface FeedbackMgmtCardProps {
  items?: FeedbackMgmtCardItem[];
...
export default function FeedbackMgmtCard({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtCardProps) {
