...
import styles from './FeedbackMgmtTimePicker2.module.css';


interface FeedbackMgmtTimePicker2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function FeedbackMgmtTimePicker2({
  label,
  name,
