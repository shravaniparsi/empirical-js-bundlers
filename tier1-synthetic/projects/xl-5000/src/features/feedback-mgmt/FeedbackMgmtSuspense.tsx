...
import FeedbackMgmtLink1 from './FeedbackMgmtLink1';
import styles from './FeedbackMgmtSuspense.module.css';
...
interface FeedbackMgmtSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
