...
import FeedbackMgmtTextArea1 from './FeedbackMgmtTextArea1';
import FeedbackMgmtContext2 from './FeedbackMgmtContext2';
import FormsTextArea from '../forms/FormsTextArea';
import styles from './FeedbackMgmtDonut.module.css';
...
interface FeedbackMgmtDonutProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtDonut({
  data,
  title,
  height = 300,
  showLegend = true,
  ...
  return (
    <div className={clsx(styles.container, className)}>
      ...
      <FeedbackMgmtTextArea1 />
      <FeedbackMgmtContext2 />
      <FormsTextArea />
      </div>
    </div>
  );
