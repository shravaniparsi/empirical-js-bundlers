...
import styles from './FeedbackMgmtTag2.module.css';

interface FeedbackMgmtTag2Item {
  priority: number;
  description: string;
  tags: string[];
  title: string;
...
interface FeedbackMgmtTag2Props {
  items?: FeedbackMgmtTag2Item[];
...
export default function FeedbackMgmtTag2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtTag2Props) {
