...
import FeedbackMgmtNavBar from './FeedbackMgmtNavBar';
import styles from './FeedbackMgmtNotification2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtNotification2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtNotification2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
  ...
  actionLabel = 'Dismiss',
  className,
}: FeedbackMgmtNotification2Props) {
