...
import FeedbackMgmtColorPicker from './FeedbackMgmtColorPicker';
import ImportsScore1 from '../imports/ImportsScore1';
import styles from './FeedbackMgmtGauge.module.css';
...
interface FeedbackMgmtGaugeProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtGauge({
  data,
  title,
  height = 300,
  showLegend = true,
