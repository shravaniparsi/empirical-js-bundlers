...
import FeedbackMgmtDivider from './FeedbackMgmtDivider';
import ProjectsTimePicker from '../projects/ProjectsTimePicker';
import styles from './FeedbackMgmtThumbnail.module.css';

interface FeedbackMgmtThumbnailItem {
  createdAt: Date;
  description: string;
  assignee: string;
  id: string;
...
interface FeedbackMgmtThumbnailProps {
  items?: FeedbackMgmtThumbnailItem[];
...
export default function FeedbackMgmtThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtThumbnailProps) {
