...
import FeedbackMgmtLink2 from './FeedbackMgmtLink2';
import FeedbackMgmtRetry1 from './FeedbackMgmtRetry1';
import ReviewsSpacer1 from '../reviews/ReviewsSpacer1';
import styles from './FeedbackMgmtScatter.module.css';
...
interface FeedbackMgmtScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtScatter({
  data,
  title,
  height = 300,
  showLegend = true,
