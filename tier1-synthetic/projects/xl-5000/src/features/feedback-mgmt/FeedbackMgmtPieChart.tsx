...
import styles from './FeedbackMgmtPieChart.module.css';
...
interface FeedbackMgmtPieChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtPieChart({
  data,
  title,
  height = 300,
  showLegend = true,
