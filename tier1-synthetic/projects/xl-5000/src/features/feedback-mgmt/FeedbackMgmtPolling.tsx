...
import styles from './FeedbackMgmtPolling.module.css';
...
interface FeedbackMgmtPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
