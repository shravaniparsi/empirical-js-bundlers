...
import styles from './FeedbackMgmtScatter1.module.css';
...
interface FeedbackMgmtScatter1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtScatter1({
  data,
  title,
  height = 300,
  showLegend = true,
