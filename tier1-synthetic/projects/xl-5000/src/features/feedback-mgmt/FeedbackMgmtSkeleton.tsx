...
import FeedbackMgmtGauge2 from './FeedbackMgmtGauge2';
import FeedbackMgmtSparkline from './FeedbackMgmtSparkline';
import ExportsFeed2 from '../exports/ExportsFeed2';
import SearchNavBar1 from '../search/SearchNavBar1';
import styles from './FeedbackMgmtSkeleton.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtSkeletonProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtSkeleton({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
