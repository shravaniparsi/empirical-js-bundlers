...
import styles from './FeedbackMgmtPopover.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtPopoverProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtPopover({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
