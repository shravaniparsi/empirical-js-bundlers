...
import styles from './FeedbackMgmtDetail.module.css';

interface FeedbackMgmtDetailItem {
  status: string;
  updatedAt: Date;
  createdAt: Date;
  description: string;
...
interface FeedbackMgmtDetailProps {
  items?: FeedbackMgmtDetailItem[];
...
export default function FeedbackMgmtDetail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtDetailProps) {
