...
import styles from './FeedbackMgmtInfiniteScroll.module.css';
...
interface FeedbackMgmtInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: FeedbackMgmtInfiniteScrollProps<T>) {
