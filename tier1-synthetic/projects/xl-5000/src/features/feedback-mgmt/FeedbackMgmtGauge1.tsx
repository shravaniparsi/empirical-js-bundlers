...
import FeedbackMgmtRetry from './FeedbackMgmtRetry';
...
import styles from './FeedbackMgmtGauge1.module.css';
...
interface FeedbackMgmtGauge1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtGauge1({
  data,
  title,
  height = 300,
  showLegend = true,
