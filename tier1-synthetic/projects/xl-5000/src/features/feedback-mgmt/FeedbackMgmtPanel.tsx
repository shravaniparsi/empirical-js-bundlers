...
import FeedbackMgmtCard from './FeedbackMgmtCard';
import CatalogCollapse from '../catalog/CatalogCollapse';
import KnowledgeBaseErrorBoundary from '../knowledge-base/KnowledgeBaseErrorBoundary';
import styles from './FeedbackMgmtPanel.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface FeedbackMgmtPanelProps {
...
export default function FeedbackMgmtPanel({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
