...
import FeedbackMgmtTag1 from './FeedbackMgmtTag1';
import styles from './FeedbackMgmtTag.module.css';

interface FeedbackMgmtTagItem {
  status: string;
  title: string;
  createdAt: Date;
  tags: string[];
...
interface FeedbackMgmtTagProps {
  items?: FeedbackMgmtTagItem[];
...
export default function FeedbackMgmtTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtTagProps) {
