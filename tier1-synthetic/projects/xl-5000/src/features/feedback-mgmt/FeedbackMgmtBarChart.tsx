...
import FeedbackMgmtSearch from './FeedbackMgmtSearch';
import FeedbackMgmtBottomNav from './FeedbackMgmtBottomNav';
import styles from './FeedbackMgmtBarChart.module.css';
...
interface FeedbackMgmtBarChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtBarChart({
  data,
  title,
  height = 300,
  showLegend = true,
