...
import styles from './FeedbackMgmtHeatmap.module.css';
...
interface FeedbackMgmtHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function FeedbackMgmtHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
