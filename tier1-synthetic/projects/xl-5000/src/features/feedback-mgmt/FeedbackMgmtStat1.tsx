...
import styles from './FeedbackMgmtStat1.module.css';

interface FeedbackMgmtStat1Item {
  assignee: string;
  updatedAt: Date;
  status: string;
  tags: string[];
...
interface FeedbackMgmtStat1Props {
  items?: FeedbackMgmtStat1Item[];
...
export default function FeedbackMgmtStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: FeedbackMgmtStat1Props) {
