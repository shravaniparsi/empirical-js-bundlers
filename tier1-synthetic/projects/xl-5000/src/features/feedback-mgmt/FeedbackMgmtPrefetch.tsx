...
import FeedbackMgmtNotification2 from './FeedbackMgmtNotification2';
import styles from './FeedbackMgmtPrefetch.module.css';
...
interface FeedbackMgmtPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
