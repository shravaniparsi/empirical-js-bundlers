...
interface FeedbackMgmtRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
