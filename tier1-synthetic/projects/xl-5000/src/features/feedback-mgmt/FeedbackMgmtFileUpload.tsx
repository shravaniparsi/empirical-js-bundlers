...
import FeedbackMgmtDrawer from './FeedbackMgmtDrawer';
import styles from './FeedbackMgmtFileUpload.module.css';


interface FeedbackMgmtFileUploadProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function FeedbackMgmtFileUpload({
  label,
  name,
