...
import FeedbackMgmtToggle from './FeedbackMgmtToggle';
import FeedbackMgmtRadio1 from './FeedbackMgmtRadio1';
import FeedbackMgmtAvatar from './FeedbackMgmtAvatar';
import styles from './FeedbackMgmtRetry2.module.css';
...
interface FeedbackMgmtRetry2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtRetry2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
