...
import FeedbackMgmtRetry2 from './FeedbackMgmtRetry2';
import styles from './FeedbackMgmtPrefetch3.module.css';
...
interface FeedbackMgmtPrefetch3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FeedbackMgmtPrefetch3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
