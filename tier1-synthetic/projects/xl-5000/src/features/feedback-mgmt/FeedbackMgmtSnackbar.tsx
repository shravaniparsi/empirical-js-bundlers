...
import styles from './FeedbackMgmtSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface FeedbackMgmtSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function FeedbackMgmtSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
