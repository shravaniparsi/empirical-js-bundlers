...
import FeedbackMgmtRetry3 from './FeedbackMgmtRetry3';
import styles from './FeedbackMgmtRadio.module.css';


interface FeedbackMgmtRadioProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function FeedbackMgmtRadio({
  label,
  name,
