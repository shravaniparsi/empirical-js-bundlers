...
import styles from './CampaignsAccordion1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CampaignsAccordion1Props {
...
export default function CampaignsAccordion1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
