...
import styles from './CampaignsTreeView.module.css';
...
interface CampaignsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function CampaignsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CampaignsTreeView">
      {activeItem && (
