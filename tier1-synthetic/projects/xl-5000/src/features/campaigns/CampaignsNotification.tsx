...
import CampaignsTextArea from './CampaignsTextArea';
import CampaignsConfirm1 from './CampaignsConfirm1';
import styles from './CampaignsNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CampaignsNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CampaignsNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
