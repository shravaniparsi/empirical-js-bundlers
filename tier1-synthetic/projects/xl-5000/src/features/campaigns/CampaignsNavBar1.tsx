...
import CampaignsSparkline from './CampaignsSparkline';
import styles from './CampaignsNavBar1.module.css';
...
interface CampaignsNavBar1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CampaignsNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CampaignsNavBar1">
      {activeItem && (
