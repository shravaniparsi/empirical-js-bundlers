...
import styles from './CampaignsLineChart1.module.css';
...
interface CampaignsLineChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CampaignsLineChart1({
  data,
  title,
  height = 300,
  showLegend = true,
