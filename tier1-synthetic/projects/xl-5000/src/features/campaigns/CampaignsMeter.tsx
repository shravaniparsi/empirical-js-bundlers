...
import styles from './CampaignsMeter.module.css';

interface CampaignsMeterItem {
  status: string;
  description: string;
  updatedAt: Date;
  id: string;
...
interface CampaignsMeterProps {
  items?: CampaignsMeterItem[];
...
export default function CampaignsMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
