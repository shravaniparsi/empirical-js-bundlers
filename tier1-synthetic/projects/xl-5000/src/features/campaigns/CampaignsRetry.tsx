...
import CampaignsPlaceholder from './CampaignsPlaceholder';
import styles from './CampaignsRetry.module.css';
...
interface CampaignsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CampaignsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
