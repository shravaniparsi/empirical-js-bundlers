...
import CampaignsRetry from './CampaignsRetry';
import CampaignsFooter from './CampaignsFooter';
import styles from './CampaignsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CampaignsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CampaignsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
