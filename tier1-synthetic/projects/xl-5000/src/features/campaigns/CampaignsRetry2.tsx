...
import CampaignsNotification from './CampaignsNotification';
import styles from './CampaignsRetry2.module.css';
...
interface CampaignsRetry2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CampaignsRetry2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
