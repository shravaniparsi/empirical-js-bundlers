...
import styles from './CampaignsRetry1.module.css';
...
interface CampaignsRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CampaignsRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
