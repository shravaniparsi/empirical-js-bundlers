...
import CampaignsBottomNav from './CampaignsBottomNav';
import styles from './CampaignsAreaChart.module.css';
...
interface CampaignsAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CampaignsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
