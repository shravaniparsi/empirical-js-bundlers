...
import styles from './CampaignsAreaChart1.module.css';
...
interface CampaignsAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CampaignsAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
