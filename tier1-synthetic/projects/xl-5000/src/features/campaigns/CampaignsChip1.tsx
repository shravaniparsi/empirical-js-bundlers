...
import styles from './CampaignsChip1.module.css';

interface CampaignsChip1Item {
  description: string;
  createdAt: Date;
  assignee: string;
  id: string;
...
interface CampaignsChip1Props {
  items?: CampaignsChip1Item[];
...
export default function CampaignsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
