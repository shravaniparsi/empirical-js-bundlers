...
import styles from './CampaignsList2.module.css';

interface CampaignsList2Item {
  title: string;
  updatedAt: Date;
  description: string;
  priority: number;
...
interface CampaignsList2Props {
  items?: CampaignsList2Item[];
...
export default function CampaignsList2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
