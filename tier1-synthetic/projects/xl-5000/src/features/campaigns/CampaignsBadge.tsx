...
import CampaignsTabs2 from './CampaignsTabs2';
import ImportsScore1 from '../imports/ImportsScore1';
import styles from './CampaignsBadge.module.css';

interface CampaignsBadgeItem {
  description: string;
  createdAt: Date;
  assignee: string;
  tags: string[];
...
interface CampaignsBadgeProps {
  items?: CampaignsBadgeItem[];
...
export default function CampaignsBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
