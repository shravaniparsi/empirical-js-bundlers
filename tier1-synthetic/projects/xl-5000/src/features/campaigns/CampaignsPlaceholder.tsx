...
import CampaignsBadge2 from './CampaignsBadge2';
import CampaignsNavBar from './CampaignsNavBar';
import CampaignsTreeView from './CampaignsTreeView';
import MediaList from '../media/MediaList';
import styles from './CampaignsPlaceholder.module.css';
...
interface CampaignsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CampaignsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
