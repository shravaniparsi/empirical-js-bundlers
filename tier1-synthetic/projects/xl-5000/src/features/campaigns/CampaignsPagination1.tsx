...
import styles from './CampaignsPagination1.module.css';
...
interface CampaignsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CampaignsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CampaignsPagination1">
      {activeItem && (
