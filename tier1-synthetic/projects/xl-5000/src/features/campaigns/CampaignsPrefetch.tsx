...
import CampaignsFunnel from './CampaignsFunnel';
import CampaignsList from './CampaignsList';
import styles from './CampaignsPrefetch.module.css';
...
interface CampaignsPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CampaignsPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
