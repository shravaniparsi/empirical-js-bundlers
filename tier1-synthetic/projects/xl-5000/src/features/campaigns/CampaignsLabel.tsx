...
import styles from './CampaignsLabel.module.css';

interface CampaignsLabelItem {
  updatedAt: Date;
  tags: string[];
  status: string;
  assignee: string;
...
interface CampaignsLabelProps {
  items?: CampaignsLabelItem[];
...
export default function CampaignsLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
