...
import CampaignsSpacer from './CampaignsSpacer';
import CampaignsNotification1 from './CampaignsNotification1';
import styles from './CampaignsHeatmap.module.css';
...
interface CampaignsHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CampaignsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
