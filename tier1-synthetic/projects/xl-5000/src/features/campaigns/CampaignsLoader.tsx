...
import styles from './CampaignsLoader.module.css';
...
interface CampaignsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CampaignsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
