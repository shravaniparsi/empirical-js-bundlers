...
import styles from './CampaignsTabs1.module.css';
...
export default function CampaignsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CampaignsTabs1">
      {activeItem && (
