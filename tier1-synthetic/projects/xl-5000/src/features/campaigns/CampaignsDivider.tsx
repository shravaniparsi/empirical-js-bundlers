...
import CampaignsSpinner from './CampaignsSpinner';
import ReviewsNavBar1 from '../reviews/ReviewsNavBar1';
import LocalizationDatePicker from '../localization/LocalizationDatePicker';
import styles from './CampaignsDivider.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CampaignsDividerProps {
...
export default function CampaignsDivider({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
