...
import CampaignsList4 from './CampaignsList4';
import CampaignsInput from './CampaignsInput';
import CampaignsDivider1 from './CampaignsDivider1';
import CatalogSticky from '../catalog/CatalogSticky';
import styles from './CampaignsRating.module.css';


interface CampaignsRatingProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CampaignsRating({
  label,
  name,
