...
import styles from './CampaignsScore.module.css';

interface CampaignsScoreItem {
  createdAt: Date;
  status: string;
  updatedAt: Date;
  description: string;
...
interface CampaignsScoreProps {
  items?: CampaignsScoreItem[];
...
export default function CampaignsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['createdAt', 'status', 'updatedAt']);
