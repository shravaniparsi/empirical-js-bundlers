...
import CampaignsSnackbar1 from './CampaignsSnackbar1';
import styles from './CampaignsModal1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CampaignsModal1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CampaignsModal1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
