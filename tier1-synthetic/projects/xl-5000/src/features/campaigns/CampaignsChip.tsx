...
import CampaignsTag from './CampaignsTag';
import UsersTextArea from '../users/UsersTextArea';
import styles from './CampaignsChip.module.css';

interface CampaignsChipItem {
  status: string;
  createdAt: Date;
  title: string;
  description: string;
...
interface CampaignsChipProps {
  items?: CampaignsChipItem[];
...
export default function CampaignsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
