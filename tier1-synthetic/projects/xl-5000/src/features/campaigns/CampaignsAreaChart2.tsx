...
import CampaignsConfirm from './CampaignsConfirm';
import OnboardingList from '../onboarding/OnboardingList';
import styles from './CampaignsAreaChart2.module.css';
...
interface CampaignsAreaChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CampaignsAreaChart2({
  data,
  title,
  height = 300,
  showLegend = true,
