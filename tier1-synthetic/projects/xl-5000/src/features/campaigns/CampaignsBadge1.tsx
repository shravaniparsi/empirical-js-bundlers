...
import styles from './CampaignsBadge1.module.css';

interface CampaignsBadge1Item {
  assignee: string;
  createdAt: Date;
  priority: number;
  id: string;
...
interface CampaignsBadge1Props {
  items?: CampaignsBadge1Item[];
...
export default function CampaignsBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CampaignsBadge1Props) {
