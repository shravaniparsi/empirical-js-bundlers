...
import CampaignsLabel from './CampaignsLabel';
import CampaignsCard from './CampaignsCard';
import CampaignsToggle from './CampaignsToggle';
import styles from './CampaignsList3.module.css';

interface CampaignsList3Item {
  description: string;
  tags: string[];
  status: string;
  id: string;
...
interface CampaignsList3Props {
  items?: CampaignsList3Item[];
...
export default function CampaignsList3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
