...
import { z } from 'zod';
import CampaignsSearch1 from './CampaignsSearch1';
import CampaignsTag from './CampaignsTag';
import styles from './CampaignsSearch.module.css';
...
export default function CampaignsSearch({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CampaignsSearchSchema.safeParse({ value: val });
