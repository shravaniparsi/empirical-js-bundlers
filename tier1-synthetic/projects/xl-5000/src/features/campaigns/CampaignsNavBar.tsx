...
import CampaignsPopover1 from './CampaignsPopover1';
import styles from './CampaignsNavBar.module.css';
...
interface CampaignsNavBarProps {
  items: NavItem[];
  activeId?: string;
...
export default function CampaignsNavBar({
  ...
  return (
    <nav className={navClasses} aria-label="CampaignsNavBar">
      {activeItem && (
