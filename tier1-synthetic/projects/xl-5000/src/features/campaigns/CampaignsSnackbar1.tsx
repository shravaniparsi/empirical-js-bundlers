...
import CampaignsNavBar1 from './CampaignsNavBar1';
import CampaignsBottomNav2 from './CampaignsBottomNav2';
import CampaignsProgress1 from './CampaignsProgress1';
import styles from './CampaignsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CampaignsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CampaignsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
