...
import styles from './CampaignsNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CampaignsNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CampaignsNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
