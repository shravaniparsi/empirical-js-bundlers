...
import styles from './CampaignsList1.module.css';

interface CampaignsList1Item {
  description: string;
  tags: string[];
  createdAt: Date;
  priority: number;
...
interface CampaignsList1Props {
  items?: CampaignsList1Item[];
...
export default function CampaignsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
