...
import CampaignsCheckbox from './CampaignsCheckbox';
import LocalizationDatePicker from '../localization/LocalizationDatePicker';
import styles from './CampaignsAutocomplete.module.css';


interface CampaignsAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CampaignsAutocomplete({
  label,
  name,
