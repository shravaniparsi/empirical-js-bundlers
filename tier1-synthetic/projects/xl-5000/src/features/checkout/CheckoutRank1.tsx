...
import styles from './CheckoutRank1.module.css';

interface CheckoutRank1Item {
  priority: number;
  description: string;
  title: string;
  createdAt: Date;
...
interface CheckoutRank1Props {
  items?: CheckoutRank1Item[];
...
export default function CheckoutRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
