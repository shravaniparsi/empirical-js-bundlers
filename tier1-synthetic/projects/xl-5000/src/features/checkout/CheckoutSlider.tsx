...
import { z } from 'zod';
import CheckoutTimePicker2 from './CheckoutTimePicker2';
...
import styles from './CheckoutSlider.module.css';

const CheckoutSliderSchema = z.object({
...
export default function CheckoutSlider({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutSliderSchema.safeParse({ value: val });
