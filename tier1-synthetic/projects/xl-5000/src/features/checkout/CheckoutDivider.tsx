...
import CheckoutSkeleton1 from './CheckoutSkeleton1';
import styles from './CheckoutDivider.module.css';
...
export default function CheckoutDivider({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
