...
import styles from './CheckoutSuspense.module.css';
...
interface CheckoutSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
