...
import CheckoutHOC1 from './CheckoutHOC1';
import InventoryProgress2 from '../inventory/InventoryProgress2';
import styles from './CheckoutPaginated.module.css';
...
interface CheckoutPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
