...
import CheckoutHeader2 from './CheckoutHeader2';
import styles from './CheckoutAlert1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CheckoutAlert1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CheckoutAlert1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
