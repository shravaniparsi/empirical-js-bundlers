...
import DocumentsNotification from '../documents/DocumentsNotification';
import styles from './CheckoutSelect.module.css';

const CheckoutSelectSchema = z.object({
...
export default function CheckoutSelect({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutSelectSchema.safeParse({ value: val });
