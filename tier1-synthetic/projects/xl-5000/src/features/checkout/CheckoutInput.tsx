...
import { z } from 'zod';
import CheckoutPagination2 from './CheckoutPagination2';
import CheckoutBarChart from './CheckoutBarChart';
import CatalogHeatmap from '../catalog/CatalogHeatmap';
...
export default function CheckoutInput({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutInputSchema.safeParse({ value: val });
