...
import CheckoutTextArea1 from './CheckoutTextArea1';
import styles from './CheckoutStepper1.module.css';
...
interface CheckoutStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutStepper1">
      {activeItem && (
