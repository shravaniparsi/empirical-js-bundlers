...
import CheckoutPaginated1 from './CheckoutPaginated1';
import CheckoutAlert1 from './CheckoutAlert1';
import CheckoutLoader1 from './CheckoutLoader1';
import styles from './CheckoutTimePicker1.module.css';


interface CheckoutTimePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutTimePicker1({
  label,
  name,
