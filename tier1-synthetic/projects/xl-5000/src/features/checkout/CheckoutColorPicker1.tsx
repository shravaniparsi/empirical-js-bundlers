...
import styles from './CheckoutColorPicker1.module.css';


interface CheckoutColorPicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutColorPicker1({
  label,
  name,
