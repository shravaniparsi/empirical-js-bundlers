...
import CheckoutResponsive1 from './CheckoutResponsive1';
import CheckoutFeed1 from './CheckoutFeed1';
import styles from './CheckoutChip1.module.css';

interface CheckoutChip1Item {
  title: string;
  status: string;
  description: string;
  createdAt: Date;
...
interface CheckoutChip1Props {
  items?: CheckoutChip1Item[];
...
export default function CheckoutChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
