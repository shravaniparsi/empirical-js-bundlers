...
import CheckoutLineChart from './CheckoutLineChart';
import styles from './CheckoutColorPicker2.module.css';


interface CheckoutColorPicker2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutColorPicker2({
  label,
  name,
