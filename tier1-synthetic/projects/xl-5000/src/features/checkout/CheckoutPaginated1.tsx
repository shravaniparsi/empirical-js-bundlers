...
import CheckoutStepper1 from './CheckoutStepper1';
import CheckoutConfirm from './CheckoutConfirm';
import CheckoutProgress2 from './CheckoutProgress2';
import PaymentsSidebar from '../payments/PaymentsSidebar';
import ProfileNavBar1 from '../profile/ProfileNavBar1';
import styles from './CheckoutPaginated1.module.css';
...
interface CheckoutPaginated1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutPaginated1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
