...
import SearchAccordion1 from '../search/SearchAccordion1';
import FormsColorPicker from '../forms/FormsColorPicker';
import styles from './CheckoutCached.module.css';
...
interface CheckoutCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
