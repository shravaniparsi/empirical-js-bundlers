...
import CheckoutScatter1 from './CheckoutScatter1';
import styles from './CheckoutTextArea1.module.css';


interface CheckoutTextArea1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutTextArea1({
  label,
  name,
