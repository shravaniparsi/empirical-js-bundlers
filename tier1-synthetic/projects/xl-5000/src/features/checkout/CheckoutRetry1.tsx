...
import styles from './CheckoutRetry1.module.css';
...
interface CheckoutRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
