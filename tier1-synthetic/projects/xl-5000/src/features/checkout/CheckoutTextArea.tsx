...
import CheckoutRetry1 from './CheckoutRetry1';
import CheckoutResponsive1 from './CheckoutResponsive1';
import styles from './CheckoutTextArea.module.css';

const CheckoutTextAreaSchema = z.object({
...
export default function CheckoutTextArea({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutTextAreaSchema.safeParse({ value: val });
