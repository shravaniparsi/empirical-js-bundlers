...
import styles from './CheckoutSummary1.module.css';

interface CheckoutSummary1Item {
  status: string;
  priority: number;
  updatedAt: Date;
  createdAt: Date;
...
interface CheckoutSummary1Props {
  items?: CheckoutSummary1Item[];
...
export default function CheckoutSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CheckoutSummary1Props) {
