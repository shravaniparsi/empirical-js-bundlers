...
import styles from './CheckoutBottomNav.module.css';
...
interface CheckoutBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutBottomNav">
      {activeItem && (
