...
import CheckoutCached from './CheckoutCached';
import CheckoutStepper from './CheckoutStepper';
import styles from './CheckoutProgress2.module.css';

interface CheckoutProgress2Item {
  priority: number;
  assignee: string;
  tags: string[];
  updatedAt: Date;
...
interface CheckoutProgress2Props {
  items?: CheckoutProgress2Item[];
...
export default function CheckoutProgress2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CheckoutProgress2Props) {
