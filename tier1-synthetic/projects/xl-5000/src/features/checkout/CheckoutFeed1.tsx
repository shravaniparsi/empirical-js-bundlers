...
import styles from './CheckoutFeed1.module.css';

interface CheckoutFeed1Item {
  title: string;
  updatedAt: Date;
  createdAt: Date;
  id: string;
...
interface CheckoutFeed1Props {
  items?: CheckoutFeed1Item[];
...
export default function CheckoutFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
