...
import styles from './CheckoutRangeSlider.module.css';


interface CheckoutRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutRangeSlider({
  label,
  name,
