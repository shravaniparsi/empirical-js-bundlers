...
import styles from './CheckoutColorPicker.module.css';


interface CheckoutColorPickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CheckoutColorPicker({
  label,
  name,
