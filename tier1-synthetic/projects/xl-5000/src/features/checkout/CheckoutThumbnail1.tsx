...
import CheckoutSpinner1 from './CheckoutSpinner1';
import styles from './CheckoutThumbnail1.module.css';

interface CheckoutThumbnail1Item {
  createdAt: Date;
  status: string;
  priority: number;
  title: string;
...
interface CheckoutThumbnail1Props {
  items?: CheckoutThumbnail1Item[];
...
export default function CheckoutThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CheckoutThumbnail1Props) {
