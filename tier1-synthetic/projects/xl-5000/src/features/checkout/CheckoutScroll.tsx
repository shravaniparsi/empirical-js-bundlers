...
import CheckoutRangeSlider from './CheckoutRangeSlider';
import CheckoutResponsive1 from './CheckoutResponsive1';
import styles from './CheckoutScroll.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CheckoutScrollProps {
...
export default function CheckoutScroll({
  children,
