...
import styles from './CheckoutPagination1.module.css';
...
interface CheckoutPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutPagination1">
      {activeItem && (
