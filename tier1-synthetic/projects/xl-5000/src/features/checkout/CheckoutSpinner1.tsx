...
import CheckoutTreeView from './CheckoutTreeView';
import styles from './CheckoutSpinner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CheckoutSpinner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CheckoutSpinner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
