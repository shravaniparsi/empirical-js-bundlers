...
import styles from './CheckoutPagination2.module.css';
...
interface CheckoutPagination2Props {
  items: NavItem[];
  activeId?: string;
...
export default function CheckoutPagination2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CheckoutPagination2">
      {activeItem && (
