...
import CheckoutThumbnail1 from './CheckoutThumbnail1';
import styles from './CheckoutHeatmap1.module.css';
...
interface CheckoutHeatmap1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CheckoutHeatmap1({
  data,
  title,
  height = 300,
  showLegend = true,
