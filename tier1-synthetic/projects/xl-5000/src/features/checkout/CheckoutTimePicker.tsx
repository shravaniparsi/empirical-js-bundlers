...
const CheckoutTimePickerSchema = z.object({
...
export default function CheckoutTimePicker({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutTimePickerSchema.safeParse({ value: val });
