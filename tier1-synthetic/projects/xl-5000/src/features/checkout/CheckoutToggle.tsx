...
import { z } from 'zod';
import CheckoutGauge from './CheckoutGauge';
import CheckoutCached from './CheckoutCached';
import styles from './CheckoutToggle.module.css';

const CheckoutToggleSchema = z.object({
...
export default function CheckoutToggle({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CheckoutToggleSchema.safeParse({ value: val });
