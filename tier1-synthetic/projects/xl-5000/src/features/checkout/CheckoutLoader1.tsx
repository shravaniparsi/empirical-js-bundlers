...
import styles from './CheckoutLoader1.module.css';
...
interface CheckoutLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CheckoutLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
