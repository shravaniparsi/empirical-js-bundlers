...
import MediaRangeSlider2 from './MediaRangeSlider2';
import MediaAvatar1 from './MediaAvatar1';
import styles from './MediaTooltip1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface MediaTooltip1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function MediaTooltip1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
