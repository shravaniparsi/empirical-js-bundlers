...
import styles from './MediaDetail2.module.css';

interface MediaDetail2Item {
  createdAt: Date;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface MediaDetail2Props {
  items?: MediaDetail2Item[];
...
export default function MediaDetail2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
