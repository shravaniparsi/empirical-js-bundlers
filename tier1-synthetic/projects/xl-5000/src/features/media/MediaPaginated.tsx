...
import styles from './MediaPaginated.module.css';
...
interface MediaPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function MediaPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
