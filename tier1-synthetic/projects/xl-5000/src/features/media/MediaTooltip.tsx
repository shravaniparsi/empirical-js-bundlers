...
import MediaAvatar4 from './MediaAvatar4';
import MediaFooter1 from './MediaFooter1';
import MediaRegistry from './MediaRegistry';
import FeedbackMgmtSummary from '../feedback-mgmt/FeedbackMgmtSummary';
import styles from './MediaTooltip.module.css';
...
export default function MediaTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
