...
import MediaAvatar2 from './MediaAvatar2';
import styles from './MediaDatePicker1.module.css';


interface MediaDatePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function MediaDatePicker1({
  label,
  name,
