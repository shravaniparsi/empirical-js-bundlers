...
import MediaErrorBoundary2 from './MediaErrorBoundary2';
import MediaPlaceholder from './MediaPlaceholder';
import MediaAutocomplete from './MediaAutocomplete';
import styles from './MediaPreview1.module.css';

interface MediaPreview1Item {
  description: string;
  assignee: string;
  tags: string[];
  updatedAt: Date;
...
interface MediaPreview1Props {
  items?: MediaPreview1Item[];
...
export default function MediaPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
