...
import styles from './MediaPagination1.module.css';
...
interface MediaPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function MediaPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="MediaPagination1">
      {activeItem && (
