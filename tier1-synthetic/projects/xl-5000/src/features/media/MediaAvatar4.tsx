...
import styles from './MediaAvatar4.module.css';

interface MediaAvatar4Item {
  title: string;
  status: string;
  tags: string[];
  id: string;
...
interface MediaAvatar4Props {
  items?: MediaAvatar4Item[];
...
export default function MediaAvatar4({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
