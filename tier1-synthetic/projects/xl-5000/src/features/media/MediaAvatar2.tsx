...
import MediaAreaChart from './MediaAreaChart';
import MediaHOC from './MediaHOC';
import SearchAutocomplete2 from '../search/SearchAutocomplete2';
import styles from './MediaAvatar2.module.css';

interface MediaAvatar2Item {
  updatedAt: Date;
  assignee: string;
  createdAt: Date;
  status: string;
...
interface MediaAvatar2Props {
  items?: MediaAvatar2Item[];
...
export default function MediaAvatar2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
