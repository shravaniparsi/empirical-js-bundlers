...
import MediaHeatmap1 from './MediaHeatmap1';
import styles from './MediaLineChart.module.css';
...
export default function MediaLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
