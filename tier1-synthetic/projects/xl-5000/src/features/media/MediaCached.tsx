...
import SupportRank from '../support/SupportRank';
import styles from './MediaCached.module.css';
...
interface MediaCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function MediaCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
