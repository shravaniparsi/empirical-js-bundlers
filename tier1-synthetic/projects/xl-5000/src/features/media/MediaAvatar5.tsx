...
import styles from './MediaAvatar5.module.css';

interface MediaAvatar5Item {
  title: string;
  createdAt: Date;
  description: string;
  id: string;
...
interface MediaAvatar5Props {
  items?: MediaAvatar5Item[];
...
export default function MediaAvatar5({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
