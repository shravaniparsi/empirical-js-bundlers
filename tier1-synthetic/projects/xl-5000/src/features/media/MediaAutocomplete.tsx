...
import MediaResponsive2 from './MediaResponsive2';
import styles from './MediaAutocomplete.module.css';

const MediaAutocompleteSchema = z.object({
...
export default function MediaAutocomplete({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = MediaAutocompleteSchema.safeParse({ value: val });
