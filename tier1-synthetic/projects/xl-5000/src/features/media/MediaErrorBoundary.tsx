...
import MediaTabs1 from './MediaTabs1';
import styles from './MediaErrorBoundary.module.css';
...
interface MediaErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function MediaErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
