...
import MediaScatter from './MediaScatter';
import MediaAreaChart from './MediaAreaChart';
import MediaSnackbar1 from './MediaSnackbar1';
import InventoryBreadcrumb from '../inventory/InventoryBreadcrumb';
import styles from './MediaTabs1.module.css';
...
export default function MediaTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="MediaTabs1">
      {activeItem && (
