...
import styles from './MediaAvatar1.module.css';

interface MediaAvatar1Item {
  priority: number;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface MediaAvatar1Props {
  items?: MediaAvatar1Item[];
...
export default function MediaAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
