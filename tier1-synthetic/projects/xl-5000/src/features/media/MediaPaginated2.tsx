...
import styles from './MediaPaginated2.module.css';
...
interface MediaPaginated2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function MediaPaginated2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
