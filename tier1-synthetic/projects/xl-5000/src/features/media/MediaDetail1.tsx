...
import styles from './MediaDetail1.module.css';

interface MediaDetail1Item {
  title: string;
  status: string;
  createdAt: Date;
  assignee: string;
...
interface MediaDetail1Props {
  items?: MediaDetail1Item[];
...
export default function MediaDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
