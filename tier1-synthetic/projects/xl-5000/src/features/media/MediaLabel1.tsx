...
import MediaGauge from './MediaGauge';
import LocalizationMenu from '../localization/LocalizationMenu';
import styles from './MediaLabel1.module.css';

interface MediaLabel1Item {
  status: string;
  title: string;
  updatedAt: Date;
  assignee: string;
...
interface MediaLabel1Props {
  items?: MediaLabel1Item[];
...
export default function MediaLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
