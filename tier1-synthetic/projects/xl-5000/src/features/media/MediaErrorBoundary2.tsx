...
import MediaGauge1 from './MediaGauge1';
import MediaComposer from './MediaComposer';
import MediaRangeSlider from './MediaRangeSlider';
import SearchDetail from '../search/SearchDetail';
import styles from './MediaErrorBoundary2.module.css';
...
interface MediaErrorBoundary2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function MediaErrorBoundary2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
