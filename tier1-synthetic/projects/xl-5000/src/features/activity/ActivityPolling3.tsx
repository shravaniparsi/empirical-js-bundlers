...
import styles from './ActivityPolling3.module.css';
...
interface ActivityPolling3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivityPolling3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
