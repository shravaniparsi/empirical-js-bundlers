...
import ActivityGrid1 from './ActivityGrid1';
import ActivityStepper from './ActivityStepper';
import styles from './ActivityContainer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ActivityContainer1Props {
...
export default function ActivityContainer1({
  children,
