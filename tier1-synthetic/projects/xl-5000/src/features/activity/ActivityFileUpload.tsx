...
import styles from './ActivityFileUpload.module.css';

const ActivityFileUploadSchema = z.object({
...
export default function ActivityFileUpload({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ActivityFileUploadSchema.safeParse({ value: val });
