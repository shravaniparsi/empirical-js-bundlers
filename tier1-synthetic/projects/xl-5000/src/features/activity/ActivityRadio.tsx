...
import styles from './ActivityRadio.module.css';

const ActivityRadioSchema = z.object({
...
export default function ActivityRadio({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ActivityRadioSchema.safeParse({ value: val });
