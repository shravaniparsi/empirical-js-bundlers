...
import ActivityPolling2 from './ActivityPolling2';
import styles from './ActivitySuspense.module.css';
...
interface ActivitySuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivitySuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
