...
import styles from './ActivityNavBar1.module.css';
...
interface ActivityNavBar1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ActivityNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ActivityNavBar1">
      {activeItem && (
