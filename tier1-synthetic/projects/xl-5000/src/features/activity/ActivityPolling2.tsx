...
import ActivitySearch1 from './ActivitySearch1';
import styles from './ActivityPolling2.module.css';
...
interface ActivityPolling2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivityPolling2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
