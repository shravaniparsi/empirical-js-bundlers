...
import styles from './ActivityBreadcrumb2.module.css';
...
interface ActivityBreadcrumb2Props {
  items: NavItem[];
  activeId?: string;
...
export default function ActivityBreadcrumb2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ActivityBreadcrumb2">
      {activeItem && (
