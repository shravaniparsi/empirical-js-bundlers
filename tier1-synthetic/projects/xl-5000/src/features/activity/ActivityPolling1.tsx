...
import ActivitySidebar1 from './ActivitySidebar1';
import styles from './ActivityPolling1.module.css';
...
interface ActivityPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivityPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
