...
import ActivityTooltip1 from './ActivityTooltip1';
import ActivityDetail from './ActivityDetail';
import styles from './ActivityRetry.module.css';
...
interface ActivityRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivityRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
