...
import ActivityAreaChart1 from './ActivityAreaChart1';
import CheckoutFunnel from '../checkout/CheckoutFunnel';
import styles from './ActivityRank3.module.css';

interface ActivityRank3Item {
  createdAt: Date;
  priority: number;
  description: string;
  updatedAt: Date;
...
interface ActivityRank3Props {
  items?: ActivityRank3Item[];
...
export default function ActivityRank3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
