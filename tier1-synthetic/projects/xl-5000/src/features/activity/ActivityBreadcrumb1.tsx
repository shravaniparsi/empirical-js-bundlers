...
import ActivitySticky1 from './ActivitySticky1';
import ActivityFeed1 from './ActivityFeed1';
import ReviewsSplit from '../reviews/ReviewsSplit';
import styles from './ActivityBreadcrumb1.module.css';
...
interface ActivityBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ActivityBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ActivityBreadcrumb1">
      {activeItem && (
