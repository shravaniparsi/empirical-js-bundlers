...
import ActivityModal1 from './ActivityModal1';
import styles from './ActivityPopover1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ActivityPopover1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ActivityPopover1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
