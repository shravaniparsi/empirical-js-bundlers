...
import ActivityPlaceholder1 from './ActivityPlaceholder1';
import styles from './ActivityPrefetch.module.css';
...
interface ActivityPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivityPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
