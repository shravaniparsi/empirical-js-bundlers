...
import styles from './ActivityPreview1.module.css';

interface ActivityPreview1Item {
  tags: string[];
  title: string;
  priority: number;
  assignee: string;
...
interface ActivityPreview1Props {
  items?: ActivityPreview1Item[];
...
export default function ActivityPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ActivityPreview1Props) {
