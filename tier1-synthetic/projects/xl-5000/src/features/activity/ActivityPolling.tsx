...
import styles from './ActivityPolling.module.css';
...
interface ActivityPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ActivityPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
