...
import styles from './ActivityRank1.module.css';

interface ActivityRank1Item {
  description: string;
  createdAt: Date;
  priority: number;
  id: string;
...
interface ActivityRank1Props {
  items?: ActivityRank1Item[];
...
export default function ActivityRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
