...
import { z } from 'zod';
import ActivityConfirm1 from './ActivityConfirm1';
import styles from './ActivityTimePicker.module.css';

const ActivityTimePickerSchema = z.object({
...
export default function ActivityTimePicker({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ActivityTimePickerSchema.safeParse({ value: val });
