...
import styles from './ActivitySummary1.module.css';

interface ActivitySummary1Item {
  tags: string[];
  createdAt: Date;
  priority: number;
  id: string;
...
interface ActivitySummary1Props {
  items?: ActivitySummary1Item[];
...
export default function ActivitySummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ActivitySummary1Props) {
