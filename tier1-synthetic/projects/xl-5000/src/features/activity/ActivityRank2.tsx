...
import ActivitySnackbar from './ActivitySnackbar';
import ActivityDivider from './ActivityDivider';
import ReportsSpinner1 from '../reports/ReportsSpinner1';
import styles from './ActivityRank2.module.css';

interface ActivityRank2Item {
  updatedAt: Date;
  description: string;
  createdAt: Date;
  tags: string[];
...
interface ActivityRank2Props {
  items?: ActivityRank2Item[];
...
export default function ActivityRank2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
