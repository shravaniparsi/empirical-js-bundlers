...
import ActivityTreeView1 from './ActivityTreeView1';
import ActivityStack1 from './ActivityStack1';
import ActivityDetail from './ActivityDetail';
import PaymentsSidebar from '../payments/PaymentsSidebar';
import AnalyticsBanner2 from '../analytics/AnalyticsBanner2';
import styles from './ActivityFeed1.module.css';

interface ActivityFeed1Item {
  title: string;
  tags: string[];
  priority: number;
  id: string;
...
interface ActivityFeed1Props {
  items?: ActivityFeed1Item[];
...
export default function ActivityFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
