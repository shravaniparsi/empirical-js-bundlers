...
import styles from './ActivityTreeView1.module.css';
...
interface ActivityTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ActivityTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ActivityTreeView1">
      {activeItem && (
