...
import styles from './ActivityLabel1.module.css';

interface ActivityLabel1Item {
  priority: number;
  updatedAt: Date;
  tags: string[];
  createdAt: Date;
...
interface ActivityLabel1Props {
  items?: ActivityLabel1Item[];
...
export default function ActivityLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
