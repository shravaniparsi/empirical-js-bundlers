...
import ActivitySearch2 from './ActivitySearch2';
import ActivityPolling from './ActivityPolling';
import styles from './ActivityBreadcrumb.module.css';
...
export default function ActivityBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ActivityBreadcrumb">
      {activeItem && (
