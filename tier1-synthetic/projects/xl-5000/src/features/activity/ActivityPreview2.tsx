...
import ActivitySuspense from './ActivitySuspense';
import ActivityTable from './ActivityTable';
import styles from './ActivityPreview2.module.css';

interface ActivityPreview2Item {
  createdAt: Date;
  description: string;
  status: string;
  id: string;
...
interface ActivityPreview2Props {
  items?: ActivityPreview2Item[];
...
export default function ActivityPreview2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ActivityPreview2Props) {
