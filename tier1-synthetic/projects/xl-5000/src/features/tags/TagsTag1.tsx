...
import TagsTimePicker from './TagsTimePicker';
import styles from './TagsTag1.module.css';

interface TagsTag1Item {
  title: string;
  priority: number;
  updatedAt: Date;
  createdAt: Date;
...
export default function TagsTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
