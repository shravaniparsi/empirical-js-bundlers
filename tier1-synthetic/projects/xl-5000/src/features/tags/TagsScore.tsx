...
import TagsSearch2 from './TagsSearch2';
import TagsPlaceholder from './TagsPlaceholder';
import styles from './TagsScore.module.css';

interface TagsScoreItem {
  updatedAt: Date;
  title: string;
  createdAt: Date;
  description: string;
...
export default function TagsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
