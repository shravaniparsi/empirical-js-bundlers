...
import styles from './TagsBottomNav1.module.css';
...
export default function TagsBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TagsBottomNav1">
      {activeItem && (
