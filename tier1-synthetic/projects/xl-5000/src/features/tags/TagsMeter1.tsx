...
import DashboardGrid2 from '../dashboard/DashboardGrid2';
import styles from './TagsMeter1.module.css';

interface TagsMeter1Item {
  status: string;
  createdAt: Date;
  priority: number;
  updatedAt: Date;
...
interface TagsMeter1Props {
  items?: TagsMeter1Item[];
...
export default function TagsMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
