...
import TagsDatePicker from './TagsDatePicker';
import styles from './TagsBottomNav.module.css';
...
export default function TagsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TagsBottomNav">
      {activeItem && (
