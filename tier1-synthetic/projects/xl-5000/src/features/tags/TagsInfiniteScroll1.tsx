...
import TagsAvatar from './TagsAvatar';
import TagsPagination from './TagsPagination';
import styles from './TagsInfiniteScroll1.module.css';
...
interface TagsInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TagsInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
