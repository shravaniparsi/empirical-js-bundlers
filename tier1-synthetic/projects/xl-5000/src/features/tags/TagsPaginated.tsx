...
import TagsGauge1 from './TagsGauge1';
import styles from './TagsPaginated.module.css';
...
interface TagsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TagsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
