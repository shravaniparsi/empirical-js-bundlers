...
import styles from './TagsPagination1.module.css';
...
interface TagsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function TagsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TagsPagination1">
      {activeItem && (
