...
import TagsBarChart1 from './TagsBarChart1';
import TagsSidebar1 from './TagsSidebar1';
import TagsSlider1 from './TagsSlider1';
import SearchStepper from '../search/SearchStepper';
import styles from './TagsSticky.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface TagsStickyProps {
...
export default function TagsSticky({
  children,
