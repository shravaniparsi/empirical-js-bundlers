...
import TagsMeter1 from './TagsMeter1';
import TagsToast from './TagsToast';
import styles from './TagsInfiniteScroll.module.css';
...
interface TagsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TagsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
