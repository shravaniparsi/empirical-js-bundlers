...
import TagsFileUpload from './TagsFileUpload';
import TagsThumbnail from './TagsThumbnail';
import styles from './TagsBreadcrumb1.module.css';
...
interface TagsBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function TagsBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TagsBreadcrumb1">
      {activeItem && (
