...
import TagsNotification from './TagsNotification';
import styles from './TagsPagination2.module.css';
...
interface TagsPagination2Props {
  items: NavItem[];
  activeId?: string;
...
export default function TagsPagination2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TagsPagination2">
      {activeItem && (
