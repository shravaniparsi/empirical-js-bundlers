...
import TagsWrapper1 from './TagsWrapper1';
import TagsLoader from './TagsLoader';
import TagsAlert from './TagsAlert';
import styles from './TagsResponsive1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface TagsResponsive1Props {
...
export default function TagsResponsive1({
  children,
