...
import { z } from 'zod';
import TagsSearch1 from './TagsSearch1';
import TagsSpacer from './TagsSpacer';
import TagsMeter1 from './TagsMeter1';
import styles from './TagsSlider.module.css';

const TagsSliderSchema = z.object({
...
export default function TagsSlider({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = TagsSliderSchema.safeParse({ value: val });
