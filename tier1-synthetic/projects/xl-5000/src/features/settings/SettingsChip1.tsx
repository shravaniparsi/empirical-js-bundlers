...
import styles from './SettingsChip1.module.css';

interface SettingsChip1Item {
  title: string;
  priority: number;
  status: string;
  tags: string[];
...
interface SettingsChip1Props {
  items?: SettingsChip1Item[];
...
export default function SettingsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
