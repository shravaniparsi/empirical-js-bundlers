...
import styles from './SettingsTreeView1.module.css';
...
interface SettingsTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function SettingsTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SettingsTreeView1">
      {activeItem && (
