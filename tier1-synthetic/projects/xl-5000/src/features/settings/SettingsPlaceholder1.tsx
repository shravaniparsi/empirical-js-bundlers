...
import SettingsAreaChart from './SettingsAreaChart';
import WorkflowsFactory from '../workflows/WorkflowsFactory';
import styles from './SettingsPlaceholder1.module.css';
...
interface SettingsPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
