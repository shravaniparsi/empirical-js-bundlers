...
import styles from './SettingsPreview1.module.css';

interface SettingsPreview1Item {
  title: string;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface SettingsPreview1Props {
  items?: SettingsPreview1Item[];
...
export default function SettingsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SettingsPreview1Props) {
