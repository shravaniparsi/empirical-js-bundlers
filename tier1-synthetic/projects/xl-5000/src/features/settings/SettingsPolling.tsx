...
import SettingsScatter2 from './SettingsScatter2';
import SettingsGrid from './SettingsGrid';
import SettingsCard3 from './SettingsCard3';
import styles from './SettingsPolling.module.css';
...
interface SettingsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
