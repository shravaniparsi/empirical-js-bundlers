...
import SettingsScroll1 from './SettingsScroll1';
import styles from './SettingsTimePicker3.module.css';


interface SettingsTimePicker3Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SettingsTimePicker3({
  label,
  name,
