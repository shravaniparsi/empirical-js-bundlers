...
import styles from './SettingsPagination1.module.css';
...
interface SettingsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function SettingsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SettingsPagination1">
      {activeItem && (
