...
import styles from './SettingsPrefetch1.module.css';
...
interface SettingsPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
