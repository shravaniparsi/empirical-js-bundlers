...
import SettingsTimePicker5 from './SettingsTimePicker5';
import SettingsAccordion1 from './SettingsAccordion1';
import SettingsScatter1 from './SettingsScatter1';
import CategoriesFooter from '../categories/CategoriesFooter';
import styles from './SettingsRank.module.css';

interface SettingsRankItem {
  assignee: string;
  tags: string[];
  priority: number;
  status: string;
...
interface SettingsRankProps {
  items?: SettingsRankItem[];
...
export default function SettingsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
