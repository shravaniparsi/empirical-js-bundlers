...
import SettingsGauge from './SettingsGauge';
import SettingsSidebar from './SettingsSidebar';
import styles from './SettingsDetail1.module.css';

interface SettingsDetail1Item {
  description: string;
  status: string;
  updatedAt: Date;
  createdAt: Date;
...
interface SettingsDetail1Props {
  items?: SettingsDetail1Item[];
...
export default function SettingsDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SettingsDetail1Props) {
