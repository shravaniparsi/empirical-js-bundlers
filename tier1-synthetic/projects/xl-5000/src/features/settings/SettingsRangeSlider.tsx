...
import { z } from 'zod';
import SettingsSplit1 from './SettingsSplit1';
import SettingsSticky from './SettingsSticky';
import SettingsAlert from './SettingsAlert';
import KnowledgeBaseHeader1 from '../knowledge-base/KnowledgeBaseHeader1';
import styles from './SettingsRangeSlider.module.css';

const SettingsRangeSliderSchema = z.object({
...
export default function SettingsRangeSlider({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = SettingsRangeSliderSchema.safeParse({ value: val });
