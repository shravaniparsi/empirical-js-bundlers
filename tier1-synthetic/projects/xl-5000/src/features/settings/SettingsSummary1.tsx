...
import styles from './SettingsSummary1.module.css';

interface SettingsSummary1Item {
  description: string;
  status: string;
  title: string;
  tags: string[];
...
interface SettingsSummary1Props {
  items?: SettingsSummary1Item[];
...
export default function SettingsSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SettingsSummary1Props) {
