...
import styles from './SettingsCached.module.css';
...
interface SettingsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
