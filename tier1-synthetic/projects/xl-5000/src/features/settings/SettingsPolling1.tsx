...
import styles from './SettingsPolling1.module.css';
...
interface SettingsPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
