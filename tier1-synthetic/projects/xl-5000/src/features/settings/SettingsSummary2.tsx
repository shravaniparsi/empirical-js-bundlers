...
import styles from './SettingsSummary2.module.css';

interface SettingsSummary2Item {
  assignee: string;
  updatedAt: Date;
  description: string;
  id: string;
...
interface SettingsSummary2Props {
  items?: SettingsSummary2Item[];
...
export default function SettingsSummary2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SettingsSummary2Props) {
