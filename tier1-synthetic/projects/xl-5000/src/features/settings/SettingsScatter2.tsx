...
import ProfileSparkline from '../profile/ProfileSparkline';
import styles from './SettingsScatter2.module.css';
...
interface SettingsScatter2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SettingsScatter2({
  data,
  title,
  height = 300,
  showLegend = true,
