...
import SettingsCached1 from './SettingsCached1';
import styles from './SettingsSparkline.module.css';
...
interface SettingsSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SettingsSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
