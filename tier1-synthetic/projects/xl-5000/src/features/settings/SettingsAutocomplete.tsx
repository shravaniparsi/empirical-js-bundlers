...
import styles from './SettingsAutocomplete.module.css';

const SettingsAutocompleteSchema = z.object({
...
export default function SettingsAutocomplete({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = SettingsAutocompleteSchema.safeParse({ value: val });
