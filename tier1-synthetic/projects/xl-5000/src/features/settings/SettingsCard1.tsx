...
import styles from './SettingsCard1.module.css';

interface SettingsCard1Item {
  title: string;
  description: string;
  tags: string[];
  assignee: string;
...
interface SettingsCard1Props {
  items?: SettingsCard1Item[];
...
export default function SettingsCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
