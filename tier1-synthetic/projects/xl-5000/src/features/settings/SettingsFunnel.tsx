...
import SettingsTimePicker3 from './SettingsTimePicker3';
import SettingsPolling1 from './SettingsPolling1';
import SchedulingRadio from '../scheduling/SchedulingRadio';
import styles from './SettingsFunnel.module.css';
...
export default function SettingsFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
