...
import styles from './SettingsCached1.module.css';
...
interface SettingsCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SettingsCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
