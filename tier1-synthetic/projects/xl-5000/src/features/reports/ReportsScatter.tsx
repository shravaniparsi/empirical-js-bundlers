...
import ReportsTextArea from './ReportsTextArea';
import TagsStack1 from '../tags/TagsStack1';
import styles from './ReportsScatter.module.css';
...
export default function ReportsScatter({
  data,
  title,
  height = 300,
  showLegend = true,
