...
import ReportsAvatar2 from './ReportsAvatar2';
import styles from './ReportsPopover2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReportsPopover2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReportsPopover2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
