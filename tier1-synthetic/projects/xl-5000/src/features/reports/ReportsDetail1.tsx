...
import ReportsGrid2 from './ReportsGrid2';
import ReportsStack1 from './ReportsStack1';
import ReportsSparkline from './ReportsSparkline';
import styles from './ReportsDetail1.module.css';

interface ReportsDetail1Item {
  tags: string[];
  title: string;
  assignee: string;
  id: string;
...
interface ReportsDetail1Props {
  items?: ReportsDetail1Item[];
...
export default function ReportsDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
