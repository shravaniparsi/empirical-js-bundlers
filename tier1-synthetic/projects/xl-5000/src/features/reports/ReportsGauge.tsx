...
import ReportsStat1 from './ReportsStat1';
import ReportsAvatar1 from './ReportsAvatar1';
import styles from './ReportsGauge.module.css';
...
export default function ReportsGauge({
  data,
  title,
  height = 300,
  showLegend = true,
