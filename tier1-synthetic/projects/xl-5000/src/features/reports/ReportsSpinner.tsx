...
import ReportsRating1 from './ReportsRating1';
import ReportsLabel from './ReportsLabel';
import styles from './ReportsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReportsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReportsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
