...
import styles from './ReportsTabs3.module.css';
...
export default function ReportsTabs3({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsTabs3">
      {activeItem && (
