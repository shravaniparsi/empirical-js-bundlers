...
import UsersFileUpload from '../users/UsersFileUpload';
import DocumentsBottomNav from '../documents/DocumentsBottomNav';
import styles from './ReportsBadge.module.css';

interface ReportsBadgeItem {
  assignee: string;
  priority: number;
  title: string;
  createdAt: Date;
...
export default function ReportsBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
