...
import ReportsTabs1 from './ReportsTabs1';
import ReportsStack1 from './ReportsStack1';
import styles from './ReportsSpinner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReportsSpinner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReportsSpinner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
