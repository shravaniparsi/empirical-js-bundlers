...
import styles from './ReportsScore.module.css';

interface ReportsScoreItem {
  updatedAt: Date;
  title: string;
  createdAt: Date;
  status: string;
...
interface ReportsScoreProps {
  items?: ReportsScoreItem[];
...
export default function ReportsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
