...
import ReportsTextArea1 from './ReportsTextArea1';
import ProductsRetry1 from '../products/ProductsRetry1';
import styles from './ReportsTable1.module.css';

interface ReportsTable1Item {
  status: string;
  tags: string[];
  updatedAt: Date;
  title: string;
...
interface ReportsTable1Props {
  items?: ReportsTable1Item[];
...
export default function ReportsTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
