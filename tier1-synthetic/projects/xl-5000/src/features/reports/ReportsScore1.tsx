...
import styles from './ReportsScore1.module.css';

interface ReportsScore1Item {
  description: string;
  tags: string[];
  priority: number;
  updatedAt: Date;
...
interface ReportsScore1Props {
  items?: ReportsScore1Item[];
...
export default function ReportsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
