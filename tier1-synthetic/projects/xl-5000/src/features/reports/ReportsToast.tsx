...
import SurveysStack from '../surveys/SurveysStack';
import styles from './ReportsToast.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReportsToastProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReportsToast({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
