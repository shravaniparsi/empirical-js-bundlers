...
import styles from './ReportsLabel1.module.css';

interface ReportsLabel1Item {
  assignee: string;
  status: string;
  description: string;
  title: string;
...
interface ReportsLabel1Props {
  items?: ReportsLabel1Item[];
...
export default function ReportsLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
