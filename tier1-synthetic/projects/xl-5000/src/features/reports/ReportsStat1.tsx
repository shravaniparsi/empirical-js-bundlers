...
import styles from './ReportsStat1.module.css';

interface ReportsStat1Item {
  priority: number;
  createdAt: Date;
  updatedAt: Date;
  id: string;
...
interface ReportsStat1Props {
  items?: ReportsStat1Item[];
...
export default function ReportsStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
