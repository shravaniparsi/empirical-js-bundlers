...
export default function ReportsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsTabs1">
      {activeItem && (
