...
import styles from './ReportsThumbnail1.module.css';

interface ReportsThumbnail1Item {
  updatedAt: Date;
  status: string;
  tags: string[];
  createdAt: Date;
...
interface ReportsThumbnail1Props {
  items?: ReportsThumbnail1Item[];
...
export default function ReportsThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReportsThumbnail1Props) {
