...
import ReportsPieChart1 from './ReportsPieChart1';
import FormsHeatmap2 from '../forms/FormsHeatmap2';
...
interface ReportsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReportsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
