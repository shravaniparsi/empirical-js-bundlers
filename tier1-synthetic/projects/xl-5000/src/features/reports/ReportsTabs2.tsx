...
import styles from './ReportsTabs2.module.css';
...
export default function ReportsTabs2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReportsTabs2">
      {activeItem && (
