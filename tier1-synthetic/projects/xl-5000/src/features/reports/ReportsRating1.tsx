...
import ReportsHeader1 from './ReportsHeader1';
import ReportsBanner2 from './ReportsBanner2';
import AuditFeed from '../audit/AuditFeed';
import styles from './ReportsRating1.module.css';


interface ReportsRating1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ReportsRating1({
  label,
  name,
