...
import styles from './ReportsThumbnail.module.css';

interface ReportsThumbnailItem {
  createdAt: Date;
  title: string;
  assignee: string;
  updatedAt: Date;
...
interface ReportsThumbnailProps {
  items?: ReportsThumbnailItem[];
...
export default function ReportsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReportsThumbnailProps) {
