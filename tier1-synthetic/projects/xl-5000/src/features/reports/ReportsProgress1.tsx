...
import ReportsRank from './ReportsRank';
import styles from './ReportsProgress1.module.css';

interface ReportsProgress1Item {
  description: string;
  updatedAt: Date;
  title: string;
  priority: number;
...
interface ReportsProgress1Props {
  items?: ReportsProgress1Item[];
...
export default function ReportsProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ReportsProgress1Props) {
