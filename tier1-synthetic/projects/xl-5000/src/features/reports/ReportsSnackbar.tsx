...
import ReportsColorPicker from './ReportsColorPicker';
import ReportsSearch from './ReportsSearch';
import ReportsProgress1 from './ReportsProgress1';
import styles from './ReportsSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReportsSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReportsSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
