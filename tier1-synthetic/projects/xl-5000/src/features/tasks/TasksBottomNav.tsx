...
import styles from './TasksBottomNav.module.css';
...
export default function TasksBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TasksBottomNav">
      {activeItem && (
