...
import TasksLabel1 from './TasksLabel1';
import TasksAreaChart from './TasksAreaChart';
import styles from './TasksScatter.module.css';
...
export default function TasksScatter({
  data,
  title,
  height = 300,
  showLegend = true,
