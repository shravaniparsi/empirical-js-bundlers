...
import styles from './TasksTimeline1.module.css';

interface TasksTimeline1Item {
  priority: number;
  title: string;
  description: string;
  id: string;
...
interface TasksTimeline1Props {
  items?: TasksTimeline1Item[];
...
export default function TasksTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
