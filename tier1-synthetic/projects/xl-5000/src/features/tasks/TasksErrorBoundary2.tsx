...
import styles from './TasksErrorBoundary2.module.css';
...
interface TasksErrorBoundary2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksErrorBoundary2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
