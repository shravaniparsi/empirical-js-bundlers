...
import TasksTimeline1 from './TasksTimeline1';
import styles from './TasksDrawer1.module.css';
...
export default function TasksDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TasksDrawer1">
      {activeItem && (
