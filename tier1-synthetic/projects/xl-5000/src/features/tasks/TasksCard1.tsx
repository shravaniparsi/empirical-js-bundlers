...
import TasksPieChart1 from './TasksPieChart1';
import TasksTable from './TasksTable';
import AuthAreaChart1 from '../auth/AuthAreaChart1';
import styles from './TasksCard1.module.css';

interface TasksCard1Item {
  title: string;
  tags: string[];
  createdAt: Date;
  description: string;
...
interface TasksCard1Props {
  items?: TasksCard1Item[];
...
export default function TasksCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
