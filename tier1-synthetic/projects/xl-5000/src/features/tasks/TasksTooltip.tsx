...
import TasksBreadcrumb1 from './TasksBreadcrumb1';
import TasksPaginated from './TasksPaginated';
import styles from './TasksTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface TasksTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function TasksTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
