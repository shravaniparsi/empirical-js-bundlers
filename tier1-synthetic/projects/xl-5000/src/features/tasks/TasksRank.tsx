...
import FaqTimeline from '../faq/FaqTimeline';
import styles from './TasksRank.module.css';

interface TasksRankItem {
  assignee: string;
  description: string;
  title: string;
  tags: string[];
...
export default function TasksRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
