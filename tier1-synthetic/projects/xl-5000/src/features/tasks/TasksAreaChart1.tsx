...
import TasksBadge3 from './TasksBadge3';
import TasksToggle from './TasksToggle';
import TasksLineChart from './TasksLineChart';
import styles from './TasksAreaChart1.module.css';
...
interface TasksAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function TasksAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
