...
import TasksRank from './TasksRank';
import styles from './TasksCached.module.css';
...
interface TasksCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
