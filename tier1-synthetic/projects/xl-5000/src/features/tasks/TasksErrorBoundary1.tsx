...
import TasksTextArea1 from './TasksTextArea1';
import CartPagination from '../cart/CartPagination';
import styles from './TasksErrorBoundary1.module.css';
...
interface TasksErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
