...
import TasksBadge2 from './TasksBadge2';
import TasksScore from './TasksScore';
import styles from './TasksNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface TasksNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
