...
import TasksPaginated from './TasksPaginated';
import TasksTable from './TasksTable';
import TasksFileUpload from './TasksFileUpload';
import styles from './TasksDatePicker1.module.css';


interface TasksDatePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function TasksDatePicker1({
  label,
  name,
