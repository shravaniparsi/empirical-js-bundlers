...
import styles from './TasksBreadcrumb2.module.css';
...
interface TasksBreadcrumb2Props {
  items: NavItem[];
  activeId?: string;
...
export default function TasksBreadcrumb2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TasksBreadcrumb2">
      {activeItem && (
