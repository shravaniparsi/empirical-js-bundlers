...
import TasksCached from './TasksCached';
import styles from './TasksPaginated1.module.css';
...
interface TasksPaginated1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksPaginated1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
