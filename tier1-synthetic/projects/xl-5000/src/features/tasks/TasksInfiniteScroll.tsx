...
import TasksDrawer1 from './TasksDrawer1';
import TasksCard1 from './TasksCard1';
import ReviewsSplit from '../reviews/ReviewsSplit';
import styles from './TasksInfiniteScroll.module.css';
...
interface TasksInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
