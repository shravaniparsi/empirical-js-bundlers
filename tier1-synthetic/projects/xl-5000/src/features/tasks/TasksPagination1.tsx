...
import styles from './TasksPagination1.module.css';
...
interface TasksPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function TasksPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TasksPagination1">
      {activeItem && (
