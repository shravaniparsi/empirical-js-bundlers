...
import styles from './TasksPaginated.module.css';
...
interface TasksPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
