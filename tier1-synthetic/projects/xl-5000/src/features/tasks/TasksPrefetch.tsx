...
import TasksResponsive from './TasksResponsive';
import styles from './TasksPrefetch.module.css';
...
interface TasksPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TasksPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
