...
import TasksBottomNav1 from './TasksBottomNav1';
import styles from './TasksStepper1.module.css';
...
export default function TasksStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TasksStepper1">
      {activeItem && (
