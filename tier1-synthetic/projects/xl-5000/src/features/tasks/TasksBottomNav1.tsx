...
import styles from './TasksBottomNav1.module.css';
...
interface TasksBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function TasksBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TasksBottomNav1">
      {activeItem && (
