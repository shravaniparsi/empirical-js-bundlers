...
import TasksTreeView1 from './TasksTreeView1';
import TasksDetail1 from './TasksDetail1';
import TasksSidebar1 from './TasksSidebar1';
import FeedbackMgmtBarChart from '../feedback-mgmt/FeedbackMgmtBarChart';
import styles from './TasksFunnel1.module.css';
...
export default function TasksFunnel1({
  data,
  title,
  height = 300,
  showLegend = true,
