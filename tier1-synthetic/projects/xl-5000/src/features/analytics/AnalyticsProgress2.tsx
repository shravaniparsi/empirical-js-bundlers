...
import styles from './AnalyticsProgress2.module.css';

interface AnalyticsProgress2Item {
  updatedAt: Date;
  tags: string[];
  assignee: string;
  priority: number;
...
interface AnalyticsProgress2Props {
  items?: AnalyticsProgress2Item[];
...
export default function AnalyticsProgress2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsProgress2Props) {
