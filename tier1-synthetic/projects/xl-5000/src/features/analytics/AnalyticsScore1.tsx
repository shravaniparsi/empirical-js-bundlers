...
import AnalyticsBadge3 from './AnalyticsBadge3';
import AnalyticsCheckbox from './AnalyticsCheckbox';
import AnalyticsResponsive from './AnalyticsResponsive';
import styles from './AnalyticsScore1.module.css';

interface AnalyticsScore1Item {
  updatedAt: Date;
  tags: string[];
  status: string;
  id: string;
...
interface AnalyticsScore1Props {
  items?: AnalyticsScore1Item[];
...
export default function AnalyticsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsScore1Props) {
