...
import styles from './AnalyticsSparkline1.module.css';
...
interface AnalyticsSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function AnalyticsSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
