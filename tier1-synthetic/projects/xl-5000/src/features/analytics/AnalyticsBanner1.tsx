...
import AnalyticsDrawer1 from './AnalyticsDrawer1';
import AnalyticsProgress1 from './AnalyticsProgress1';
import styles from './AnalyticsBanner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface AnalyticsBanner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function AnalyticsBanner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
