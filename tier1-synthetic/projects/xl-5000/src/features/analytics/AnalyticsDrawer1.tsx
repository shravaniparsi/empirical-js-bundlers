...
import styles from './AnalyticsDrawer1.module.css';
...
interface AnalyticsDrawer1Props {
  items: NavItem[];
  activeId?: string;
...
export default function AnalyticsDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AnalyticsDrawer1">
      {activeItem && (
