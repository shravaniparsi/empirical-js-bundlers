...
import AnalyticsGauge from './AnalyticsGauge';
import styles from './AnalyticsCard1.module.css';

interface AnalyticsCard1Item {
  updatedAt: Date;
  assignee: string;
  tags: string[];
  status: string;
...
interface AnalyticsCard1Props {
  items?: AnalyticsCard1Item[];
...
export default function AnalyticsCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
