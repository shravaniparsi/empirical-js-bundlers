...
import AnalyticsProvider1 from './AnalyticsProvider1';
import styles from './AnalyticsBanner2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface AnalyticsBanner2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function AnalyticsBanner2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
