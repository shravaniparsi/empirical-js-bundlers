...
import styles from './AnalyticsSummary2.module.css';

interface AnalyticsSummary2Item {
  assignee: string;
  tags: string[];
  title: string;
  status: string;
...
interface AnalyticsSummary2Props {
  items?: AnalyticsSummary2Item[];
...
export default function AnalyticsSummary2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsSummary2Props) {
