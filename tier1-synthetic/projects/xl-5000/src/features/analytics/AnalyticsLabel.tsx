...
import styles from './AnalyticsLabel.module.css';

interface AnalyticsLabelItem {
  priority: number;
  status: string;
  title: string;
  updatedAt: Date;
...
interface AnalyticsLabelProps {
  items?: AnalyticsLabelItem[];
...
export default function AnalyticsLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
