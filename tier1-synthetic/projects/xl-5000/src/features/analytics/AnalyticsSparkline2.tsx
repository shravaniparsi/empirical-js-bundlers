...
import styles from './AnalyticsSparkline2.module.css';
...
interface AnalyticsSparkline2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function AnalyticsSparkline2({
  data,
  title,
  height = 300,
  showLegend = true,
