...
import styles from './AnalyticsSparkline4.module.css';
...
interface AnalyticsSparkline4Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function AnalyticsSparkline4({
  data,
  title,
  height = 300,
  showLegend = true,
