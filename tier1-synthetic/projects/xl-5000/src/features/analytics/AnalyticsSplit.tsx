...
import AnalyticsSummary1 from './AnalyticsSummary1';
import NotificationsAreaChart from '../notifications/NotificationsAreaChart';
import styles from './AnalyticsSplit.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface AnalyticsSplitProps {
...
export default function AnalyticsSplit({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
