...
import styles from './AnalyticsPolling.module.css';
...
interface AnalyticsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
