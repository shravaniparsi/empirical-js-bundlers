...
import AnalyticsTextArea1 from './AnalyticsTextArea1';
import styles from './AnalyticsPolling1.module.css';
...
interface AnalyticsPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
