...
import styles from './AnalyticsBadge1.module.css';

interface AnalyticsBadge1Item {
  assignee: string;
  status: string;
  title: string;
  createdAt: Date;
...
interface AnalyticsBadge1Props {
  items?: AnalyticsBadge1Item[];
...
export default function AnalyticsBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsBadge1Props) {
