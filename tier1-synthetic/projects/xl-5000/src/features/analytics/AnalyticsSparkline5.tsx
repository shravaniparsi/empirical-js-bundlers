...
import styles from './AnalyticsSparkline5.module.css';
...
interface AnalyticsSparkline5Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function AnalyticsSparkline5({
  data,
  title,
  height = 300,
  showLegend = true,
