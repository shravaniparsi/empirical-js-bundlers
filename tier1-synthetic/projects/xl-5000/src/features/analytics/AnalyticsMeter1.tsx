...
import styles from './AnalyticsMeter1.module.css';

interface AnalyticsMeter1Item {
  description: string;
  title: string;
  assignee: string;
  updatedAt: Date;
...
interface AnalyticsMeter1Props {
  items?: AnalyticsMeter1Item[];
...
export default function AnalyticsMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsMeter1Props) {
