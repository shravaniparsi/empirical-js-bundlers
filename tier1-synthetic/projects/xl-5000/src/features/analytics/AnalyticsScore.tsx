...
import AnalyticsSparkline1 from './AnalyticsSparkline1';
import AnalyticsMeter2 from './AnalyticsMeter2';
import styles from './AnalyticsScore.module.css';

interface AnalyticsScoreItem {
  tags: string[];
  assignee: string;
  priority: number;
  id: string;
...
interface AnalyticsScoreProps {
  items?: AnalyticsScoreItem[];
...
export default function AnalyticsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
