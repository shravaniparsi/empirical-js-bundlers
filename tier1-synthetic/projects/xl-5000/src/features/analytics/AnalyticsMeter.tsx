...
import AnalyticsMeter2 from './AnalyticsMeter2';
import styles from './AnalyticsMeter.module.css';

interface AnalyticsMeterItem {
  priority: number;
  assignee: string;
  title: string;
  updatedAt: Date;
...
interface AnalyticsMeterProps {
  items?: AnalyticsMeterItem[];
...
export default function AnalyticsMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
