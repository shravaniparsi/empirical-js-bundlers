...
import styles from './AnalyticsSummary1.module.css';

interface AnalyticsSummary1Item {
  tags: string[];
  priority: number;
  updatedAt: Date;
  id: string;
...
interface AnalyticsSummary1Props {
  items?: AnalyticsSummary1Item[];
...
export default function AnalyticsSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsSummary1Props) {
