...
import styles from './AnalyticsMeter2.module.css';

interface AnalyticsMeter2Item {
  status: string;
  title: string;
  priority: number;
  tags: string[];
...
interface AnalyticsMeter2Props {
  items?: AnalyticsMeter2Item[];
...
export default function AnalyticsMeter2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsMeter2Props) {
