...
import styles from './AnalyticsLabel1.module.css';

interface AnalyticsLabel1Item {
  priority: number;
  createdAt: Date;
  updatedAt: Date;
  id: string;
...
interface AnalyticsLabel1Props {
  items?: AnalyticsLabel1Item[];
...
export default function AnalyticsLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsLabel1Props) {
