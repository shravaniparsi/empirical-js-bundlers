...
import AnalyticsRank from './AnalyticsRank';
import AnalyticsGauge from './AnalyticsGauge';
import styles from './AnalyticsBadge3.module.css';

interface AnalyticsBadge3Item {
  title: string;
  tags: string[];
  priority: number;
  assignee: string;
...
interface AnalyticsBadge3Props {
  items?: AnalyticsBadge3Item[];
...
export default function AnalyticsBadge3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: AnalyticsBadge3Props) {
