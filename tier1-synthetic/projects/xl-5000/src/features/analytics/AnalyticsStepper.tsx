...
import styles from './AnalyticsStepper.module.css';
...
interface AnalyticsStepperProps {
  items: NavItem[];
  activeId?: string;
...
export default function AnalyticsStepper({
  ...
  return (
    <nav className={navClasses} aria-label="AnalyticsStepper">
      {activeItem && (
