...
import AnalyticsCollapse from './AnalyticsCollapse';
import styles from './AnalyticsErrorBoundary1.module.css';
...
interface AnalyticsErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: AnalyticsErrorBoundary1Props<T>) {
