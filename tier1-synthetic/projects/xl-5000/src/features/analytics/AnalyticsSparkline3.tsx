...
import styles from './AnalyticsSparkline3.module.css';
...
interface AnalyticsSparkline3Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function AnalyticsSparkline3({
  data,
  title,
  height = 300,
  showLegend = true,
