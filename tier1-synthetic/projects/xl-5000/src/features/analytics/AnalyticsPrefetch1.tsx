...
import AnalyticsFileUpload1 from './AnalyticsFileUpload1';
import AnalyticsFileUpload from './AnalyticsFileUpload';
import AnalyticsSummary3 from './AnalyticsSummary3';
import styles from './AnalyticsPrefetch1.module.css';
...
interface AnalyticsPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
