...
import AnalyticsSelect1 from './AnalyticsSelect1';
import AnalyticsBadge1 from './AnalyticsBadge1';
import styles from './AnalyticsPrefetch.module.css';
...
interface AnalyticsPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
