...
import styles from './ApiKeysTreeView1.module.css';
...
interface ApiKeysTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ApiKeysTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysTreeView1">
      {activeItem && (
