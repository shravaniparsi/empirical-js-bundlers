...
import ApiKeysPopover from './ApiKeysPopover';
import styles from './ApiKeysTreeView.module.css';
...
interface ApiKeysTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function ApiKeysTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysTreeView">
      {activeItem && (
