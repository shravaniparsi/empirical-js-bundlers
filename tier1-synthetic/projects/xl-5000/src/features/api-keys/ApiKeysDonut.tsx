...
import ShippingBreadcrumb3 from '../shipping/ShippingBreadcrumb3';
import styles from './ApiKeysDonut.module.css';
...
export default function ApiKeysDonut({
  data,
  title,
  height = 300,
  showLegend = true,
