...
import ApiKeysTimePicker from './ApiKeysTimePicker';
import ApiKeysSnackbar from './ApiKeysSnackbar';
import styles from './ApiKeysToast1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ApiKeysToast1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ApiKeysToast1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
