...
import ApiKeysRating from './ApiKeysRating';
import ApiKeysTabs from './ApiKeysTabs';
import SurveysInput from '../surveys/SurveysInput';
import styles from './ApiKeysLink.module.css';
...
export default function ApiKeysLink({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysLink">
      {activeItem && (
