...
import styles from './ApiKeysAvatar.module.css';

interface ApiKeysAvatarItem {
  status: string;
  createdAt: Date;
  title: string;
  id: string;
...
interface ApiKeysAvatarProps {
  items?: ApiKeysAvatarItem[];
...
export default function ApiKeysAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
