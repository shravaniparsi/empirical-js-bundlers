...
import ApiKeysTimeline from './ApiKeysTimeline';
import styles from './ApiKeysBarChart1.module.css';
...
interface ApiKeysBarChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ApiKeysBarChart1({
  data,
  title,
  height = 300,
  showLegend = true,
