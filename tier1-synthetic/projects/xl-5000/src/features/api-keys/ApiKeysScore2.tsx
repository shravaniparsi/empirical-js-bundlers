...
import styles from './ApiKeysScore2.module.css';

interface ApiKeysScore2Item {
  description: string;
  title: string;
  status: string;
  updatedAt: Date;
...
interface ApiKeysScore2Props {
  items?: ApiKeysScore2Item[];
...
export default function ApiKeysScore2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
