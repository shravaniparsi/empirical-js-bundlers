...
import styles from './ApiKeysBottomNav1.module.css';
...
interface ApiKeysBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ApiKeysBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysBottomNav1">
      {activeItem && (
