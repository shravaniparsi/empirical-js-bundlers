...
import styles from './ApiKeysColorPicker1.module.css';


interface ApiKeysColorPicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ApiKeysColorPicker1({
  label,
  name,
