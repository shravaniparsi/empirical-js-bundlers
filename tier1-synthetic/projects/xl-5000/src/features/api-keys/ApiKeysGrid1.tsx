...
import styles from './ApiKeysGrid1.module.css';

interface ApiKeysGrid1Item {
  status: string;
  assignee: string;
  createdAt: Date;
  title: string;
...
interface ApiKeysGrid1Props {
  items?: ApiKeysGrid1Item[];
...
export default function ApiKeysGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
