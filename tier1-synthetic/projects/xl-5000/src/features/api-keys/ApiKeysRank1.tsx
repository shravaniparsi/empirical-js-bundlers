...
import styles from './ApiKeysRank1.module.css';

interface ApiKeysRank1Item {
  assignee: string;
  status: string;
  updatedAt: Date;
  tags: string[];
...
interface ApiKeysRank1Props {
  items?: ApiKeysRank1Item[];
...
export default function ApiKeysRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
