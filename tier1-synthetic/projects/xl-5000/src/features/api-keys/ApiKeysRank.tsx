...
import ApiKeysToast from './ApiKeysToast';
import styles from './ApiKeysRank.module.css';

interface ApiKeysRankItem {
  tags: string[];
  assignee: string;
  updatedAt: Date;
  title: string;
...
interface ApiKeysRankProps {
  items?: ApiKeysRankItem[];
...
export default function ApiKeysRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
