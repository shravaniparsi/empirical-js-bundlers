...
import ApiKeysBadge from './ApiKeysBadge';
import ApiKeysRank from './ApiKeysRank';
import ApiKeysSearch1 from './ApiKeysSearch1';
import AuthList from '../auth/AuthList';
import styles from './ApiKeysNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ApiKeysNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ApiKeysNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
