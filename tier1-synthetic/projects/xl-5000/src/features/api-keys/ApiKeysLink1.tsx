...
import ApiKeysLabel1 from './ApiKeysLabel1';
import RolesProgress1 from '../roles/RolesProgress1';
import styles from './ApiKeysLink1.module.css';
...
export default function ApiKeysLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysLink1">
      {activeItem && (
