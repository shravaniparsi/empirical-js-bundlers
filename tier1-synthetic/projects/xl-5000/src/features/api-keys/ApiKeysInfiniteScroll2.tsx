...
import ApiKeysScore2 from './ApiKeysScore2';
import ApiKeysTimePicker2 from './ApiKeysTimePicker2';
import CommentsResponsive1 from '../comments/CommentsResponsive1';
import ShippingSpinner from '../shipping/ShippingSpinner';
import styles from './ApiKeysInfiniteScroll2.module.css';
...
interface ApiKeysInfiniteScroll2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ApiKeysInfiniteScroll2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
