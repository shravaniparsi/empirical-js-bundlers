...
import styles from './ApiKeysBadge.module.css';

interface ApiKeysBadgeItem {
  status: string;
  tags: string[];
  description: string;
  updatedAt: Date;
...
interface ApiKeysBadgeProps {
  items?: ApiKeysBadgeItem[];
...
export default function ApiKeysBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
