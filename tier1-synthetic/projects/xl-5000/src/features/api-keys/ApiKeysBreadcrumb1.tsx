...
import styles from './ApiKeysBreadcrumb1.module.css';
...
interface ApiKeysBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ApiKeysBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ApiKeysBreadcrumb1">
      {activeItem && (
