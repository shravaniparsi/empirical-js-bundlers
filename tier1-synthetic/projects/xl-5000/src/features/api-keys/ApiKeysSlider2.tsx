...
import ApiKeysDonut1 from './ApiKeysDonut1';
import ApiKeysSearch from './ApiKeysSearch';
import ApiKeysTimePicker1 from './ApiKeysTimePicker1';
import styles from './ApiKeysSlider2.module.css';


interface ApiKeysSlider2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ApiKeysSlider2({
  label,
  name,
