...
import styles from './ApiKeysRank2.module.css';

interface ApiKeysRank2Item {
  updatedAt: Date;
  description: string;
  tags: string[];
  createdAt: Date;
...
interface ApiKeysRank2Props {
  items?: ApiKeysRank2Item[];
...
export default function ApiKeysRank2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
