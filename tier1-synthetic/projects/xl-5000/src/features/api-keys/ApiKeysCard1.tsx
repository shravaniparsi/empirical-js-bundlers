...
import styles from './ApiKeysCard1.module.css';

interface ApiKeysCard1Item {
  priority: number;
  assignee: string;
  tags: string[];
  status: string;
...
interface ApiKeysCard1Props {
  items?: ApiKeysCard1Item[];
...
export default function ApiKeysCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
