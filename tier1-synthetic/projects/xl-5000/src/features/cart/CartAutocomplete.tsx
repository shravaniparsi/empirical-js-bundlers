...
import CartRadio2 from './CartRadio2';
import styles from './CartAutocomplete.module.css';


interface CartAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CartAutocomplete({
  label,
  name,
