...
import CartHeatmap3 from './CartHeatmap3';
import UsersHOC from '../users/UsersHOC';
import styles from './CartTreeView.module.css';
...
export default function CartTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CartTreeView">
      {activeItem && (
