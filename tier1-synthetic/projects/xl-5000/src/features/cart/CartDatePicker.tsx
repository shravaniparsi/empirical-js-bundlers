...
import { z } from 'zod';
import CartConfirm1 from './CartConfirm1';
import styles from './CartDatePicker.module.css';

const CartDatePickerSchema = z.object({
...
export default function CartDatePicker({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CartDatePickerSchema.safeParse({ value: val });
