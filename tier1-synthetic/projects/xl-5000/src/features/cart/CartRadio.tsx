...
import styles from './CartRadio.module.css';

const CartRadioSchema = z.object({
...
export default function CartRadio({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CartRadioSchema.safeParse({ value: val });
