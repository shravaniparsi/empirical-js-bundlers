...
import CartGauge1 from './CartGauge1';
import CartSticky1 from './CartSticky1';
import styles from './CartHeatmap3.module.css';
...
export default function CartHeatmap3({
  data,
  title,
  height = 300,
  showLegend = true,
