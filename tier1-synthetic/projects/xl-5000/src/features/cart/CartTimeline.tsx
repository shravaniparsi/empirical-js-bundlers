...
import CartFileUpload1 from './CartFileUpload1';
import CartBottomNav2 from './CartBottomNav2';
import CartLink1 from './CartLink1';
import styles from './CartTimeline.module.css';

interface CartTimelineItem {
  assignee: string;
  title: string;
  updatedAt: Date;
  priority: number;
