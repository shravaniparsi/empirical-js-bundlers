...
import styles from './CartThumbnail1.module.css';

interface CartThumbnail1Item {
  description: string;
  tags: string[];
  priority: number;
  status: string;
...
interface CartThumbnail1Props {
  items?: CartThumbnail1Item[];
...
export default function CartThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
