...
import CartSearch1 from './CartSearch1';
import CartStack from './CartStack';
import styles from './CartSuspense.module.css';
...
interface CartSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CartSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
