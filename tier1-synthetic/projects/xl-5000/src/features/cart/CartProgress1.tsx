...
import styles from './CartProgress1.module.css';

interface CartProgress1Item {
  priority: number;
  updatedAt: Date;
  status: string;
  tags: string[];
...
interface CartProgress1Props {
  items?: CartProgress1Item[];
...
export default function CartProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
