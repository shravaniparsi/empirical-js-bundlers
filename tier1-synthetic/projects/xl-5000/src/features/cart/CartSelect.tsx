...
import { z } from 'zod';
import CartStack1 from './CartStack1';
import CartScatter from './CartScatter';
import CartFeed1 from './CartFeed1';
import styles from './CartSelect.module.css';

const CartSelectSchema = z.object({
...
export default function CartSelect({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CartSelectSchema.safeParse({ value: val });
