...
import CartHeatmap1 from './CartHeatmap1';
import CartSpinner from './CartSpinner';
import styles from './CartDetail1.module.css';

interface CartDetail1Item {
  tags: string[];
  priority: number;
  status: string;
  updatedAt: Date;
...
interface CartDetail1Props {
  items?: CartDetail1Item[];
...
export default function CartDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
