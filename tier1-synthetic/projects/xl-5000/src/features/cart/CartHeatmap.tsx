...
import CartAreaChart from './CartAreaChart';
import CartSuspense from './CartSuspense';
import DashboardSidebar from '../dashboard/DashboardSidebar';
import styles from './CartHeatmap.module.css';
...
export default function CartHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
