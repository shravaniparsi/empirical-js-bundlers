...
import CartPieChart from './CartPieChart';
import CartRetry1 from './CartRetry1';
import CartStepper from './CartStepper';
import styles from './CartBottomNav1.module.css';
...
export default function CartBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CartBottomNav1">
      {activeItem && (
