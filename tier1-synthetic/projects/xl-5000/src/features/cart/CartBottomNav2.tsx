...
import styles from './CartBottomNav2.module.css';
...
export default function CartBottomNav2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CartBottomNav2">
      {activeItem && (
