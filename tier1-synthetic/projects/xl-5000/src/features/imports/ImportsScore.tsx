...
import ImportsDivider from './ImportsDivider';
...
import styles from './ImportsScore.module.css';

interface ImportsScoreItem {
  status: string;
  title: string;
  assignee: string;
  tags: string[];
...
interface ImportsScoreProps {
  items?: ImportsScoreItem[];
...
export default function ImportsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
