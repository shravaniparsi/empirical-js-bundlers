...
import ImportsSplit from './ImportsSplit';
import ImportsTabs from './ImportsTabs';
import ShippingTag1 from '../shipping/ShippingTag1';
import styles from './ImportsDetail1.module.css';

interface ImportsDetail1Item {
  status: string;
  description: string;
  updatedAt: Date;
  tags: string[];
...
interface ImportsDetail1Props {
  items?: ImportsDetail1Item[];
...
export default function ImportsDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
