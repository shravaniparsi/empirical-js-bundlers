...
import ImportsAdapter from './ImportsAdapter';
import FormsColorPicker from '../forms/FormsColorPicker';
import styles from './ImportsRank.module.css';

interface ImportsRankItem {
  assignee: string;
  description: string;
  priority: number;
  id: string;
...
interface ImportsRankProps {
  items?: ImportsRankItem[];
...
export default function ImportsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
