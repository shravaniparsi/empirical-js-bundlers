...
import styles from './ImportsAvatar1.module.css';

interface ImportsAvatar1Item {
  priority: number;
  updatedAt: Date;
  createdAt: Date;
  status: string;
...
interface ImportsAvatar1Props {
  items?: ImportsAvatar1Item[];
...
export default function ImportsAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
