...
import ImportsConfirm from './ImportsConfirm';
import ShippingTag1 from '../shipping/ShippingTag1';
import styles from './ImportsScatter1.module.css';
...
interface ImportsScatter1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ImportsScatter1({
  data,
  title,
  height = 300,
  showLegend = true,
