...
import ImportsColorPicker2 from './ImportsColorPicker2';
import ImportsInput from './ImportsInput';
import styles from './ImportsPieChart.module.css';
...
interface ImportsPieChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ImportsPieChart({
  data,
  title,
  height = 300,
  showLegend = true,
