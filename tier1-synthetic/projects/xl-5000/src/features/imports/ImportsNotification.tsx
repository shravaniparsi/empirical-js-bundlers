...
import styles from './ImportsNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ImportsNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ImportsNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
