...
import ImportsAlert from './ImportsAlert';
import ImportsPaginated from './ImportsPaginated';
import CommentsGrid2 from '../comments/CommentsGrid2';
import CatalogPaginated from '../catalog/CatalogPaginated';
import styles from './ImportsPreview.module.css';

interface ImportsPreviewItem {
  tags: string[];
  assignee: string;
  status: string;
  title: string;
...
interface ImportsPreviewProps {
  items?: ImportsPreviewItem[];
...
export default function ImportsPreview({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
