...
export default function ImportsNavBar({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ImportsNavBar">
      {activeItem && (
