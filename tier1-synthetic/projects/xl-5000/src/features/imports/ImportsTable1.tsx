...
import ImportsDatePicker1 from './ImportsDatePicker1';
import ImportsColorPicker from './ImportsColorPicker';
import ReviewsSidebar from '../reviews/ReviewsSidebar';
import styles from './ImportsTable1.module.css';

interface ImportsTable1Item {
  tags: string[];
  priority: number;
  updatedAt: Date;
  status: string;
...
interface ImportsTable1Props {
  items?: ImportsTable1Item[];
...
export default function ImportsTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
