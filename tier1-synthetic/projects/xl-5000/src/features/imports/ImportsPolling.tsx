...
import styles from './ImportsPolling.module.css';
...
interface ImportsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ImportsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
