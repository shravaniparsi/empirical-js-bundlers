...
import styles from './ImportsProgress.module.css';

interface ImportsProgressItem {
  description: string;
  tags: string[];
  updatedAt: Date;
  assignee: string;
...
interface ImportsProgressProps {
  items?: ImportsProgressItem[];
...
export default function ImportsProgress({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ImportsProgressProps) {
