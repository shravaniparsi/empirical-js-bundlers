...
import ImportsAccordion from './ImportsAccordion';
import styles from './ImportsSkeleton1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ImportsSkeleton1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ImportsSkeleton1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
