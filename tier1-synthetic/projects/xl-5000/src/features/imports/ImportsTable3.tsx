...
import ImportsResponsive1 from './ImportsResponsive1';
import ImportsBreadcrumb from './ImportsBreadcrumb';
import styles from './ImportsTable3.module.css';

interface ImportsTable3Item {
  createdAt: Date;
  tags: string[];
  description: string;
  updatedAt: Date;
...
interface ImportsTable3Props {
  items?: ImportsTable3Item[];
...
export default function ImportsTable3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
