...
import SearchGrid4 from '../search/SearchGrid4';
import styles from './ImportsConfirm2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ImportsConfirm2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ImportsConfirm2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
