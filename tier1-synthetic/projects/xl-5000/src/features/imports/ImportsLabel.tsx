...
import ImportsToast from './ImportsToast';
import styles from './ImportsLabel.module.css';

interface ImportsLabelItem {
  createdAt: Date;
  title: string;
  tags: string[];
  assignee: string;
...
interface ImportsLabelProps {
  items?: ImportsLabelItem[];
...
export default function ImportsLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
