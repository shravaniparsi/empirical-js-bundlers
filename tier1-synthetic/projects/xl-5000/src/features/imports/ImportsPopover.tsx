...
import ImportsProvider1 from './ImportsProvider1';
import ImportsRating1 from './ImportsRating1';
import styles from './ImportsPopover.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ImportsPopoverProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ImportsPopover({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
