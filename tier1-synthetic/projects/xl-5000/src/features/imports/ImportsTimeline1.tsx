...
import OrdersScore2 from '../orders/OrdersScore2';
import WorkflowsSuspense from '../workflows/WorkflowsSuspense';
import styles from './ImportsTimeline1.module.css';

interface ImportsTimeline1Item {
  createdAt: Date;
  title: string;
  assignee: string;
  tags: string[];
...
interface ImportsTimeline1Props {
  items?: ImportsTimeline1Item[];
...
export default function ImportsTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ImportsTimeline1Props) {
