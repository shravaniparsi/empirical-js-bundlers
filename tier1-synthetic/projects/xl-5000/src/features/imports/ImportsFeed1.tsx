...
import ImportsScatter1 from './ImportsScatter1';
import ImportsModal from './ImportsModal';
import styles from './ImportsFeed1.module.css';

interface ImportsFeed1Item {
  createdAt: Date;
  title: string;
  assignee: string;
  updatedAt: Date;
...
interface ImportsFeed1Props {
  items?: ImportsFeed1Item[];
...
export default function ImportsFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
