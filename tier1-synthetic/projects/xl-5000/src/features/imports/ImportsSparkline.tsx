...
import ImportsRangeSlider from './ImportsRangeSlider';
import ApiKeysColorPicker1 from '../api-keys/ApiKeysColorPicker1';
import styles from './ImportsSparkline.module.css';
...
interface ImportsSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ImportsSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
