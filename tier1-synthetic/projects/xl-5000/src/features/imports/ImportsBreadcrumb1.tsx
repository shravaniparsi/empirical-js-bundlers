...
import styles from './ImportsBreadcrumb1.module.css';
...
interface ImportsBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ImportsBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ImportsBreadcrumb1">
      {activeItem && (
