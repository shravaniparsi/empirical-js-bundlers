...
import ImportsPreview1 from './ImportsPreview1';
import TasksPaginated1 from '../tasks/TasksPaginated1';
import styles from './ImportsAvatar.module.css';

interface ImportsAvatarItem {
  tags: string[];
  status: string;
  title: string;
  id: string;
...
interface ImportsAvatarProps {
  items?: ImportsAvatarItem[];
...
export default function ImportsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
