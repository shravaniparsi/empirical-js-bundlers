...
import ImportsLabel from './ImportsLabel';
import styles from './ImportsLoader.module.css';
...
interface ImportsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ImportsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
