...
import ImportsPlaceholder1 from './ImportsPlaceholder1';
import ImportsConfirm from './ImportsConfirm';
import styles from './ImportsFunnel.module.css';
...
export default function ImportsFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
