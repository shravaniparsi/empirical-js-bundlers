...
import ImportsSlider from './ImportsSlider';
import ImportsAreaChart from './ImportsAreaChart';
import ImportsPreview1 from './ImportsPreview1';
import styles from './ImportsGauge.module.css';
...
export default function ImportsGauge({
  data,
  title,
  height = 300,
  showLegend = true,
