...
import styles from './ImportsBreadcrumb.module.css';
...
interface ImportsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function ImportsBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ImportsBreadcrumb">
      {activeItem && (
