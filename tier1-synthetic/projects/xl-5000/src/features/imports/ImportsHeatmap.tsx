...
import ImportsCollapse from './ImportsCollapse';
import ImportsScatter from './ImportsScatter';
import ImportsToggle from './ImportsToggle';
import SchedulingRetry1 from '../scheduling/SchedulingRetry1';
import styles from './ImportsHeatmap.module.css';
...
export default function ImportsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
