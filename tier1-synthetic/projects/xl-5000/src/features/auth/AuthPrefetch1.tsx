...
import PermissionsSticky from '../permissions/PermissionsSticky';
import styles from './AuthPrefetch1.module.css';
...
interface AuthPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuthPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
