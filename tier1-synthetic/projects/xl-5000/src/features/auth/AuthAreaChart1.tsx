...
import AuthFileUpload from './AuthFileUpload';
import AuthInput1 from './AuthInput1';
import AuthTreeView1 from './AuthTreeView1';
import BillingDetail3 from '../billing/BillingDetail3';
import styles from './AuthAreaChart1.module.css';
...
export default function AuthAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
