...
import styles from './AuthTreeView1.module.css';
...
export default function AuthTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuthTreeView1">
      {activeItem && (
