...
import styles from './AuthTreeView.module.css';
...
export default function AuthTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuthTreeView">
      {activeItem && (
