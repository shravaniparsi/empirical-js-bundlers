...
import AuthChip2 from './AuthChip2';
import AuthInput from './AuthInput';
import AuthPaginated from './AuthPaginated';
import LocalizationSnackbar1 from '../localization/LocalizationSnackbar1';
import styles from './AuthTimePicker.module.css';


interface AuthTimePickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function AuthTimePicker({
  label,
  name,
