...
import AuthPanel1 from './AuthPanel1';
import ThemesSticky1 from '../themes/ThemesSticky1';
import styles from './AuthStepper1.module.css';
...
export default function AuthStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuthStepper1">
      {activeItem && (
