...
import styles from './AuthBottomNav2.module.css';
...
export default function AuthBottomNav2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuthBottomNav2">
      {activeItem && (
