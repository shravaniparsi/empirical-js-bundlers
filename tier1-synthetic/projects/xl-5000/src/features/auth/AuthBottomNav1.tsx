...
import AuthBarChart from './AuthBarChart';
import AuthCard from './AuthCard';
import FeedbackMgmtDrawer1 from '../feedback-mgmt/FeedbackMgmtDrawer1';
import styles from './AuthBottomNav1.module.css';
...
export default function AuthBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AuthBottomNav1">
      {activeItem && (
