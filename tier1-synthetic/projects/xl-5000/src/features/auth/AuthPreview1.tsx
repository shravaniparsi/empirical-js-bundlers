...
import styles from './AuthPreview1.module.css';

interface AuthPreview1Item {
  createdAt: Date;
  title: string;
  description: string;
  assignee: string;
...
interface AuthPreview1Props {
  items?: AuthPreview1Item[];
...
export default function AuthPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
