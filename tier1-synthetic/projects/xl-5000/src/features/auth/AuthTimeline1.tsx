...
import styles from './AuthTimeline1.module.css';

interface AuthTimeline1Item {
  createdAt: Date;
  status: string;
  title: string;
  priority: number;
...
interface AuthTimeline1Props {
  items?: AuthTimeline1Item[];
...
export default function AuthTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
