...
import styles from './UsersTimeline1.module.css';

interface UsersTimeline1Item {
  description: string;
  title: string;
  assignee: string;
  updatedAt: Date;
...
interface UsersTimeline1Props {
  items?: UsersTimeline1Item[];
...
export default function UsersTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
