...
import UsersGauge from './UsersGauge';
import ApiKeysRating from '../api-keys/ApiKeysRating';
import styles from './UsersNavBar2.module.css';
...
export default function UsersNavBar2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersNavBar2">
      {activeItem && (
