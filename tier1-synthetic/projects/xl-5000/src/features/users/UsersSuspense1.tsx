...
import styles from './UsersSuspense1.module.css';
...
interface UsersSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function UsersSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
