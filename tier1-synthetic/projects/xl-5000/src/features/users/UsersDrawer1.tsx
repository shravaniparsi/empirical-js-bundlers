...
import styles from './UsersDrawer1.module.css';
...
export default function UsersDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersDrawer1">
      {activeItem && (
