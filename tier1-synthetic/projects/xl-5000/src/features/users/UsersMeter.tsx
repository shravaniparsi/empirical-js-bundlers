...
import PermissionsDonut1 from '../permissions/PermissionsDonut1';
import styles from './UsersMeter.module.css';

interface UsersMeterItem {
  priority: number;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface UsersMeterProps {
  items?: UsersMeterItem[];
...
export default function UsersMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
