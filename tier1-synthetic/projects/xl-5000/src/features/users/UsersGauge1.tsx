...
import UsersSuspense1 from './UsersSuspense1';
import ExportsPolling from '../exports/ExportsPolling';
import styles from './UsersGauge1.module.css';
...
export default function UsersGauge1({
  data,
  title,
  height = 300,
  showLegend = true,
