...
import UsersRetry from './UsersRetry';
import styles from './UsersSuspense.module.css';
...
interface UsersSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function UsersSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
