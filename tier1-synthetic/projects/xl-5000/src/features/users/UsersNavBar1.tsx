...
import UsersInput1 from './UsersInput1';
import UsersSticky from './UsersSticky';
import UsersNavBar from './UsersNavBar';
import styles from './UsersNavBar1.module.css';
...
export default function UsersNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="UsersNavBar1">
      {activeItem && (
