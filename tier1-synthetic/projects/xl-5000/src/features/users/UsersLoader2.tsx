...
import UsersFileUpload2 from './UsersFileUpload2';
import styles from './UsersLoader2.module.css';
...
interface UsersLoader2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function UsersLoader2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
