...
import styles from './UsersPreview2.module.css';

interface UsersPreview2Item {
  status: string;
  tags: string[];
  updatedAt: Date;
  id: string;
...
interface UsersPreview2Props {
  items?: UsersPreview2Item[];
...
export default function UsersPreview2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
