...
import UsersScatter2 from './UsersScatter2';
import UsersWrapper from './UsersWrapper';
import UsersTimeline1 from './UsersTimeline1';
import KnowledgeBaseLink1 from '../knowledge-base/KnowledgeBaseLink1';
import UsersDonut2 from './UsersDonut2';
import styles from './UsersPreview1.module.css';

interface UsersPreview1Item {
  priority: number;
  updatedAt: Date;
  createdAt: Date;
  tags: string[];
...
interface UsersPreview1Props {
  items?: UsersPreview1Item[];
...
export default function UsersPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['priority', 'updatedAt', 'createdAt']);
