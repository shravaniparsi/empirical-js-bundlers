...
import UsersProgress1 from './UsersProgress1';
import UsersStack1 from './UsersStack1';
import styles from './UsersTimeline.module.css';

interface UsersTimelineItem {
  createdAt: Date;
  title: string;
  updatedAt: Date;
  tags: string[];
...
export default function UsersTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
