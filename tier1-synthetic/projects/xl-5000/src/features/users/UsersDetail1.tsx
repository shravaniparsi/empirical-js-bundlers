...
import styles from './UsersDetail1.module.css';

interface UsersDetail1Item {
  priority: number;
  createdAt: Date;
  description: string;
  status: string;
...
interface UsersDetail1Props {
  items?: UsersDetail1Item[];
...
export default function UsersDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
