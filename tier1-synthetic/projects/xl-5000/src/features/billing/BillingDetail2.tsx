...
import BillingCollapse2 from './BillingCollapse2';
import styles from './BillingDetail2.module.css';

interface BillingDetail2Item {
  status: string;
  priority: number;
  assignee: string;
  id: string;
...
interface BillingDetail2Props {
  items?: BillingDetail2Item[];
...
export default function BillingDetail2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
