...
import styles from './BillingInfiniteScroll2.module.css';
...
interface BillingInfiniteScroll2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingInfiniteScroll2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
