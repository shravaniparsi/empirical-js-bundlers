...
import BillingRegistry1 from './BillingRegistry1';
import styles from './BillingCached.module.css';
...
interface BillingCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
