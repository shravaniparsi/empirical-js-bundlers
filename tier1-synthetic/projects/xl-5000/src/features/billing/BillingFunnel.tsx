...
import OnboardingBreadcrumb from '../onboarding/OnboardingBreadcrumb';
import styles from './BillingFunnel.module.css';
...
export default function BillingFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
