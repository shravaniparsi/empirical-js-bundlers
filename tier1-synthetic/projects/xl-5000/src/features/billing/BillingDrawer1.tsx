...
import styles from './BillingDrawer1.module.css';
...
export default function BillingDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="BillingDrawer1">
      {activeItem && (
