...
import BillingStepper1 from './BillingStepper1';
import BillingFunnel from './BillingFunnel';
import BillingContext from './BillingContext';
import WorkflowsFactory from '../workflows/WorkflowsFactory';
import styles from './BillingSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface BillingSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function BillingSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
