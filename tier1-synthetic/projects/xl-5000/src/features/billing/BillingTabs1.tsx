...
import BillingThumbnail2 from './BillingThumbnail2';
import styles from './BillingTabs1.module.css';
...
export default function BillingTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="BillingTabs1">
      {activeItem && (
