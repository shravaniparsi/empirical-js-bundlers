...
import BillingCheckbox1 from './BillingCheckbox1';
import styles from './BillingInfiniteScroll.module.css';
...
interface BillingInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
