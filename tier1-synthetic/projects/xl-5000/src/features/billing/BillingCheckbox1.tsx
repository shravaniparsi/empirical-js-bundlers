...
import BillingRangeSlider1 from './BillingRangeSlider1';
import styles from './BillingCheckbox1.module.css';


interface BillingCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function BillingCheckbox1({
  label,
  name,
