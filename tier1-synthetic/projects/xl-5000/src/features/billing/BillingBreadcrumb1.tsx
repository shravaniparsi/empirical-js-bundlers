...
import styles from './BillingBreadcrumb1.module.css';
...
interface BillingBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function BillingBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="BillingBreadcrumb1">
      {activeItem && (
