...
import BillingSpacer from './BillingSpacer';
import BillingProvider from './BillingProvider';
import BillingSplit from './BillingSplit';
import InventoryProgress2 from '../inventory/InventoryProgress2';
import styles from './BillingPreview1.module.css';

interface BillingPreview1Item {
  createdAt: Date;
  description: string;
  title: string;
  updatedAt: Date;
...
interface BillingPreview1Props {
  items?: BillingPreview1Item[];
...
export default function BillingPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: BillingPreview1Props) {
