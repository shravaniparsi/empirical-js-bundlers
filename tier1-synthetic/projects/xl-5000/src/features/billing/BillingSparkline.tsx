...
import BillingSparkline1 from './BillingSparkline1';
import styles from './BillingSparkline.module.css';
...
interface BillingSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function BillingSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
