...
import styles from './BillingThumbnail2.module.css';

interface BillingThumbnail2Item {
  updatedAt: Date;
  assignee: string;
  status: string;
  createdAt: Date;
...
interface BillingThumbnail2Props {
  items?: BillingThumbnail2Item[];
...
export default function BillingThumbnail2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: BillingThumbnail2Props) {
