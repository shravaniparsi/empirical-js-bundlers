...
import styles from './BillingTreeView.module.css';
...
interface BillingTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function BillingTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="BillingTreeView">
      {activeItem && (
