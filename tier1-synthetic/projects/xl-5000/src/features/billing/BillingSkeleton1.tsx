...
import BillingScore from './BillingScore';
import styles from './BillingSkeleton1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface BillingSkeleton1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function BillingSkeleton1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
