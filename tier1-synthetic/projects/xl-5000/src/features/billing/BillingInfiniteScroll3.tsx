...
import styles from './BillingInfiniteScroll3.module.css';
...
interface BillingInfiniteScroll3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingInfiniteScroll3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
