...
import BillingTimeline1 from './BillingTimeline1';
import BillingInfiniteScroll1 from './BillingInfiniteScroll1';
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['description', 'updatedAt', 'createdAt']);
