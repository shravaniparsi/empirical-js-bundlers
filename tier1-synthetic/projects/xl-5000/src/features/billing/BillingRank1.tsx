...
import styles from './BillingRank1.module.css';

interface BillingRank1Item {
  priority: number;
  updatedAt: Date;
  status: string;
  title: string;
...
interface BillingRank1Props {
  items?: BillingRank1Item[];
...
export default function BillingRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
