...
import BillingColorPicker1 from './BillingColorPicker1';
import BillingDrawer from './BillingDrawer';
import styles from './BillingSelect1.module.css';


interface BillingSelect1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function BillingSelect1({
  label,
  name,
