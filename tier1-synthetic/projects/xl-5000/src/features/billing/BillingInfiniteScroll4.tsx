...
import styles from './BillingInfiniteScroll4.module.css';
...
interface BillingInfiniteScroll4Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingInfiniteScroll4<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
