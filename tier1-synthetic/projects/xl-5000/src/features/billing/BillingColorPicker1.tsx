...
import styles from './BillingColorPicker1.module.css';


interface BillingColorPicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function BillingColorPicker1({
  label,
  name,
