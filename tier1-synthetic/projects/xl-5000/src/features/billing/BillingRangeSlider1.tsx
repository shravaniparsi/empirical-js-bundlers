...
import styles from './BillingRangeSlider1.module.css';


interface BillingRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function BillingRangeSlider1({
  label,
  name,
