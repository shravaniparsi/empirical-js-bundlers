...
import BillingRank1 from './BillingRank1';
import styles from './BillingRetry1.module.css';
...
interface BillingRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
