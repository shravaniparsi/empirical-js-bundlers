...
interface BillingLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function BillingLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
