...
import styles from './BillingDetail1.module.css';

interface BillingDetail1Item {
  assignee: string;
  updatedAt: Date;
  description: string;
  status: string;
...
interface BillingDetail1Props {
  items?: BillingDetail1Item[];
...
export default function BillingDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
