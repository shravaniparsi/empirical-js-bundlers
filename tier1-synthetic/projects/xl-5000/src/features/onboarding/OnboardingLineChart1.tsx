...
import OnboardingPrefetch from './OnboardingPrefetch';
import styles from './OnboardingLineChart1.module.css';
...
interface OnboardingLineChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OnboardingLineChart1({
  data,
  title,
  height = 300,
  showLegend = true,
