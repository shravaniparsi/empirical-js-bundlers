...
import styles from './OnboardingFileUpload.module.css';

const OnboardingFileUploadSchema = z.object({
...
export default function OnboardingFileUpload({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = OnboardingFileUploadSchema.safeParse({ value: val });
