...
import OnboardingTag1 from './OnboardingTag1';
import OnboardingInput from './OnboardingInput';
import OnboardingBreadcrumb from './OnboardingBreadcrumb';
import styles from './OnboardingSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface OnboardingSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function OnboardingSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
