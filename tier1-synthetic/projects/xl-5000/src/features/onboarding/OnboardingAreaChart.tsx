...
import styles from './OnboardingAreaChart.module.css';
...
interface OnboardingAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OnboardingAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
