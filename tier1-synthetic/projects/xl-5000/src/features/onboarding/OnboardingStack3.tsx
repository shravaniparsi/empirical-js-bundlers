...
import OnboardingResponsive from './OnboardingResponsive';
import OnboardingPopover3 from './OnboardingPopover3';
import styles from './OnboardingStack3.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface OnboardingStack3Props {
...
export default function OnboardingStack3({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
