...
import styles from './OnboardingPrefetch2.module.css';
...
interface OnboardingPrefetch2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OnboardingPrefetch2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
