...
import styles from './OnboardingRetry.module.css';
...
interface OnboardingRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OnboardingRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
