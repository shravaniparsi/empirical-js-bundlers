...
import styles from './OnboardingLineChart2.module.css';
...
interface OnboardingLineChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OnboardingLineChart2({
  data,
  title,
  height = 300,
  showLegend = true,
