...
import styles from './OnboardingAreaChart1.module.css';
...
interface OnboardingAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OnboardingAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
