...
import styles from './OnboardingList2.module.css';

interface OnboardingList2Item {
  tags: string[];
  createdAt: Date;
  title: string;
  id: string;
...
interface OnboardingList2Props {
  items?: OnboardingList2Item[];
...
export default function OnboardingList2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: OnboardingList2Props) {
