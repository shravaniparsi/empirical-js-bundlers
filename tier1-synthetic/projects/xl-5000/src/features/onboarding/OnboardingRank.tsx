...
import OnboardingSnackbar1 from './OnboardingSnackbar1';
import OnboardingAreaChart1 from './OnboardingAreaChart1';
import styles from './OnboardingRank.module.css';

interface OnboardingRankItem {
  title: string;
  priority: number;
  assignee: string;
  createdAt: Date;
...
interface OnboardingRankProps {
  items?: OnboardingRankItem[];
