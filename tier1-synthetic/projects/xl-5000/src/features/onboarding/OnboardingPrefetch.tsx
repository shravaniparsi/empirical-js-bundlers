...
import OnboardingLabel2 from './OnboardingLabel2';
import styles from './OnboardingPrefetch.module.css';
...
interface OnboardingPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OnboardingPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
