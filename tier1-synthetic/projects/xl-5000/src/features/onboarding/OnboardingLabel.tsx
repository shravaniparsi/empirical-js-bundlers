...
import OnboardingPopover1 from './OnboardingPopover1';
import InventorySummary from '../inventory/InventorySummary';
import styles from './OnboardingLabel.module.css';

interface OnboardingLabelItem {
  createdAt: Date;
  description: string;
  tags: string[];
  status: string;
...
export default function OnboardingLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: OnboardingLabelProps) {
