...
import OnboardingSticky1 from './OnboardingSticky1';
import OnboardingPopover2 from './OnboardingPopover2';
import styles from './OnboardingScatter.module.css';
...
interface OnboardingScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function OnboardingScatter({
  data,
  title,
  height = 300,
  showLegend = true,
