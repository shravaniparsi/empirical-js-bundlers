...
import styles from './OnboardingBreadcrumb1.module.css';
...
interface OnboardingBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function OnboardingBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OnboardingBreadcrumb1">
      {activeItem && (
