...
import OnboardingPopover2 from './OnboardingPopover2';
import LocalizationRadio from '../localization/LocalizationRadio';
import styles from './OnboardingPagination1.module.css';
...
interface OnboardingPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function OnboardingPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OnboardingPagination1">
      {activeItem && (
