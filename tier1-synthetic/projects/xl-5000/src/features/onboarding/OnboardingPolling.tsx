...
import styles from './OnboardingPolling.module.css';
...
interface OnboardingPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OnboardingPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
