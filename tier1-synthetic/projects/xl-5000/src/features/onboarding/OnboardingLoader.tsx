...
import styles from './OnboardingLoader.module.css';
...
interface OnboardingLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OnboardingLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
