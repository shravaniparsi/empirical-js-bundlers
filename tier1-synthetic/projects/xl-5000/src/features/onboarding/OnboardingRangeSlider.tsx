...
import styles from './OnboardingRangeSlider.module.css';


interface OnboardingRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function OnboardingRangeSlider({
  label,
  name,
