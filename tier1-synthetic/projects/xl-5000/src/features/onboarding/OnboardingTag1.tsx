...
import styles from './OnboardingTag1.module.css';

interface OnboardingTag1Item {
  description: string;
  title: string;
  priority: number;
  tags: string[];
...
interface OnboardingTag1Props {
  items?: OnboardingTag1Item[];
...
export default function OnboardingTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
