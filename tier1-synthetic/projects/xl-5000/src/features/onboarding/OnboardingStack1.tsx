...
import OnboardingTimeline1 from './OnboardingTimeline1';
import ExportsDivider2 from '../exports/ExportsDivider2';
import styles from './OnboardingStack1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface OnboardingStack1Props {
...
export default function OnboardingStack1({
  children,
