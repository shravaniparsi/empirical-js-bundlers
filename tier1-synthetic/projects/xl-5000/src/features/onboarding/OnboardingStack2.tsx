...
import OnboardingScatter from './OnboardingScatter';
import styles from './OnboardingStack2.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface OnboardingStack2Props {
...
export default function OnboardingStack2({
  children,
