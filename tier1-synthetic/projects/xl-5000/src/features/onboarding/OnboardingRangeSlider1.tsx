...
import OnboardingList2 from './OnboardingList2';
import styles from './OnboardingRangeSlider1.module.css';


interface OnboardingRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function OnboardingRangeSlider1({
  label,
  name,
