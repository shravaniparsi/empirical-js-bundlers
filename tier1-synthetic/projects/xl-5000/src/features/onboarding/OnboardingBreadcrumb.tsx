...
import styles from './OnboardingBreadcrumb.module.css';
...
export default function OnboardingBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OnboardingBreadcrumb">
      {activeItem && (
