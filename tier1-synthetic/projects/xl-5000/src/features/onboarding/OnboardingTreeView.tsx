...
import OnboardingSlider1 from './OnboardingSlider1';
import ActivityTooltip from '../activity/ActivityTooltip';
import styles from './OnboardingTreeView.module.css';
...
interface OnboardingTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function OnboardingTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OnboardingTreeView">
      {activeItem && (
