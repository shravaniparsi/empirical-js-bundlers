...
import styles from './OnboardingThumbnail.module.css';

interface OnboardingThumbnailItem {
  priority: number;
  description: string;
  updatedAt: Date;
  id: string;
...
interface OnboardingThumbnailProps {
  items?: OnboardingThumbnailItem[];
...
export default function OnboardingThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: OnboardingThumbnailProps) {
