...
import OnboardingSnackbar2 from './OnboardingSnackbar2';
import OnboardingPopover1 from './OnboardingPopover1';
import OnboardingHook from './OnboardingHook';
import styles from './OnboardingLineChart.module.css';
...
export default function OnboardingLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
