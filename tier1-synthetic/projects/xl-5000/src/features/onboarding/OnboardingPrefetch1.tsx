...
import OnboardingGauge1 from './OnboardingGauge1';
import OnboardingTextArea from './OnboardingTextArea';
import styles from './OnboardingPrefetch1.module.css';
...
interface OnboardingPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function OnboardingPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
