...
import OnboardingScroll1 from './OnboardingScroll1';
import OnboardingRetry from './OnboardingRetry';
import styles from './OnboardingDatePicker1.module.css';


interface OnboardingDatePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function OnboardingDatePicker1({
  label,
  name,
