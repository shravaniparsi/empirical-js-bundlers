...
import OnboardingBreadcrumb1 from './OnboardingBreadcrumb1';
import OnboardingGauge from './OnboardingGauge';
import OnboardingFunnel from './OnboardingFunnel';
import styles from './OnboardingPopover2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface OnboardingPopover2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function OnboardingPopover2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
