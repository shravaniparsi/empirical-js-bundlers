...
import OnboardingDatePicker1 from './OnboardingDatePicker1';
import InventoryBreadcrumb from '../inventory/InventoryBreadcrumb';
import styles from './OnboardingDrawer.module.css';
...
export default function OnboardingDrawer({
  ...
  return (
    <nav className={navClasses} aria-label="OnboardingDrawer">
      {activeItem && (
