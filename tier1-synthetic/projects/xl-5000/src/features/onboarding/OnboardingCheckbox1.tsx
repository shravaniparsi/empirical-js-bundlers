...
import styles from './OnboardingCheckbox1.module.css';


interface OnboardingCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function OnboardingCheckbox1({
  label,
  name,
