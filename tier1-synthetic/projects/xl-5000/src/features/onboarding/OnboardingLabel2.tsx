...
import OnboardingRangeSlider from './OnboardingRangeSlider';
import OnboardingBarChart from './OnboardingBarChart';
import OnboardingToggle from './OnboardingToggle';
import FaqLineChart2 from '../faq/FaqLineChart2';
import styles from './OnboardingLabel2.module.css';

interface OnboardingLabel2Item {
  tags: string[];
  assignee: string;
  priority: number;
  status: string;
...
interface OnboardingLabel2Props {
  items?: OnboardingLabel2Item[];
...
export default function OnboardingLabel2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: OnboardingLabel2Props) {
