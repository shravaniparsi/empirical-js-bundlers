...
import ThemesBottomNav from './ThemesBottomNav';
import ThemesAccordion from './ThemesAccordion';
import ThemesWrapper from './ThemesWrapper';
import styles from './ThemesMeter.module.css';

interface ThemesMeterItem {
  status: string;
  updatedAt: Date;
  description: string;
  tags: string[];
...
interface ThemesMeterProps {
  items?: ThemesMeterItem[];
...
export default function ThemesMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
