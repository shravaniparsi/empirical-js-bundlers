...
import ThemesStepper from './ThemesStepper';
import styles from './ThemesLoader1.module.css';
...
interface ThemesLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ThemesLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
