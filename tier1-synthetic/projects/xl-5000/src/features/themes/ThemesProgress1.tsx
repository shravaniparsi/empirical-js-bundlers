...
import styles from './ThemesProgress1.module.css';

interface ThemesProgress1Item {
  description: string;
  createdAt: Date;
  title: string;
  assignee: string;
...
interface ThemesProgress1Props {
  items?: ThemesProgress1Item[];
...
export default function ThemesProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ThemesProgress1Props) {
