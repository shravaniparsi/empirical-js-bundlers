...
import ThemesCollapse from './ThemesCollapse';
import ThemesBanner from './ThemesBanner';
import styles from './ThemesFeed.module.css';

interface ThemesFeedItem {
  createdAt: Date;
  title: string;
  status: string;
  priority: number;
...
interface ThemesFeedProps {
  items?: ThemesFeedItem[];
...
export default function ThemesFeed({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
