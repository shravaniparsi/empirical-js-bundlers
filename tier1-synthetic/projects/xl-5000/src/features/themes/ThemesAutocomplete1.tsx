...
import styles from './ThemesAutocomplete1.module.css';


interface ThemesAutocomplete1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ThemesAutocomplete1({
  label,
  name,
