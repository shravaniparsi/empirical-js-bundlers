...
import ThemesBridge from './ThemesBridge';
import ThemesAutocomplete1 from './ThemesAutocomplete1';
import PaymentsTreeView from '../payments/PaymentsTreeView';
import ReviewsDetail1 from '../reviews/ReviewsDetail1';
import styles from './ThemesAlert.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ThemesAlertProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ThemesAlert({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
