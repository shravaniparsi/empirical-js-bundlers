...
import ThemesProgress1 from './ThemesProgress1';
import styles from './ThemesSparkline.module.css';
...
interface ThemesSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ThemesSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
