...
import ThemesInput1 from './ThemesInput1';
import ThemesStepper2 from './ThemesStepper2';
import ThemesInput from './ThemesInput';
import styles from './ThemesPagination.module.css';
...
interface ThemesPaginationProps {
  items: NavItem[];
  activeId?: string;
...
export default function ThemesPagination({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesPagination">
      {activeItem && (
