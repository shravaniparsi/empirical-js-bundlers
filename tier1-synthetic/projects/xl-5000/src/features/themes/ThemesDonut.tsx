...
import ThemesDatePicker from './ThemesDatePicker';
import ThemesLink1 from './ThemesLink1';
import ThemesDivider3 from './ThemesDivider3';
import styles from './ThemesDonut.module.css';
...
export default function ThemesDonut({
  data,
  title,
  height = 300,
  showLegend = true,
