...
import ThemesSparkline from './ThemesSparkline';
import ActivityRadio from '../activity/ActivityRadio';
import styles from './ThemesSuspense.module.css';
...
interface ThemesSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ThemesSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
