...
import styles from './ThemesThumbnail.module.css';

interface ThemesThumbnailItem {
  priority: number;
  description: string;
  updatedAt: Date;
  assignee: string;
...
interface ThemesThumbnailProps {
  items?: ThemesThumbnailItem[];
...
export default function ThemesThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ThemesThumbnailProps) {
