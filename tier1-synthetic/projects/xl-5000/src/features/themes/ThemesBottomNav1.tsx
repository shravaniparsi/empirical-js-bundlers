...
import ThemesSpinner from './ThemesSpinner';
...
import styles from './ThemesBottomNav1.module.css';
...
interface ThemesBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ThemesBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesBottomNav1">
      {activeItem && (
