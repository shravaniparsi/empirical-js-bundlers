...
import ThemesDivider2 from './ThemesDivider2';
import styles from './ThemesConfirm1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ThemesConfirm1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ThemesConfirm1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
