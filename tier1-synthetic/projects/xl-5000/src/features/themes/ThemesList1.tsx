...
import ThemesAlert1 from './ThemesAlert1';
import styles from './ThemesList1.module.css';

interface ThemesList1Item {
  title: string;
  updatedAt: Date;
  createdAt: Date;
  tags: string[];
...
interface ThemesList1Props {
  items?: ThemesList1Item[];
...
export default function ThemesList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
