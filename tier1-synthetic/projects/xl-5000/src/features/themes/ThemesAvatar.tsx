...
import CatalogChip1 from '../catalog/CatalogChip1';
import styles from './ThemesAvatar.module.css';

interface ThemesAvatarItem {
  priority: number;
  title: string;
  status: string;
  description: string;
...
interface ThemesAvatarProps {
  items?: ThemesAvatarItem[];
...
export default function ThemesAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
