...
import ThemesAutocomplete from './ThemesAutocomplete';
import WebhooksCached2 from '../webhooks/WebhooksCached2';
import styles from './ThemesAreaChart.module.css';
...
interface ThemesAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ThemesAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
