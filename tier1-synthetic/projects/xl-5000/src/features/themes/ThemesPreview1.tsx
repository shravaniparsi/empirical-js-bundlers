...
import ThemesAvatar2 from './ThemesAvatar2';
import ThemesInput2 from './ThemesInput2';
import styles from './ThemesPreview1.module.css';

interface ThemesPreview1Item {
  createdAt: Date;
  updatedAt: Date;
  priority: number;
  id: string;
...
interface ThemesPreview1Props {
  items?: ThemesPreview1Item[];
...
export default function ThemesPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
