...
import ThemesSticky2 from './ThemesSticky2';
import styles from './ThemesTreeView.module.css';
...
export default function ThemesTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesTreeView">
      {activeItem && (
