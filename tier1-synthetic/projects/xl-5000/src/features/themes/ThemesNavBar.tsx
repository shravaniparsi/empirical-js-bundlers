...
import ThemesColorPicker from './ThemesColorPicker';
import ThemesComposer from './ThemesComposer';
import styles from './ThemesNavBar.module.css';
...
export default function ThemesNavBar({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesNavBar">
      {activeItem && (
