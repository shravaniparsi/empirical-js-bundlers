...
import ThemesFunnel1 from './ThemesFunnel1';
import styles from './ThemesAvatar2.module.css';

interface ThemesAvatar2Item {
  priority: number;
  updatedAt: Date;
  createdAt: Date;
  assignee: string;
...
interface ThemesAvatar2Props {
  items?: ThemesAvatar2Item[];
...
export default function ThemesAvatar2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
