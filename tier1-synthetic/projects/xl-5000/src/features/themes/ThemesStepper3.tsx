...
import styles from './ThemesStepper3.module.css';
...
export default function ThemesStepper3({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ThemesStepper3">
      {activeItem && (
