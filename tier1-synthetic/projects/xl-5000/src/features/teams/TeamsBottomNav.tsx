...
import TeamsTable1 from './TeamsTable1';
import styles from './TeamsBottomNav.module.css';
...
export default function TeamsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TeamsBottomNav">
      {activeItem && (
