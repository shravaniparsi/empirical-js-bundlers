...
import TeamsTreeView1 from './TeamsTreeView1';
import TeamsPaginated1 from './TeamsPaginated1';
import styles from './TeamsLoader.module.css';
...
interface TeamsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
