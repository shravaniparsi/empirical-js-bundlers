...
import TeamsBadge1 from './TeamsBadge1';
import WebhooksSkeleton2 from '../webhooks/WebhooksSkeleton2';
import styles from './TeamsPaginated.module.css';
...
interface TeamsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
