...
import TeamsAutocomplete1 from './TeamsAutocomplete1';
import NotificationsHeatmap1 from '../notifications/NotificationsHeatmap1';
import styles from './TeamsLoader2.module.css';
...
interface TeamsLoader2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsLoader2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
