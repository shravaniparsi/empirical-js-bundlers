...
import styles from './TeamsStepper.module.css';
...
export default function TeamsStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TeamsStepper">
      {activeItem && (
