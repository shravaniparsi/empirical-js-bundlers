...
import TeamsAvatar1 from './TeamsAvatar1';
import TeamsSuspense from './TeamsSuspense';
import styles from './TeamsInfiniteScroll.module.css';
...
interface TeamsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
