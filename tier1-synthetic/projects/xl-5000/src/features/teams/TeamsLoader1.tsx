...
import TeamsHOC2 from './TeamsHOC2';
import TeamsAvatar1 from './TeamsAvatar1';
import styles from './TeamsLoader1.module.css';
...
interface TeamsLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
