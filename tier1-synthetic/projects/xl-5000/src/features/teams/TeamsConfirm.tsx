...
import TeamsAvatar2 from './TeamsAvatar2';
import ImportsScatter1 from '../imports/ImportsScatter1';
import ImportsScore1 from '../imports/ImportsScore1';
import styles from './TeamsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface TeamsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function TeamsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
