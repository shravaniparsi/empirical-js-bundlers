...
import styles from './TeamsThumbnail.module.css';

interface TeamsThumbnailItem {
  description: string;
  priority: number;
  assignee: string;
  createdAt: Date;
...
interface TeamsThumbnailProps {
  items?: TeamsThumbnailItem[];
...
export default function TeamsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
