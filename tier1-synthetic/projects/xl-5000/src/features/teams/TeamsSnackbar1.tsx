...
import TeamsTimePicker1 from './TeamsTimePicker1';
import ReportsSpinner1 from '../reports/ReportsSpinner1';
import styles from './TeamsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface TeamsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function TeamsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
