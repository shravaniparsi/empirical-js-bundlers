...
import styles from './TeamsSummary1.module.css';

interface TeamsSummary1Item {
  title: string;
  tags: string[];
  priority: number;
  id: string;
...
interface TeamsSummary1Props {
  items?: TeamsSummary1Item[];
...
export default function TeamsSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
