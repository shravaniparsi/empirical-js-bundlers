...
import styles from './TeamsPaginated1.module.css';
...
interface TeamsPaginated1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsPaginated1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
