...
import styles from './TeamsAvatar1.module.css';

interface TeamsAvatar1Item {
  description: string;
  updatedAt: Date;
  assignee: string;
  title: string;
...
interface TeamsAvatar1Props {
  items?: TeamsAvatar1Item[];
...
export default function TeamsAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
