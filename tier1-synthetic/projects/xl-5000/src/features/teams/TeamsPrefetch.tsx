...
import TeamsHOC from './TeamsHOC';
import ReviewsSplit from '../reviews/ReviewsSplit';
import styles from './TeamsPrefetch.module.css';
...
interface TeamsPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TeamsPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
