...
import TeamsThumbnail from './TeamsThumbnail';
import TeamsResponsive from './TeamsResponsive';
import styles from './TeamsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface TeamsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function TeamsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
