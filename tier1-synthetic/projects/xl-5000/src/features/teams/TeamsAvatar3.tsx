...
import styles from './TeamsAvatar3.module.css';

interface TeamsAvatar3Item {
  title: string;
  updatedAt: Date;
  createdAt: Date;
  description: string;
...
interface TeamsAvatar3Props {
  items?: TeamsAvatar3Item[];
...
export default function TeamsAvatar3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
