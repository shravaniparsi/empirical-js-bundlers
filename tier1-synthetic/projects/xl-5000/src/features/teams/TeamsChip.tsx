...
import KnowledgeBaseSkeleton1 from '../knowledge-base/KnowledgeBaseSkeleton1';
import styles from './TeamsChip.module.css';

interface TeamsChipItem {
  priority: number;
  updatedAt: Date;
  description: string;
  status: string;
...
export default function TeamsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
