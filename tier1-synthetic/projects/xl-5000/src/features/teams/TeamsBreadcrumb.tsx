...
import TeamsRangeSlider from './TeamsRangeSlider';
import styles from './TeamsBreadcrumb.module.css';
...
interface TeamsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function TeamsBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TeamsBreadcrumb">
      {activeItem && (
