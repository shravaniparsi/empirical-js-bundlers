...
import TeamsSidebar1 from './TeamsSidebar1';
import styles from './TeamsAvatar.module.css';

interface TeamsAvatarItem {
  title: string;
  assignee: string;
  status: string;
  id: string;
...
export default function TeamsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
