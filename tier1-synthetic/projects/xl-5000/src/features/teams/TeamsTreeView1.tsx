...
import TeamsDivider1 from './TeamsDivider1';
import TeamsBarChart1 from './TeamsBarChart1';
import OrdersScore1 from '../orders/OrdersScore1';
import styles from './TeamsTreeView1.module.css';
...
export default function TeamsTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TeamsTreeView1">
      {activeItem && (
