...
import styles from './TeamsBottomNav1.module.css';
...
interface TeamsBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function TeamsBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TeamsBottomNav1">
      {activeItem && (
