...
import TeamsDivider3 from './TeamsDivider3';
import CommentsResponsive1 from '../comments/CommentsResponsive1';
import styles from './TeamsTable1.module.css';

interface TeamsTable1Item {
  tags: string[];
  priority: number;
  createdAt: Date;
  title: string;
...
interface TeamsTable1Props {
  items?: TeamsTable1Item[];
...
export default function TeamsTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
