...
import styles from './ReviewsTreeView1.module.css';
...
interface ReviewsTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReviewsTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsTreeView1">
      {activeItem && (
