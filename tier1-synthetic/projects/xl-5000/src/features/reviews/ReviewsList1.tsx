...
import styles from './ReviewsList1.module.css';

interface ReviewsList1Item {
  createdAt: Date;
  status: string;
  tags: string[];
  assignee: string;
...
interface ReviewsList1Props {
  items?: ReviewsList1Item[];
...
export default function ReviewsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
