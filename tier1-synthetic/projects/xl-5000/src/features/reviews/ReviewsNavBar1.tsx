...
import ReviewsRating1 from './ReviewsRating1';
import styles from './ReviewsNavBar1.module.css';
...
export default function ReviewsNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsNavBar1">
      {activeItem && (
