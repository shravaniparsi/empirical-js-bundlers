...
import ReviewsBottomNav1 from './ReviewsBottomNav1';
import ReviewsBottomNav from './ReviewsBottomNav';
import ReviewsStepper1 from './ReviewsStepper1';
import styles from './ReviewsNavBar.module.css';
...
export default function ReviewsNavBar({
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsNavBar">
      {activeItem && (
