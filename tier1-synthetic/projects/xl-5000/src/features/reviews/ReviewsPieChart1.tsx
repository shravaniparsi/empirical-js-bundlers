...
import ReviewsPagination1 from './ReviewsPagination1';
...
import styles from './ReviewsPieChart1.module.css';
...
interface ReviewsPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ReviewsPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
