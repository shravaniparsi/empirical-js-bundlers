...
import styles from './ReviewsSelect.module.css';

const ReviewsSelectSchema = z.object({
...
export default function ReviewsSelect({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ReviewsSelectSchema.safeParse({ value: val });
