...
import ReviewsToggle from './ReviewsToggle';
import IntegrationsSpacer2 from '../integrations/IntegrationsSpacer2';
import InventoryPieChart from '../inventory/InventoryPieChart';
import styles from './ReviewsColorPicker1.module.css';


interface ReviewsColorPicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ReviewsColorPicker1({
  label,
  name,
