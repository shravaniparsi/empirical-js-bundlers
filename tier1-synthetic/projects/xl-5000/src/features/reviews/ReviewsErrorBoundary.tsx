...
import ReviewsSuspense1 from './ReviewsSuspense1';
import ReviewsRating2 from './ReviewsRating2';
import ReviewsSkeleton from './ReviewsSkeleton';
import styles from './ReviewsErrorBoundary.module.css';
...
interface ReviewsErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
