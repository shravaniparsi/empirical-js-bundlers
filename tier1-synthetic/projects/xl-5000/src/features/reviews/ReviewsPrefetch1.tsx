...
import ReviewsInfiniteScroll from './ReviewsInfiniteScroll';
import styles from './ReviewsPrefetch1.module.css';
...
interface ReviewsPrefetch1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsPrefetch1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
