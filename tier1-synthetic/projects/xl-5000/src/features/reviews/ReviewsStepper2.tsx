...
import styles from './ReviewsStepper2.module.css';
...
interface ReviewsStepper2Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReviewsStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsStepper2">
      {activeItem && (
