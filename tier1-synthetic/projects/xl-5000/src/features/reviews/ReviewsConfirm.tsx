...
import ReviewsColorPicker from './ReviewsColorPicker';
import ApiKeysColorPicker1 from '../api-keys/ApiKeysColorPicker1';
import styles from './ReviewsConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReviewsConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReviewsConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
