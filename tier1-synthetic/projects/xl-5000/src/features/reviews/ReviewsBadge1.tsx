...
import ReviewsPieChart1 from './ReviewsPieChart1';
import styles from './ReviewsBadge1.module.css';

interface ReviewsBadge1Item {
  assignee: string;
  priority: number;
  status: string;
  createdAt: Date;
...
interface ReviewsBadge1Props {
  items?: ReviewsBadge1Item[];
...
export default function ReviewsBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
