...
import ReviewsStepper2 from './ReviewsStepper2';
import ReviewsHeatmap from './ReviewsHeatmap';
import ReviewsBottomNav from './ReviewsBottomNav';
import styles from './ReviewsInfiniteScroll1.module.css';
...
interface ReviewsInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
