...
import ReviewsDetail1 from './ReviewsDetail1';
import DashboardToast from '../dashboard/DashboardToast';
import styles from './ReviewsPopover3.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ReviewsPopover3Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ReviewsPopover3({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
