...
import ReviewsPrefetch1 from './ReviewsPrefetch1';
import ReviewsPolling1 from './ReviewsPolling1';
import ReviewsCollapse from './ReviewsCollapse';
import styles from './ReviewsStepper1.module.css';
...
interface ReviewsStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReviewsStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsStepper1">
      {activeItem && (
