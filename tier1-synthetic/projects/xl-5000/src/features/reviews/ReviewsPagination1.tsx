...
import ReviewsSuspense from './ReviewsSuspense';
import UsersTextArea from '../users/UsersTextArea';
import styles from './ReviewsPagination1.module.css';
...
interface ReviewsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ReviewsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ReviewsPagination1">
      {activeItem && (
