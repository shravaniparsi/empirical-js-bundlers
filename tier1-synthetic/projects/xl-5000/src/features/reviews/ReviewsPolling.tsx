...
import styles from './ReviewsPolling.module.css';
...
interface ReviewsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
