...
import styles from './ReviewsPolling1.module.css';
...
interface ReviewsPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
