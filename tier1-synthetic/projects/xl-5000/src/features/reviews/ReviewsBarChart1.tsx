...
import ReviewsColorPicker2 from './ReviewsColorPicker2';
import ReviewsStepper from './ReviewsStepper';
import ReviewsBottomNav from './ReviewsBottomNav';
import styles from './ReviewsBarChart1.module.css';
...
interface ReviewsBarChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ReviewsBarChart1({
  data,
  title,
  height = 300,
  showLegend = true,
