...
import styles from './ReviewsPolling2.module.css';
...
interface ReviewsPolling2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsPolling2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
