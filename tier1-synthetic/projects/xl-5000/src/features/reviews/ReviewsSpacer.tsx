...
import ReviewsAreaChart from './ReviewsAreaChart';
import styles from './ReviewsSpacer.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ReviewsSpacerProps {
...
export default function ReviewsSpacer({
  children,
