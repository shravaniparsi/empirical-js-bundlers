...
import ReviewsBreadcrumb from './ReviewsBreadcrumb';
import CheckoutFunnel from '../checkout/CheckoutFunnel';
import OnboardingDatePicker from '../onboarding/OnboardingDatePicker';
import styles from './ReviewsStat.module.css';

interface ReviewsStatItem {
  assignee: string;
  title: string;
  description: string;
  id: string;
...
interface ReviewsStatProps {
  items?: ReviewsStatItem[];
...
export default function ReviewsStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
