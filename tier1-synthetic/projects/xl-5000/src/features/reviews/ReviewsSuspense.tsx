...
import styles from './ReviewsSuspense.module.css';
...
interface ReviewsSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ReviewsSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
