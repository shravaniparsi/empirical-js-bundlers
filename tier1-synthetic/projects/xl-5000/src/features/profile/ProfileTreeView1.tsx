...
import styles from './ProfileTreeView1.module.css';
...
interface ProfileTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProfileTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProfileTreeView1">
      {activeItem && (
