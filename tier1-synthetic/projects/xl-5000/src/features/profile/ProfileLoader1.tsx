...
import styles from './ProfileLoader1.module.css';
...
interface ProfileLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfileLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
