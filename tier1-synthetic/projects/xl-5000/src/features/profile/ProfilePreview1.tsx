...
import styles from './ProfilePreview1.module.css';

interface ProfilePreview1Item {
  createdAt: Date;
  tags: string[];
  title: string;
  priority: number;
...
interface ProfilePreview1Props {
  items?: ProfilePreview1Item[];
...
export default function ProfilePreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ProfilePreview1Props) {
