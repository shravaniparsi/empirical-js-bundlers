...
import ProfileMenu2 from './ProfileMenu2';
import styles from './ProfileStepper2.module.css';
...
interface ProfileStepper2Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProfileStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProfileStepper2">
      {activeItem && (
