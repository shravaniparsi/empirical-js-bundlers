...
import ProfileTimeline1 from './ProfileTimeline1';
import ProfileSpinner from './ProfileSpinner';
import SchedulingDatePicker from '../scheduling/SchedulingDatePicker';
import styles from './ProfileTooltip1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProfileTooltip1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProfileTooltip1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
