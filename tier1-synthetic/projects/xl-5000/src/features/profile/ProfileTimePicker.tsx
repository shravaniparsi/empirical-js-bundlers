...
import styles from './ProfileTimePicker.module.css';

const ProfileTimePickerSchema = z.object({
...
export default function ProfileTimePicker({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ProfileTimePickerSchema.safeParse({ value: val });
