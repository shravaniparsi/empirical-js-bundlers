...
import styles from './ProfileList1.module.css';

interface ProfileList1Item {
  createdAt: Date;
  status: string;
  assignee: string;
  tags: string[];
...
interface ProfileList1Props {
  items?: ProfileList1Item[];
...
export default function ProfileList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
