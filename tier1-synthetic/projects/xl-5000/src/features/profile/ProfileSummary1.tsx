...
import styles from './ProfileSummary1.module.css';

interface ProfileSummary1Item {
  createdAt: Date;
  description: string;
  tags: string[];
  priority: number;
...
interface ProfileSummary1Props {
  items?: ProfileSummary1Item[];
...
export default function ProfileSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ProfileSummary1Props) {
