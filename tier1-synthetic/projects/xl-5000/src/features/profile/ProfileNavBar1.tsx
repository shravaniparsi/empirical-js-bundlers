...
import styles from './ProfileNavBar1.module.css';
...
export default function ProfileNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProfileNavBar1">
      {activeItem && (
