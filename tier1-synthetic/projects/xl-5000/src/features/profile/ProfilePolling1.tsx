...
import styles from './ProfilePolling1.module.css';
...
interface ProfilePolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfilePolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
