...
import styles from './ProfileMenu1.module.css';
...
export default function ProfileMenu1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProfileMenu1">
      {activeItem && (
