...
interface ProfilePollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProfilePolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
