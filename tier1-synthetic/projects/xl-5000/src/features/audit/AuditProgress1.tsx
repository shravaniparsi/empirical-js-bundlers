...
import styles from './AuditProgress1.module.css';

interface AuditProgress1Item {
  tags: string[];
  title: string;
  description: string;
  updatedAt: Date;
...
interface AuditProgress1Props {
  items?: AuditProgress1Item[];
...
export default function AuditProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
