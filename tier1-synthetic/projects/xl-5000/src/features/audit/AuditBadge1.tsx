...
import AuditSelect1 from './AuditSelect1';
import AuditProvider from './AuditProvider';
import AuditStat1 from './AuditStat1';
import SearchDetail from '../search/SearchDetail';
import styles from './AuditBadge1.module.css';

interface AuditBadge1Item {
  updatedAt: Date;
  assignee: string;
  priority: number;
  description: string;
...
interface AuditBadge1Props {
  items?: AuditBadge1Item[];
...
export default function AuditBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
