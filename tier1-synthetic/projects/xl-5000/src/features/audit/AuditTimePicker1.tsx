...
import AuditProvider2 from './AuditProvider2';
import AuditComposer2 from './AuditComposer2';
import styles from './AuditTimePicker1.module.css';


interface AuditTimePicker1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function AuditTimePicker1({
  label,
  name,
