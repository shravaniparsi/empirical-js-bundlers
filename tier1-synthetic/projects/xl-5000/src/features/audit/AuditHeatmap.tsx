...
import AuditBadge1 from './AuditBadge1';
import AuditColorPicker from './AuditColorPicker';
import CampaignsLabel from '../campaigns/CampaignsLabel';
import styles from './AuditHeatmap.module.css';
...
export default function AuditHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
