...
import styles from './AuditProgress2.module.css';

interface AuditProgress2Item {
  title: string;
  createdAt: Date;
  assignee: string;
  updatedAt: Date;
...
interface AuditProgress2Props {
  items?: AuditProgress2Item[];
...
export default function AuditProgress2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
