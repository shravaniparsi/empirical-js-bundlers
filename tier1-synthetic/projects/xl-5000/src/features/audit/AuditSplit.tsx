...
import FeedbackMgmtPolling from '../feedback-mgmt/FeedbackMgmtPolling';
import styles from './AuditSplit.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface AuditSplitProps {
...
export default function AuditSplit({
  children,
