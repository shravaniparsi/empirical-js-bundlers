...
import AuditErrorBoundary1 from './AuditErrorBoundary1';
import AuditSplit1 from './AuditSplit1';
import ReportsLabel from '../reports/ReportsLabel';
import styles from './AuditPrefetch.module.css';
...
interface AuditPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
