...
import AuditRetry2 from './AuditRetry2';
import styles from './AuditPaginated.module.css';
...
interface AuditPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
