...
import AuditScatter from './AuditScatter';
import AuditInfiniteScroll from './AuditInfiniteScroll';
import AuditHook from './AuditHook';
import FaqHeatmap from '../faq/FaqHeatmap';
import styles from './AuditRetry3.module.css';
...
interface AuditRetry3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AuditRetry3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
