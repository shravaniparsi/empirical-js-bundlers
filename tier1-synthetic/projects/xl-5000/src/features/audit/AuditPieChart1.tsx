...
import AuditSpinner1 from './AuditSpinner1';
import styles from './AuditPieChart1.module.css';
...
export default function AuditPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
