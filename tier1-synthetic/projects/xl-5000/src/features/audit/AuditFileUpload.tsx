...
import { z } from 'zod';
import AuditPrefetch from './AuditPrefetch';
import AuditScatter1 from './AuditScatter1';
import ExportsList2 from '../exports/ExportsList2';
import FeedbackMgmtDrawer1 from '../feedback-mgmt/FeedbackMgmtDrawer1';
import styles from './AuditFileUpload.module.css';

const AuditFileUploadSchema = z.object({
...
export default function AuditFileUpload({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = AuditFileUploadSchema.safeParse({ value: val });
