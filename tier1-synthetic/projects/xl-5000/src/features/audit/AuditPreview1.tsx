...
import styles from './AuditPreview1.module.css';

interface AuditPreview1Item {
  status: string;
  title: string;
  tags: string[];
  id: string;
...
interface AuditPreview1Props {
  items?: AuditPreview1Item[];
...
export default function AuditPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
