...
import AuditRank from './AuditRank';
import WebhooksTable from '../webhooks/WebhooksTable';
import styles from './AuditScore1.module.css';

interface AuditScore1Item {
  assignee: string;
  description: string;
  createdAt: Date;
  updatedAt: Date;
...
interface AuditScore1Props {
  items?: AuditScore1Item[];
...
export default function AuditScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
