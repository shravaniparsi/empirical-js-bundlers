...
import styles from './RolesNavBar1.module.css';
...
export default function RolesNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesNavBar1">
      {activeItem && (
