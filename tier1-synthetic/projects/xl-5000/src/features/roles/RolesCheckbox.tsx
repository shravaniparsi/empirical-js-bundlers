...
import RolesSelect1 from './RolesSelect1';
import styles from './RolesCheckbox.module.css';

const RolesCheckboxSchema = z.object({
...
export default function RolesCheckbox({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = RolesCheckboxSchema.safeParse({ value: val });
