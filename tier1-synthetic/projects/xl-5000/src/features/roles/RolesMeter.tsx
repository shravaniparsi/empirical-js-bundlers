...
import RolesSplit2 from './RolesSplit2';
import RolesErrorBoundary1 from './RolesErrorBoundary1';
import styles from './RolesMeter.module.css';

interface RolesMeterItem {
  priority: number;
  updatedAt: Date;
  description: string;
  status: string;
...
interface RolesMeterProps {
  items?: RolesMeterItem[];
...
export default function RolesMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
