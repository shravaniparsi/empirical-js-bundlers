...
import RolesHeatmap from './RolesHeatmap';
import ShippingPanel1 from '../shipping/ShippingPanel1';
import styles from './RolesRangeSlider1.module.css';


interface RolesRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function RolesRangeSlider1({
  label,
  name,
