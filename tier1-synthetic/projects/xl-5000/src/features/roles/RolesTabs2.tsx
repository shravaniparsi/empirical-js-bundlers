...
import RolesToast from './RolesToast';
import RolesTimePicker from './RolesTimePicker';
import RolesSearch3 from './RolesSearch3';
import styles from './RolesTabs2.module.css';
...
export default function RolesTabs2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesTabs2">
      {activeItem && (
