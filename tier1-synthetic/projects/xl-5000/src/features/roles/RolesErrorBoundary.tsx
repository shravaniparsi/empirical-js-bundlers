...
import RolesAvatar1 from './RolesAvatar1';
import RolesPagination from './RolesPagination';
import styles from './RolesErrorBoundary.module.css';
...
interface RolesErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function RolesErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
