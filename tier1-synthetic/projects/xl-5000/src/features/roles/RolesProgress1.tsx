...
import RolesPagination2 from './RolesPagination2';
import styles from './RolesProgress1.module.css';

interface RolesProgress1Item {
  priority: number;
  updatedAt: Date;
  createdAt: Date;
  status: string;
...
interface RolesProgress1Props {
  items?: RolesProgress1Item[];
...
export default function RolesProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
