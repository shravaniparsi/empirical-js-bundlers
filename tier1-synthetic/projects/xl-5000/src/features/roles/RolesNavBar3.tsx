...
import styles from './RolesNavBar3.module.css';
...
export default function RolesNavBar3({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesNavBar3">
      {activeItem && (
