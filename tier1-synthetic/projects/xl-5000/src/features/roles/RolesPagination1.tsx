...
import styles from './RolesPagination1.module.css';
...
interface RolesPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function RolesPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesPagination1">
      {activeItem && (
