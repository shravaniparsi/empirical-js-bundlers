...
import styles from './RolesPagination3.module.css';
...
interface RolesPagination3Props {
  items: NavItem[];
  activeId?: string;
...
export default function RolesPagination3({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesPagination3">
      {activeItem && (
