...
import styles from './RolesDetail1.module.css';

interface RolesDetail1Item {
  assignee: string;
  createdAt: Date;
  priority: number;
  tags: string[];
...
interface RolesDetail1Props {
  items?: RolesDetail1Item[];
...
export default function RolesDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
