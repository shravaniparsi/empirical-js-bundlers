...
import RolesThumbnail from './RolesThumbnail';
import RolesBridge from './RolesBridge';
import styles from './RolesStepper2.module.css';
...
export default function RolesStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesStepper2">
      {activeItem && (
