...
import RolesStepper1 from './RolesStepper1';
import RolesAccordion1 from './RolesAccordion1';
import TemplatesGrid from '../templates/TemplatesGrid';
import styles from './RolesFileUpload.module.css';


interface RolesFileUploadProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function RolesFileUpload({
  label,
  name,
