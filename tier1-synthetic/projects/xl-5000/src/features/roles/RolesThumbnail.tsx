...
import RolesDivider from './RolesDivider';
import RolesBridge from './RolesBridge';
import RolesSummary from './RolesSummary';
import styles from './RolesThumbnail.module.css';

interface RolesThumbnailItem {
  tags: string[];
  description: string;
  priority: number;
  updatedAt: Date;
...
interface RolesThumbnailProps {
  items?: RolesThumbnailItem[];
...
export default function RolesThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
