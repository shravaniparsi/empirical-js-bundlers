...
import RolesNavBar3 from './RolesNavBar3';
import RolesSummary from './RolesSummary';
import styles from './RolesAvatar1.module.css';

interface RolesAvatar1Item {
  tags: string[];
  priority: number;
  updatedAt: Date;
  assignee: string;
...
interface RolesAvatar1Props {
  items?: RolesAvatar1Item[];
...
export default function RolesAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
