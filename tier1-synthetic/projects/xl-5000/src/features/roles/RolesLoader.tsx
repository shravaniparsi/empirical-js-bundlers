...
import RolesDetail1 from './RolesDetail1';
import RolesCheckbox4 from './RolesCheckbox4';
import RolesResponsive from './RolesResponsive';
import styles from './RolesLoader.module.css';
...
interface RolesLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function RolesLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
