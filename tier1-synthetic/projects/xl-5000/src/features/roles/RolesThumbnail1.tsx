...
import styles from './RolesThumbnail1.module.css';

interface RolesThumbnail1Item {
  title: string;
  assignee: string;
  updatedAt: Date;
  id: string;
...
interface RolesThumbnail1Props {
  items?: RolesThumbnail1Item[];
...
export default function RolesThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: RolesThumbnail1Props) {
