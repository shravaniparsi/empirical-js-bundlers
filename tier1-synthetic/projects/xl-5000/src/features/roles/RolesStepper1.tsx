...
import styles from './RolesStepper1.module.css';
...
export default function RolesStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesStepper1">
      {activeItem && (
