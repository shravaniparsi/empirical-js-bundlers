...
import RolesScatter2 from './RolesScatter2';
...
import styles from './RolesRank.module.css';

interface RolesRankItem {
  title: string;
  createdAt: Date;
  status: string;
  priority: number;
...
export default function RolesRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
