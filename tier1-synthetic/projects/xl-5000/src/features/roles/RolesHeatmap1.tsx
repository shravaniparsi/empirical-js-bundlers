...
import RolesFileUpload from './RolesFileUpload';
import RolesAvatar1 from './RolesAvatar1';
import styles from './RolesHeatmap1.module.css';
...
export default function RolesHeatmap1({
  data,
  title,
  height = 300,
  showLegend = true,
