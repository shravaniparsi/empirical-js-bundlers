...
import RolesLineChart from './RolesLineChart';
import KnowledgeBasePlaceholder from '../knowledge-base/KnowledgeBasePlaceholder';
import ReviewsDetail1 from '../reviews/ReviewsDetail1';
import styles from './RolesSticky.module.css';
...
export default function RolesSticky({
  children,
