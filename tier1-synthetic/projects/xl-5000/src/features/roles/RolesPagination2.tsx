...
import RolesHeatmap1 from './RolesHeatmap1';
import styles from './RolesPagination2.module.css';
...
interface RolesPagination2Props {
  items: NavItem[];
  activeId?: string;
...
export default function RolesPagination2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesPagination2">
      {activeItem && (
