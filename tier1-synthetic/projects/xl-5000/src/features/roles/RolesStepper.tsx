...
import RolesLineChart1 from './RolesLineChart1';
import ReviewsSplit from '../reviews/ReviewsSplit';
import styles from './RolesStepper.module.css';
...
export default function RolesStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="RolesStepper">
      {activeItem && (
