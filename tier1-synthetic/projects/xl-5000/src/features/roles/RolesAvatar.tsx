...
import RolesSuspense from './RolesSuspense';
import styles from './RolesAvatar.module.css';

interface RolesAvatarItem {
  assignee: string;
  title: string;
  createdAt: Date;
  updatedAt: Date;
...
interface RolesAvatarProps {
  items?: RolesAvatarItem[];
...
export default function RolesAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
