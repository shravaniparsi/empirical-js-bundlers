...
import RolesNavBar from './RolesNavBar';
import SchedulingRadio from '../scheduling/SchedulingRadio';
import styles from './RolesTimePicker.module.css';


interface RolesTimePickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function RolesTimePicker({
  label,
  name,
