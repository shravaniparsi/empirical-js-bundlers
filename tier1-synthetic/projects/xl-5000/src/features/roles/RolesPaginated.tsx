...
import styles from './RolesPaginated.module.css';
...
interface RolesPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function RolesPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
