...
import styles from './LocalizationLink1.module.css';
...
interface LocalizationLink1Props {
  items: NavItem[];
  activeId?: string;
...
export default function LocalizationLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="LocalizationLink1">
      {activeItem && (
