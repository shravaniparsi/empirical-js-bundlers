...
import styles from './LocalizationFeed1.module.css';

interface LocalizationFeed1Item {
  title: string;
  createdAt: Date;
  description: string;
  id: string;
...
interface LocalizationFeed1Props {
  items?: LocalizationFeed1Item[];
...
export default function LocalizationFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationFeed1Props) {
