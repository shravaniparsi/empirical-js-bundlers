...
import LocalizationResponsive from './LocalizationResponsive';
...
import styles from './LocalizationSpacer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface LocalizationSpacer1Props {
...
export default function LocalizationSpacer1({
  children,
