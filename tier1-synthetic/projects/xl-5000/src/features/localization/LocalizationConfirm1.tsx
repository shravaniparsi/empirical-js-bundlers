...
import styles from './LocalizationConfirm1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface LocalizationConfirm1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function LocalizationConfirm1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
