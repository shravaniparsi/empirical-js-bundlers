...
import styles from './LocalizationBreadcrumb1.module.css';
...
interface LocalizationBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function LocalizationBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="LocalizationBreadcrumb1">
      {activeItem && (
