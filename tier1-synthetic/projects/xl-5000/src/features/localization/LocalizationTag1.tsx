...
import styles from './LocalizationTag1.module.css';

interface LocalizationTag1Item {
  tags: string[];
  assignee: string;
  status: string;
  description: string;
...
interface LocalizationTag1Props {
  items?: LocalizationTag1Item[];
...
export default function LocalizationTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationTag1Props) {
