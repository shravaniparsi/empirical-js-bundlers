...
import styles from './LocalizationBreadcrumb2.module.css';
...
interface LocalizationBreadcrumb2Props {
  items: NavItem[];
  activeId?: string;
...
export default function LocalizationBreadcrumb2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="LocalizationBreadcrumb2">
      {activeItem && (
