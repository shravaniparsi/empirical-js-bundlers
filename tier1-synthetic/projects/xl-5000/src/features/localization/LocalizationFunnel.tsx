...
import LocalizationSpinner from './LocalizationSpinner';
import LocalizationSearch from './LocalizationSearch';
import styles from './LocalizationFunnel.module.css';
...
interface LocalizationFunnelProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function LocalizationFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
