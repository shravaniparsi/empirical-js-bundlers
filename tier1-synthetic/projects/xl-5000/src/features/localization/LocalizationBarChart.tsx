...
import LocalizationBreadcrumb1 from './LocalizationBreadcrumb1';
import LocalizationLoader2 from './LocalizationLoader2';
import styles from './LocalizationBarChart.module.css';
...
interface LocalizationBarChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function LocalizationBarChart({
  data,
  title,
  height = 300,
  showLegend = true,
