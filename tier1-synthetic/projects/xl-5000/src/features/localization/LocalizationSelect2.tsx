...
import styles from './LocalizationSelect2.module.css';


interface LocalizationSelect2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function LocalizationSelect2({
  label,
  name,
