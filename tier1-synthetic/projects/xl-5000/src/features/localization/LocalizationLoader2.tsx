...
import LocalizationLabel1 from './LocalizationLabel1';
import LocalizationTag1 from './LocalizationTag1';
import InventoryFunnel from '../inventory/InventoryFunnel';
import styles from './LocalizationLoader2.module.css';
...
interface LocalizationLoader2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function LocalizationLoader2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
