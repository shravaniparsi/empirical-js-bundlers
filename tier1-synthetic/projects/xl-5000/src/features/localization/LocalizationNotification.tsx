...
import styles from './LocalizationNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface LocalizationNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function LocalizationNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
