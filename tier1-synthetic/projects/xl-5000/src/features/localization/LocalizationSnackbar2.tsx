...
import styles from './LocalizationSnackbar2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface LocalizationSnackbar2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function LocalizationSnackbar2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
