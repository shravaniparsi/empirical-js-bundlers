...
import styles from './LocalizationLoader1.module.css';
...
interface LocalizationLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function LocalizationLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
