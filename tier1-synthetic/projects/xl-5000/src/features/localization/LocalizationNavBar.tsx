...
import styles from './LocalizationNavBar.module.css';
...
interface LocalizationNavBarProps {
  items: NavItem[];
  activeId?: string;
...
export default function LocalizationNavBar({
  ...
  return (
    <nav className={navClasses} aria-label="LocalizationNavBar">
      {activeItem && (
