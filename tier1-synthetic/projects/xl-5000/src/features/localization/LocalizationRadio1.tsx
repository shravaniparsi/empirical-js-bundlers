...
import FaqRank from '../faq/FaqRank';
import NotificationsScore from '../notifications/NotificationsScore';
import styles from './LocalizationRadio1.module.css';


interface LocalizationRadio1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function LocalizationRadio1({
  label,
  name,
