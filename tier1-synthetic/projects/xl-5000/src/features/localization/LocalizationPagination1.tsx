...
import styles from './LocalizationPagination1.module.css';
...
interface LocalizationPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function LocalizationPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="LocalizationPagination1">
      {activeItem && (
