...
import LocalizationSidebar1 from './LocalizationSidebar1';
import styles from './LocalizationGauge2.module.css';
...
interface LocalizationGauge2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function LocalizationGauge2({
  data,
  title,
  height = 300,
  showLegend = true,
