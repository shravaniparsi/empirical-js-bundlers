...
import styles from './LocalizationDetail.module.css';

interface LocalizationDetailItem {
  description: string;
  createdAt: Date;
  assignee: string;
  status: string;
...
interface LocalizationDetailProps {
  items?: LocalizationDetailItem[];
