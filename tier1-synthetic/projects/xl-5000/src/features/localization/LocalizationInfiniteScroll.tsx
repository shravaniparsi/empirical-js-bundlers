...
import LocalizationRating1 from './LocalizationRating1';
import LocalizationGauge2 from './LocalizationGauge2';
import SettingsPagination1 from '../settings/SettingsPagination1';
import ReportsSpinner1 from '../reports/ReportsSpinner1';
import styles from './LocalizationInfiniteScroll.module.css';
...
interface LocalizationInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function LocalizationInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: LocalizationInfiniteScrollProps<T>) {
