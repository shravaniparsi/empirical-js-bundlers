...
import LocalizationScore1 from './LocalizationScore1';
import LocalizationGauge2 from './LocalizationGauge2';
import styles from './LocalizationGauge1.module.css';
...
interface LocalizationGauge1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function LocalizationGauge1({
  data,
  title,
  height = 300,
  showLegend = true,
