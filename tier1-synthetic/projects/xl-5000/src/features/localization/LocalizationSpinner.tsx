...
import styles from './LocalizationSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface LocalizationSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function LocalizationSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
