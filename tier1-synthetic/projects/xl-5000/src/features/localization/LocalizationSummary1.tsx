...
import styles from './LocalizationSummary1.module.css';

interface LocalizationSummary1Item {
  createdAt: Date;
  tags: string[];
  description: string;
  id: string;
...
interface LocalizationSummary1Props {
  items?: LocalizationSummary1Item[];
...
export default function LocalizationSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationSummary1Props) {
