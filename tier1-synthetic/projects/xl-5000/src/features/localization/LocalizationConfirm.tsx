...
import styles from './LocalizationConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface LocalizationConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function LocalizationConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
