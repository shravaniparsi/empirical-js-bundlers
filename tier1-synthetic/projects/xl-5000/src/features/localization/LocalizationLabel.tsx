...
import styles from './LocalizationLabel.module.css';

interface LocalizationLabelItem {
  status: string;
  title: string;
  tags: string[];
  priority: number;
...
interface LocalizationLabelProps {
  items?: LocalizationLabelItem[];
...
export default function LocalizationLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationLabelProps) {
