...
import styles from './LocalizationChip.module.css';

interface LocalizationChipItem {
  title: string;
  assignee: string;
  status: string;
  description: string;
...
interface LocalizationChipProps {
  items?: LocalizationChipItem[];
...
export default function LocalizationChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationChipProps) {
