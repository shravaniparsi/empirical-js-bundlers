...
import styles from './LocalizationPaginated.module.css';
...
interface LocalizationPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function LocalizationPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
