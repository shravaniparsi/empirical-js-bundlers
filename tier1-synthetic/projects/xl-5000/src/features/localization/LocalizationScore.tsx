...
import LocalizationLoader1 from './LocalizationLoader1';
import styles from './LocalizationScore.module.css';

interface LocalizationScoreItem {
  priority: number;
  description: string;
  tags: string[];
  status: string;
...
interface LocalizationScoreProps {
  items?: LocalizationScoreItem[];
...
export default function LocalizationScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationScoreProps) {
