...
import LocalizationBreadcrumb2 from './LocalizationBreadcrumb2';
import styles from './LocalizationDetail1.module.css';

interface LocalizationDetail1Item {
  assignee: string;
  title: string;
  createdAt: Date;
  updatedAt: Date;
...
interface LocalizationDetail1Props {
  items?: LocalizationDetail1Item[];
...
export default function LocalizationDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationDetail1Props) {
