...
import styles from './LocalizationSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface LocalizationSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function LocalizationSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
