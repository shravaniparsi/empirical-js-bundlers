...
import styles from './LocalizationLabel1.module.css';

interface LocalizationLabel1Item {
  updatedAt: Date;
  assignee: string;
  status: string;
  title: string;
...
interface LocalizationLabel1Props {
  items?: LocalizationLabel1Item[];
...
export default function LocalizationLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationLabel1Props) {
