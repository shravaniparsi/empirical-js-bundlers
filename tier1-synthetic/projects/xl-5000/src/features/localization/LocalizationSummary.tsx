...
import ImportsScroll2 from '../imports/ImportsScroll2';
import styles from './LocalizationSummary.module.css';

interface LocalizationSummaryItem {
  tags: string[];
  assignee: string;
  description: string;
  createdAt: Date;
...
export default function LocalizationSummary({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: LocalizationSummaryProps) {
