...
interface LocalizationGaugeProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function LocalizationGauge({
  data,
  title,
  height = 300,
  showLegend = true,
