...
import LocalizationFeed from './LocalizationFeed';
import LocalizationPanel from './LocalizationPanel';
import LocalizationFooter from './LocalizationFooter';
import RolesLoader from '../roles/RolesLoader';
import styles from './LocalizationScroll.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface LocalizationScrollProps {
...
export default function LocalizationScroll({
  children,
