...
import LocalizationScroll from './LocalizationScroll';
import LocalizationSnackbar2 from './LocalizationSnackbar2';
import styles from './LocalizationSidebar1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface LocalizationSidebar1Props {
...
export default function LocalizationSidebar1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
