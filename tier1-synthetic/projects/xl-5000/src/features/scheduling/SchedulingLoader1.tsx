...
import styles from './SchedulingLoader1.module.css';
...
interface SchedulingLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
