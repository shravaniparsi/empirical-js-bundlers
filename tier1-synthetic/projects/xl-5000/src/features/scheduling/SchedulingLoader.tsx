...
import SchedulingScatter from './SchedulingScatter';
import SchedulingRegistry from './SchedulingRegistry';
import styles from './SchedulingLoader.module.css';
...
interface SchedulingLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
