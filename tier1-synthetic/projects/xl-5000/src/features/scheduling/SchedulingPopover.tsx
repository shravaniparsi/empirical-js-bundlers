...
import SchedulingBadge from './SchedulingBadge';
import UsersGauge from '../users/UsersGauge';
import styles from './SchedulingPopover.module.css';
...
export default function SchedulingPopover({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
