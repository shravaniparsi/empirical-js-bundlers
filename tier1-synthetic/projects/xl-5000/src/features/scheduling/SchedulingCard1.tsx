...
import styles from './SchedulingCard1.module.css';

interface SchedulingCard1Item {
  status: string;
  createdAt: Date;
  updatedAt: Date;
  title: string;
...
interface SchedulingCard1Props {
  items?: SchedulingCard1Item[];
...
export default function SchedulingCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingCard1Props) {
