...
import styles from './SchedulingStat.module.css';

interface SchedulingStatItem {
  tags: string[];
  assignee: string;
  updatedAt: Date;
  priority: number;
...
interface SchedulingStatProps {
  items?: SchedulingStatItem[];
...
export default function SchedulingStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
