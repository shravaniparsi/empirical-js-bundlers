...
import SchedulingPanel1 from './SchedulingPanel1';
import styles from './SchedulingBadge2.module.css';

interface SchedulingBadge2Item {
  assignee: string;
  tags: string[];
  createdAt: Date;
  title: string;
...
interface SchedulingBadge2Props {
  items?: SchedulingBadge2Item[];
...
export default function SchedulingBadge2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingBadge2Props) {
