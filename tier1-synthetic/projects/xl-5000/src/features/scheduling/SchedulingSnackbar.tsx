...
import SchedulingBadge2 from './SchedulingBadge2';
import styles from './SchedulingSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SchedulingSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SchedulingSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
