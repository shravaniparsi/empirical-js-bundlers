...
import SchedulingAvatar1 from './SchedulingAvatar1';
import styles from './SchedulingDonut1.module.css';
...
interface SchedulingDonut1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SchedulingDonut1({
  data,
  title,
  height = 300,
  showLegend = true,
