...
import styles from './SchedulingPolling.module.css';
...
interface SchedulingPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
