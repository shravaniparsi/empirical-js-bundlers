...
import SchedulingCached from './SchedulingCached';
import styles from './SchedulingSummary1.module.css';

interface SchedulingSummary1Item {
  updatedAt: Date;
  assignee: string;
  tags: string[];
  createdAt: Date;
...
interface SchedulingSummary1Props {
  items?: SchedulingSummary1Item[];
...
export default function SchedulingSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingSummary1Props) {
