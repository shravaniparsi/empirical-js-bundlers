...
import SchedulingMeter from './SchedulingMeter';
import styles from './SchedulingCached1.module.css';
...
interface SchedulingCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
