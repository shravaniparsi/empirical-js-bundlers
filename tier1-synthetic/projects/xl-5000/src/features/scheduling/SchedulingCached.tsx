...
import styles from './SchedulingCached.module.css';
...
interface SchedulingCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
