...
import styles from './SchedulingCheckbox1.module.css';


interface SchedulingCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SchedulingCheckbox1({
  label,
  name,
