...
import SchedulingRetry1 from './SchedulingRetry1';
import SchedulingThumbnail1 from './SchedulingThumbnail1';
import styles from './SchedulingTabs1.module.css';
...
interface SchedulingTabs1Props {
  items: NavItem[];
  activeId?: string;
...
export default function SchedulingTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SchedulingTabs1">
      {activeItem && (
