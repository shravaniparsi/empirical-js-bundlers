...
import SchedulingSpacer from './SchedulingSpacer';
import SchedulingSplit from './SchedulingSplit';
import styles from './SchedulingSparkline.module.css';
...
interface SchedulingSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SchedulingSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
