...
import styles from './SchedulingTag1.module.css';

interface SchedulingTag1Item {
  title: string;
  status: string;
  createdAt: Date;
  tags: string[];
...
interface SchedulingTag1Props {
  items?: SchedulingTag1Item[];
...
export default function SchedulingTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
