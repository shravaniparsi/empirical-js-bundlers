...
import styles from './SchedulingTimeline4.module.css';

interface SchedulingTimeline4Item {
  tags: string[];
  status: string;
  title: string;
  id: string;
...
interface SchedulingTimeline4Props {
  items?: SchedulingTimeline4Item[];
...
export default function SchedulingTimeline4({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingTimeline4Props) {
