...
import SchedulingBreadcrumb from './SchedulingBreadcrumb';
import DocumentsCached from '../documents/DocumentsCached';
import styles from './SchedulingTag.module.css';

interface SchedulingTagItem {
  updatedAt: Date;
  createdAt: Date;
  status: string;
  title: string;
...
interface SchedulingTagProps {
  items?: SchedulingTagItem[];
...
export default function SchedulingTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['updatedAt', 'createdAt', 'status']);
