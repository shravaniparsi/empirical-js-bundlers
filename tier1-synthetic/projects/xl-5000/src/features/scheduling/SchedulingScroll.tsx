...
import SchedulingPolling from './SchedulingPolling';
import styles from './SchedulingScroll.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SchedulingScrollProps {
...
export default function SchedulingScroll({
  children,
