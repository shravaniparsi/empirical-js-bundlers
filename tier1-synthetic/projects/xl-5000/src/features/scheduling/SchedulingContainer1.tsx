...
import styles from './SchedulingContainer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SchedulingContainer1Props {
...
export default function SchedulingContainer1({
  children,
