...
import styles from './SchedulingBottomNav.module.css';
...
interface SchedulingBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function SchedulingBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SchedulingBottomNav">
      {activeItem && (
