...
import SchedulingAccordion from './SchedulingAccordion';
import styles from './SchedulingRating1.module.css';


interface SchedulingRating1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SchedulingRating1({
  label,
  name,
