...
import styles from './SchedulingBadge1.module.css';

interface SchedulingBadge1Item {
  tags: string[];
  createdAt: Date;
  status: string;
  title: string;
...
interface SchedulingBadge1Props {
  items?: SchedulingBadge1Item[];
...
export default function SchedulingBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingBadge1Props) {
