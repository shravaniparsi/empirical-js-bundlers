...
import SchedulingBadge1 from './SchedulingBadge1';
import SchedulingToggle1 from './SchedulingToggle1';
import SchedulingMenu from './SchedulingMenu';
import styles from './SchedulingChip.module.css';

interface SchedulingChipItem {
  createdAt: Date;
  description: string;
  updatedAt: Date;
  id: string;
...
interface SchedulingChipProps {
  items?: SchedulingChipItem[];
...
export default function SchedulingChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
