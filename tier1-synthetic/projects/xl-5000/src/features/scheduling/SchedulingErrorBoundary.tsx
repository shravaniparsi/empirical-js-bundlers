...
import SchedulingToast2 from './SchedulingToast2';
import SchedulingThumbnail from './SchedulingThumbnail';
import styles from './SchedulingErrorBoundary.module.css';
...
interface SchedulingErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: SchedulingErrorBoundaryProps<T>) {
