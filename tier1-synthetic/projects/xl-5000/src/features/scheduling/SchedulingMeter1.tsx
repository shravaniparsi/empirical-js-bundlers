...
import styles from './SchedulingMeter1.module.css';

interface SchedulingMeter1Item {
  updatedAt: Date;
  createdAt: Date;
  priority: number;
  assignee: string;
...
interface SchedulingMeter1Props {
  items?: SchedulingMeter1Item[];
...
export default function SchedulingMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingMeter1Props) {
