...
import SchedulingConfirm from './SchedulingConfirm';
import SchedulingToggle1 from './SchedulingToggle1';
import styles from './SchedulingPaginated.module.css';
...
interface SchedulingPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
