...
import SchedulingTag from './SchedulingTag';
import styles from './SchedulingTreeView.module.css';
...
interface SchedulingTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function SchedulingTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SchedulingTreeView">
      {activeItem && (
