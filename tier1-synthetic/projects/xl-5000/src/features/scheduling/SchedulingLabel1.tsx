...
import SchedulingResponsive from './SchedulingResponsive';
import ApiKeysRating from '../api-keys/ApiKeysRating';
import styles from './SchedulingLabel1.module.css';

interface SchedulingLabel1Item {
  title: string;
  description: string;
  status: string;
  assignee: string;
...
interface SchedulingLabel1Props {
  items?: SchedulingLabel1Item[];
...
export default function SchedulingLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingLabel1Props) {
