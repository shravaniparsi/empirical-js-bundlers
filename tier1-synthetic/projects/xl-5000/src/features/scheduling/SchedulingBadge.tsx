...
import SchedulingTag1 from './SchedulingTag1';
import SchedulingSticky1 from './SchedulingSticky1';
import styles from './SchedulingBadge.module.css';

interface SchedulingBadgeItem {
  description: string;
  assignee: string;
  updatedAt: Date;
  tags: string[];
...
interface SchedulingBadgeProps {
  items?: SchedulingBadgeItem[];
...
export default function SchedulingBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingBadgeProps) {
