...
import SchedulingScroll from './SchedulingScroll';
import styles from './SchedulingToast2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SchedulingToast2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SchedulingToast2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
