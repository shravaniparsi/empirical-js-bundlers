...
import SchedulingContainer1 from './SchedulingContainer1';
import SchedulingSpacer1 from './SchedulingSpacer1';
import SearchScore from '../search/SearchScore';
import SearchAreaChart from '../search/SearchAreaChart';
import styles from './SchedulingSparkline1.module.css';
...
interface SchedulingSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SchedulingSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
