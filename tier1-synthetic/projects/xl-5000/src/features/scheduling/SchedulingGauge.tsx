...
import SchedulingStat1 from './SchedulingStat1';
import SchedulingCached1 from './SchedulingCached1';
import styles from './SchedulingGauge.module.css';
...
interface SchedulingGaugeProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SchedulingGauge({
  data,
  title,
  height = 300,
  showLegend = true,
