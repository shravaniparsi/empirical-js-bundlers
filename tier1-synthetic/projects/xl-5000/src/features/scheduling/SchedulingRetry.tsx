...
import styles from './SchedulingRetry.module.css';
...
interface SchedulingRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
