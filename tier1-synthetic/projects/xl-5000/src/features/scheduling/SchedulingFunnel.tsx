...
import SchedulingSnackbar from './SchedulingSnackbar';
import SchedulingAutocomplete1 from './SchedulingAutocomplete1';
import styles from './SchedulingFunnel.module.css';
...
interface SchedulingFunnelProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SchedulingFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
