...
import SchedulingAvatar from './SchedulingAvatar';
import SchedulingToast3 from './SchedulingToast3';
import styles from './SchedulingRetry1.module.css';
...
interface SchedulingRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SchedulingRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
