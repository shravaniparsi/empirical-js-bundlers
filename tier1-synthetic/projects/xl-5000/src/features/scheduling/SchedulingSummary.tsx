...
import SchedulingRegistry1 from './SchedulingRegistry1';
import SchedulingLabel1 from './SchedulingLabel1';
import ReviewsHook from '../reviews/ReviewsHook';
import styles from './SchedulingSummary.module.css';

interface SchedulingSummaryItem {
  assignee: string;
  tags: string[];
  description: string;
  id: string;
