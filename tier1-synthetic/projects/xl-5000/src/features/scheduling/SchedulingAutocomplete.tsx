...
import styles from './SchedulingAutocomplete.module.css';


interface SchedulingAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SchedulingAutocomplete({
  label,
  name,
