...
import styles from './SchedulingBreadcrumb.module.css';
...
export default function SchedulingBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SchedulingBreadcrumb">
      {activeItem && (
