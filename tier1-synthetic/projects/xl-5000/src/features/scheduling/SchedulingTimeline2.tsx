...
import SchedulingDonut from './SchedulingDonut';
import SchedulingSparkline from './SchedulingSparkline';
import styles from './SchedulingTimeline2.module.css';

interface SchedulingTimeline2Item {
  status: string;
  createdAt: Date;
  updatedAt: Date;
  id: string;
...
interface SchedulingTimeline2Props {
  items?: SchedulingTimeline2Item[];
...
export default function SchedulingTimeline2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingTimeline2Props) {
