...
import SchedulingHook from './SchedulingHook';
import SchedulingDonut1 from './SchedulingDonut1';
import SchedulingRegistry from './SchedulingRegistry';
import styles from './SchedulingToast.module.css';
...
export default function SchedulingToast({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
