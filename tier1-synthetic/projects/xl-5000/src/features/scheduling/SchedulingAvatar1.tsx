...
import SchedulingSticky from './SchedulingSticky';
import SchedulingThumbnail1 from './SchedulingThumbnail1';
import styles from './SchedulingAvatar1.module.css';

interface SchedulingAvatar1Item {
  priority: number;
  createdAt: Date;
  description: string;
  title: string;
...
interface SchedulingAvatar1Props {
  items?: SchedulingAvatar1Item[];
...
export default function SchedulingAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SchedulingAvatar1Props) {
