...
import SchedulingTimeline2 from './SchedulingTimeline2';
import SchedulingSticky1 from './SchedulingSticky1';
import SchedulingPlaceholder from './SchedulingPlaceholder';
import styles from './SchedulingSpacer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SchedulingSpacer1Props {
...
export default function SchedulingSpacer1({
  children,
