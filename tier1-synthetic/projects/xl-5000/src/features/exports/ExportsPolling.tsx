...
import ExportsErrorBoundary from './ExportsErrorBoundary';
import ExportsTag from './ExportsTag';
import styles from './ExportsPolling.module.css';
...
interface ExportsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ExportsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
