...
import ExportsRank from './ExportsRank';
import styles from './ExportsErrorBoundary.module.css';
...
interface ExportsErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ExportsErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
