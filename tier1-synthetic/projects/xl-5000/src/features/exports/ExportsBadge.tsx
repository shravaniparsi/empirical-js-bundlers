...
import styles from './ExportsBadge.module.css';

interface ExportsBadgeItem {
  updatedAt: Date;
  tags: string[];
  title: string;
  description: string;
...
interface ExportsBadgeProps {
  items?: ExportsBadgeItem[];
...
export default function ExportsBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
