...
import styles from './ExportsThumbnail.module.css';

interface ExportsThumbnailItem {
  description: string;
  createdAt: Date;
  status: string;
  tags: string[];
...
interface ExportsThumbnailProps {
  items?: ExportsThumbnailItem[];
...
export default function ExportsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ExportsThumbnailProps) {
