...
import styles from './ExportsAutocomplete.module.css';


interface ExportsAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ExportsAutocomplete({
  label,
  name,
