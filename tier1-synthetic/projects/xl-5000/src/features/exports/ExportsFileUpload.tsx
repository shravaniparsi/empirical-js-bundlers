...
import ExportsTimePicker1 from './ExportsTimePicker1';
import ExportsContainer2 from './ExportsContainer2';
import styles from './ExportsFileUpload.module.css';


interface ExportsFileUploadProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ExportsFileUpload({
  label,
  name,
