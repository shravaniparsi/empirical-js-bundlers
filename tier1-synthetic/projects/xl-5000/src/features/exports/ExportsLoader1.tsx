...
import ExportsTimePicker from './ExportsTimePicker';
import ExportsBottomNav2 from './ExportsBottomNav2';
import ExportsDonut from './ExportsDonut';
import styles from './ExportsLoader1.module.css';
...
interface ExportsLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ExportsLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
