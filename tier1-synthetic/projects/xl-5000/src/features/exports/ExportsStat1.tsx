...
import ExportsSpinner from './ExportsSpinner';
import styles from './ExportsStat1.module.css';

interface ExportsStat1Item {
  priority: number;
  updatedAt: Date;
  assignee: string;
  id: string;
...
interface ExportsStat1Props {
  items?: ExportsStat1Item[];
...
export default function ExportsStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
