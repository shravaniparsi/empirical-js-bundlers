...
import ExportsCached from './ExportsCached';
import styles from './ExportsBadge1.module.css';

interface ExportsBadge1Item {
  description: string;
  title: string;
  status: string;
  priority: number;
...
interface ExportsBadge1Props {
  items?: ExportsBadge1Item[];
...
export default function ExportsBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
