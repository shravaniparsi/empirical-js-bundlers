...
import ExportsDivider1 from './ExportsDivider1';
import ExportsPolling from './ExportsPolling';
import ExportsTimeline from './ExportsTimeline';
import styles from './ExportsFeed2.module.css';

interface ExportsFeed2Item {
  tags: string[];
  title: string;
  status: string;
  updatedAt: Date;
...
interface ExportsFeed2Props {
  items?: ExportsFeed2Item[];
...
export default function ExportsFeed2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
