...
import styles from './ExportsPolling1.module.css';
...
interface ExportsPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ExportsPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
