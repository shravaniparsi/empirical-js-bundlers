...
import styles from './ExportsRangeSlider1.module.css';


interface ExportsRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ExportsRangeSlider1({
  label,
  name,
