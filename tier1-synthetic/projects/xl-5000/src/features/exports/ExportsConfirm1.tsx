...
import ExportsPieChart1 from './ExportsPieChart1';
import ExportsStack from './ExportsStack';
import styles from './ExportsConfirm1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ExportsConfirm1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ExportsConfirm1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
