...
import ExportsDivider from './ExportsDivider';
import styles from './ExportsPieChart1.module.css';
...
interface ExportsPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ExportsPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
