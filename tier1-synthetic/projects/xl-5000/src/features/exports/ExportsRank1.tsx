...
import styles from './ExportsRank1.module.css';

interface ExportsRank1Item {
  tags: string[];
  assignee: string;
  updatedAt: Date;
  priority: number;
...
interface ExportsRank1Props {
  items?: ExportsRank1Item[];
...
export default function ExportsRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
