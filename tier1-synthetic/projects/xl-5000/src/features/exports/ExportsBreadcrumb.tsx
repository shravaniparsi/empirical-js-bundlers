...
import styles from './ExportsBreadcrumb.module.css';
...
interface ExportsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function ExportsBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ExportsBreadcrumb">
      {activeItem && (
