...
import ExportsSticky from './ExportsSticky';
import ExportsLoader from './ExportsLoader';
import ExportsConfirm from './ExportsConfirm';
import ProfileStepper3 from '../profile/ProfileStepper3';
import styles from './ExportsSkeleton2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ExportsSkeleton2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ExportsSkeleton2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
