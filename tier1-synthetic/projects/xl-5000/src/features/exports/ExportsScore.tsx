...
import styles from './ExportsScore.module.css';

interface ExportsScoreItem {
  assignee: string;
  status: string;
  createdAt: Date;
  priority: number;
...
interface ExportsScoreProps {
  items?: ExportsScoreItem[];
...
export default function ExportsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
