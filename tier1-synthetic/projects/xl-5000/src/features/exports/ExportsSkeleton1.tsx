...
import ExportsFileUpload1 from './ExportsFileUpload1';
import ExportsThumbnail from './ExportsThumbnail';
import styles from './ExportsSkeleton1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ExportsSkeleton1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ExportsSkeleton1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
