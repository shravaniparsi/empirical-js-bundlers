...
import ExportsRank2 from './ExportsRank2';
import styles from './ExportsTimePicker.module.css';


interface ExportsTimePickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ExportsTimePicker({
  label,
  name,
