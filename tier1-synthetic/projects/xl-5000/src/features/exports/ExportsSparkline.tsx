...
import ExportsStack1 from './ExportsStack1';
import ExportsPanel1 from './ExportsPanel1';
import styles from './ExportsSparkline.module.css';
...
interface ExportsSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ExportsSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
