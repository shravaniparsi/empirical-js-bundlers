...
import ExportsDatePicker from './ExportsDatePicker';
import ExportsFeed from './ExportsFeed';
import styles from './ExportsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ExportsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ExportsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
