...
import styles from './ExportsProgress.module.css';

interface ExportsProgressItem {
  updatedAt: Date;
  tags: string[];
  description: string;
  id: string;
...
interface ExportsProgressProps {
  items?: ExportsProgressItem[];
...
export default function ExportsProgress({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ExportsProgressProps) {
