...
import ExportsAvatar from './ExportsAvatar';
import ExportsAreaChart from './ExportsAreaChart';
import ExportsFeed1 from './ExportsFeed1';
import styles from './ExportsLoader.module.css';
...
interface ExportsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ExportsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
