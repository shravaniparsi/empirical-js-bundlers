...
import styles from './ExportsPreview1.module.css';

interface ExportsPreview1Item {
  title: string;
  tags: string[];
  updatedAt: Date;
  status: string;
...
interface ExportsPreview1Props {
  items?: ExportsPreview1Item[];
...
export default function ExportsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ExportsPreview1Props) {
