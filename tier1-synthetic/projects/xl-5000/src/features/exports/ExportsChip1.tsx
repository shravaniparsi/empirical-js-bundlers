...
import styles from './ExportsChip1.module.css';

interface ExportsChip1Item {
  status: string;
  tags: string[];
  priority: number;
  updatedAt: Date;
...
interface ExportsChip1Props {
  items?: ExportsChip1Item[];
...
export default function ExportsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
