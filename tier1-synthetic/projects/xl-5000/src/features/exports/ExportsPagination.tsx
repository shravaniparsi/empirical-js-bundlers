...
import ExportsFeed2 from './ExportsFeed2';
import ExportsSkeleton1 from './ExportsSkeleton1';
import DashboardPanel1 from '../dashboard/DashboardPanel1';
import styles from './ExportsPagination.module.css';
...
interface ExportsPaginationProps {
  items: NavItem[];
  activeId?: string;
...
export default function ExportsPagination({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ExportsPagination">
      {activeItem && (
