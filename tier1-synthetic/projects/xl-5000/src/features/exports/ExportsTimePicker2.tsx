...
import ExportsErrorBoundary1 from './ExportsErrorBoundary1';
import ExportsAlert from './ExportsAlert';
import ExportsPieChart from './ExportsPieChart';
import styles from './ExportsTimePicker2.module.css';


interface ExportsTimePicker2Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function ExportsTimePicker2({
  label,
  name,
