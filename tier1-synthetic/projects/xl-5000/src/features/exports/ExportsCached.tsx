...
import ExportsBottomNav1 from './ExportsBottomNav1';
import styles from './ExportsCached.module.css';
...
interface ExportsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ExportsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
