...
import styles from './ExportsBottomNav2.module.css';
...
interface ExportsBottomNav2Props {
  items: NavItem[];
  activeId?: string;
...
export default function ExportsBottomNav2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ExportsBottomNav2">
      {activeItem && (
