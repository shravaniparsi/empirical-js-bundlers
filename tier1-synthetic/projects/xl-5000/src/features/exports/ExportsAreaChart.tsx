...
import ExportsList1 from './ExportsList1';
import styles from './ExportsAreaChart.module.css';
...
interface ExportsAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ExportsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
