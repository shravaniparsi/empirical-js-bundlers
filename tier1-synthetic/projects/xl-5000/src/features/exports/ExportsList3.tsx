...
import styles from './ExportsList3.module.css';

interface ExportsList3Item {
  status: string;
  updatedAt: Date;
  assignee: string;
  tags: string[];
...
interface ExportsList3Props {
  items?: ExportsList3Item[];
...
export default function ExportsList3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
