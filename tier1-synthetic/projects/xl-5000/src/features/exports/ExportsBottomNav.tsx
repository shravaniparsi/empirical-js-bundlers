...
import styles from './ExportsBottomNav.module.css';
...
interface ExportsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function ExportsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ExportsBottomNav">
      {activeItem && (
