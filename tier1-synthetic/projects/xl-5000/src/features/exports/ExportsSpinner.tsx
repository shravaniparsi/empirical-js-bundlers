...
import ExportsConfirm1 from './ExportsConfirm1';
import ExportsPreview from './ExportsPreview';
import ExportsFeed from './ExportsFeed';
import styles from './ExportsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ExportsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ExportsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
