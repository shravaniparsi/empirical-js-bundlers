...
import ExportsContainer2 from './ExportsContainer2';
import ExportsChip1 from './ExportsChip1';
import InventoryBanner1 from '../inventory/InventoryBanner1';
import styles from './ExportsBottomNav1.module.css';
...
interface ExportsBottomNav1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ExportsBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ExportsBottomNav1">
      {activeItem && (
