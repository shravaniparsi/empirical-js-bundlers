...
import styles from './ExportsChip2.module.css';

interface ExportsChip2Item {
  assignee: string;
  status: string;
  tags: string[];
  updatedAt: Date;
...
interface ExportsChip2Props {
  items?: ExportsChip2Item[];
...
export default function ExportsChip2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
