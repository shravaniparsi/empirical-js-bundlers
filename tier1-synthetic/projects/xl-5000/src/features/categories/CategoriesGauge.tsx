...
import CategoriesPolling from './CategoriesPolling';
import styles from './CategoriesGauge.module.css';
...
interface CategoriesGaugeProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CategoriesGauge({
  data,
  title,
  height = 300,
  showLegend = true,
