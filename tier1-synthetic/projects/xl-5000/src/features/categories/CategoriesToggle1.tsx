...
import CategoriesBadge1 from './CategoriesBadge1';
import CategoriesMeter2 from './CategoriesMeter2';
import CategoriesContainer1 from './CategoriesContainer1';
import styles from './CategoriesToggle1.module.css';


interface CategoriesToggle1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CategoriesToggle1({
  label,
  name,
