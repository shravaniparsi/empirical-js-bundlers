...
import styles from './CategoriesCheckbox1.module.css';


interface CategoriesCheckbox1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CategoriesCheckbox1({
  label,
  name,
