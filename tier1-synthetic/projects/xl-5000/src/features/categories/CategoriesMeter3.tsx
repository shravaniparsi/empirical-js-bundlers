...
import styles from './CategoriesMeter3.module.css';

interface CategoriesMeter3Item {
  tags: string[];
  createdAt: Date;
  description: string;
  status: string;
...
interface CategoriesMeter3Props {
  items?: CategoriesMeter3Item[];
...
export default function CategoriesMeter3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesMeter3Props) {
