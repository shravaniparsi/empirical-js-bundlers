...
import CategoriesSpacer from './CategoriesSpacer';
import CategoriesFooter1 from './CategoriesFooter1';
import CategoriesContainer2 from './CategoriesContainer2';
import styles from './CategoriesNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CategoriesNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CategoriesNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
