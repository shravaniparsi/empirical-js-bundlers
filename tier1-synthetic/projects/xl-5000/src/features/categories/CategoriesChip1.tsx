...
import styles from './CategoriesChip1.module.css';

interface CategoriesChip1Item {
  createdAt: Date;
  updatedAt: Date;
  priority: number;
  title: string;
...
interface CategoriesChip1Props {
  items?: CategoriesChip1Item[];
...
export default function CategoriesChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesChip1Props) {
