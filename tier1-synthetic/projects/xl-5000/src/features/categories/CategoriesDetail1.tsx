...
import CategoriesColorPicker from './CategoriesColorPicker';
import CategoriesGrid1 from './CategoriesGrid1';
import PaymentsSlider from '../payments/PaymentsSlider';
import styles from './CategoriesDetail1.module.css';

interface CategoriesDetail1Item {
  status: string;
  description: string;
  updatedAt: Date;
  tags: string[];
...
interface CategoriesDetail1Props {
  items?: CategoriesDetail1Item[];
...
export default function CategoriesDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesDetail1Props) {
