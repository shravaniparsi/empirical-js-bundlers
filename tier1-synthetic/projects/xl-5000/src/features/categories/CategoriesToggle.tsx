...
import CategoriesTimePicker1 from './CategoriesTimePicker1';
import styles from './CategoriesToggle.module.css';

const CategoriesToggleSchema = z.object({
...
export default function CategoriesToggle({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CategoriesToggleSchema.safeParse({ value: val });
