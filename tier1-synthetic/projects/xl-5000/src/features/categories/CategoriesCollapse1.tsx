...
import styles from './CategoriesCollapse1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CategoriesCollapse1Props {
...
export default function CategoriesCollapse1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
