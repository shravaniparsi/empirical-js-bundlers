...
import styles from './CategoriesInfiniteScroll.module.css';
...
interface CategoriesInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: CategoriesInfiniteScrollProps<T>) {
