...
import styles from './CategoriesPieChart1.module.css';
...
interface CategoriesPieChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CategoriesPieChart1({
  data,
  title,
  height = 300,
  showLegend = true,
