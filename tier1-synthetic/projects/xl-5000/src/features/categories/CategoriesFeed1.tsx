...
import styles from './CategoriesFeed1.module.css';

interface CategoriesFeed1Item {
  createdAt: Date;
  priority: number;
  title: string;
  assignee: string;
...
interface CategoriesFeed1Props {
  items?: CategoriesFeed1Item[];
...
export default function CategoriesFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesFeed1Props) {
