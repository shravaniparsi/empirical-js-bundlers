...
import styles from './CategoriesTreeView1.module.css';
...
interface CategoriesTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CategoriesTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CategoriesTreeView1">
      {activeItem && (
