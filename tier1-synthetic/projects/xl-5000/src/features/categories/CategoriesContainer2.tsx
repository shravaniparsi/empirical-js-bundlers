...
import styles from './CategoriesContainer2.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CategoriesContainer2Props {
...
export default function CategoriesContainer2({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
