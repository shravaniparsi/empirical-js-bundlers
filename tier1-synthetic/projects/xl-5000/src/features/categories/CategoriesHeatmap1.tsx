...
import CategoriesSearch1 from './CategoriesSearch1';
import CatalogPaginated from '../catalog/CatalogPaginated';
import styles from './CategoriesHeatmap1.module.css';
...
interface CategoriesHeatmap1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CategoriesHeatmap1({
  data,
  title,
  height = 300,
  showLegend = true,
