...
import styles from './CategoriesCard1.module.css';

interface CategoriesCard1Item {
  status: string;
  title: string;
  tags: string[];
  updatedAt: Date;
...
interface CategoriesCard1Props {
  items?: CategoriesCard1Item[];
...
export default function CategoriesCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesCard1Props) {
