...
interface CategoriesSparkline2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CategoriesSparkline2({
  data,
  title,
  height = 300,
  showLegend = true,
