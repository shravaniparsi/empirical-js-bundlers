...
import styles from './CategoriesTabs2.module.css';
...
interface CategoriesTabs2Props {
  items: NavItem[];
  activeId?: string;
...
export default function CategoriesTabs2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CategoriesTabs2">
      {activeItem && (
