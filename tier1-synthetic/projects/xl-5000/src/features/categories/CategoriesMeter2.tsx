...
import styles from './CategoriesMeter2.module.css';

interface CategoriesMeter2Item {
  title: string;
  description: string;
  assignee: string;
  status: string;
...
interface CategoriesMeter2Props {
  items?: CategoriesMeter2Item[];
...
export default function CategoriesMeter2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesMeter2Props) {
