...
import styles from './CategoriesLink1.module.css';
...
interface CategoriesLink1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CategoriesLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CategoriesLink1">
      {activeItem && (
