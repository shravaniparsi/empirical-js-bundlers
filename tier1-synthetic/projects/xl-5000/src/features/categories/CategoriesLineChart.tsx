...
import CategoriesBanner1 from './CategoriesBanner1';
import AdminAreaChart1 from '../admin/AdminAreaChart1';
import styles from './CategoriesLineChart.module.css';
...
export default function CategoriesLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
