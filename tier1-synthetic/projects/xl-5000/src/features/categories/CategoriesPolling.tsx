...
import styles from './CategoriesPolling.module.css';
...
interface CategoriesPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
