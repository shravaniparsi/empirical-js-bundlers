...
import CategoriesTabs2 from './CategoriesTabs2';
import styles from './CategoriesSparkline1.module.css';
...
interface CategoriesSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CategoriesSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
