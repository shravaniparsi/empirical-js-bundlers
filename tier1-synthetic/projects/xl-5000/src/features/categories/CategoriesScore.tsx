...
import CategoriesCached from './CategoriesCached';
import CategoriesPreview from './CategoriesPreview';
import styles from './CategoriesScore.module.css';

interface CategoriesScoreItem {
  createdAt: Date;
  assignee: string;
  tags: string[];
  priority: number;
...
export default function CategoriesScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CategoriesScoreProps) {
