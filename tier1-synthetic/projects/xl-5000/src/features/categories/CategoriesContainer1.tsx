...
import CategoriesSplit from './CategoriesSplit';
import CategoriesPrefetch1 from './CategoriesPrefetch1';
import styles from './CategoriesContainer1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CategoriesContainer1Props {
...
export default function CategoriesContainer1({
  children,
