...
import styles from './CategoriesLink2.module.css';
...
interface CategoriesLink2Props {
  items: NavItem[];
  activeId?: string;
...
export default function CategoriesLink2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CategoriesLink2">
      {activeItem && (
