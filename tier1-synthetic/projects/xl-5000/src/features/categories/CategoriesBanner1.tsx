...
import CategoriesFeed1 from './CategoriesFeed1';
import CategoriesInput from './CategoriesInput';
import styles from './CategoriesBanner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CategoriesBanner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CategoriesBanner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
