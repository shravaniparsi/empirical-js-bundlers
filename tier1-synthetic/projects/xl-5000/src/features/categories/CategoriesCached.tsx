...
import CategoriesToggle1 from './CategoriesToggle1';
import CategoriesRangeSlider from './CategoriesRangeSlider';
import CategoriesBanner from './CategoriesBanner';
import InventoryProgress2 from '../inventory/InventoryProgress2';
import OrdersScore1 from '../orders/OrdersScore1';
import styles from './CategoriesCached.module.css';
...
interface CategoriesCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CategoriesCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
