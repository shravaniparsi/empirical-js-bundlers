...
import FaqNotification from './FaqNotification';
import FaqTag1 from './FaqTag1';
import FaqAlert from './FaqAlert';
import styles from './FaqPaginated.module.css';
...
interface FaqPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FaqPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
