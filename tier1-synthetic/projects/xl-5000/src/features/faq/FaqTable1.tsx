...
import FaqLineChart1 from './FaqLineChart1';
import styles from './FaqTable1.module.css';

interface FaqTable1Item {
  status: string;
  title: string;
  updatedAt: Date;
  priority: number;
...
export default function FaqTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
