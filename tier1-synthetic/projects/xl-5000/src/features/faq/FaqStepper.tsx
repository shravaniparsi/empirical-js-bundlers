...
import FaqColorPicker1 from './FaqColorPicker1';
import FaqTreeView from './FaqTreeView';
import FaqProvider from './FaqProvider';
import styles from './FaqStepper.module.css';
...
export default function FaqStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="FaqStepper">
      {activeItem && (
