...
import FaqTable1 from './FaqTable1';
import FaqDrawer from './FaqDrawer';
import FaqResponsive from './FaqResponsive';
import styles from './FaqAvatar.module.css';

interface FaqAvatarItem {
  title: string;
  status: string;
  assignee: string;
  priority: number;
...
export default function FaqAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
