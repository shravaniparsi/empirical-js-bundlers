...
import FaqTextArea1 from './FaqTextArea1';
import FaqAlert1 from './FaqAlert1';
import styles from './FaqBottomNav.module.css';
...
export default function FaqBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="FaqBottomNav">
      {activeItem && (
