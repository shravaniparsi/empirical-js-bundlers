...
import SurveysSidebar from '../surveys/SurveysSidebar';
import styles from './FaqRetry.module.css';
...
interface FaqRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FaqRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
