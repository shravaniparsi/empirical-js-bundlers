...
import FaqRangeSlider from './FaqRangeSlider';
import FaqFeed1 from './FaqFeed1';
import InventoryBreadcrumb from '../inventory/InventoryBreadcrumb';
import styles from './FaqTimeline1.module.css';

interface FaqTimeline1Item {
  createdAt: Date;
  description: string;
  updatedAt: Date;
  status: string;
...
interface FaqTimeline1Props {
  items?: FaqTimeline1Item[];
...
export default function FaqTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
