...
import FaqAreaChart1 from './FaqAreaChart1';
import FaqDatePicker from './FaqDatePicker';
import styles from './FaqBottomNav1.module.css';
...
export default function FaqBottomNav1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="FaqBottomNav1">
      {activeItem && (
