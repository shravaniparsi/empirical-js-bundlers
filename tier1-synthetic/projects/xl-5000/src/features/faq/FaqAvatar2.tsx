...
import FaqScatter from './FaqScatter';
import FaqStat from './FaqStat';
import styles from './FaqAvatar2.module.css';

interface FaqAvatar2Item {
  status: string;
  createdAt: Date;
  assignee: string;
  title: string;
...
interface FaqAvatar2Props {
  items?: FaqAvatar2Item[];
...
export default function FaqAvatar2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
