...
import FaqPagination1 from './FaqPagination1';
import FaqHeader1 from './FaqHeader1';
import IntegrationsScroll1 from '../integrations/IntegrationsScroll1';
import styles from './FaqPagination.module.css';
...
export default function FaqPagination({
  ...
  return (
    <nav className={navClasses} aria-label="FaqPagination">
      {activeItem && (
