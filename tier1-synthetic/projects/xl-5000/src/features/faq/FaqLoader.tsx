...
import FaqScatter2 from './FaqScatter2';
import FaqSpinner from './FaqSpinner';
import FaqFeed1 from './FaqFeed1';
import styles from './FaqLoader.module.css';
...
interface FaqLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FaqLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
