...
import styles from './FaqPagination1.module.css';
...
export default function FaqPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="FaqPagination1">
      {activeItem && (
