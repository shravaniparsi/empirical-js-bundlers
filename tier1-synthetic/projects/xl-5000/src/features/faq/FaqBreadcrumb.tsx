...
import FaqTimeline1 from './FaqTimeline1';
import FaqRetry from './FaqRetry';
import AdminTooltip3 from '../admin/AdminTooltip3';
import styles from './FaqBreadcrumb.module.css';
...
export default function FaqBreadcrumb({
  ...
  return (
    <nav className={navClasses} aria-label="FaqBreadcrumb">
      {activeItem && (
