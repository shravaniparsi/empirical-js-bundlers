...
import FaqChip1 from './FaqChip1';
import FaqSnackbar1 from './FaqSnackbar1';
import FaqRetry from './FaqRetry';
import styles from './FaqBadge1.module.css';

interface FaqBadge1Item {
  assignee: string;
  priority: number;
  description: string;
  status: string;
...
export default function FaqBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
