...
import FaqBottomNav1 from './FaqBottomNav1';
import FaqChip from './FaqChip';
import styles from './FaqScatter1.module.css';
...
export default function FaqScatter1({
  data,
  title,
  height = 300,
  showLegend = true,
