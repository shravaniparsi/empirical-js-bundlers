...
import FaqTextArea2 from './FaqTextArea2';
import FaqAvatar1 from './FaqAvatar1';
import FaqDetail from './FaqDetail';
import styles from './FaqPaginated1.module.css';
...
interface FaqPaginated1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function FaqPaginated1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
