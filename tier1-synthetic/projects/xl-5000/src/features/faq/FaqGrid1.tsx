...
import FaqAvatar from './FaqAvatar';
import FaqAvatar1 from './FaqAvatar1';
import styles from './FaqGrid1.module.css';

interface FaqGrid1Item {
  title: string;
  createdAt: Date;
  description: string;
  priority: number;
...
export default function FaqGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
