...
import styles from './DocumentsAvatar.module.css';

interface DocumentsAvatarItem {
  updatedAt: Date;
  description: string;
  createdAt: Date;
  id: string;
...
interface DocumentsAvatarProps {
  items?: DocumentsAvatarItem[];
...
export default function DocumentsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: DocumentsAvatarProps) {
