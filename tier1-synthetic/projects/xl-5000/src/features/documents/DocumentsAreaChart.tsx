...
import DocumentsSuspense1 from './DocumentsSuspense1';
import DocumentsTag from './DocumentsTag';
import styles from './DocumentsAreaChart.module.css';
...
interface DocumentsAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function DocumentsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
