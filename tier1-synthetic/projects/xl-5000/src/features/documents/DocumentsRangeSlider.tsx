...
import styles from './DocumentsRangeSlider.module.css';


interface DocumentsRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function DocumentsRangeSlider({
  label,
  name,
