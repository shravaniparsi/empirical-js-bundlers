...
import styles from './DocumentsBottomNav.module.css';
...
interface DocumentsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function DocumentsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DocumentsBottomNav">
      {activeItem && (
