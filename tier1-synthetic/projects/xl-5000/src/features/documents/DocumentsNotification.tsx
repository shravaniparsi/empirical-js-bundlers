...
import FaqStat from '../faq/FaqStat';
import styles from './DocumentsNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface DocumentsNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function DocumentsNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
