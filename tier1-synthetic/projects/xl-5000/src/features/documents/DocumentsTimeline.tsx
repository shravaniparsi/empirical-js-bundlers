...
import DocumentsSpinner from './DocumentsSpinner';
import DocumentsScatter from './DocumentsScatter';
import OrdersHeatmap1 from '../orders/OrdersHeatmap1';
import styles from './DocumentsTimeline.module.css';

interface DocumentsTimelineItem {
  priority: number;
  tags: string[];
  assignee: string;
  title: string;
