...
import CampaignsAreaChart2 from '../campaigns/CampaignsAreaChart2';
import styles from './DocumentsCached.module.css';
...
interface DocumentsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
