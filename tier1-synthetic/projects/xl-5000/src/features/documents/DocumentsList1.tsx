...
import styles from './DocumentsList1.module.css';

interface DocumentsList1Item {
  title: string;
  tags: string[];
  description: string;
  assignee: string;
...
interface DocumentsList1Props {
  items?: DocumentsList1Item[];
...
export default function DocumentsList1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
