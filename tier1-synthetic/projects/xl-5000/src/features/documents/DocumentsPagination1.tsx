...
import styles from './DocumentsPagination1.module.css';
...
interface DocumentsPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function DocumentsPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DocumentsPagination1">
      {activeItem && (
