...
import DocumentsSpacer from './DocumentsSpacer';
import ApiKeysTextArea from '../api-keys/ApiKeysTextArea';
import styles from './DocumentsDetail.module.css';

interface DocumentsDetailItem {
  title: string;
  tags: string[];
  description: string;
  priority: number;
