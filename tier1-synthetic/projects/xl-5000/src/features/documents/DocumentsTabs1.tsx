...
import DocumentsAreaChart from './DocumentsAreaChart';
import DocumentsBanner from './DocumentsBanner';
import styles from './DocumentsTabs1.module.css';
...
export default function DocumentsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="DocumentsTabs1">
      {activeItem && (
