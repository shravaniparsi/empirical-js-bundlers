...
import DocumentsScore from './DocumentsScore';
import DocumentsTabs1 from './DocumentsTabs1';
import DocumentsSticky from './DocumentsSticky';
import FeedbackMgmtSummary from '../feedback-mgmt/FeedbackMgmtSummary';
import styles from './DocumentsPolling.module.css';
...
interface DocumentsPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
