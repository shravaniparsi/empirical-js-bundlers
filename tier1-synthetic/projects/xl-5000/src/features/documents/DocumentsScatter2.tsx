...
import DocumentsStat from './DocumentsStat';
import styles from './DocumentsScatter2.module.css';
...
interface DocumentsScatter2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function DocumentsScatter2({
  data,
  title,
  height = 300,
  showLegend = true,
