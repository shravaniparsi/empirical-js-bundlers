...
import DocumentsScatter from './DocumentsScatter';
import styles from './DocumentsScore1.module.css';

interface DocumentsScore1Item {
  tags: string[];
  createdAt: Date;
  priority: number;
  assignee: string;
...
interface DocumentsScore1Props {
  items?: DocumentsScore1Item[];
...
export default function DocumentsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: DocumentsScore1Props) {
