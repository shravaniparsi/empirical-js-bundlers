...
import DocumentsFunnel1 from './DocumentsFunnel1';
import DocumentsContext from './DocumentsContext';
import styles from './DocumentsHeatmap.module.css';
...
export default function DocumentsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
