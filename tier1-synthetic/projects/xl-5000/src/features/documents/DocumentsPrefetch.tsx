...
import DocumentsSnackbar from './DocumentsSnackbar';
import DocumentsHeatmap from './DocumentsHeatmap';
import ProductsDonut1 from '../products/ProductsDonut1';
import styles from './DocumentsPrefetch.module.css';
...
interface DocumentsPrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsPrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
