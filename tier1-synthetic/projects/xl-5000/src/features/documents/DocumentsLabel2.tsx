...
import styles from './DocumentsLabel2.module.css';

interface DocumentsLabel2Item {
  tags: string[];
  status: string;
  priority: number;
  assignee: string;
...
interface DocumentsLabel2Props {
  items?: DocumentsLabel2Item[];
...
export default function DocumentsLabel2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: DocumentsLabel2Props) {
