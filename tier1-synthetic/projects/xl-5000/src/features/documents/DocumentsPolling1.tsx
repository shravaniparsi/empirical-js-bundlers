...
import DocumentsResponsive from './DocumentsResponsive';
import DocumentsTreeView from './DocumentsTreeView';
import FaqBadge1 from '../faq/FaqBadge1';
import ShippingTag1 from '../shipping/ShippingTag1';
import styles from './DocumentsPolling1.module.css';
...
interface DocumentsPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function DocumentsPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
