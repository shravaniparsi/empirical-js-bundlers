...
import DocumentsHOC from './DocumentsHOC';
import DocumentsTextArea from './DocumentsTextArea';
import TemplatesStepper1 from '../templates/TemplatesStepper1';
import AuthAreaChart1 from '../auth/AuthAreaChart1';
import TeamsPreview from '../teams/TeamsPreview';
import styles from './DocumentsStat1.module.css';

interface DocumentsStat1Item {
  updatedAt: Date;
  description: string;
  priority: number;
  status: string;
...
interface DocumentsStat1Props {
  items?: DocumentsStat1Item[];
...
export default function DocumentsStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
