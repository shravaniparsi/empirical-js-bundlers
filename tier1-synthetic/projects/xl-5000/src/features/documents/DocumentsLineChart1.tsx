...
import DocumentsSuspense from './DocumentsSuspense';
import DocumentsPanel from './DocumentsPanel';
import DocumentsSnackbar1 from './DocumentsSnackbar1';
import styles from './DocumentsLineChart1.module.css';
...
interface DocumentsLineChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function DocumentsLineChart1({
  data,
  title,
  height = 300,
  showLegend = true,
