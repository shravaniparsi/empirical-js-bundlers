...
import DocumentsStat1 from './DocumentsStat1';
import DocumentsTable2 from './DocumentsTable2';
import styles from './DocumentsSnackbar1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface DocumentsSnackbar1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function DocumentsSnackbar1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
