...
import DocumentsLabel from './DocumentsLabel';
import DocumentsDetail from './DocumentsDetail';
import ReviewsSidebar from '../reviews/ReviewsSidebar';
import styles from './DocumentsNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface DocumentsNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function DocumentsNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
