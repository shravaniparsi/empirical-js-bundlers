...
import DocumentsMeter from './DocumentsMeter';
import DocumentsSnackbar from './DocumentsSnackbar';
import DocumentsScore from './DocumentsScore';
import styles from './DocumentsBarChart1.module.css';
...
interface DocumentsBarChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function DocumentsBarChart1({
  data,
  title,
  height = 300,
  showLegend = true,
