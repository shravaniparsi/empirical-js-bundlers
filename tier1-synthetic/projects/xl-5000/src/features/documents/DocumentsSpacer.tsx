...
import DocumentsTable1 from './DocumentsTable1';
import OnboardingDatePicker from '../onboarding/OnboardingDatePicker';
import styles from './DocumentsSpacer.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface DocumentsSpacerProps {
...
export default function DocumentsSpacer({
  children,
