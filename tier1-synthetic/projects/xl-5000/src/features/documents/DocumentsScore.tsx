...
import styles from './DocumentsScore.module.css';

interface DocumentsScoreItem {
  title: string;
  createdAt: Date;
  assignee: string;
  description: string;
...
interface DocumentsScoreProps {
  items?: DocumentsScoreItem[];
...
export default function DocumentsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
