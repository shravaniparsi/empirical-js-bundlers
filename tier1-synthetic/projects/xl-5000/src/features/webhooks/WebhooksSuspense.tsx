...
import styles from './WebhooksSuspense.module.css';
...
interface WebhooksSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
