...
import WebhooksSuspense1 from './WebhooksSuspense1';
...
import styles from './WebhooksLoader.module.css';
...
interface WebhooksLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
