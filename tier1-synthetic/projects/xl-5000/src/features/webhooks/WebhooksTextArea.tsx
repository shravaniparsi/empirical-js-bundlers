...
import WebhooksStepper from './WebhooksStepper';
import styles from './WebhooksTextArea.module.css';


interface WebhooksTextAreaProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function WebhooksTextArea({
  label,
  name,
