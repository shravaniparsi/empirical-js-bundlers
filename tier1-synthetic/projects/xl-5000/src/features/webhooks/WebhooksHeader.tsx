...
import WebhooksRating from './WebhooksRating';
import LocalizationInfiniteScroll from '../localization/LocalizationInfiniteScroll';
import AnalyticsList from '../analytics/AnalyticsList';
import styles from './WebhooksHeader.module.css';
