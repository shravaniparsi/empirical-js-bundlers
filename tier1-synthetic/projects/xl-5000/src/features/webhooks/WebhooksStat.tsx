...
import WebhooksDetail3 from './WebhooksDetail3';
import styles from './WebhooksStat.module.css';

interface WebhooksStatItem {
  updatedAt: Date;
  createdAt: Date;
  tags: string[];
  title: string;
...
interface WebhooksStatProps {
  items?: WebhooksStatItem[];
...
export default function WebhooksStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
