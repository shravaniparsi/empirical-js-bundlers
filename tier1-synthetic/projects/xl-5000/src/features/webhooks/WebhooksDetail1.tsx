...
import styles from './WebhooksDetail1.module.css';

interface WebhooksDetail1Item {
  createdAt: Date;
  description: string;
  assignee: string;
  priority: number;
...
interface WebhooksDetail1Props {
  items?: WebhooksDetail1Item[];
...
export default function WebhooksDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WebhooksDetail1Props) {
