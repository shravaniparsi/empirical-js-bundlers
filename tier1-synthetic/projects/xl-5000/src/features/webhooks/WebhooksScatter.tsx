...
import WebhooksTabs2 from './WebhooksTabs2';
import WebhooksChip from './WebhooksChip';
import ApiKeysPieChart1 from '../api-keys/ApiKeysPieChart1';
import styles from './WebhooksScatter.module.css';
...
interface WebhooksScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WebhooksScatter({
  data,
  title,
  height = 300,
  showLegend = true,
