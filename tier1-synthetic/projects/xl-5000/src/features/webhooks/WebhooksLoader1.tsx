...
import styles from './WebhooksLoader1.module.css';
...
interface WebhooksLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
