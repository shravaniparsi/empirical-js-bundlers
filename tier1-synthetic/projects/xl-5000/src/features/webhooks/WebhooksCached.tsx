...
import styles from './WebhooksCached.module.css';
...
interface WebhooksCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
