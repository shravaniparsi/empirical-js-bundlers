...
import WebhooksSearch3 from './WebhooksSearch3';
import styles from './WebhooksTabs1.module.css';
...
export default function WebhooksTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksTabs1">
      {activeItem && (
