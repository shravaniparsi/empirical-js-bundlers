...
import styles from './WebhooksLink.module.css';
...
export default function WebhooksLink({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksLink">
      {activeItem && (
