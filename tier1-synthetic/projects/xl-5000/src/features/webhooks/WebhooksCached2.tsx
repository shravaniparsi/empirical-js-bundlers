...
import WebhooksStack2 from './WebhooksStack2';
import WebhooksStack from './WebhooksStack';
import MediaBadge from '../media/MediaBadge';
import styles from './WebhooksCached2.module.css';
...
interface WebhooksCached2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksCached2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
