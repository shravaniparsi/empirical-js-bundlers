...
import styles from './WebhooksTimeline.module.css';

interface WebhooksTimelineItem {
  tags: string[];
  description: string;
  title: string;
  assignee: string;
...
interface WebhooksTimelineProps {
  items?: WebhooksTimelineItem[];
...
export default function WebhooksTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WebhooksTimelineProps) {
