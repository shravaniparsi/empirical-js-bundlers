...
import WebhooksTag1 from './WebhooksTag1';
import MediaBadge from '../media/MediaBadge';
import styles from './WebhooksDrawer.module.css';
...
export default function WebhooksDrawer({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksDrawer">
      {activeItem && (
