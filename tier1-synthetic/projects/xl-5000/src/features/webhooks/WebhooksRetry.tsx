...
import WebhooksLink from './WebhooksLink';
import WorkflowsSuspense from '../workflows/WorkflowsSuspense';
import styles from './WebhooksRetry.module.css';
...
interface WebhooksRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
