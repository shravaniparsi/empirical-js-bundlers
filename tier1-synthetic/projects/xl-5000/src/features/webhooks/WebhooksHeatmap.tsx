...
import WebhooksSkeleton1 from './WebhooksSkeleton1';
import styles from './WebhooksHeatmap.module.css';
...
interface WebhooksHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WebhooksHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
