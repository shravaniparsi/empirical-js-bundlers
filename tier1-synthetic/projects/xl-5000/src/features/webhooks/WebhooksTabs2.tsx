...
import WebhooksScore from './WebhooksScore';
import WebhooksLoader1 from './WebhooksLoader1';
import styles from './WebhooksTabs2.module.css';
...
export default function WebhooksTabs2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksTabs2">
      {activeItem && (
