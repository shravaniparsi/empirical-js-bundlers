...
import styles from './WebhooksTag3.module.css';

interface WebhooksTag3Item {
  createdAt: Date;
  title: string;
  assignee: string;
  id: string;
...
interface WebhooksTag3Props {
  items?: WebhooksTag3Item[];
...
export default function WebhooksTag3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
