...
import styles from './WebhooksLoader2.module.css';
...
interface WebhooksLoader2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksLoader2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
