...
import styles from './WebhooksBadge1.module.css';

interface WebhooksBadge1Item {
  title: string;
  priority: number;
  createdAt: Date;
  id: string;
...
interface WebhooksBadge1Props {
  items?: WebhooksBadge1Item[];
...
export default function WebhooksBadge1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
