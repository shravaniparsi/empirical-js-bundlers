...
import styles from './WebhooksRank.module.css';

interface WebhooksRankItem {
  createdAt: Date;
  updatedAt: Date;
  priority: number;
  status: string;
...
interface WebhooksRankProps {
  items?: WebhooksRankItem[];
...
export default function WebhooksRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
