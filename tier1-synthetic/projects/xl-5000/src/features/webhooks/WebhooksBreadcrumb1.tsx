...
import styles from './WebhooksBreadcrumb1.module.css';
...
interface WebhooksBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function WebhooksBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksBreadcrumb1">
      {activeItem && (
