...
import WebhooksDetail2 from './WebhooksDetail2';
import styles from './WebhooksGrid1.module.css';

interface WebhooksGrid1Item {
  createdAt: Date;
  description: string;
  priority: number;
  updatedAt: Date;
...
interface WebhooksGrid1Props {
  items?: WebhooksGrid1Item[];
...
export default function WebhooksGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
