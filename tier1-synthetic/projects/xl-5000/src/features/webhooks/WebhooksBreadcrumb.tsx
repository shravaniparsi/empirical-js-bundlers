...
import WebhooksStat from './WebhooksStat';
import styles from './WebhooksBreadcrumb.module.css';
...
interface WebhooksBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function WebhooksBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WebhooksBreadcrumb">
      {activeItem && (
