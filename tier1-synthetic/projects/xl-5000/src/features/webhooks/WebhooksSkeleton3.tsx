...
import WebhooksPopover from './WebhooksPopover';
import ActivityStepper from '../activity/ActivityStepper';
import ReportsMeter1 from '../reports/ReportsMeter1';
import styles from './WebhooksSkeleton3.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WebhooksSkeleton3Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WebhooksSkeleton3({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
