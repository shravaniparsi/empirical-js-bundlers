...
import WebhooksSuspense from './WebhooksSuspense';
import WebhooksStack from './WebhooksStack';
import KnowledgeBaseFunnel1 from '../knowledge-base/KnowledgeBaseFunnel1';
import styles from './WebhooksProgress3.module.css';

interface WebhooksProgress3Item {
  assignee: string;
  status: string;
  priority: number;
  id: string;
...
interface WebhooksProgress3Props {
  items?: WebhooksProgress3Item[];
...
export default function WebhooksProgress3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WebhooksProgress3Props) {
