...
import WebhooksToast from './WebhooksToast';
import styles from './WebhooksSkeleton.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WebhooksSkeletonProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WebhooksSkeleton({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
