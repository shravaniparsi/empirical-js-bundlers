...
interface WebhooksLoader3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksLoader3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
