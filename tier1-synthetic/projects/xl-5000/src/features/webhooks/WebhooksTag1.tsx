...
import styles from './WebhooksTag1.module.css';

interface WebhooksTag1Item {
  priority: number;
  updatedAt: Date;
  assignee: string;
  tags: string[];
...
interface WebhooksTag1Props {
  items?: WebhooksTag1Item[];
...
export default function WebhooksTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
