...
import styles from './WebhooksCached1.module.css';
...
interface WebhooksCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WebhooksCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
