...
import CatalogGauge from './CatalogGauge';
import CatalogStat1 from './CatalogStat1';
import styles from './CatalogGauge1.module.css';
...
export default function CatalogGauge1({
  data,
  title,
  height = 300,
  showLegend = true,
