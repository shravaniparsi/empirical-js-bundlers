...
import styles from './CatalogScore1.module.css';

interface CatalogScore1Item {
  createdAt: Date;
  updatedAt: Date;
  status: string;
  assignee: string;
...
interface CatalogScore1Props {
  items?: CatalogScore1Item[];
...
export default function CatalogScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
