...
import CatalogTextArea from './CatalogTextArea';
import CategoriesRegistry from '../categories/CategoriesRegistry';
import styles from './CatalogSuspense.module.css';
...
interface CatalogSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CatalogSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
