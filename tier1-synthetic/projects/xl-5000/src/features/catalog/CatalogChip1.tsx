...
import styles from './CatalogChip1.module.css';

interface CatalogChip1Item {
  createdAt: Date;
  assignee: string;
  status: string;
  title: string;
...
interface CatalogChip1Props {
  items?: CatalogChip1Item[];
...
export default function CatalogChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
