...
import CatalogSplit1 from './CatalogSplit1';
import CatalogAreaChart from './CatalogAreaChart';
import CatalogTextArea1 from './CatalogTextArea1';
import ShippingFileUpload2 from '../shipping/ShippingFileUpload2';
import styles from './CatalogStat1.module.css';

interface CatalogStat1Item {
  priority: number;
  assignee: string;
  description: string;
  updatedAt: Date;
...
interface CatalogStat1Props {
  items?: CatalogStat1Item[];
...
export default function CatalogStat1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
