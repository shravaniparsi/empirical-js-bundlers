...
import styles from './CatalogPagination2.module.css';
...
interface CatalogPagination2Props {
  items: NavItem[];
  activeId?: string;
...
export default function CatalogPagination2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CatalogPagination2">
      {activeItem && (
