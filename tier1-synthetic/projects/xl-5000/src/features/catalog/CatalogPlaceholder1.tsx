...
import CatalogFileUpload from './CatalogFileUpload';
import styles from './CatalogPlaceholder1.module.css';
...
interface CatalogPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CatalogPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
