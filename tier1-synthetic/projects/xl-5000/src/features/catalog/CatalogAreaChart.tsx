...
import CatalogMenu1 from './CatalogMenu1';
import CatalogRating1 from './CatalogRating1';
import CatalogDivider1 from './CatalogDivider1';
import styles from './CatalogAreaChart.module.css';
...
interface CatalogAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CatalogAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
