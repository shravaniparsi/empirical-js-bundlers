...
import CatalogPagination1 from './CatalogPagination1';
import CatalogGauge1 from './CatalogGauge1';
import CatalogSidebar2 from './CatalogSidebar2';
import styles from './CatalogScatter.module.css';
...
export default function CatalogScatter({
  data,
  title,
  height = 300,
  showLegend = true,
