...
import styles from './CatalogMenu1.module.css';
...
export default function CatalogMenu1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CatalogMenu1">
      {activeItem && (
