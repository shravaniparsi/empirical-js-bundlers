...
import CatalogCheckbox1 from './CatalogCheckbox1';
import styles from './CatalogPaginated.module.css';
...
interface CatalogPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CatalogPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
