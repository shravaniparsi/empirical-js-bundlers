...
import CatalogPanel1 from './CatalogPanel1';
import CatalogPanel from './CatalogPanel';
import styles from './CatalogConfirm.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface CatalogConfirmProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function CatalogConfirm({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
