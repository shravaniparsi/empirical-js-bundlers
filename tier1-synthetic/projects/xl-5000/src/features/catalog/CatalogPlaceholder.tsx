...
import CatalogInput2 from './CatalogInput2';
import styles from './CatalogPlaceholder.module.css';
...
interface CatalogPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CatalogPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
