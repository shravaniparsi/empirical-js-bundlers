...
import CatalogSuspense1 from './CatalogSuspense1';
import CatalogAccordion from './CatalogAccordion';
import ImportsHeatmap from '../imports/ImportsHeatmap';
import styles from './CatalogToggle.module.css';

const CatalogToggleSchema = z.object({
...
export default function CatalogToggle({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = CatalogToggleSchema.safeParse({ value: val });
