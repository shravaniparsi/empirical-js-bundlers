...
import CatalogModal2 from './CatalogModal2';
import CatalogChip from './CatalogChip';
import styles from './CatalogSparkline1.module.css';
...
interface CatalogSparkline1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CatalogSparkline1({
  data,
  title,
  height = 300,
  showLegend = true,
