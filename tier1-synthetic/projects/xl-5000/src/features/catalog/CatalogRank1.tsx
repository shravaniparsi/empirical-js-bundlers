...
import styles from './CatalogRank1.module.css';

interface CatalogRank1Item {
  assignee: string;
  tags: string[];
  updatedAt: Date;
  createdAt: Date;
...
interface CatalogRank1Props {
  items?: CatalogRank1Item[];
...
export default function CatalogRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
