...
import CatalogRadio from './CatalogRadio';
import CatalogPlaceholder1 from './CatalogPlaceholder1';
import styles from './CatalogCheckbox.module.css';


interface CatalogCheckboxProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function CatalogCheckbox({
  label,
  name,
