...
import CatalogPagination2 from './CatalogPagination2';
import CatalogToast from './CatalogToast';
import styles from './CatalogPagination1.module.css';
...
interface CatalogPagination1Props {
  items: NavItem[];
  activeId?: string;
...
export default function CatalogPagination1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CatalogPagination1">
      {activeItem && (
