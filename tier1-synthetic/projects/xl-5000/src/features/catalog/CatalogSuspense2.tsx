...
import CatalogGrid2 from './CatalogGrid2';
import CatalogList from './CatalogList';
import styles from './CatalogSuspense2.module.css';
...
interface CatalogSuspense2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CatalogSuspense2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
