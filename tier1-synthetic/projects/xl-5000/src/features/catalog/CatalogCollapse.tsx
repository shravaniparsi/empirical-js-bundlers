...
import CatalogSpinner from './CatalogSpinner';
import CatalogPagination from './CatalogPagination';
import styles from './CatalogCollapse.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface CatalogCollapseProps {
...
export default function CatalogCollapse({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
