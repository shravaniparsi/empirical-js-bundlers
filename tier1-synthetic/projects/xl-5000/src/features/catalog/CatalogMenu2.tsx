...
import styles from './CatalogMenu2.module.css';
...
export default function CatalogMenu2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CatalogMenu2">
      {activeItem && (
