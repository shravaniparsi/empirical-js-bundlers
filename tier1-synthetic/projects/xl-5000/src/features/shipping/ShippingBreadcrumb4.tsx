...
import styles from './ShippingBreadcrumb4.module.css';
...
interface ShippingBreadcrumb4Props {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingBreadcrumb4({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingBreadcrumb4">
      {activeItem && (
