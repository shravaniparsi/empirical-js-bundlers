...
import ProductsScatter1 from '../products/ProductsScatter1';
import styles from './ShippingSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ShippingSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ShippingSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
