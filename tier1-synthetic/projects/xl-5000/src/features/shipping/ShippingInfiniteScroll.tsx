...
import WebhooksBanner from '../webhooks/WebhooksBanner';
import styles from './ShippingInfiniteScroll.module.css';
...
interface ShippingInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
