...
import ShippingFileUpload1 from './ShippingFileUpload1';
import styles from './ShippingTreeView.module.css';
...
interface ShippingTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingTreeView">
      {activeItem && (
