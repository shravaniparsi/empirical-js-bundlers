...
import ShippingProgress4 from './ShippingProgress4';
import styles from './ShippingMeter.module.css';

interface ShippingMeterItem {
  priority: number;
  assignee: string;
  title: string;
  id: string;
...
export default function ShippingMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
