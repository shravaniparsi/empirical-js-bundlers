...
import styles from './ShippingSuspense.module.css';
...
interface ShippingSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
