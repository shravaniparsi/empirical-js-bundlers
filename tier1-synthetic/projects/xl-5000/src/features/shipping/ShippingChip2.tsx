...
import styles from './ShippingChip2.module.css';

interface ShippingChip2Item {
  status: string;
  assignee: string;
  description: string;
  priority: number;
...
interface ShippingChip2Props {
  items?: ShippingChip2Item[];
...
export default function ShippingChip2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
