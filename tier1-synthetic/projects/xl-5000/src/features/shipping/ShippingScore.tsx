...
import styles from './ShippingScore.module.css';

interface ShippingScoreItem {
  createdAt: Date;
  assignee: string;
  status: string;
  updatedAt: Date;
...
interface ShippingScoreProps {
  items?: ShippingScoreItem[];
...
export default function ShippingScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
