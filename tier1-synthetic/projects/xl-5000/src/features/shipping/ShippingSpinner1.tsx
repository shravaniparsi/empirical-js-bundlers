...
import ShippingResponsive from './ShippingResponsive';
import ShippingConfirm1 from './ShippingConfirm1';
import WorkflowsSticky from '../workflows/WorkflowsSticky';
import styles from './ShippingSpinner1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ShippingSpinner1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ShippingSpinner1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
