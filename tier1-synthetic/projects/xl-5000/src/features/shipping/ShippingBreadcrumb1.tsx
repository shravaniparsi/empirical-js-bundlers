...
import styles from './ShippingBreadcrumb1.module.css';
...
interface ShippingBreadcrumb1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingBreadcrumb1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingBreadcrumb1">
      {activeItem && (
