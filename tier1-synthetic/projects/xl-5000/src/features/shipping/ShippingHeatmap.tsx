...
import ShippingFileUpload2 from './ShippingFileUpload2';
import ShippingBanner from './ShippingBanner';
import CategoriesAdapter1 from '../categories/CategoriesAdapter1';
import styles from './ShippingHeatmap.module.css';
...
interface ShippingHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ShippingHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
