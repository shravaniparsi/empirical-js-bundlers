...
import styles from './ShippingLoader.module.css';
...
interface ShippingLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
