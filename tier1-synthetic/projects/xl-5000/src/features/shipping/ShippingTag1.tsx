...
import LocalizationSpinner from '../localization/LocalizationSpinner';
import styles from './ShippingTag1.module.css';

interface ShippingTag1Item {
  assignee: string;
  status: string;
  description: string;
  id: string;
...
interface ShippingTag1Props {
  items?: ShippingTag1Item[];
...
export default function ShippingTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
