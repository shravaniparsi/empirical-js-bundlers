...
import ShippingBreadcrumb4 from './ShippingBreadcrumb4';
import styles from './ShippingFeed1.module.css';

interface ShippingFeed1Item {
  assignee: string;
  description: string;
  tags: string[];
  title: string;
...
interface ShippingFeed1Props {
  items?: ShippingFeed1Item[];
...
export default function ShippingFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
