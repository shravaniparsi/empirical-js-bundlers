...
import ShippingToggle2 from './ShippingToggle2';
import styles from './ShippingCached.module.css';
...
interface ShippingCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
