...
import SupportAreaChart2 from '../support/SupportAreaChart2';
import styles from './ShippingRetry.module.css';
...
interface ShippingRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
