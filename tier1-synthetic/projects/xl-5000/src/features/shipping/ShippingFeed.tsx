...
import ShippingChip2 from './ShippingChip2';
import styles from './ShippingFeed.module.css';

interface ShippingFeedItem {
  tags: string[];
  description: string;
  assignee: string;
  title: string;
...
export default function ShippingFeed({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
