...
import ShippingToggle1 from './ShippingToggle1';
import ShippingConfirm1 from './ShippingConfirm1';
import AuthList from '../auth/AuthList';
import styles from './ShippingTreeView2.module.css';
...
interface ShippingTreeView2Props {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingTreeView2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingTreeView2">
      {activeItem && (
