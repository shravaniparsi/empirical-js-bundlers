...
import styles from './ShippingBreadcrumb.module.css';
...
interface ShippingBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingBreadcrumb({
  ...
  return (
    <nav className={navClasses} aria-label="ShippingBreadcrumb">
      {activeItem && (
