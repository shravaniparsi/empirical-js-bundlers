...
import ShippingCached from './ShippingCached';
import styles from './ShippingTreeView1.module.css';
...
interface ShippingTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingTreeView1">
      {activeItem && (
