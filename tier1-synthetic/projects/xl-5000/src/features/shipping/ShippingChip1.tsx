...
import styles from './ShippingChip1.module.css';

interface ShippingChip1Item {
  createdAt: Date;
  status: string;
  priority: number;
  tags: string[];
...
interface ShippingChip1Props {
  items?: ShippingChip1Item[];
...
export default function ShippingChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
