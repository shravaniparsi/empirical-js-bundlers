...
import { z } from 'zod';
import ShippingGrid1 from './ShippingGrid1';
import ShippingSuspense from './ShippingSuspense';
import styles from './ShippingToggle.module.css';

const ShippingToggleSchema = z.object({
...
export default function ShippingToggle({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = ShippingToggleSchema.safeParse({ value: val });
