...
import ShippingChip1 from './ShippingChip1';
import NotificationsScore from '../notifications/NotificationsScore';
import styles from './ShippingPolling.module.css';
...
interface ShippingPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ShippingPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
