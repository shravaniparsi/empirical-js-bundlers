...
import ShippingPieChart from './ShippingPieChart';
import CheckoutRank from '../checkout/CheckoutRank';
import styles from './ShippingScatter.module.css';
...
interface ShippingScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function ShippingScatter({
  data,
  title,
  height = 300,
  showLegend = true,
