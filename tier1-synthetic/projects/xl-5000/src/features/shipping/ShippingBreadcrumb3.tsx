...
import styles from './ShippingBreadcrumb3.module.css';
...
interface ShippingBreadcrumb3Props {
  items: NavItem[];
  activeId?: string;
...
export default function ShippingBreadcrumb3({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ShippingBreadcrumb3">
      {activeItem && (
