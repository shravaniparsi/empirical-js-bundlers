...
import ShippingSpacer1 from './ShippingSpacer1';
import ShippingScroll from './ShippingScroll';
import ReportsMeter1 from '../reports/ReportsMeter1';
import styles from './ShippingTable1.module.css';

interface ShippingTable1Item {
  updatedAt: Date;
  createdAt: Date;
  priority: number;
  assignee: string;
...
interface ShippingTable1Props {
  items?: ShippingTable1Item[];
...
export default function ShippingTable1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
