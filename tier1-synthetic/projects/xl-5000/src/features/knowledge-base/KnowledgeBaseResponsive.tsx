...
import KnowledgeBaseHeader1 from './KnowledgeBaseHeader1';
import KnowledgeBaseSummary from './KnowledgeBaseSummary';
import ReviewsSummary from '../reviews/ReviewsSummary';
import styles from './KnowledgeBaseResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface KnowledgeBaseResponsiveProps {
...
export default function KnowledgeBaseResponsive({
  children,
