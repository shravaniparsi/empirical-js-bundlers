...
import styles from './KnowledgeBaseHeader1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface KnowledgeBaseHeader1Props {
...
export default function KnowledgeBaseHeader1({
  children,
