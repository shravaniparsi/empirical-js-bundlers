...
import styles from './KnowledgeBaseStepper1.module.css';
...
interface KnowledgeBaseStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function KnowledgeBaseStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="KnowledgeBaseStepper1">
      {activeItem && (
