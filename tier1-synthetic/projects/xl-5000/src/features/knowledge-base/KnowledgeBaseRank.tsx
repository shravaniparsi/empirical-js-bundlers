...
import styles from './KnowledgeBaseRank.module.css';

interface KnowledgeBaseRankItem {
  title: string;
  updatedAt: Date;
  assignee: string;
  createdAt: Date;
...
interface KnowledgeBaseRankProps {
  items?: KnowledgeBaseRankItem[];
...
export default function KnowledgeBaseRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseRankProps) {
