...
import KnowledgeBaseToast from './KnowledgeBaseToast';
import styles from './KnowledgeBaseScatter.module.css';
...
interface KnowledgeBaseScatterProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBaseScatter({
  data,
  title,
  height = 300,
  showLegend = true,
