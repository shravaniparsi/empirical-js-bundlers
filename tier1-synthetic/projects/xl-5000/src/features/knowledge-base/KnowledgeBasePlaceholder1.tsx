...
import styles from './KnowledgeBasePlaceholder1.module.css';
...
interface KnowledgeBasePlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBasePlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: KnowledgeBasePlaceholder1Props<T>) {
