...
import styles from './KnowledgeBasePolling1.module.css';
...
interface KnowledgeBasePolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBasePolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
