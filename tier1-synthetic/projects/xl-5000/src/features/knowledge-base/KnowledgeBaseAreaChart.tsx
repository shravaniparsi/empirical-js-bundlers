...
import KnowledgeBaseSummary2 from './KnowledgeBaseSummary2';
import KnowledgeBaseDrawer1 from './KnowledgeBaseDrawer1';
import KnowledgeBasePlaceholder1 from './KnowledgeBasePlaceholder1';
import styles from './KnowledgeBaseAreaChart.module.css';
...
interface KnowledgeBaseAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBaseAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
