...
import styles from './KnowledgeBaseRating1.module.css';


interface KnowledgeBaseRating1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function KnowledgeBaseRating1({
  label,
  name,
