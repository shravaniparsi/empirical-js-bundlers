...
import styles from './KnowledgeBaseLoader.module.css';
...
interface KnowledgeBaseLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBaseLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
