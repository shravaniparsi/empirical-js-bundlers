...
import styles from './KnowledgeBaseSparkline.module.css';
...
interface KnowledgeBaseSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBaseSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
