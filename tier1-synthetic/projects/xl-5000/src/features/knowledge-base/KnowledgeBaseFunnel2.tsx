...
import KnowledgeBaseFunnel from './KnowledgeBaseFunnel';
import KnowledgeBaseRank from './KnowledgeBaseRank';
import KnowledgeBaseChip from './KnowledgeBaseChip';
import styles from './KnowledgeBaseFunnel2.module.css';
...
interface KnowledgeBaseFunnel2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBaseFunnel2({
  data,
  title,
  height = 300,
  showLegend = true,
