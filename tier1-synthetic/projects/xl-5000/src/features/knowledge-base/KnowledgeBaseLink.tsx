...
import LocalizationPagination from '../localization/LocalizationPagination';
import styles from './KnowledgeBaseLink.module.css';
...
export default function KnowledgeBaseLink({
  ...
  return (
    <nav className={navClasses} aria-label="KnowledgeBaseLink">
      {activeItem && (
