...
import styles from './KnowledgeBaseSuspense.module.css';
...
interface KnowledgeBaseSuspenseProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBaseSuspense<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
