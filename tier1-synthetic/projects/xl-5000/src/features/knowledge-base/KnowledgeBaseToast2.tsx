...
import KnowledgeBaseFunnel1 from './KnowledgeBaseFunnel1';
import KnowledgeBaseLoader from './KnowledgeBaseLoader';
import styles from './KnowledgeBaseToast2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface KnowledgeBaseToast2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function KnowledgeBaseToast2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
