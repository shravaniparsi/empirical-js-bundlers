...
import KnowledgeBaseErrorBoundary from './KnowledgeBaseErrorBoundary';
import KnowledgeBaseSidebar from './KnowledgeBaseSidebar';
import styles from './KnowledgeBaseSummary1.module.css';

interface KnowledgeBaseSummary1Item {
  priority: number;
  status: string;
  description: string;
  assignee: string;
...
interface KnowledgeBaseSummary1Props {
  items?: KnowledgeBaseSummary1Item[];
...
export default function KnowledgeBaseSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseSummary1Props) {
