...
import styles from './KnowledgeBaseLabel.module.css';

interface KnowledgeBaseLabelItem {
  description: string;
  status: string;
  assignee: string;
  priority: number;
...
interface KnowledgeBaseLabelProps {
  items?: KnowledgeBaseLabelItem[];
...
export default function KnowledgeBaseLabel({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseLabelProps) {
