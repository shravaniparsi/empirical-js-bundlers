...
import styles from './KnowledgeBaseSkeleton1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface KnowledgeBaseSkeleton1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function KnowledgeBaseSkeleton1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
