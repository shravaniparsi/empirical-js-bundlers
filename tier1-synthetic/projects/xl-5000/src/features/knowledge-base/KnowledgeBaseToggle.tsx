...
import { z } from 'zod';
import KnowledgeBaseList1 from './KnowledgeBaseList1';
import KnowledgeBasePanel1 from './KnowledgeBasePanel1';
import styles from './KnowledgeBaseToggle.module.css';

const KnowledgeBaseToggleSchema = z.object({
...
export default function KnowledgeBaseToggle({
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = KnowledgeBaseToggleSchema.safeParse({ value: val });
