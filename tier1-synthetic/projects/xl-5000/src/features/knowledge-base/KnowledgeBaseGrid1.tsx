...
import styles from './KnowledgeBaseGrid1.module.css';

interface KnowledgeBaseGrid1Item {
  updatedAt: Date;
  status: string;
  priority: number;
  id: string;
...
interface KnowledgeBaseGrid1Props {
  items?: KnowledgeBaseGrid1Item[];
...
export default function KnowledgeBaseGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseGrid1Props) {
