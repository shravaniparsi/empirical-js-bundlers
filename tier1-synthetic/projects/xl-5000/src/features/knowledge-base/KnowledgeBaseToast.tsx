...
import KnowledgeBaseGrid3 from './KnowledgeBaseGrid3';
import styles from './KnowledgeBaseToast.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface KnowledgeBaseToastProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function KnowledgeBaseToast({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
