...
import styles from './KnowledgeBaseLink1.module.css';
...
interface KnowledgeBaseLink1Props {
  items: NavItem[];
  activeId?: string;
...
export default function KnowledgeBaseLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="KnowledgeBaseLink1">
      {activeItem && (
