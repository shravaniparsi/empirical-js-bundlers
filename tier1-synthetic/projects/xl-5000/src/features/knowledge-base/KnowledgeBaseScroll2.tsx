...
import KnowledgeBaseRank2 from './KnowledgeBaseRank2';
import KnowledgeBaseGrid2 from './KnowledgeBaseGrid2';
import KnowledgeBaseTable from './KnowledgeBaseTable';
import WorkflowsCard from '../workflows/WorkflowsCard';
import styles from './KnowledgeBaseScroll2.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface KnowledgeBaseScroll2Props {
...
export default function KnowledgeBaseScroll2({
  children,
