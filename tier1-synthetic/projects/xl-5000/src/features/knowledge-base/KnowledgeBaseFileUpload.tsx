...
import { z } from 'zod';
import KnowledgeBaseErrorBoundary1 from './KnowledgeBaseErrorBoundary1';
import styles from './KnowledgeBaseFileUpload.module.css';

const KnowledgeBaseFileUploadSchema = z.object({
...
export default function KnowledgeBaseFileUpload({
  label,
  name,
  ...
  const debouncedValidate = useCallback(
    debounce((val: string) => {
      const result = KnowledgeBaseFileUploadSchema.safeParse({ value: val });
