...
import KnowledgeBaseSuspense from './KnowledgeBaseSuspense';
import styles from './KnowledgeBaseFunnel1.module.css';
...
interface KnowledgeBaseFunnel1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBaseFunnel1({
  data,
  title,
  height = 300,
  showLegend = true,
