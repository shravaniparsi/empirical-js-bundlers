...
import styles from './KnowledgeBasePrefetch.module.css';
...
interface KnowledgeBasePrefetchProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBasePrefetch<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
