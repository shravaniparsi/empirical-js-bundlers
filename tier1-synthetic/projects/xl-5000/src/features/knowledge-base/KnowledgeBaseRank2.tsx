...
import KnowledgeBaseStat from './KnowledgeBaseStat';
...
import styles from './KnowledgeBaseRank2.module.css';

interface KnowledgeBaseRank2Item {
  updatedAt: Date;
  description: string;
  priority: number;
  assignee: string;
...
interface KnowledgeBaseRank2Props {
  items?: KnowledgeBaseRank2Item[];
...
export default function KnowledgeBaseRank2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseRank2Props) {
