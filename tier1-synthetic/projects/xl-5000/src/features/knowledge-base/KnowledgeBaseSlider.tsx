...
import styles from './KnowledgeBaseSlider.module.css';


interface KnowledgeBaseSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function KnowledgeBaseSlider({
  label,
  name,
