...
import styles from './KnowledgeBasePlaceholder.module.css';
...
interface KnowledgeBasePlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBasePlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: KnowledgeBasePlaceholderProps<T>) {
