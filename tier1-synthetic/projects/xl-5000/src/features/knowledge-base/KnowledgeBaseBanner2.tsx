...
import KnowledgeBaseSearch1 from './KnowledgeBaseSearch1';
import styles from './KnowledgeBaseBanner2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface KnowledgeBaseBanner2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function KnowledgeBaseBanner2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
