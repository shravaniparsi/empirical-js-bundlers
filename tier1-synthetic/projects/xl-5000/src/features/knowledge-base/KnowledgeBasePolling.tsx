...
import styles from './KnowledgeBasePolling.module.css';
...
interface KnowledgeBasePollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBasePolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
