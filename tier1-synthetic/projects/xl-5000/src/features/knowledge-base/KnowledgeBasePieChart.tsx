...
import CatalogSidebar2 from '../catalog/CatalogSidebar2';
import styles from './KnowledgeBasePieChart.module.css';
...
interface KnowledgeBasePieChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBasePieChart({
  data,
  title,
  height = 300,
  showLegend = true,
