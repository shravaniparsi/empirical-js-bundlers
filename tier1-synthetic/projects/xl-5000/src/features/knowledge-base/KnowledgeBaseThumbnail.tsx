...
import styles from './KnowledgeBaseThumbnail.module.css';

interface KnowledgeBaseThumbnailItem {
  tags: string[];
  assignee: string;
  status: string;
  updatedAt: Date;
...
interface KnowledgeBaseThumbnailProps {
  items?: KnowledgeBaseThumbnailItem[];
...
export default function KnowledgeBaseThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseThumbnailProps) {
