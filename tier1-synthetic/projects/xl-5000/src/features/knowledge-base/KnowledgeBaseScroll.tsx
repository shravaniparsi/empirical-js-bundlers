...
import CampaignsFooter from '../campaigns/CampaignsFooter';
import styles from './KnowledgeBaseScroll.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface KnowledgeBaseScrollProps {
...
export default function KnowledgeBaseScroll({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
