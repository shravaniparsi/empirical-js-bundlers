...
import KnowledgeBaseToast2 from './KnowledgeBaseToast2';
import ThemesSticky1 from '../themes/ThemesSticky1';
import styles from './KnowledgeBasePlaceholder2.module.css';
...
interface KnowledgeBasePlaceholder2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBasePlaceholder2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: KnowledgeBasePlaceholder2Props<T>) {
