...
import styles from './KnowledgeBaseCached.module.css';
...
interface KnowledgeBaseCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBaseCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
