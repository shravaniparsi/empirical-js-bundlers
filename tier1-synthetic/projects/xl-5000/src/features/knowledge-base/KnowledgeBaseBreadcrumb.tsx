...
import styles from './KnowledgeBaseBreadcrumb.module.css';
...
export default function KnowledgeBaseBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="KnowledgeBaseBreadcrumb">
      {activeItem && (
