...
import styles from './KnowledgeBaseStat.module.css';

interface KnowledgeBaseStatItem {
  priority: number;
  tags: string[];
  description: string;
  assignee: string;
...
interface KnowledgeBaseStatProps {
  items?: KnowledgeBaseStatItem[];
...
export default function KnowledgeBaseStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseStatProps) {
