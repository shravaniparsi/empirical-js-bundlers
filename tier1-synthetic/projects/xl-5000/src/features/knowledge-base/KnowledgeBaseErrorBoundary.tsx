...
import KnowledgeBaseBanner1 from './KnowledgeBaseBanner1';
import styles from './KnowledgeBaseErrorBoundary.module.css';
...
interface KnowledgeBaseErrorBoundaryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBaseErrorBoundary<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: KnowledgeBaseErrorBoundaryProps<T>) {
