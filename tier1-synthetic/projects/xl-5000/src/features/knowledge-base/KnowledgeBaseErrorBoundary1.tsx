...
import TagsScatter from '../tags/TagsScatter';
import styles from './KnowledgeBaseErrorBoundary1.module.css';
...
interface KnowledgeBaseErrorBoundary1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function KnowledgeBaseErrorBoundary1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: KnowledgeBaseErrorBoundary1Props<T>) {
