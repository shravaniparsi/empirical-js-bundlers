...
import KnowledgeBaseResponsive1 from './KnowledgeBaseResponsive1';
import KnowledgeBaseLabel from './KnowledgeBaseLabel';
import NotificationsAreaChart from '../notifications/NotificationsAreaChart';
import styles from './KnowledgeBaseToast1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface KnowledgeBaseToast1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function KnowledgeBaseToast1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
