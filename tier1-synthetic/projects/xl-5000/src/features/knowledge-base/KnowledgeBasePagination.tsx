...
import KnowledgeBaseSlider from './KnowledgeBaseSlider';
import styles from './KnowledgeBasePagination.module.css';
...
export default function KnowledgeBasePagination({
  ...
  return (
    <nav className={navClasses} aria-label="KnowledgeBasePagination">
      {activeItem && (
