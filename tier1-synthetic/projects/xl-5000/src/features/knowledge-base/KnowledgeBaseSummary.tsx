...
import KnowledgeBaseLink1 from './KnowledgeBaseLink1';
import KnowledgeBasePlaceholder from './KnowledgeBasePlaceholder';
import KnowledgeBaseHOC from './KnowledgeBaseHOC';
import styles from './KnowledgeBaseSummary.module.css';

interface KnowledgeBaseSummaryItem {
  priority: number;
  tags: string[];
  assignee: string;
  status: string;
...
interface KnowledgeBaseSummaryProps {
  items?: KnowledgeBaseSummaryItem[];
