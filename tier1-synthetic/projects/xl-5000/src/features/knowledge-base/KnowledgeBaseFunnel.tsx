...
import styles from './KnowledgeBaseFunnel.module.css';
...
interface KnowledgeBaseFunnelProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function KnowledgeBaseFunnel({
  data,
  title,
  height = 300,
  showLegend = true,
