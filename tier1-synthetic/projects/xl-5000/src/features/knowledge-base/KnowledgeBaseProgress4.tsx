...
import styles from './KnowledgeBaseProgress4.module.css';

interface KnowledgeBaseProgress4Item {
  description: string;
  assignee: string;
  status: string;
  updatedAt: Date;
...
interface KnowledgeBaseProgress4Props {
  items?: KnowledgeBaseProgress4Item[];
...
export default function KnowledgeBaseProgress4({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: KnowledgeBaseProgress4Props) {
