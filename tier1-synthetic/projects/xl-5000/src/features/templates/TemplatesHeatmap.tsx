...
import TemplatesProgress1 from './TemplatesProgress1';
import TemplatesSummary from './TemplatesSummary';
import TemplatesDonut1 from './TemplatesDonut1';
import styles from './TemplatesHeatmap.module.css';
...
interface TemplatesHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function TemplatesHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
