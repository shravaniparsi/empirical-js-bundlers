...
import styles from './TemplatesProgress.module.css';

interface TemplatesProgressItem {
  tags: string[];
  title: string;
  assignee: string;
  id: string;
...
interface TemplatesProgressProps {
  items?: TemplatesProgressItem[];
...
export default function TemplatesProgress({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesProgressProps) {
