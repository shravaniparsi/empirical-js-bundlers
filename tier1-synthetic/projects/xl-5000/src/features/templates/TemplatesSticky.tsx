...
import TemplatesSummary2 from './TemplatesSummary2';
import TemplatesLink from './TemplatesLink';
import styles from './TemplatesSticky.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface TemplatesStickyProps {
...
export default function TemplatesSticky({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
