...
import TemplatesDonut from './TemplatesDonut';
...
import styles from './TemplatesModal1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface TemplatesModal1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function TemplatesModal1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
