...
import TemplatesResponsive from './TemplatesResponsive';
import TemplatesStack2 from './TemplatesStack2';
import TemplatesErrorBoundary from './TemplatesErrorBoundary';
import styles from './TemplatesPlaceholder.module.css';
...
interface TemplatesPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
