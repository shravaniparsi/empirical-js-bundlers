...
import TemplatesLineChart1 from './TemplatesLineChart1';
import WorkflowsSuspense from '../workflows/WorkflowsSuspense';
import styles from './TemplatesLineChart.module.css';
...
interface TemplatesLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function TemplatesLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
