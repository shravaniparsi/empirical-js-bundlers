...
import styles from './TemplatesChip.module.css';

interface TemplatesChipItem {
  description: string;
  tags: string[];
  title: string;
  assignee: string;
...
interface TemplatesChipProps {
  items?: TemplatesChipItem[];
...
export default function TemplatesChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
