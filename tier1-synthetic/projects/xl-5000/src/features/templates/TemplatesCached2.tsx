...
import styles from './TemplatesCached2.module.css';
...
interface TemplatesCached2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesCached2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
