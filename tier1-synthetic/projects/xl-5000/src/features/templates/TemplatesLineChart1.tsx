...
interface TemplatesLineChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function TemplatesLineChart1({
  data,
  title,
  height = 300,
  showLegend = true,
