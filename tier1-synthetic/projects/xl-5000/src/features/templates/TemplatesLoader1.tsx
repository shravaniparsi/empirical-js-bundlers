...
import TemplatesColorPicker from './TemplatesColorPicker';
import TemplatesLoader2 from './TemplatesLoader2';
import TemplatesCached2 from './TemplatesCached2';
import styles from './TemplatesLoader1.module.css';
...
interface TemplatesLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
