...
import TemplatesStepper from './TemplatesStepper';
import styles from './TemplatesDatePicker.module.css';


interface TemplatesDatePickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function TemplatesDatePicker({
  label,
  name,
