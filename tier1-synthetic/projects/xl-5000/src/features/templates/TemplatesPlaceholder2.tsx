...
import styles from './TemplatesPlaceholder2.module.css';
...
interface TemplatesPlaceholder2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesPlaceholder2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
