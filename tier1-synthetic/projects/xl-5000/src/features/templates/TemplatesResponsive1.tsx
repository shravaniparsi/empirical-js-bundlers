...
import TemplatesSticky from './TemplatesSticky';
...
import styles from './TemplatesResponsive1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface TemplatesResponsive1Props {
...
export default function TemplatesResponsive1({
  children,
