...
import styles from './TemplatesThumbnail.module.css';

interface TemplatesThumbnailItem {
  status: string;
  title: string;
  assignee: string;
  createdAt: Date;
...
interface TemplatesThumbnailProps {
  items?: TemplatesThumbnailItem[];
...
export default function TemplatesThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesThumbnailProps) {
