...
import styles from './TemplatesSummary1.module.css';

interface TemplatesSummary1Item {
  updatedAt: Date;
  tags: string[];
  title: string;
  createdAt: Date;
...
interface TemplatesSummary1Props {
  items?: TemplatesSummary1Item[];
...
export default function TemplatesSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesSummary1Props) {
