...
import TemplatesPlaceholder from './TemplatesPlaceholder';
import styles from './TemplatesGrid2.module.css';

interface TemplatesGrid2Item {
  title: string;
  assignee: string;
  priority: number;
  id: string;
...
interface TemplatesGrid2Props {
  items?: TemplatesGrid2Item[];
...
export default function TemplatesGrid2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
