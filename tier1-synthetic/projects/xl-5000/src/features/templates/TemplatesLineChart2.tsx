...
import TemplatesScroll from './TemplatesScroll';
import TemplatesModal from './TemplatesModal';
import TemplatesSlider1 from './TemplatesSlider1';
import styles from './TemplatesLineChart2.module.css';
...
interface TemplatesLineChart2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function TemplatesLineChart2({
  data,
  title,
  height = 300,
  showLegend = true,
