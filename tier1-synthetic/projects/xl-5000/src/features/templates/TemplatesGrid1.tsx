...
import TemplatesTooltip from './TemplatesTooltip';
import styles from './TemplatesGrid1.module.css';

interface TemplatesGrid1Item {
  priority: number;
  createdAt: Date;
  status: string;
  description: string;
...
interface TemplatesGrid1Props {
  items?: TemplatesGrid1Item[];
...
export default function TemplatesGrid1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
