...
import ReportsTabs3 from '../reports/ReportsTabs3';
import styles from './TemplatesBadge.module.css';

interface TemplatesBadgeItem {
  createdAt: Date;
  description: string;
  title: string;
  priority: number;
...
interface TemplatesBadgeProps {
  items?: TemplatesBadgeItem[];
...
export default function TemplatesBadge({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
