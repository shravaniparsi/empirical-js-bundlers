...
import TemplatesChip from './TemplatesChip';
import TemplatesModal2 from './TemplatesModal2';
import styles from './TemplatesSlider1.module.css';


interface TemplatesSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function TemplatesSlider1({
  label,
  name,
