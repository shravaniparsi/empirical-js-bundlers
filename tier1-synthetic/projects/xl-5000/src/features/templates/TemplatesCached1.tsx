...
import styles from './TemplatesCached1.module.css';
...
interface TemplatesCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
