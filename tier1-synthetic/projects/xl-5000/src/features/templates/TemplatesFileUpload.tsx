...
import styles from './TemplatesFileUpload.module.css';


interface TemplatesFileUploadProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function TemplatesFileUpload({
  label,
  name,
