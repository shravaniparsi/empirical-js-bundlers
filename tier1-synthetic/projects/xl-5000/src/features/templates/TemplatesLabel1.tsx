...
import styles from './TemplatesLabel1.module.css';

interface TemplatesLabel1Item {
  priority: number;
  description: string;
  createdAt: Date;
  status: string;
...
interface TemplatesLabel1Props {
  items?: TemplatesLabel1Item[];
...
export default function TemplatesLabel1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesLabel1Props) {
