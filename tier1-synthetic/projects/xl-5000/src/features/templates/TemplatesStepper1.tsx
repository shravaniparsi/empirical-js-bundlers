...
import styles from './TemplatesStepper1.module.css';
...
interface TemplatesStepper1Props {
  items: NavItem[];
  activeId?: string;
...
export default function TemplatesStepper1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TemplatesStepper1">
      {activeItem && (
