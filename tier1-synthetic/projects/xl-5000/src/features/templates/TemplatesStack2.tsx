...
import TemplatesStepper1 from './TemplatesStepper1';
import styles from './TemplatesStack2.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface TemplatesStack2Props {
...
export default function TemplatesStack2({
  children,
