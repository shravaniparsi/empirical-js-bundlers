...
import styles from './TemplatesLink1.module.css';
...
export default function TemplatesLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TemplatesLink1">
      {activeItem && (
