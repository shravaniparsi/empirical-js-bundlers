...
import styles from './TemplatesProgress1.module.css';

interface TemplatesProgress1Item {
  status: string;
  assignee: string;
  description: string;
  id: string;
...
interface TemplatesProgress1Props {
  items?: TemplatesProgress1Item[];
...
export default function TemplatesProgress1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesProgress1Props) {
