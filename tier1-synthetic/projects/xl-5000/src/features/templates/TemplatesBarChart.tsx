...
interface TemplatesBarChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function TemplatesBarChart({
  data,
  title,
  height = 300,
  showLegend = true,
