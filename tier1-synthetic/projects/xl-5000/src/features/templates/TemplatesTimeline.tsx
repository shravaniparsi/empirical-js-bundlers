...
import styles from './TemplatesTimeline.module.css';

interface TemplatesTimelineItem {
  description: string;
  assignee: string;
  status: string;
  createdAt: Date;
...
interface TemplatesTimelineProps {
  items?: TemplatesTimelineItem[];
...
export default function TemplatesTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesTimelineProps) {
