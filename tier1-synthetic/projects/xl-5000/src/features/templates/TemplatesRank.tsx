...
import styles from './TemplatesRank.module.css';

interface TemplatesRankItem {
  priority: number;
  updatedAt: Date;
  assignee: string;
  tags: string[];
...
interface TemplatesRankProps {
  items?: TemplatesRankItem[];
...
export default function TemplatesRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
