...
import TemplatesSummary1 from './TemplatesSummary1';
import TemplatesCheckbox2 from './TemplatesCheckbox2';
import TagsSummary from '../tags/TagsSummary';
import styles from './TemplatesTag.module.css';

interface TemplatesTagItem {
  createdAt: Date;
  assignee: string;
  updatedAt: Date;
  id: string;
...
interface TemplatesTagProps {
  items?: TemplatesTagItem[];
