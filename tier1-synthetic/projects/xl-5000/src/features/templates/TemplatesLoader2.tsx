...
import styles from './TemplatesLoader2.module.css';
...
interface TemplatesLoader2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesLoader2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
