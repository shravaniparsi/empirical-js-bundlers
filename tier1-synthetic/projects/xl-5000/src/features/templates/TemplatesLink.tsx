...
import styles from './TemplatesLink.module.css';
...
export default function TemplatesLink({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="TemplatesLink">
      {activeItem && (
