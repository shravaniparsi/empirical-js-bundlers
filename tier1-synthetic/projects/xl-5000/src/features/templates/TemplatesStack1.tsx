...
import TemplatesPlaceholder1 from './TemplatesPlaceholder1';
import TemplatesModal from './TemplatesModal';
import styles from './TemplatesStack1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface TemplatesStack1Props {
...
export default function TemplatesStack1({
  children,
