...
import styles from './TemplatesRank1.module.css';

interface TemplatesRank1Item {
  assignee: string;
  createdAt: Date;
  updatedAt: Date;
  priority: number;
...
interface TemplatesRank1Props {
  items?: TemplatesRank1Item[];
...
export default function TemplatesRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
