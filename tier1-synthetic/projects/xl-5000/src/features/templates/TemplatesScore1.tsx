...
import styles from './TemplatesScore1.module.css';

interface TemplatesScore1Item {
  status: string;
  updatedAt: Date;
  description: string;
  assignee: string;
...
interface TemplatesScore1Props {
  items?: TemplatesScore1Item[];
...
export default function TemplatesScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: TemplatesScore1Props) {
