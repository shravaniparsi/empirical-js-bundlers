...
import styles from './TemplatesScore.module.css';

interface TemplatesScoreItem {
  priority: number;
  description: string;
  status: string;
  createdAt: Date;
...
interface TemplatesScoreProps {
  items?: TemplatesScoreItem[];
...
export default function TemplatesScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
