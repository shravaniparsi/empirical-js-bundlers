...
import styles from './TemplatesLoader.module.css';
...
interface TemplatesLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
