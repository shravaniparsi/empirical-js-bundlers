...
import TemplatesSpinner from './TemplatesSpinner';
import styles from './TemplatesCached.module.css';
...
interface TemplatesCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function TemplatesCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
