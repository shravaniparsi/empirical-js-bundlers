...
import styles from './ProductsAvatar1.module.css';

interface ProductsAvatar1Item {
  description: string;
  updatedAt: Date;
  tags: string[];
  status: string;
...
interface ProductsAvatar1Props {
  items?: ProductsAvatar1Item[];
...
export default function ProductsAvatar1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ProductsAvatar1Props) {
