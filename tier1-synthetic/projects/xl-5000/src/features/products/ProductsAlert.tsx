...
import ProductsModal1 from './ProductsModal1';
import ProductsSplit1 from './ProductsSplit1';
import ProductsSticky from './ProductsSticky';
import MediaSnackbar1 from '../media/MediaSnackbar1';
import styles from './ProductsAlert.module.css';
...
export default function ProductsAlert({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
