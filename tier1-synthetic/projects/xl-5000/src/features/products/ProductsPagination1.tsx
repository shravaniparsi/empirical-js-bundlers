...
import AuditCollapse1 from '../audit/AuditCollapse1';
import styles from './ProductsPagination1.module.css';
...
export default function ProductsPagination1({
  ...
  return (
    <nav className={navClasses} aria-label="ProductsPagination1">
      {activeItem && (
