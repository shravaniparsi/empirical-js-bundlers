...
import styles from './ProductsTag1.module.css';

interface ProductsTag1Item {
  assignee: string;
  tags: string[];
  createdAt: Date;
  id: string;
...
interface ProductsTag1Props {
  items?: ProductsTag1Item[];
...
export default function ProductsTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
