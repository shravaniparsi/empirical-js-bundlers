...
import ProductsSnackbar from './ProductsSnackbar';
import ProductsDetail from './ProductsDetail';
import styles from './ProductsPreview1.module.css';

interface ProductsPreview1Item {
  description: string;
  title: string;
  priority: number;
  tags: string[];
...
interface ProductsPreview1Props {
  items?: ProductsPreview1Item[];
...
export default function ProductsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ProductsPreview1Props) {
