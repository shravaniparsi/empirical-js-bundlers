...
import ProductsAvatar1 from './ProductsAvatar1';
import ProductsFooter from './ProductsFooter';
import styles from './ProductsTreeView.module.css';
...
export default function ProductsTreeView({
  ...
  return (
    <nav className={navClasses} aria-label="ProductsTreeView">
      {activeItem && (
