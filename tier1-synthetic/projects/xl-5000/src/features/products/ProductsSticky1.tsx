...
import ProductsSpacer1 from './ProductsSpacer1';
import ProductsBottomNav1 from './ProductsBottomNav1';
import ProductsRetry from './ProductsRetry';
import RolesLoader from '../roles/RolesLoader';
import styles from './ProductsSticky1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ProductsSticky1Props {
...
export default function ProductsSticky1({
  children,
