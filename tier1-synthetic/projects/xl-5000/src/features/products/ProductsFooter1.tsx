...
import ProductsPanel1 from './ProductsPanel1';
import UsersSnackbar from '../users/UsersSnackbar';
import styles from './ProductsFooter1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ProductsFooter1Props {
...
export default function ProductsFooter1({
  children,
