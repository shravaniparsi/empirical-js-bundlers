...
import styles from './ProductsDrawer1.module.css';
...
interface ProductsDrawer1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProductsDrawer1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProductsDrawer1">
      {activeItem && (
