...
import styles from './ProductsThumbnail1.module.css';

interface ProductsThumbnail1Item {
  assignee: string;
  updatedAt: Date;
  title: string;
  createdAt: Date;
...
interface ProductsThumbnail1Props {
  items?: ProductsThumbnail1Item[];
...
export default function ProductsThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: ProductsThumbnail1Props) {
