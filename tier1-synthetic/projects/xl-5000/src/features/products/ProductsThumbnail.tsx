...
import PermissionsCheckbox from '../permissions/PermissionsCheckbox';
import AuthList from '../auth/AuthList';
import styles from './ProductsThumbnail.module.css';

interface ProductsThumbnailItem {
  description: string;
  title: string;
  status: string;
  id: string;
...
interface ProductsThumbnailProps {
  items?: ProductsThumbnailItem[];
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['description', 'title', 'status']);
