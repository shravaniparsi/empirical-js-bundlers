...
import ProductsModal2 from './ProductsModal2';
import styles from './ProductsSnackbar.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProductsSnackbarProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProductsSnackbar({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
