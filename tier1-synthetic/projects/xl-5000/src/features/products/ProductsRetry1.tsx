...
import styles from './ProductsRetry1.module.css';
...
interface ProductsRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
