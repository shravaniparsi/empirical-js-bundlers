...
import styles from './ProductsScore1.module.css';

interface ProductsScore1Item {
  title: string;
  updatedAt: Date;
  createdAt: Date;
  status: string;
...
interface ProductsScore1Props {
  items?: ProductsScore1Item[];
...
export default function ProductsScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
