...
import styles from './ProductsFeed1.module.css';

interface ProductsFeed1Item {
  assignee: string;
  createdAt: Date;
  title: string;
  status: string;
...
interface ProductsFeed1Props {
  items?: ProductsFeed1Item[];
...
export default function ProductsFeed1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
