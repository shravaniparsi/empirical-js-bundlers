...
import styles from './ProductsTabs1.module.css';
...
export default function ProductsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProductsTabs1">
      {activeItem && (
