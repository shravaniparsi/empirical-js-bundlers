...
import styles from './ProductsFeed2.module.css';

interface ProductsFeed2Item {
  title: string;
  createdAt: Date;
  status: string;
  description: string;
...
interface ProductsFeed2Props {
  items?: ProductsFeed2Item[];
...
export default function ProductsFeed2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
