...
import ProductsContainer1 from './ProductsContainer1';
import styles from './ProductsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProductsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProductsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
