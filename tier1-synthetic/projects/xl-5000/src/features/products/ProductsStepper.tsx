...
import ProductsColorPicker1 from './ProductsColorPicker1';
import ProductsPagination1 from './ProductsPagination1';
import ProductsChip from './ProductsChip';
import styles from './ProductsStepper.module.css';
...
interface ProductsStepperProps {
  items: NavItem[];
  activeId?: string;
...
export default function ProductsStepper({
  ...
  return (
    <nav className={navClasses} aria-label="ProductsStepper">
      {activeItem && (
