...
import ProductsFactory1 from './ProductsFactory1';
import ProductsPanel from './ProductsPanel';
import styles from './ProductsSplit1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ProductsSplit1Props {
...
export default function ProductsSplit1({
  children,
