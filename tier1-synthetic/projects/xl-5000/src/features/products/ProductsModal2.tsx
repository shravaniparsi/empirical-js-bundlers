...
import ProductsModal3 from './ProductsModal3';
import ProductsTable from './ProductsTable';
import styles from './ProductsModal2.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface ProductsModal2Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function ProductsModal2({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
