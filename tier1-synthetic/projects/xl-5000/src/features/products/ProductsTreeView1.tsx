...
import ProductsDonut1 from './ProductsDonut1';
import styles from './ProductsTreeView1.module.css';
...
interface ProductsTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function ProductsTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="ProductsTreeView1">
      {activeItem && (
