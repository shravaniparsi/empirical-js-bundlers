...
import ProductsCollapse from './ProductsCollapse';
import styles from './ProductsDonut2.module.css';
...
export default function ProductsDonut2({
  data,
  title,
  height = 300,
  showLegend = true,
