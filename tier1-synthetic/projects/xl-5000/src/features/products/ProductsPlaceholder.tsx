...
import styles from './ProductsPlaceholder.module.css';
...
interface ProductsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function ProductsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
