...
import styles from './SurveysPaginated.module.css';
...
interface SurveysPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SurveysPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
