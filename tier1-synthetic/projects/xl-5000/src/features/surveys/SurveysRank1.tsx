...
import SurveysInfiniteScroll from './SurveysInfiniteScroll';
import SurveysPanel from './SurveysPanel';
import SurveysFunnel from './SurveysFunnel';
import styles from './SurveysRank1.module.css';

interface SurveysRank1Item {
  priority: number;
  createdAt: Date;
  description: string;
  status: string;
...
interface SurveysRank1Props {
  items?: SurveysRank1Item[];
...
export default function SurveysRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
