...
import SurveysPreview1 from './SurveysPreview1';
import SearchNavBar1 from '../search/SearchNavBar1';
import styles from './SurveysMeter1.module.css';

interface SurveysMeter1Item {
  description: string;
  updatedAt: Date;
  tags: string[];
  status: string;
...
interface SurveysMeter1Props {
  items?: SurveysMeter1Item[];
...
export default function SurveysMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
