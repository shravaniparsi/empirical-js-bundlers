...
import styles from './SurveysNavBar1.module.css';
...
export default function SurveysNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SurveysNavBar1">
      {activeItem && (
