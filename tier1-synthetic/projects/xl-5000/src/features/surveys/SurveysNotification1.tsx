...
import SurveysFunnel1 from './SurveysFunnel1';
import SurveysPanel2 from './SurveysPanel2';
import ReviewsSplit from '../reviews/ReviewsSplit';
import styles from './SurveysNotification1.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SurveysNotification1Props {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SurveysNotification1({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
