...
import styles from './SurveysSummary2.module.css';

interface SurveysSummary2Item {
  status: string;
  description: string;
  title: string;
  createdAt: Date;
...
interface SurveysSummary2Props {
  items?: SurveysSummary2Item[];
...
export default function SurveysSummary2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SurveysSummary2Props) {
