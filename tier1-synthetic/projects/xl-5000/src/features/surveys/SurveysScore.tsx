...
import styles from './SurveysScore.module.css';

interface SurveysScoreItem {
  status: string;
  title: string;
  priority: number;
  assignee: string;
...
interface SurveysScoreProps {
  items?: SurveysScoreItem[];
...
export default function SurveysScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
