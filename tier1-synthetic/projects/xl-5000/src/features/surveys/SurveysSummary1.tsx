...
import SurveysToggle from './SurveysToggle';
import SurveysGauge1 from './SurveysGauge1';
import styles from './SurveysSummary1.module.css';

interface SurveysSummary1Item {
  createdAt: Date;
  tags: string[];
  title: string;
  updatedAt: Date;
...
interface SurveysSummary1Props {
  items?: SurveysSummary1Item[];
...
export default function SurveysSummary1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SurveysSummary1Props) {
