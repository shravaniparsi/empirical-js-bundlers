...
import styles from './SurveysNotification.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SurveysNotificationProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SurveysNotification({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
