...
import SurveysNotification from './SurveysNotification';
import SurveysRegistry from './SurveysRegistry';
import styles from './SurveysSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface SurveysSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function SurveysSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
