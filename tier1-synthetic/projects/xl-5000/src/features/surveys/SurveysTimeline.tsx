...
import SurveysDetail1 from './SurveysDetail1';
import styles from './SurveysTimeline.module.css';

interface SurveysTimelineItem {
  updatedAt: Date;
  status: string;
  title: string;
  description: string;
...
interface SurveysTimelineProps {
  items?: SurveysTimelineItem[];
...
export default function SurveysTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SurveysTimelineProps) {
