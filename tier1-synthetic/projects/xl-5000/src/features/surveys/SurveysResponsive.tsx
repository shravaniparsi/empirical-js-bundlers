...
import SurveysLoader from './SurveysLoader';
import SurveysErrorBoundary from './SurveysErrorBoundary';
import styles from './SurveysResponsive.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SurveysResponsiveProps {
...
export default function SurveysResponsive({
  children,
