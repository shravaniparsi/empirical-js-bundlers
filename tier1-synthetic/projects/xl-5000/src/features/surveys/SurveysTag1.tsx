...
import SurveysBottomNav from './SurveysBottomNav';
import styles from './SurveysTag1.module.css';

interface SurveysTag1Item {
  title: string;
  priority: number;
  tags: string[];
  updatedAt: Date;
...
interface SurveysTag1Props {
  items?: SurveysTag1Item[];
...
export default function SurveysTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
