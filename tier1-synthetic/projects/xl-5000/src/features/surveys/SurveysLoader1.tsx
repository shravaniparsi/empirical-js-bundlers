...
import SurveysBarChart1 from './SurveysBarChart1';
import SurveysResponsive1 from './SurveysResponsive1';
import styles from './SurveysLoader1.module.css';
...
interface SurveysLoader1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SurveysLoader1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
