...
import styles from './SurveysDetail1.module.css';

interface SurveysDetail1Item {
  createdAt: Date;
  status: string;
  description: string;
  id: string;
...
interface SurveysDetail1Props {
  items?: SurveysDetail1Item[];
...
export default function SurveysDetail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
