...
import styles from './SurveysAvatar.module.css';

interface SurveysAvatarItem {
  description: string;
  assignee: string;
  priority: number;
  updatedAt: Date;
...
interface SurveysAvatarProps {
  items?: SurveysAvatarItem[];
...
export default function SurveysAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
