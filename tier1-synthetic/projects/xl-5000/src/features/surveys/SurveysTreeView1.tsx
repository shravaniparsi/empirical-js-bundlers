...
import SurveysMeter3 from './SurveysMeter3';
import SurveysPreview from './SurveysPreview';
import styles from './SurveysTreeView1.module.css';
...
interface SurveysTreeView1Props {
  items: NavItem[];
  activeId?: string;
...
export default function SurveysTreeView1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SurveysTreeView1">
      {activeItem && (
