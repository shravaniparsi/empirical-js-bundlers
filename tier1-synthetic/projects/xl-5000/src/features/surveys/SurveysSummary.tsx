...
import SurveysGauge2 from './SurveysGauge2';
import SurveysDonut from './SurveysDonut';
import SurveysPolling from './SurveysPolling';
import styles from './SurveysSummary.module.css';

interface SurveysSummaryItem {
  updatedAt: Date;
  status: string;
  priority: number;
  id: string;
...
interface SurveysSummaryProps {
  items?: SurveysSummaryItem[];
