...
import SurveysLineChart from './SurveysLineChart';
import SurveysTreeView1 from './SurveysTreeView1';
import styles from './SurveysAutocomplete.module.css';


interface SurveysAutocompleteProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SurveysAutocomplete({
  label,
  name,
