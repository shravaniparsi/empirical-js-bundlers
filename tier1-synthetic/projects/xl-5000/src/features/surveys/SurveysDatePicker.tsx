...
import SurveysSpinner from './SurveysSpinner';
import styles from './SurveysDatePicker.module.css';


interface SurveysDatePickerProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function SurveysDatePicker({
  label,
  name,
