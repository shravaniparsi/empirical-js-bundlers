...
import styles from './SurveysTimeline1.module.css';

interface SurveysTimeline1Item {
  updatedAt: Date;
  status: string;
  priority: number;
  id: string;
...
interface SurveysTimeline1Props {
  items?: SurveysTimeline1Item[];
...
export default function SurveysTimeline1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: SurveysTimeline1Props) {
