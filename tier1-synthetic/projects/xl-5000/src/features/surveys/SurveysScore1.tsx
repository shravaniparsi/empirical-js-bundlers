...
import styles from './SurveysScore1.module.css';

interface SurveysScore1Item {
  priority: number;
  assignee: string;
  createdAt: Date;
  updatedAt: Date;
...
interface SurveysScore1Props {
  items?: SurveysScore1Item[];
...
export default function SurveysScore1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
