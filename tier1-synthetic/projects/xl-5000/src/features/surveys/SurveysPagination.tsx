...
import SurveysPaginated1 from './SurveysPaginated1';
import SurveysMeter1 from './SurveysMeter1';
import SurveysHeader from './SurveysHeader';
import MediaErrorBoundary from '../media/MediaErrorBoundary';
import styles from './SurveysPagination.module.css';
...
export default function SurveysPagination({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SurveysPagination">
      {activeItem && (
