...
import SurveysScore1 from './SurveysScore1';
import styles from './SurveysMeter3.module.css';

interface SurveysMeter3Item {
  priority: number;
  updatedAt: Date;
  createdAt: Date;
  assignee: string;
...
interface SurveysMeter3Props {
  items?: SurveysMeter3Item[];
...
export default function SurveysMeter3({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
