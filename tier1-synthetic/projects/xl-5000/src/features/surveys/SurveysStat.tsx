...
import SurveysMeter from './SurveysMeter';
import SurveysDatePicker from './SurveysDatePicker';
import SettingsAreaChart from '../settings/SettingsAreaChart';
import styles from './SurveysStat.module.css';

interface SurveysStatItem {
  status: string;
  title: string;
  tags: string[];
  assignee: string;
...
interface SurveysStatProps {
  items?: SurveysStatItem[];
...
export default function SurveysStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
