...
import SurveysRating from './SurveysRating';
import styles from './SurveysFeed.module.css';

interface SurveysFeedItem {
  tags: string[];
  description: string;
  createdAt: Date;
  assignee: string;
...
interface SurveysFeedProps {
  items?: SurveysFeedItem[];
...
export default function SurveysFeed({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
