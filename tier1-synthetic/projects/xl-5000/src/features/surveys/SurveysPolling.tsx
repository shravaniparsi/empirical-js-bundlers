...
import SurveysResponsive2 from './SurveysResponsive2';
import SurveysGrid1 from './SurveysGrid1';
import styles from './SurveysPolling.module.css';
...
interface SurveysPollingProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SurveysPolling<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
