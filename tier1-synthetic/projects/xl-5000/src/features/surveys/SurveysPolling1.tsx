...
import styles from './SurveysPolling1.module.css';
...
interface SurveysPolling1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SurveysPolling1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
