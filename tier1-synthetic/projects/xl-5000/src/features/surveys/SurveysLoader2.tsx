...
import styles from './SurveysLoader2.module.css';
...
interface SurveysLoader2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function SurveysLoader2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
