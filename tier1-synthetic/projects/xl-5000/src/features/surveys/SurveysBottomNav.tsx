...
import SurveysToast from './SurveysToast';
import styles from './SurveysBottomNav.module.css';
...
interface SurveysBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function SurveysBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SurveysBottomNav">
      {activeItem && (
