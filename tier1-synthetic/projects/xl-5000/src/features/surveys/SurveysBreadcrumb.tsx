...
import styles from './SurveysBreadcrumb.module.css';
...
interface SurveysBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function SurveysBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SurveysBreadcrumb">
      {activeItem && (
