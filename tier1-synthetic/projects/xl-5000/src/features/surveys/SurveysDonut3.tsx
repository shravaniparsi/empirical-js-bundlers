...
import SurveysPreview2 from './SurveysPreview2';
import SurveysLoader1 from './SurveysLoader1';
import styles from './SurveysDonut3.module.css';
...
export default function SurveysDonut3({
  data,
  title,
  height = 300,
  showLegend = true,
