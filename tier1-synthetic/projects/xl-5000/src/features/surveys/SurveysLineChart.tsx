...
import SurveysRank from './SurveysRank';
import styles from './SurveysLineChart.module.css';
...
interface SurveysLineChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SurveysLineChart({
  data,
  title,
  height = 300,
  showLegend = true,
