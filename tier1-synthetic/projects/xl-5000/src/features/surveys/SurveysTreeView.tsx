...
import styles from './SurveysTreeView.module.css';
...
interface SurveysTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function SurveysTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SurveysTreeView">
      {activeItem && (
