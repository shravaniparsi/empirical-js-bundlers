...
import SurveysNavBar from './SurveysNavBar';
import SurveysRadio from './SurveysRadio';
import SurveysScroll from './SurveysScroll';
import styles from './SurveysCard.module.css';

interface SurveysCardItem {
  priority: number;
  assignee: string;
  title: string;
  tags: string[];
