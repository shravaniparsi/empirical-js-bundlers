...
import styles from './CommentsPlaceholder.module.css';
...
interface CommentsPlaceholderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsPlaceholder<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
