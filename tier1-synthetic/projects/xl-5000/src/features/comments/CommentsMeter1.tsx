...
import styles from './CommentsMeter1.module.css';

interface CommentsMeter1Item {
  createdAt: Date;
  priority: number;
  assignee: string;
  title: string;
...
interface CommentsMeter1Props {
  items?: CommentsMeter1Item[];
...
export default function CommentsMeter1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
