...
import styles from './CommentsLoader.module.css';
...
interface CommentsLoaderProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsLoader<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
