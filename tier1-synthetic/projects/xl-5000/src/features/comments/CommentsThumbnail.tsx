...
import styles from './CommentsThumbnail.module.css';

interface CommentsThumbnailItem {
  priority: number;
  title: string;
  tags: string[];
  assignee: string;
...
interface CommentsThumbnailProps {
  items?: CommentsThumbnailItem[];
...
export default function CommentsThumbnail({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CommentsThumbnailProps) {
