...
import styles from './CommentsPaginated.module.css';
...
interface CommentsPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
