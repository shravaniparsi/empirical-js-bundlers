...
import styles from './CommentsCached.module.css';
...
interface CommentsCachedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsCached<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
