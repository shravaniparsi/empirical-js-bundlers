...
import styles from './CommentsProgress.module.css';

interface CommentsProgressItem {
  assignee: string;
  updatedAt: Date;
  priority: number;
  tags: string[];
...
export default function CommentsProgress({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CommentsProgressProps) {
