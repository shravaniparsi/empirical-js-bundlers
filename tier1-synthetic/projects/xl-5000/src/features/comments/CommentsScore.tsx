...
import CommentsSpinner2 from './CommentsSpinner2';
import CommentsAreaChart1 from './CommentsAreaChart1';
import styles from './CommentsScore.module.css';

interface CommentsScoreItem {
  description: string;
  createdAt: Date;
  title: string;
  updatedAt: Date;
...
export default function CommentsScore({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
