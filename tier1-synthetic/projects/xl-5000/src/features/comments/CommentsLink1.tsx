...
import styles from './CommentsLink1.module.css';
...
export default function CommentsLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CommentsLink1">
      {activeItem && (
