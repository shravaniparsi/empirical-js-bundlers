...
import CommentsCached from './CommentsCached';
import styles from './CommentsAreaChart.module.css';
...
interface CommentsAreaChartProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CommentsAreaChart({
  data,
  title,
  height = 300,
  showLegend = true,
