...
import styles from './CommentsChip1.module.css';

interface CommentsChip1Item {
  tags: string[];
  assignee: string;
  title: string;
  id: string;
...
interface CommentsChip1Props {
  items?: CommentsChip1Item[];
...
export default function CommentsChip1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
