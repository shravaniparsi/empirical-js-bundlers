...
import CommentsHOC1 from './CommentsHOC1';
import styles from './CommentsCard1.module.css';

interface CommentsCard1Item {
  title: string;
  description: string;
  priority: number;
  status: string;
...
interface CommentsCard1Props {
  items?: CommentsCard1Item[];
...
export default function CommentsCard1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
