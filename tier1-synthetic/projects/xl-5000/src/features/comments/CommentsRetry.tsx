...
import ShippingScroll from '../shipping/ShippingScroll';
import styles from './CommentsRetry.module.css';
...
interface CommentsRetryProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsRetry<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
