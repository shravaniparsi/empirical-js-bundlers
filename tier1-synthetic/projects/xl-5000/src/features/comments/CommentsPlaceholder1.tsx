...
import CommentsRangeSlider from './CommentsRangeSlider';
import CommentsPaginated from './CommentsPaginated';
import styles from './CommentsPlaceholder1.module.css';
...
interface CommentsPlaceholder1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsPlaceholder1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
