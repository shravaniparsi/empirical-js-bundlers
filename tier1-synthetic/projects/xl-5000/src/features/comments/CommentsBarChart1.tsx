...
import CommentsMeter from './CommentsMeter';
import styles from './CommentsBarChart1.module.css';
...
interface CommentsBarChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function CommentsBarChart1({
  data,
  title,
  height = 300,
  showLegend = true,
