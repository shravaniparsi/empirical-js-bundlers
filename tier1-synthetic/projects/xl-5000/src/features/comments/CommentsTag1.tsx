...
import CommentsPieChart from './CommentsPieChart';
import CommentsTable from './CommentsTable';
import styles from './CommentsTag1.module.css';

interface CommentsTag1Item {
  description: string;
  createdAt: Date;
  assignee: string;
  id: string;
...
interface CommentsTag1Props {
  items?: CommentsTag1Item[];
...
export default function CommentsTag1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
