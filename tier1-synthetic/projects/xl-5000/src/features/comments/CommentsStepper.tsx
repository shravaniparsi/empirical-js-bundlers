...
import CommentsMeter1 from './CommentsMeter1';
import styles from './CommentsStepper.module.css';
...
interface CommentsStepperProps {
  items: NavItem[];
  activeId?: string;
...
export default function CommentsStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CommentsStepper">
      {activeItem && (
