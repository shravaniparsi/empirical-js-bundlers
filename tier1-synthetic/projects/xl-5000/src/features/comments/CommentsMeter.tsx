...
import styles from './CommentsMeter.module.css';

interface CommentsMeterItem {
  priority: number;
  title: string;
  status: string;
  id: string;
...
interface CommentsMeterProps {
  items?: CommentsMeterItem[];
...
export default function CommentsMeter({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
