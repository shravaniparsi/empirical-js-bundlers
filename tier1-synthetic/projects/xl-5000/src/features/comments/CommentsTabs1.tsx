...
import styles from './CommentsTabs1.module.css';
...
export default function CommentsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CommentsTabs1">
      {activeItem && (
