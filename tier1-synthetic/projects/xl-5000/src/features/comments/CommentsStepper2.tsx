...
import CommentsPieChart2 from './CommentsPieChart2';
import CommentsTag from './CommentsTag';
import AuditFooter from '../audit/AuditFooter';
import styles from './CommentsStepper2.module.css';
...
interface CommentsStepper2Props {
  items: NavItem[];
  activeId?: string;
...
export default function CommentsStepper2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CommentsStepper2">
      {activeItem && (
