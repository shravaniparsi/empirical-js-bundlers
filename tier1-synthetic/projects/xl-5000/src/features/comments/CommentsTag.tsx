...
import CommentsChip2 from './CommentsChip2';
import styles from './CommentsTag.module.css';

interface CommentsTagItem {
  tags: string[];
  createdAt: Date;
  description: string;
  title: string;
...
interface CommentsTagProps {
  items?: CommentsTagItem[];
...
export default function CommentsTag({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
