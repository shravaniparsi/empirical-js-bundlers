...
import styles from './CommentsBottomNav.module.css';
...
interface CommentsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function CommentsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="CommentsBottomNav">
      {activeItem && (
