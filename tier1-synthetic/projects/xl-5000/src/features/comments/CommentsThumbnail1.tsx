...
import styles from './CommentsThumbnail1.module.css';

interface CommentsThumbnail1Item {
  createdAt: Date;
  updatedAt: Date;
  title: string;
  tags: string[];
...
interface CommentsThumbnail1Props {
  items?: CommentsThumbnail1Item[];
...
export default function CommentsThumbnail1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: CommentsThumbnail1Props) {
