...
import CommentsCollapse1 from './CommentsCollapse1';
import styles from './CommentsStat.module.css';

interface CommentsStatItem {
  updatedAt: Date;
  createdAt: Date;
  assignee: string;
  tags: string[];
...
interface CommentsStatProps {
  items?: CommentsStatItem[];
...
export default function CommentsStat({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
