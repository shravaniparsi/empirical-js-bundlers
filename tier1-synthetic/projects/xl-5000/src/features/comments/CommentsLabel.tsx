...
import CommentsLineChart1 from './CommentsLineChart1';
import CommentsRetry from './CommentsRetry';
import styles from './CommentsLabel.module.css';

interface CommentsLabelItem {
  description: string;
  updatedAt: Date;
  assignee: string;
  title: string;
...
interface CommentsLabelProps {
  items?: CommentsLabelItem[];
