...
import styles from './CommentsRetry1.module.css';
...
interface CommentsRetry1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function CommentsRetry1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
