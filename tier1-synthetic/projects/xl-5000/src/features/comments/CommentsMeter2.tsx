...
import styles from './CommentsMeter2.module.css';

interface CommentsMeter2Item {
  createdAt: Date;
  assignee: string;
  description: string;
  priority: number;
...
interface CommentsMeter2Props {
  items?: CommentsMeter2Item[];
...
export default function CommentsMeter2({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
