...
import WorkflowsHeader1 from './WorkflowsHeader1';
import WorkflowsPrefetch from './WorkflowsPrefetch';
import styles from './WorkflowsStepper.module.css';
...
interface WorkflowsStepperProps {
  items: NavItem[];
  activeId?: string;
...
export default function WorkflowsStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsStepper">
      {activeItem && (
