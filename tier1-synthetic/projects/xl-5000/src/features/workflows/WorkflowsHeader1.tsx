...
import WorkflowsTabs1 from './WorkflowsTabs1';
import ProfileNavBar1 from '../profile/ProfileNavBar1';
import styles from './WorkflowsHeader1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface WorkflowsHeader1Props {
...
export default function WorkflowsHeader1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
