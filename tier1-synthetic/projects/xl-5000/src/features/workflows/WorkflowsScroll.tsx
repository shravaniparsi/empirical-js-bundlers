...
import InventoryRating from '../inventory/InventoryRating';
import styles from './WorkflowsScroll.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface WorkflowsScrollProps {
...
export default function WorkflowsScroll({
  children,
