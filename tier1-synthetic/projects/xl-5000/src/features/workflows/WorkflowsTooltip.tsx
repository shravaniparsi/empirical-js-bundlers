...
import WorkflowsSticky from './WorkflowsSticky';
import WorkflowsGrid2 from './WorkflowsGrid2';
import WorkflowsBadge from './WorkflowsBadge';
import styles from './WorkflowsTooltip.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WorkflowsTooltipProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WorkflowsTooltip({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
