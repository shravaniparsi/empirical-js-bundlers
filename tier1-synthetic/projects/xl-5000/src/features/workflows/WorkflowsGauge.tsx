...
import WorkflowsGrid3 from './WorkflowsGrid3';
import ProductsDrawer from '../products/ProductsDrawer';
import styles from './WorkflowsGauge.module.css';
...
export default function WorkflowsGauge({
  data,
  title,
  height = 300,
  showLegend = true,
