...
import WorkflowsInput3 from './WorkflowsInput3';
import styles from './WorkflowsCached2.module.css';
...
interface WorkflowsCached2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsCached2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
