...
import WorkflowsSnackbar from './WorkflowsSnackbar';
import styles from './WorkflowsTabs1.module.css';
...
export default function WorkflowsTabs1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsTabs1">
      {activeItem && (
