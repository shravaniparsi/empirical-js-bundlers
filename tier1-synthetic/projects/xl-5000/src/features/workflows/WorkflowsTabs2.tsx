...
import styles from './WorkflowsTabs2.module.css';
...
export default function WorkflowsTabs2({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsTabs2">
      {activeItem && (
