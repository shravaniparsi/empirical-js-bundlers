...
import styles from './WorkflowsPreview1.module.css';

interface WorkflowsPreview1Item {
  updatedAt: Date;
  tags: string[];
  assignee: string;
  priority: number;
...
interface WorkflowsPreview1Props {
  items?: WorkflowsPreview1Item[];
...
export default function WorkflowsPreview1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WorkflowsPreview1Props) {
