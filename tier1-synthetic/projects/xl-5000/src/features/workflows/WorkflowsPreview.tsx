...
import styles from './WorkflowsPreview.module.css';

interface WorkflowsPreviewItem {
  updatedAt: Date;
  status: string;
  assignee: string;
  description: string;
...
interface WorkflowsPreviewProps {
  items?: WorkflowsPreviewItem[];
