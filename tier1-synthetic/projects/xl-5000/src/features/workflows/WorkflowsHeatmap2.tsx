...
import WorkflowsTimeline1 from './WorkflowsTimeline1';
import TeamsAvatar1 from '../teams/TeamsAvatar1';
import NotificationsContext from '../notifications/NotificationsContext';
import styles from './WorkflowsHeatmap2.module.css';
...
interface WorkflowsHeatmap2Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsHeatmap2({
  data,
  title,
  height = 300,
  showLegend = true,
