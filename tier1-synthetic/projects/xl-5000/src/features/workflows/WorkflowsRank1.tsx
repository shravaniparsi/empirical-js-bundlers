...
import styles from './WorkflowsRank1.module.css';

interface WorkflowsRank1Item {
  createdAt: Date;
  description: string;
  tags: string[];
  id: string;
...
interface WorkflowsRank1Props {
  items?: WorkflowsRank1Item[];
...
export default function WorkflowsRank1({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
