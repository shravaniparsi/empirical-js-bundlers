...
import WorkflowsInput2 from './WorkflowsInput2';
import WorkflowsProvider from './WorkflowsProvider';
import styles from './WorkflowsAlert.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface WorkflowsAlertProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function WorkflowsAlert({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
