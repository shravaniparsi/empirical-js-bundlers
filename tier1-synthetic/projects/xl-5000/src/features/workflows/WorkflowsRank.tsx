...
import WorkflowsGauge from './WorkflowsGauge';
import WorkflowsNavBar from './WorkflowsNavBar';
import styles from './WorkflowsRank.module.css';

interface WorkflowsRankItem {
  status: string;
  createdAt: Date;
  priority: number;
  title: string;
...
interface WorkflowsRankProps {
  items?: WorkflowsRankItem[];
...
export default function WorkflowsRank({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
