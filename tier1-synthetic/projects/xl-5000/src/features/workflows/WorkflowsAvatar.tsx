...
import styles from './WorkflowsAvatar.module.css';

interface WorkflowsAvatarItem {
  description: string;
  updatedAt: Date;
  status: string;
  assignee: string;
...
interface WorkflowsAvatarProps {
  items?: WorkflowsAvatarItem[];
...
export default function WorkflowsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WorkflowsAvatarProps) {
