...
import styles from './WorkflowsNavBar1.module.css';
...
interface WorkflowsNavBar1Props {
  items: NavItem[];
  activeId?: string;
...
export default function WorkflowsNavBar1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsNavBar1">
      {activeItem && (
