...
import WorkflowsScroll from './WorkflowsScroll';
import styles from './WorkflowsTextArea.module.css';


interface WorkflowsTextAreaProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function WorkflowsTextArea({
  label,
  name,
