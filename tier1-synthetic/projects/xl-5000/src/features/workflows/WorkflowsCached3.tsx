...
import styles from './WorkflowsCached3.module.css';
...
interface WorkflowsCached3Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsCached3<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
