...
import styles from './WorkflowsSuspense2.module.css';
...
interface WorkflowsSuspense2Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsSuspense2<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
