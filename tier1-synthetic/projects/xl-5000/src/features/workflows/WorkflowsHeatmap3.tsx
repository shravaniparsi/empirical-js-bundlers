...
import ReviewsToggle1 from '../reviews/ReviewsToggle1';
import SettingsCard3 from '../settings/SettingsCard3';
import styles from './WorkflowsHeatmap3.module.css';
...
interface WorkflowsHeatmap3Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsHeatmap3({
  data,
  title,
  height = 300,
  showLegend = true,
