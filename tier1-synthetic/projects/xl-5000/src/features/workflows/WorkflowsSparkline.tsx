...
import WorkflowsPlaceholder from './WorkflowsPlaceholder';
import WorkflowsAreaChart1 from './WorkflowsAreaChart1';
import WorkflowsGrid2 from './WorkflowsGrid2';
import AdminColorPicker from '../admin/AdminColorPicker';
import AuthChip from '../auth/AuthChip';
import FormsPolling2 from '../forms/FormsPolling2';
import styles from './WorkflowsSparkline.module.css';
...
interface WorkflowsSparklineProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsSparkline({
  data,
  title,
  height = 300,
  showLegend = true,
