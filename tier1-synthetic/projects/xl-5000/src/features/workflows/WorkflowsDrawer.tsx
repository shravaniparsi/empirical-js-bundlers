...
import WorkflowsBreadcrumb from './WorkflowsBreadcrumb';
import WorkflowsSuspense1 from './WorkflowsSuspense1';
import styles from './WorkflowsDrawer.module.css';
...
export default function WorkflowsDrawer({
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsDrawer">
      {activeItem && (
