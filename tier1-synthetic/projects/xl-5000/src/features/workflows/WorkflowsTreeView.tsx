...
import styles from './WorkflowsTreeView.module.css';
...
interface WorkflowsTreeViewProps {
  items: NavItem[];
  activeId?: string;
...
export default function WorkflowsTreeView({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsTreeView">
      {activeItem && (
