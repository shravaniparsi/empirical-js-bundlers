...
import WorkflowsRangeSlider from './WorkflowsRangeSlider';
import WorkflowsNavBar1 from './WorkflowsNavBar1';
import WorkflowsBottomNav from './WorkflowsBottomNav';
import styles from './WorkflowsHeatmap.module.css';
...
interface WorkflowsHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
