...
import OrdersTag1 from '../orders/OrdersTag1';
import styles from './WorkflowsBreadcrumb.module.css';
...
interface WorkflowsBreadcrumbProps {
  items: NavItem[];
  activeId?: string;
...
export default function WorkflowsBreadcrumb({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="WorkflowsBreadcrumb">
      {activeItem && (
