...
import styles from './WorkflowsTimeline.module.css';

interface WorkflowsTimelineItem {
  description: string;
  updatedAt: Date;
  title: string;
  assignee: string;
...
interface WorkflowsTimelineProps {
  items?: WorkflowsTimelineItem[];
...
export default function WorkflowsTimeline({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: WorkflowsTimelineProps) {
