...
import styles from './WorkflowsRangeSlider.module.css';


interface WorkflowsRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function WorkflowsRangeSlider({
  label,
  name,
