...
import WorkflowsBreadcrumb1 from './WorkflowsBreadcrumb1';
import WorkflowsSidebar from './WorkflowsSidebar';
import styles from './WorkflowsSuspense1.module.css';
...
interface WorkflowsSuspense1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsSuspense1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
