...
import styles from './WorkflowsChip.module.css';

interface WorkflowsChipItem {
  createdAt: Date;
  updatedAt: Date;
  tags: string[];
  assignee: string;
...
interface WorkflowsChipProps {
  items?: WorkflowsChipItem[];
...
export default function WorkflowsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
