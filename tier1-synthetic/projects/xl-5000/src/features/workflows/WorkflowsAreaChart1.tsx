...
import styles from './WorkflowsAreaChart1.module.css';
...
interface WorkflowsAreaChart1Props {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function WorkflowsAreaChart1({
  data,
  title,
  height = 300,
  showLegend = true,
