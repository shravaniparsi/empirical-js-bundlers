...
import WorkflowsFactory from './WorkflowsFactory';
import styles from './WorkflowsCached1.module.css';
...
interface WorkflowsCached1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function WorkflowsCached1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
