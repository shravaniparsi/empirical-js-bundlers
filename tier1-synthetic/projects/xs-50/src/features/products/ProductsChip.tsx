...
import styles from './ProductsChip.module.css';

interface ProductsChipItem {
  assignee: string;
  description: string;
  priority: number;
  id: string;
...
interface ProductsChipProps {
  items?: ProductsChipItem[];
...
export default function ProductsChip({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
