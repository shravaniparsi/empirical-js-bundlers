...
import OrdersScore from './OrdersScore';
import styles from './OrdersBottomNav.module.css';
...
interface OrdersBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function OrdersBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OrdersBottomNav">
      {activeItem && (
