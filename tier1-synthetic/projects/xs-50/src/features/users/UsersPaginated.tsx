...
import UsersPrefetch from './UsersPrefetch';
import OrdersBottomNav from '../orders/OrdersBottomNav';
import styles from './UsersPaginated.module.css';
...
interface UsersPaginatedProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function UsersPaginated<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
