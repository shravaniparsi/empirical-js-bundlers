...
import styles from './NotificationsTag.module.css';

interface NotificationsTagItem {
  updatedAt: Date;
  title: string;
  priority: number;
  tags: string[];
...
interface NotificationsTagProps {
  items?: NotificationsTagItem[];
    ...
    <div className={clsx(styles.container, styles[variant], className)}>
      ...
      <ul className={styles.list}>
        {visibleItems.map(item => {
          const picked = pick(item, ['updatedAt', 'title', 'priority']);
