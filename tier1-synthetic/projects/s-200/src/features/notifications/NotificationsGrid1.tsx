...
import SettingsLink1 from '../settings/SettingsLink1';
import styles from './NotificationsGrid1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface NotificationsGrid1Props {
...
export default function NotificationsGrid1({
  children,
  direction = 'vertical',
  gap = 'md',
  padding = 'md',
