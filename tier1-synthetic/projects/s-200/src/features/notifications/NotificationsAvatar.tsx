...
import styles from './NotificationsAvatar.module.css';

interface NotificationsAvatarItem {
  createdAt: Date;
  priority: number;
  updatedAt: Date;
  status: string;
...
interface NotificationsAvatarProps {
  items?: NotificationsAvatarItem[];
...
export default function NotificationsAvatar({
  items = [],
  onItemClick,
  variant = 'detailed',
  className,
  maxItems = 10,
}: NotificationsAvatarProps) {
