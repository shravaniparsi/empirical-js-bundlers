...
import ProductsStat from '../products/ProductsStat';
import AuthTabs from '../auth/AuthTabs';
import styles from './ReportsSticky.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface ReportsStickyProps {
...
export default function ReportsSticky({
  children,
