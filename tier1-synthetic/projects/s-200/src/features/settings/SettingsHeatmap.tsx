...
import SettingsDivider1 from './SettingsDivider1';
import AuthTabs from '../auth/AuthTabs';
import DashboardScore from '../dashboard/DashboardScore';
import styles from './SettingsHeatmap.module.css';
...
interface SettingsHeatmapProps {
  data: DataPoint[];
  title?: string;
  height?: number;
  showLegend?: boolean;
...
export default function SettingsHeatmap({
  data,
  title,
  height = 300,
  showLegend = true,
