...
import SettingsPolling from './SettingsPolling';
import SettingsPaginated from './SettingsPaginated';
import styles from './SettingsDivider1.module.css';

type LayoutDirection = 'horizontal' | 'vertical';
type LayoutGap = 'none' | 'sm' | 'md' | 'lg' | 'xl';

interface SettingsDivider1Props {
...
export default function SettingsDivider1({
  children,
