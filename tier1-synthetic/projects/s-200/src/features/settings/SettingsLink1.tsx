...
import styles from './SettingsLink1.module.css';
...
export default function SettingsLink1({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="SettingsLink1">
      {activeItem && (
