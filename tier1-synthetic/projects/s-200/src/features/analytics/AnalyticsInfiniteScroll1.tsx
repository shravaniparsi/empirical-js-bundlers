...
import styles from './AnalyticsInfiniteScroll1.module.css';
...
interface AnalyticsInfiniteScroll1Props<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsInfiniteScroll1<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: AnalyticsInfiniteScroll1Props<T>) {
