...
import styles from './AnalyticsInfiniteScroll.module.css';
...
interface AnalyticsInfiniteScrollProps<T = unknown> {
  url?: string;
  fetchFn?: () => Promise<T>;
...
export default function AnalyticsInfiniteScroll<T = unknown>({
  url,
  fetchFn,
  children: renderProp,
  retryCount = 3,
  ...
  errorFallback,
  className,
}: AnalyticsInfiniteScrollProps<T>) {
