...
import styles from './AnalyticsRangeSlider.module.css';


interface AnalyticsRangeSliderProps {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function AnalyticsRangeSlider({
  label,
  name,
