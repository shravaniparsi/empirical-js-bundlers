...
import DashboardTag from '../dashboard/DashboardTag';
import styles from './AnalyticsSpinner.module.css';

type Severity = 'info' | 'success' | 'warning' | 'error';

interface AnalyticsSpinnerProps {
  open?: boolean;
  severity?: Severity;
  title?: string;
  message: string;
...
export default function AnalyticsSpinner({
  open: controlledOpen,
  severity = 'info',
  title,
  message,
