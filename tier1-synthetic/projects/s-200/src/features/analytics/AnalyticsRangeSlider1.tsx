...
import AnalyticsBottomNav from './AnalyticsBottomNav';
import AnalyticsTimePicker from './AnalyticsTimePicker';
import OrdersGrid from '../orders/OrdersGrid';
import DashboardScore from '../dashboard/DashboardScore';
import styles from './AnalyticsRangeSlider1.module.css';


interface AnalyticsRangeSlider1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function AnalyticsRangeSlider1({
  label,
  name,
