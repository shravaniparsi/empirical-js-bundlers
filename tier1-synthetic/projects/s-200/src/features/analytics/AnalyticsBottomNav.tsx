...
import AnalyticsInfiniteScroll from './AnalyticsInfiniteScroll';
import AnalyticsHOC from './AnalyticsHOC';
import AnalyticsTextArea from './AnalyticsTextArea';
import DashboardScore from '../dashboard/DashboardScore';
import styles from './AnalyticsBottomNav.module.css';
...
interface AnalyticsBottomNavProps {
  items: NavItem[];
  activeId?: string;
...
export default function AnalyticsBottomNav({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="AnalyticsBottomNav">
      {activeItem && (
