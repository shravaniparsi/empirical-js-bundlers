...
import UsersPrefetch from '../users/UsersPrefetch';
import styles from './OrdersToggle1.module.css';


interface OrdersToggle1Props {
  label: string;
  name: string;
  value?: string;
  defaultValue?: string;
...
export default function OrdersToggle1({
  label,
  name,
