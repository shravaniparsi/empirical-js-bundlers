...
import styles from './OrdersStepper.module.css';
...
export default function OrdersStepper({
  items,
  activeId,
  onSelect,
  ...
  return (
    <nav className={navClasses} aria-label="OrdersStepper">
      {activeItem && (
